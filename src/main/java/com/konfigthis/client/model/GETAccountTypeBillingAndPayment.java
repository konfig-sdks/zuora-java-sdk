 ...
 */
@ApiModel(description = "Container for billing and payment information for the account.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class GETAccountTypeBillingAndPayment {
  ...
  public GETAccountTypeBillingAndPayment() {
  }

  public GETAccountTypeBillingAndPayment additionalEmailAddresses(List<String> additionalEmailAddresses) {
  ...
  public GETAccountTypeBillingAndPayment addAdditionalEmailAddressesItem(String additionalEmailAddressesItem) {
  ...
  **/
  ...
  public GETAccountTypeBillingAndPayment autoPay(Boolean autoPay) {
  ...
  **/
  ...
  public GETAccountTypeBillingAndPayment defaultPaymentMethodId(String defaultPaymentMethodId) {
  ...
  **/
  ...
  public GETAccountTypeBillingAndPayment invoiceDeliveryPrefsEmail(Boolean invoiceDeliveryPrefsEmail) {
  ...
  **/
  ...
  public GETAccountTypeBillingAndPayment invoiceDeliveryPrefsPrint(Boolean invoiceDeliveryPrefsPrint) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A payment-terms indicator defined in the web-based UI administrative settings, e.g., \"Net 30\". ")
   ...
   * @return the GETAccountTypeBillingAndPayment instance itself
   */
  public GETAccountTypeBillingAndPayment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalEmailAddresses, geTAccountTypeBillingAndPayment.additionalEmailAddresses) &&
        Objects.equals(this.autoPay, geTAccountTypeBillingAndPayment.autoPay) &&
        Objects.equals(this.billCycleDay, geTAccountTypeBillingAndPayment.billCycleDay) &&
        Objects.equals(this.currency, geTAccountTypeBillingAndPayment.currency) &&
        Objects.equals(this.defaultPaymentMethodId, geTAccountTypeBillingAndPayment.defaultPaymentMethodId) &&
        Objects.equals(this.invoiceDeliveryPrefsEmail, geTAccountTypeBillingAndPayment.invoiceDeliveryPrefsEmail) &&
        Objects.equals(this.invoiceDeliveryPrefsPrint, geTAccountTypeBillingAndPayment.invoiceDeliveryPrefsPrint) &&
        ...
        Objects.equals(this.additionalProperties, geTAccountTypeBillingAndPayment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additionalEmailAddresses, autoPay, billCycleDay, currency, defaultPaymentMethodId, invoiceDeliveryPrefsEmail, invoiceDeliveryPrefsPrint, paymentGateway, paymentTerm, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETAccountTypeBillingAndPayment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETAccountTypeBillingAndPayment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETAccountTypeBillingAndPayment is not found in the empty JSON string", GETAccountTypeBillingAndPayment.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETAccountTypeBillingAndPayment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETAccountTypeBillingAndPayment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETAccountTypeBillingAndPayment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETAccountTypeBillingAndPayment.class));

       return (TypeAdapter<T>) new TypeAdapter<GETAccountTypeBillingAndPayment>() {
           @Override
           public void write(JsonWriter out, GETAccountTypeBillingAndPayment value) throws IOException {
           ...
           @Override
           public GETAccountTypeBillingAndPayment read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETAccountTypeBillingAndPayment instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETAccountTypeBillingAndPayment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETAccountTypeBillingAndPayment
  * @throws IOException if the JSON string is invalid with respect to GETAccountTypeBillingAndPayment
  */
  public static GETAccountTypeBillingAndPayment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETAccountTypeBillingAndPayment.class);
  }

 /**
  * Convert an instance of GETAccountTypeBillingAndPayment to an JSON string
  *
  * @return JSON string
  */
