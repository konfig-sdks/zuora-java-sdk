...
public class POSTPaymentMethodDecryption {
 ...
 public enum MitProfileTypeEnum {
  ...
  public POSTPaymentMethodDecryption() {
  }

  public POSTPaymentMethodDecryption accountID(String accountID) {
  ...
  **/
  ...
  @ApiModelProperty(example = "402891a25a02e11c015a02f3c6100003", value = "The ID of the customer account associated with this payment method. To create an orphan payment method that is not associated with any customer account, you do not need to specify this field during creation. However, you must associate the orphan payment method with a customer account within 10 days. Otherwise, this orphan payment method will be deleted.")
  ...
  public POSTPaymentMethodDecryption cardHolderInfo(CreatePaymentMethodCardholderInfo cardHolderInfo) {
  ...
  **/
  ...
  public POSTPaymentMethodDecryption integrationType(String integrationType) {
  ...
  **/
  ...
  @ApiModelProperty(example = "ApplePay", required = true, value = "Field to identify the token decryption type.  **Note:** The only value at this time is `ApplePay`.  ")
  ...
  public POSTPaymentMethodDecryption invoiceId(String invoiceId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "INV000000005", value = "The id of invoice this payment will apply to.  **Note:** When `processPayment` is `true`, this field is required. Only one invoice can be paid; for scenarios where you want to pay for multiple invoices, set `processPayment` to `false` and call payment API separately. ")
  ...
  public POSTPaymentMethodDecryption merchantID(String merchantID) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "merchant.CN.com.zuora.services416", required = true, value = "The Merchant ID that was configured for use with Apple Pay in the Apple iOS Developer Center. ")
  ...
  public POSTPaymentMethodDecryption mitConsentAgreementSrc(MitConsentAgreementSrcEnum mitConsentAgreementSrc) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "EXTERNAL", value = "This field is only available for the following gateway integrations to create stored credential profiles within payment methods:   - Chase Paymentech Orbital Gateway   - CyberSource Payment API v2.0   - Stripe v2   - Vantiv (Now Worldpay)  Specify how the consent agreement has been established with the customer. The allowed value is `External`. It is required if the `mitProfileAction` field is specified. If you do not specify the `mitProfileAction` field, Zuora will automatically create a stored credential profile for the payment method, with the default value `External` set to this field. ")
  ...
  public POSTPaymentMethodDecryption mitProfileAction(MitProfileActionEnum mitProfileAction) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ACTIVATE", value = "This field is only available for the following gateway integrations to create stored credential profiles within payment methods:   - Chase Paymentech Orbital Gateway   - CyberSource Payment API v2.0   - Stripe v2   - Vantiv (Now Worldpay)  Specify either of the following values in this field:        - `Activate` - Use this value if you are creating the stored credential profile after receiving the customer's consent.          Zuora will create the stored credential profile then send a cardholder-initiated transaction (CIT) to the payment gateway to validate the stored credential profile. If the CIT succeeds, the status of the stored credential profile will be `Active`. If the CIT does not succeed, Zuora will not create a stored credential profile.            If the payment gateway does not support the stored credential transaction framework, the status of the stored credential profile will be `Agreed`.        - `Persist` - Use this value if the stored credential profile represents a stored credential profile in an external system. The status of the payment method's stored credential profile will be `Active`.    If you do not specify this field, Zuora will automatically create a stored credential profile for the payment method, with the default value `Activate` set to this field.      ")
  ...
  public POSTPaymentMethodDecryption mitProfileType(MitProfileTypeEnum mitProfileType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "RECURRING", value = "This field is only available for the following gateway integrations to create stored credential profiles within payment methods:   - Chase Paymentech Orbital Gateway   - CyberSource Payment API v2.0   - Stripe v2   - Vantiv (Now Worldpay)  This field indicates the type of the stored credential profile to process recurring or unsecheduled transactions. It is required if the `mitProfileAction` field is specified. If you do not specify the `mitProfileAction` field, Zuora will automatically create a stored credential profile for the payment method, with the default value `Recurring` set to this field.      ")
  ...
  public POSTPaymentMethodDecryption paymentGateway(String paymentGateway) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CyberSourceOPG", value = "The label name of the gateway instance configured in Zuora that should process the payment. When creating a Payment, this must be a valid gateway instance ID and this gateway must support the specific payment method. If not specified, the default gateway of your Zuora customer account will be used.  **Note:** When `processPayment` is `true`, this field is required. When `processPayment` is `false`, the default payment gateway of your Zuora customer account will be used no matter whether a payment gateway instance is specified in the `paymentGateway` field. ")
  ...
  public POSTPaymentMethodDecryption paymentToken(Object paymentToken) {
  ...
  **/
  ...
  public POSTPaymentMethodDecryption processPayment(Boolean processPayment) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "A boolean flag to control whether a payment should be processed after creating payment method. The payment amount will be equivalent to the amount the merchant supplied in the ApplePay session. Default is false.  If this field is set to `true`, you must specify the `paymentGateway` field with the payment gateway instance name.  If this field is set to `false`:   - The default payment gateway of your Zuora customer account will be used no matter whether a payment gateway instance is specified in the `paymentGateway` field.    - You must select the **Verify new credit card** check box on the gateway instance settings page. Otherwise, the cryptogram will not be sent to the gateway.   - A separate subscribe or payment API call is required after this payment method creation call. ")
   ...
   * @return the POSTPaymentMethodDecryption instance itself
   */
  public POSTPaymentMethodDecryption putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTPaymentMethodDecryption poSTPaymentMethodDecryption = (POSTPaymentMethodDecryption) o;
    return Objects.equals(this.accountID, poSTPaymentMethodDecryption.accountID) &&
        Objects.equals(this.cardHolderInfo, poSTPaymentMethodDecryption.cardHolderInfo) &&
        Objects.equals(this.integrationType, poSTPaymentMethodDecryption.integrationType) &&
        Objects.equals(this.invoiceId, poSTPaymentMethodDecryption.invoiceId) &&
        Objects.equals(this.merchantID, poSTPaymentMethodDecryption.merchantID) &&
        Objects.equals(this.mitConsentAgreementSrc, poSTPaymentMethodDecryption.mitConsentAgreementSrc) &&
        Objects.equals(this.mitProfileAction, poSTPaymentMethodDecryption.mitProfileAction) &&
        Objects.equals(this.mitProfileType, poSTPaymentMethodDecryption.mitProfileType) &&
        Objects.equals(this.paymentGateway, poSTPaymentMethodDecryption.paymentGateway) &&
        Objects.equals(this.paymentToken, poSTPaymentMethodDecryption.paymentToken) &&
        Objects.equals(this.processPayment, poSTPaymentMethodDecryption.processPayment)&&
        Objects.equals(this.additionalProperties, poSTPaymentMethodDecryption.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class POSTPaymentMethodDecryption {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTPaymentMethodDecryption
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTPaymentMethodDecryption.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTPaymentMethodDecryption is not found in the empty JSON string", POSTPaymentMethodDecryption.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : POSTPaymentMethodDecryption.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTPaymentMethodDecryption.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTPaymentMethodDecryption' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTPaymentMethodDecryption> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTPaymentMethodDecryption.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTPaymentMethodDecryption>() {
           @Override
           public void write(JsonWriter out, POSTPaymentMethodDecryption value) throws IOException {
           ...
           @Override
           public POSTPaymentMethodDecryption read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTPaymentMethodDecryption instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTPaymentMethodDecryption given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTPaymentMethodDecryption
  * @throws IOException if the JSON string is invalid with respect to POSTPaymentMethodDecryption
  */
  public static POSTPaymentMethodDecryption fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTPaymentMethodDecryption.class);
  }

 /**
  * Convert an instance of POSTPaymentMethodDecryption to an JSON string
  *
  * @return JSON string
  */
