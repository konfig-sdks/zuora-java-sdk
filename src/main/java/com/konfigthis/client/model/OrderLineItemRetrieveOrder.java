...
public class OrderLineItemRetrieveOrder {
 ...
 public enum TaxModeEnum {
  ...
  public OrderLineItemRetrieveOrder() {
  }

  public OrderLineItemRetrieveOrder amendedByOrderOn(String amendedByOrderOn) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder amount(Double amount) {
  ...
  public OrderLineItemRetrieveOrder amount(Integer amount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The calculated gross amount for the Order Line Item. ")
  ...
  public OrderLineItemRetrieveOrder amountWithoutTax(Double amountWithoutTax) {
  ...
  public OrderLineItemRetrieveOrder amountWithoutTax(Integer amountWithoutTax) {
    
    
    
    
    this.amountWithoutTax = amountWithoutTax.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The calculated gross amount for an order line item excluding tax. If the tax mode is tax exclusive, the value of this field equals that of the `amount` field.  If the tax mode of an order line item is not set, the system treats it as tax exclusive by default. The value of the `amountWithoutTax` field equals that of the `amount` field.  If you create an order line item from the product catalog, the tax mode and tax code of the product rate plan charge are used for the order line item by default. You can still overwrite this default set-up by setting the tax mode and tax code of the order line item. ")
  ...
  public OrderLineItemRetrieveOrder id(UUID id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The sytem generated Id for the Order Line Item. ")
  ...
  public OrderLineItemRetrieveOrder invoiceGroupNumber(String invoiceGroupNumber) {
   ...
   /**
   * The number of the invoice group associated with the order line item.   The value of this field is &#x60;null&#x60; if you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled. 
   * @return invoiceGroupNumber
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of the invoice group associated with the order line item.   The value of this field is `null` if you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled. ")
  ...
  public OrderLineItemRetrieveOrder itemNumber(String itemNumber) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder originalOrderDate(LocalDate originalOrderDate) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder quantityFulfilled(Double quantityFulfilled) {
  ...
  public OrderLineItemRetrieveOrder quantityFulfilled(Integer quantityFulfilled) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder quantityPendingFulfillment(Double quantityPendingFulfillment) {
  ...
  public OrderLineItemRetrieveOrder quantityPendingFulfillment(Integer quantityPendingFulfillment) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder description(String description) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder UOM(String UOM) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder accountingCode(String accountingCode) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder adjustmentLiabilityAccountingCode(String adjustmentLiabilityAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder adjustmentRevenueAccountingCode(String adjustmentRevenueAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder amountPerUnit(Double amountPerUnit) {
  ...
  public OrderLineItemRetrieveOrder amountPerUnit(Integer amountPerUnit) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder billTargetDate(LocalDate billTargetDate) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder billTo(String billTo) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder billToSnapshotId(String billToSnapshotId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The snapshot of the ID for an account used as the sold-to contact of an order line item. This field is used to store the original information about the account, in case the information about the account is changed after the creation of the order line item. The `billToSnapshotId` field is exposed while retrieving the order line item details. ")
  ...
  public OrderLineItemRetrieveOrder billingRule(BillingRuleEnum billingRule) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The billing rule of the Order Line Item. ")
  ...
  public OrderLineItemRetrieveOrder contractAssetAccountingCode(String contractAssetAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder contractLiabilityAccountingCode(String contractLiabilityAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder contractRecognizedRevenueAccountingCode(String contractRecognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder currency(String currency) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder customFields(Map<String, Object> customFields) {
  ...
  public OrderLineItemRetrieveOrder putCustomFieldsItem(String key, Object customFieldsItem) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder deferredRevenueAccountingCode(String deferredRevenueAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder discount(Double discount) {
  ...
  public OrderLineItemRetrieveOrder discount(Integer discount) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder excludeItemBillingFromRevenueAccounting(Boolean excludeItemBillingFromRevenueAccounting) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder excludeItemBookingFromRevenueAccounting(Boolean excludeItemBookingFromRevenueAccounting) {
   ...
   /**
   * The flag to exclude Order Line Item from revenue accounting.  **Note**: This field is only available if you have the &lt;a href&#x3D;\&quot;https://knowledgecenter.zuora.com/Zuora_Billing/Enable_Order_to_Revenue\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Order to Revenue&lt;/a&gt; or [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration) feature enabled.  
   * @return excludeItemBookingFromRevenueAccounting
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The flag to exclude Order Line Item from revenue accounting.  **Note**: This field is only available if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Enable_Order_to_Revenue\" target=\"_blank\">Order to Revenue</a> or [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration) feature enabled.  ")
  ...
  public OrderLineItemRetrieveOrder inlineDiscountPerUnit(Double inlineDiscountPerUnit) {
  ...
  public OrderLineItemRetrieveOrder inlineDiscountPerUnit(Integer inlineDiscountPerUnit) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder inlineDiscountType(InlineDiscountTypeEnum inlineDiscountType) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder invoiceOwnerAccountId(String invoiceOwnerAccountId) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder invoiceOwnerAccountName(String invoiceOwnerAccountName) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder invoiceOwnerAccountNumber(String invoiceOwnerAccountNumber) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder isAllocationEligible(Boolean isAllocationEligible) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder isUnbilled(Boolean isUnbilled) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder itemCategory(ItemCategoryEnum itemCategory) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SALES", value = "The category of the Order Line Item, to indicate a product sale or return. ")
  ...
  public OrderLineItemRetrieveOrder itemName(String itemName) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder itemState(ItemStateEnum itemState) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The state of an Order Line Item. See [State transitions for an order, order line item, and fulfillment](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AB_Order_Line_Item_States_and_Order_States) for more information. ")
  ...
  public OrderLineItemRetrieveOrder itemType(ItemTypeEnum itemType) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder listPrice(Double listPrice) {
  ...
  public OrderLineItemRetrieveOrder listPrice(Integer listPrice) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder listPricePerUnit(Double listPricePerUnit) {
  ...
  public OrderLineItemRetrieveOrder listPricePerUnit(Integer listPricePerUnit) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder originalOrderId(String originalOrderId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the original sale order for a return order line item.  ")
  ...
  public OrderLineItemRetrieveOrder originalOrderLineItemId(String originalOrderLineItemId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the original sale order line item for a return order line item.  ")
  ...
  public OrderLineItemRetrieveOrder originalOrderLineItemNumber(String originalOrderLineItemNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of the original sale order line item for a return order line item.  ")
  ...
  public OrderLineItemRetrieveOrder originalOrderNumber(String originalOrderNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of the original sale order for a return order line item.  ")
  ...
  public OrderLineItemRetrieveOrder ownerAccountId(String ownerAccountId) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder ownerAccountName(String ownerAccountName) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder ownerAccountNumber(String ownerAccountNumber) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder productCode(String productCode) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder productRatePlanChargeId(String productRatePlanChargeId) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder purchaseOrderNumber(String purchaseOrderNumber) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder quantity(Double quantity) {
  ...
  public OrderLineItemRetrieveOrder quantity(Integer quantity) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder quantityAvailableForReturn(Double quantityAvailableForReturn) {
  ...
  public OrderLineItemRetrieveOrder quantityAvailableForReturn(Integer quantityAvailableForReturn) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder recognizedRevenueAccountingCode(String recognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder relatedSubscriptionNumber(String relatedSubscriptionNumber) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder requiresFulfillment(Boolean requiresFulfillment) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder revenueRecognitionRule(String revenueRecognitionRule) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder revenueRecognitionTiming(RevenueRecognitionTimingEnum revenueRecognitionTiming) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder revenueAmortizationMethod(RevenueAmortizationMethodEnum revenueAmortizationMethod) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder sequenceSetId(String sequenceSetId) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder soldTo(String soldTo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of a contact that belongs to the owner acount or billing account of the order line item. Use this field to assign an existing account as the sold-to contact of an order line item. ")
  ...
  public OrderLineItemRetrieveOrder soldToSnapshotId(String soldToSnapshotId) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder taxCode(String taxCode) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder taxMode(TaxModeEnum taxMode) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder transactionEndDate(LocalDate transactionEndDate) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder transactionStartDate(LocalDate transactionStartDate) {
  ...
  **/
  ...
  public OrderLineItemRetrieveOrder unbilledReceivablesAccountingCode(String unbilledReceivablesAccountingCode) {
  ...
  **/
   ...
   * @return the OrderLineItemRetrieveOrder instance itself
   */
  public OrderLineItemRetrieveOrder putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderLineItemRetrieveOrder orderLineItemRetrieveOrder = (OrderLineItemRetrieveOrder) o;
    return Objects.equals(this.amendedByOrderOn, orderLineItemRetrieveOrder.amendedByOrderOn) &&
        Objects.equals(this.amount, orderLineItemRetrieveOrder.amount) &&
        Objects.equals(this.amountWithoutTax, orderLineItemRetrieveOrder.amountWithoutTax) &&
        Objects.equals(this.id, orderLineItemRetrieveOrder.id) &&
        Objects.equals(this.invoiceGroupNumber, orderLineItemRetrieveOrder.invoiceGroupNumber) &&
        Objects.equals(this.itemNumber, orderLineItemRetrieveOrder.itemNumber) &&
        Objects.equals(this.originalOrderDate, orderLineItemRetrieveOrder.originalOrderDate) &&
        Objects.equals(this.quantityFulfilled, orderLineItemRetrieveOrder.quantityFulfilled) &&
        Objects.equals(this.quantityPendingFulfillment, orderLineItemRetrieveOrder.quantityPendingFulfillment) &&
        Objects.equals(this.description, orderLineItemRetrieveOrder.description) &&
        Objects.equals(this.UOM, orderLineItemRetrieveOrder.UOM) &&
        Objects.equals(this.accountingCode, orderLineItemRetrieveOrder.accountingCode) &&
        Objects.equals(this.adjustmentLiabilityAccountingCode, orderLineItemRetrieveOrder.adjustmentLiabilityAccountingCode) &&
        Objects.equals(this.adjustmentRevenueAccountingCode, orderLineItemRetrieveOrder.adjustmentRevenueAccountingCode) &&
        Objects.equals(this.amountPerUnit, orderLineItemRetrieveOrder.amountPerUnit) &&
        Objects.equals(this.billTargetDate, orderLineItemRetrieveOrder.billTargetDate) &&
        Objects.equals(this.billTo, orderLineItemRetrieveOrder.billTo) &&
        Objects.equals(this.billToSnapshotId, orderLineItemRetrieveOrder.billToSnapshotId) &&
        Objects.equals(this.billingRule, orderLineItemRetrieveOrder.billingRule) &&
        Objects.equals(this.contractAssetAccountingCode, orderLineItemRetrieveOrder.contractAssetAccountingCode) &&
        Objects.equals(this.contractLiabilityAccountingCode, orderLineItemRetrieveOrder.contractLiabilityAccountingCode) &&
        Objects.equals(this.contractRecognizedRevenueAccountingCode, orderLineItemRetrieveOrder.contractRecognizedRevenueAccountingCode) &&
        Objects.equals(this.currency, orderLineItemRetrieveOrder.currency) &&
        Objects.equals(this.customFields, orderLineItemRetrieveOrder.customFields) &&
        Objects.equals(this.deferredRevenueAccountingCode, orderLineItemRetrieveOrder.deferredRevenueAccountingCode) &&
        Objects.equals(this.discount, orderLineItemRetrieveOrder.discount) &&
        Objects.equals(this.excludeItemBillingFromRevenueAccounting, orderLineItemRetrieveOrder.excludeItemBillingFromRevenueAccounting) &&
        Objects.equals(this.excludeItemBookingFromRevenueAccounting, orderLineItemRetrieveOrder.excludeItemBookingFromRevenueAccounting) &&
        Objects.equals(this.inlineDiscountPerUnit, orderLineItemRetrieveOrder.inlineDiscountPerUnit) &&
        Objects.equals(this.inlineDiscountType, orderLineItemRetrieveOrder.inlineDiscountType) &&
        Objects.equals(this.invoiceOwnerAccountId, orderLineItemRetrieveOrder.invoiceOwnerAccountId) &&
        Objects.equals(this.invoiceOwnerAccountName, orderLineItemRetrieveOrder.invoiceOwnerAccountName) &&
        Objects.equals(this.invoiceOwnerAccountNumber, orderLineItemRetrieveOrder.invoiceOwnerAccountNumber) &&
        Objects.equals(this.isAllocationEligible, orderLineItemRetrieveOrder.isAllocationEligible) &&
        Objects.equals(this.isUnbilled, orderLineItemRetrieveOrder.isUnbilled) &&
        Objects.equals(this.itemCategory, orderLineItemRetrieveOrder.itemCategory) &&
        Objects.equals(this.itemName, orderLineItemRetrieveOrder.itemName) &&
        Objects.equals(this.itemState, orderLineItemRetrieveOrder.itemState) &&
        Objects.equals(this.itemType, orderLineItemRetrieveOrder.itemType) &&
        Objects.equals(this.listPrice, orderLineItemRetrieveOrder.listPrice) &&
        Objects.equals(this.listPricePerUnit, orderLineItemRetrieveOrder.listPricePerUnit) &&
        Objects.equals(this.originalOrderId, orderLineItemRetrieveOrder.originalOrderId) &&
        Objects.equals(this.originalOrderLineItemId, orderLineItemRetrieveOrder.originalOrderLineItemId) &&
        Objects.equals(this.originalOrderLineItemNumber, orderLineItemRetrieveOrder.originalOrderLineItemNumber) &&
        Objects.equals(this.originalOrderNumber, orderLineItemRetrieveOrder.originalOrderNumber) &&
        Objects.equals(this.ownerAccountId, orderLineItemRetrieveOrder.ownerAccountId) &&
        Objects.equals(this.ownerAccountName, orderLineItemRetrieveOrder.ownerAccountName) &&
        Objects.equals(this.ownerAccountNumber, orderLineItemRetrieveOrder.ownerAccountNumber) &&
        Objects.equals(this.productCode, orderLineItemRetrieveOrder.productCode) &&
        Objects.equals(this.productRatePlanChargeId, orderLineItemRetrieveOrder.productRatePlanChargeId) &&
        Objects.equals(this.purchaseOrderNumber, orderLineItemRetrieveOrder.purchaseOrderNumber) &&
        Objects.equals(this.quantity, orderLineItemRetrieveOrder.quantity) &&
        Objects.equals(this.quantityAvailableForReturn, orderLineItemRetrieveOrder.quantityAvailableForReturn) &&
        Objects.equals(this.recognizedRevenueAccountingCode, orderLineItemRetrieveOrder.recognizedRevenueAccountingCode) &&
        Objects.equals(this.relatedSubscriptionNumber, orderLineItemRetrieveOrder.relatedSubscriptionNumber) &&
        Objects.equals(this.requiresFulfillment, orderLineItemRetrieveOrder.requiresFulfillment) &&
        Objects.equals(this.revenueRecognitionRule, orderLineItemRetrieveOrder.revenueRecognitionRule) &&
        Objects.equals(this.revenueRecognitionTiming, orderLineItemRetrieveOrder.revenueRecognitionTiming) &&
        Objects.equals(this.revenueAmortizationMethod, orderLineItemRetrieveOrder.revenueAmortizationMethod) &&
        Objects.equals(this.sequenceSetId, orderLineItemRetrieveOrder.sequenceSetId) &&
        Objects.equals(this.soldTo, orderLineItemRetrieveOrder.soldTo) &&
        Objects.equals(this.soldToSnapshotId, orderLineItemRetrieveOrder.soldToSnapshotId) &&
        Objects.equals(this.taxCode, orderLineItemRetrieveOrder.taxCode) &&
        Objects.equals(this.taxMode, orderLineItemRetrieveOrder.taxMode) &&
        Objects.equals(this.transactionEndDate, orderLineItemRetrieveOrder.transactionEndDate) &&
        Objects.equals(this.transactionStartDate, orderLineItemRetrieveOrder.transactionStartDate) &&
        Objects.equals(this.unbilledReceivablesAccountingCode, orderLineItemRetrieveOrder.unbilledReceivablesAccountingCode)&&
        Objects.equals(this.additionalProperties, orderLineItemRetrieveOrder.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderLineItemRetrieveOrder {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderLineItemRetrieveOrder
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderLineItemRetrieveOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderLineItemRetrieveOrder is not found in the empty JSON string", OrderLineItemRetrieveOrder.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderLineItemRetrieveOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderLineItemRetrieveOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderLineItemRetrieveOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderLineItemRetrieveOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderLineItemRetrieveOrder>() {
           @Override
           public void write(JsonWriter out, OrderLineItemRetrieveOrder value) throws IOException {
           ...
           @Override
           public OrderLineItemRetrieveOrder read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderLineItemRetrieveOrder instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderLineItemRetrieveOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderLineItemRetrieveOrder
  * @throws IOException if the JSON string is invalid with respect to OrderLineItemRetrieveOrder
  */
  public static OrderLineItemRetrieveOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderLineItemRetrieveOrder.class);
  }

 /**
  * Convert an instance of OrderLineItemRetrieveOrder to an JSON string
  *
  * @return JSON string
  */
