 ...
 */
@ApiModel(description = "Container for optional sold-to contact. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PUTAccountTypeSoldToContact {
  ...
  public PUTAccountTypeSoldToContact() {
  }
  ...
  **/
   ...
   * @return the PUTAccountTypeSoldToContact instance itself
   */
  public PUTAccountTypeSoldToContact putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address1, puTAccountTypeSoldToContact.address1) &&
        ...
        Objects.equals(this.additionalProperties, puTAccountTypeSoldToContact.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTAccountTypeSoldToContact
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTAccountTypeSoldToContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTAccountTypeSoldToContact is not found in the empty JSON string", PUTAccountTypeSoldToContact.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PUTAccountTypeSoldToContact.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTAccountTypeSoldToContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTAccountTypeSoldToContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTAccountTypeSoldToContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTAccountTypeSoldToContact.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTAccountTypeSoldToContact>() {
           @Override
           public void write(JsonWriter out, PUTAccountTypeSoldToContact value) throws IOException {
           ...
           @Override
           public PUTAccountTypeSoldToContact read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTAccountTypeSoldToContact instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTAccountTypeSoldToContact given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTAccountTypeSoldToContact
  * @throws IOException if the JSON string is invalid with respect to PUTAccountTypeSoldToContact
  */
  public static PUTAccountTypeSoldToContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTAccountTypeSoldToContact.class);
  }

 /**
  * Convert an instance of PUTAccountTypeSoldToContact to an JSON string
  *
  * @return JSON string
  */
