...
public class UpdateTask {
 ...
 public enum StatusEnum {
  ...
  public UpdateTask tags(List<String> tags) {
  ...
  public UpdateTask addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public UpdateTask actionType(String actionType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of task. ")
  ...
  public UpdateTask callType(String callType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the API used. ")
  ...
  public UpdateTask concurrentLimit(Integer concurrentLimit) {
    if (concurrentLimit != null && concurrentLimit < 1) {
      throw new IllegalArgumentException("Invalid value for concurrentLimit. Must be greater than or equal to 1.");
    }
    if (concurrentLimit != null && concurrentLimit > 9999999) {
      throw new IllegalArgumentException("Invalid value for concurrentLimit. Must be less than or equal to 9999999.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The maximum number of this task that can run concurrently. ")
  ...
  public UpdateTask id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The unique ID of the task. ")
  ...
  **/
  ...
  public UpdateTask _object(String _object) {
  ...
  **/
  ...
  public UpdateTask objectId(String objectId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the task instance. ")
  ...
  public UpdateTask workflowId(Integer workflowId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the workflow the task belongs to. ")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, updateTask.tags) &&
        Objects.equals(this.actionType, updateTask.actionType) &&
        Objects.equals(this.callType, updateTask.callType) &&
        Objects.equals(this.concurrentLimit, updateTask.concurrentLimit) &&
        Objects.equals(this.id, updateTask.id) &&
        Objects.equals(this.name, updateTask.name) &&
        Objects.equals(this._object, updateTask._object) &&
        Objects.equals(this.objectId, updateTask.objectId) &&
        Objects.equals(this.status, updateTask.status) &&
        Objects.equals(this.workflowId, updateTask.workflowId)&&
        Objects.equals(this.additionalProperties, updateTask.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, actionType, callType, concurrentLimit, id, name, _object, objectId, status, workflowId, additionalProperties);
  }
