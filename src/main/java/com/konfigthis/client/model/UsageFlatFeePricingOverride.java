...
public class UsageFlatFeePricingOverride {
 ...
 public enum PriceChangeOptionEnum {
  ...
  public UsageFlatFeePricingOverride() {
  }

  public UsageFlatFeePricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public UsageFlatFeePricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public UsageFlatFeePricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public UsageFlatFeePricingOverride listPrice(Double listPrice) {
  ...
  public UsageFlatFeePricingOverride listPrice(Integer listPrice) {
  ...
  **/
  ...
  public UsageFlatFeePricingOverride originalListPrice(Double originalListPrice) {
  ...
  public UsageFlatFeePricingOverride originalListPrice(Integer originalListPrice) {
  ...
  **/
   ...
   * @return the UsageFlatFeePricingOverride instance itself
   */
  public UsageFlatFeePricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UsageFlatFeePricingOverride usageFlatFeePricingOverride = (UsageFlatFeePricingOverride) o;
    return Objects.equals(this.priceChangeOption, usageFlatFeePricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, usageFlatFeePricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.listPrice, usageFlatFeePricingOverride.listPrice) &&
        Objects.equals(this.originalListPrice, usageFlatFeePricingOverride.originalListPrice)&&
        Objects.equals(this.additionalProperties, usageFlatFeePricingOverride.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, listPrice, originalListPrice, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UsageFlatFeePricingOverride {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsageFlatFeePricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsageFlatFeePricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsageFlatFeePricingOverride is not found in the empty JSON string", UsageFlatFeePricingOverride.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsageFlatFeePricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsageFlatFeePricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsageFlatFeePricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsageFlatFeePricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<UsageFlatFeePricingOverride>() {
           @Override
           public void write(JsonWriter out, UsageFlatFeePricingOverride value) throws IOException {
           ...
           @Override
           public UsageFlatFeePricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UsageFlatFeePricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UsageFlatFeePricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UsageFlatFeePricingOverride
  * @throws IOException if the JSON string is invalid with respect to UsageFlatFeePricingOverride
  */
  public static UsageFlatFeePricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsageFlatFeePricingOverride.class);
  }

 /**
  * Convert an instance of UsageFlatFeePricingOverride to an JSON string
  *
  * @return JSON string
  */
