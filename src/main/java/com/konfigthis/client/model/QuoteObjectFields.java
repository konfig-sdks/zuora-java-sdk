 ...
 */
@ApiModel(description = "The fields populated for a quote when a quote is sent to Zuora Billing from Zuora Quote. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class QuoteObjectFields {
  ...
  private String opportunityCloseDateQT;
  ...
  public QuoteObjectFields() {
  }

  public QuoteObjectFields opportunityCloseDateQT(String opportunityCloseDateQT) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The closing date of the Opportunity.  This field is used in Zuora Reporting Data Sources to report on Subscription metrics.  If the subscription was originated from Zuora Quotes, the value is populated with the value from Zuora Quotes. ")
  ...
  public QuoteObjectFields opportunityNameQT(String opportunityNameQT) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique identifier of the Opportunity.   This field is used in the Zuora Reporting Data Sources to report on Subscription metrics.  If the subscription was originated from Zuora Quotes, the value is populated with the value from Zuora Quotes.  **Character limit**: 100 ")
  ...
  public QuoteObjectFields quoteBusinessTypeQT(String quoteBusinessTypeQT) {
  ...
  **/
  ...
  public QuoteObjectFields quoteNumberQT(String quoteNumberQT) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique identifier of the Quote.  This field is used in the Zuora Reporting Data Sources to report on Subscription metrics.  If the subscription was originated from Zuora Quotes, the value is populated with the value from Zuora Quotes.  **Character limit**: 32 ")
  ...
  public QuoteObjectFields quoteTypeQT(String quoteTypeQT) {
  ...
  **/
   ...
   * @return the QuoteObjectFields instance itself
   */
  public QuoteObjectFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    QuoteObjectFields quoteObjectFields = (QuoteObjectFields) o;
    return Objects.equals(this.opportunityCloseDateQT, quoteObjectFields.opportunityCloseDateQT) &&
        Objects.equals(this.opportunityNameQT, quoteObjectFields.opportunityNameQT) &&
        Objects.equals(this.quoteBusinessTypeQT, quoteObjectFields.quoteBusinessTypeQT) &&
        Objects.equals(this.quoteNumberQT, quoteObjectFields.quoteNumberQT) &&
        Objects.equals(this.quoteTypeQT, quoteObjectFields.quoteTypeQT)&&
        Objects.equals(this.additionalProperties, quoteObjectFields.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(opportunityCloseDateQT, opportunityNameQT, quoteBusinessTypeQT, quoteNumberQT, quoteTypeQT, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class QuoteObjectFields {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to QuoteObjectFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!QuoteObjectFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QuoteObjectFields is not found in the empty JSON string", QuoteObjectFields.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("OpportunityCloseDate__QT") != null && !jsonObj.get("OpportunityCloseDate__QT").isJsonNull()) && !jsonObj.get("OpportunityCloseDate__QT").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `OpportunityCloseDate__QT` to be a primitive type in the JSON string but got `%s`", jsonObj.get("OpportunityCloseDate__QT").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QuoteObjectFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QuoteObjectFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QuoteObjectFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QuoteObjectFields.class));

       return (TypeAdapter<T>) new TypeAdapter<QuoteObjectFields>() {
           @Override
           public void write(JsonWriter out, QuoteObjectFields value) throws IOException {
           ...
           @Override
           public QuoteObjectFields read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             QuoteObjectFields instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of QuoteObjectFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of QuoteObjectFields
  * @throws IOException if the JSON string is invalid with respect to QuoteObjectFields
  */
  public static QuoteObjectFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QuoteObjectFields.class);
  }

 /**
  * Convert an instance of QuoteObjectFields to an JSON string
  *
  * @return JSON string
  */
