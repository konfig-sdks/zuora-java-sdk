 ...
 */
@ApiModel(description = "Container for sold-to contact information. Uses the same field structure as billToContact. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class GETAccountTypeSoldToContact {
  ...
  public GETAccountTypeSoldToContact() {
  }
  ...
  **/
  ...
  public GETAccountTypeSoldToContact id(String id) {
  ...
  **/
   ...
   * @return the GETAccountTypeSoldToContact instance itself
   */
  public GETAccountTypeSoldToContact putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address1, geTAccountTypeSoldToContact.address1) &&
        ...
        Objects.equals(this.id, geTAccountTypeSoldToContact.id) &&
        ...
        Objects.equals(this.additionalProperties, geTAccountTypeSoldToContact.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETAccountTypeSoldToContact
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETAccountTypeSoldToContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETAccountTypeSoldToContact is not found in the empty JSON string", GETAccountTypeSoldToContact.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETAccountTypeSoldToContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETAccountTypeSoldToContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETAccountTypeSoldToContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETAccountTypeSoldToContact.class));

       return (TypeAdapter<T>) new TypeAdapter<GETAccountTypeSoldToContact>() {
           @Override
           public void write(JsonWriter out, GETAccountTypeSoldToContact value) throws IOException {
           ...
           @Override
           public GETAccountTypeSoldToContact read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETAccountTypeSoldToContact instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETAccountTypeSoldToContact given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETAccountTypeSoldToContact
  * @throws IOException if the JSON string is invalid with respect to GETAccountTypeSoldToContact
  */
  public static GETAccountTypeSoldToContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETAccountTypeSoldToContact.class);
  }

 /**
  * Convert an instance of GETAccountTypeSoldToContact to an JSON string
  *
  * @return JSON string
  */
