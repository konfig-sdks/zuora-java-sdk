...
public class POSTDelayAuthorizeCapture {
 ...
 public enum MitTransactionSourceEnum {
  ...
  public POSTDelayAuthorizeCapture() {
  }

  public POSTDelayAuthorizeCapture accountId(String accountId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "402881e861bd8a7e0161c6a453750026", value = "The ID of the customer account. Either `accountId` or `accountNumber` is required.")
  ...
  public POSTDelayAuthorizeCapture accountNumber(String accountNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "A00000004", value = "The number of the customer account. Either `accountNumber` or `accountId` is required.")
  ...
  public POSTDelayAuthorizeCapture amount(Double amount) {
  ...
  public POSTDelayAuthorizeCapture amount(Integer amount) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1.99", required = true, value = "The amount of the trasaction.")
  ...
  public POSTDelayAuthorizeCapture gatewayOptions(PUTVerifyPaymentMethodTypeGatewayOptions gatewayOptions) {
  ...
  **/
  ...
  public PUTVerifyPaymentMethodTypeGatewayOptions getGatewayOptions() {
    return gatewayOptions;
  }


  public void setGatewayOptions(PUTVerifyPaymentMethodTypeGatewayOptions gatewayOptions) {
  ...
  public POSTDelayAuthorizeCapture gatewayOrderId(String gatewayOrderId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "A001", required = true, value = "The order ID for the specific gateway.  The specified order ID will be used in transaction authorization. If you specify an empty value for this field, Zuora will generate an ID and you will have to associate this ID with your order ID by yourself if needed. It is recommended to specify an ID for this field. ")
  ...
  public POSTDelayAuthorizeCapture mitTransactionSource(MitTransactionSourceEnum mitTransactionSource) {
  ...
  **/
  ...
  public POSTDelayAuthorizeCapture paymentGatewayId(String paymentGatewayId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the payment gateway instance.")
  ...
  public POSTDelayAuthorizeCapture softDescriptor(String softDescriptor) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Service fee", value = "A text, rendered on a cardholder’s statement, describing a particular product or service purchased by the cardholder.")
  ...
  public POSTDelayAuthorizeCapture softDescriptorPhone(String softDescriptorPhone) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "400-000-1234", value = "The phone number that relates to the soft descriptor, usually the phone number of customer service.")
   ...
   * @return the POSTDelayAuthorizeCapture instance itself
   */
  public POSTDelayAuthorizeCapture putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTDelayAuthorizeCapture poSTDelayAuthorizeCapture = (POSTDelayAuthorizeCapture) o;
    return Objects.equals(this.accountId, poSTDelayAuthorizeCapture.accountId) &&
        Objects.equals(this.accountNumber, poSTDelayAuthorizeCapture.accountNumber) &&
        Objects.equals(this.amount, poSTDelayAuthorizeCapture.amount) &&
        Objects.equals(this.gatewayOptions, poSTDelayAuthorizeCapture.gatewayOptions) &&
        Objects.equals(this.gatewayOrderId, poSTDelayAuthorizeCapture.gatewayOrderId) &&
        Objects.equals(this.mitTransactionSource, poSTDelayAuthorizeCapture.mitTransactionSource) &&
        Objects.equals(this.paymentGatewayId, poSTDelayAuthorizeCapture.paymentGatewayId) &&
        Objects.equals(this.softDescriptor, poSTDelayAuthorizeCapture.softDescriptor) &&
        Objects.equals(this.softDescriptorPhone, poSTDelayAuthorizeCapture.softDescriptorPhone)&&
        Objects.equals(this.additionalProperties, poSTDelayAuthorizeCapture.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, accountNumber, amount, gatewayOptions, gatewayOrderId, mitTransactionSource, paymentGatewayId, softDescriptor, softDescriptorPhone, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class POSTDelayAuthorizeCapture {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("gatewayOrderId");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTDelayAuthorizeCapture
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTDelayAuthorizeCapture.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTDelayAuthorizeCapture is not found in the empty JSON string", POSTDelayAuthorizeCapture.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : POSTDelayAuthorizeCapture.openapiRequiredFields) {
      ...
      if (jsonObj.get("gatewayOptions") != null && !jsonObj.get("gatewayOptions").isJsonNull()) {
        PUTVerifyPaymentMethodTypeGatewayOptions.validateJsonObject(jsonObj.getAsJsonObject("gatewayOptions"));
      }
      if (!jsonObj.get("gatewayOrderId").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTDelayAuthorizeCapture.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTDelayAuthorizeCapture' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTDelayAuthorizeCapture> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTDelayAuthorizeCapture.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTDelayAuthorizeCapture>() {
           @Override
           public void write(JsonWriter out, POSTDelayAuthorizeCapture value) throws IOException {
           ...
           @Override
           public POSTDelayAuthorizeCapture read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTDelayAuthorizeCapture instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTDelayAuthorizeCapture given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTDelayAuthorizeCapture
  * @throws IOException if the JSON string is invalid with respect to POSTDelayAuthorizeCapture
  */
  public static POSTDelayAuthorizeCapture fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTDelayAuthorizeCapture.class);
  }

 /**
  * Convert an instance of POSTDelayAuthorizeCapture to an JSON string
  *
  * @return JSON string
  */
