...
public class ProxyModifyProduct {
  ...
  **/
  ...
  public ProxyModifyProduct productNumber(String productNumber) {
  ...
  **/
  ...
  public ProxyModifyProduct integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public ProxyModifyProduct integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public ProxyModifyProduct itemTypeNS(ItemTypeNSEnum itemTypeNS) {
  ...
  **/
  ...
  public ProxyModifyProduct syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the ProxyModifyProduct instance itself
   */
  public ProxyModifyProduct putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowFeatureChanges, proxyModifyProduct.allowFeatureChanges) &&
        ...
        Objects.equals(this.productNumber, proxyModifyProduct.productNumber) &&
        Objects.equals(this.SKU, proxyModifyProduct.SKU) &&
        Objects.equals(this.integrationIdNS, proxyModifyProduct.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, proxyModifyProduct.integrationStatusNS) &&
        Objects.equals(this.itemTypeNS, proxyModifyProduct.itemTypeNS) &&
        Objects.equals(this.syncDateNS, proxyModifyProduct.syncDateNS)&&
        Objects.equals(this.additionalProperties, proxyModifyProduct.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProxyModifyProduct
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProxyModifyProduct.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProxyModifyProduct is not found in the empty JSON string", ProxyModifyProduct.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProxyModifyProduct.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProxyModifyProduct' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProxyModifyProduct> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProxyModifyProduct.class));

       return (TypeAdapter<T>) new TypeAdapter<ProxyModifyProduct>() {
           @Override
           public void write(JsonWriter out, ProxyModifyProduct value) throws IOException {
           ...
           @Override
           public ProxyModifyProduct read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProxyModifyProduct instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProxyModifyProduct given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProxyModifyProduct
  * @throws IOException if the JSON string is invalid with respect to ProxyModifyProduct
  */
  public static ProxyModifyProduct fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProxyModifyProduct.class);
  }

 /**
  * Convert an instance of ProxyModifyProduct to an JSON string
  *
  * @return JSON string
  */
