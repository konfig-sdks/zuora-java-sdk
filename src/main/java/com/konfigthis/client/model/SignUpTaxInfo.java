 ...
 */
@ApiModel(description = "Information about the tax exempt status of a customer account. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SignUpTaxInfo {
   ...
   */
  @JsonAdapter(ExemptStatusEnum.Adapter.class)
 public enum ExemptStatusEnum {
    FALSE("false"),
    ...
    public static ExemptStatusEnum fromValue(String value) {
      for (ExemptStatusEnum b : ExemptStatusEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ExemptStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ExemptStatusEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ExemptStatusEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ExemptStatusEnum.fromValue(value);
      }
    }
  }
  ...
  private ExemptStatusEnum exemptStatus = ExemptStatusEnum.FALSE;

  public SignUpTaxInfo() {
  }

  public SignUpTaxInfo vaTId(String vaTId) {
  ...
  **/
  ...
  public SignUpTaxInfo companyCode(String companyCode) {
  ...
  **/
  ...
  public SignUpTaxInfo exemptCertificateId(String exemptCertificateId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of the customer tax exemption certificate. Applicable if you use Zuora Tax or Connect tax engines. ")
  ...
  public SignUpTaxInfo exemptCertificateType(String exemptCertificateType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Type of tax exemption certificate that the customer holds. Applicable if you use Zuora Tax or Connect tax engines. ")
  ...
  public SignUpTaxInfo exemptDescription(String exemptDescription) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Description of the tax exemption certificate that the customer holds. Applicable if you use Zuora Tax or Connect tax engines. ")
  ...
  public SignUpTaxInfo exemptEffectiveDate(LocalDate exemptEffectiveDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date when the customer tax exemption starts, in YYYY-MM-DD format. Applicable if you use Zuora Tax or Connect tax engines. ")
  ...
  public SignUpTaxInfo exemptExpirationDate(LocalDate exemptExpirationDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date when the customer tax exemption expires, in YYYY-MM-DD format. Applicable if you use Zuora Tax or Connect tax engines. ")
  ...
  public SignUpTaxInfo exemptIssuingJurisdiction(String exemptIssuingJurisdiction) {
  ...
  **/
  ...
  public SignUpTaxInfo exemptStatus(ExemptStatusEnum exemptStatus) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "FALSE", value = "Status of the account tax exemption. Applicable if you use Zuora Tax or Connect tax engines. Required if you use Zuora Tax.  ")

  public ExemptStatusEnum getExemptStatus() {
    return exemptStatus;
  }


  public void setExemptStatus(ExemptStatusEnum exemptStatus) {
   ...
   * @return the SignUpTaxInfo instance itself
   */
  public SignUpTaxInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SignUpTaxInfo signUpTaxInfo = (SignUpTaxInfo) o;
    return Objects.equals(this.vaTId, signUpTaxInfo.vaTId) &&
        Objects.equals(this.companyCode, signUpTaxInfo.companyCode) &&
        Objects.equals(this.exemptCertificateId, signUpTaxInfo.exemptCertificateId) &&
        Objects.equals(this.exemptCertificateType, signUpTaxInfo.exemptCertificateType) &&
        Objects.equals(this.exemptDescription, signUpTaxInfo.exemptDescription) &&
        Objects.equals(this.exemptEffectiveDate, signUpTaxInfo.exemptEffectiveDate) &&
        Objects.equals(this.exemptExpirationDate, signUpTaxInfo.exemptExpirationDate) &&
        Objects.equals(this.exemptIssuingJurisdiction, signUpTaxInfo.exemptIssuingJurisdiction) &&
        Objects.equals(this.exemptStatus, signUpTaxInfo.exemptStatus)&&
        Objects.equals(this.additionalProperties, signUpTaxInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vaTId, companyCode, exemptCertificateId, exemptCertificateType, exemptDescription, exemptEffectiveDate, exemptExpirationDate, exemptIssuingJurisdiction, exemptStatus, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SignUpTaxInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SignUpTaxInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SignUpTaxInfo is not found in the empty JSON string", SignUpTaxInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SignUpTaxInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SignUpTaxInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SignUpTaxInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SignUpTaxInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SignUpTaxInfo>() {
           @Override
           public void write(JsonWriter out, SignUpTaxInfo value) throws IOException {
           ...
           @Override
           public SignUpTaxInfo read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SignUpTaxInfo instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SignUpTaxInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SignUpTaxInfo
  * @throws IOException if the JSON string is invalid with respect to SignUpTaxInfo
  */
  public static SignUpTaxInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SignUpTaxInfo.class);
  }

 /**
  * Convert an instance of SignUpTaxInfo to an JSON string
  *
  * @return JSON string
  */
