...
public class CreditMemoFromInvoiceRequest {
  public static final String SERIALIZED_NAME_AUTO_APPLY_TO_INVOICE_UPON_POSTING = "autoApplyToInvoiceUponPosting";
  @SerializedName(SERIALIZED_NAME_AUTO_APPLY_TO_INVOICE_UPON_POSTING)
  ...
  private List<CreditMemoItemFromInvoiceItemType> items = null;
  ...
  private Boolean taxAutoCalculation = true;
  ...
  public CreditMemoFromInvoiceRequest() {
  }

  public CreditMemoFromInvoiceRequest autoApplyToInvoiceUponPosting(Boolean autoApplyToInvoiceUponPosting) {
   ...
   * @return autoApplyToInvoiceUponPosting
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the credit memo automatically applies to the invoice upon posting. ")

  public Boolean getAutoApplyToInvoiceUponPosting() {
    return autoApplyToInvoiceUponPosting;
  }


  public void setAutoApplyToInvoiceUponPosting(Boolean autoApplyToInvoiceUponPosting) {
  ...
  public CreditMemoFromInvoiceRequest autoPost(Boolean autoPost) {
   ...
   /**
   * Whether to automatically post the credit memo after it is created.  Setting this field to &#x60;true&#x60;, you do not need to separately call the [Post credit memo](https://developer.zuora.com/api-references/api/operation/PUT_PostCreditMemo) operation to post the credit memo. 
   * @return autoPost
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to automatically post the credit memo after it is created.  Setting this field to `true`, you do not need to separately call the [Post credit memo](https://developer.zuora.com/api-references/api/operation/PUT_PostCreditMemo) operation to post the credit memo. ")
  ...
  public CreditMemoFromInvoiceRequest comment(String comment) {
  ...
  **/
  ...
  public CreditMemoFromInvoiceRequest effectiveDate(LocalDate effectiveDate) {
  ...
  **/
  ...
  public CreditMemoFromInvoiceRequest excludeFromAutoApplyRules(Boolean excludeFromAutoApplyRules) {
  ...
  **/
  ...
  public CreditMemoFromInvoiceRequest invoiceId(String invoiceId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the invoice that the credit memo is created from. * If this field is specified, its value must be the same as the value of the `invoiceId` path parameter. Otherwise, its value overrides the value of the `invoiceId` path parameter.  * If this field is not specified, the value of the `invoiceId` path parameter is used. ")
  ...
  public CreditMemoFromInvoiceRequest items(List<CreditMemoItemFromInvoiceItemType> items) {
  ...
  public CreditMemoFromInvoiceRequest addItemsItem(CreditMemoItemFromInvoiceItemType itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for items. The maximum number of items is 1,000. ")

  public List<CreditMemoItemFromInvoiceItemType> getItems() {
    return items;
  }


  public void setItems(List<CreditMemoItemFromInvoiceItemType> items) {
  ...
  public CreditMemoFromInvoiceRequest reasonCode(String reasonCode) {
  ...
  **/
  ...
  public CreditMemoFromInvoiceRequest taxAutoCalculation(Boolean taxAutoCalculation) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Whether to automatically calculate taxes in the credit memo. ")
  ...
  public CreditMemoFromInvoiceRequest integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public CreditMemoFromInvoiceRequest integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public CreditMemoFromInvoiceRequest originNS(String originNS) {
  ...
  **/
  ...
  public CreditMemoFromInvoiceRequest syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public CreditMemoFromInvoiceRequest transactionNS(String transactionNS) {
  ...
  **/
   ...
   * @return the CreditMemoFromInvoiceRequest instance itself
   */
  public CreditMemoFromInvoiceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreditMemoFromInvoiceRequest creditMemoFromInvoiceRequest = (CreditMemoFromInvoiceRequest) o;
    return Objects.equals(this.autoApplyToInvoiceUponPosting, creditMemoFromInvoiceRequest.autoApplyToInvoiceUponPosting) &&
        Objects.equals(this.autoPost, creditMemoFromInvoiceRequest.autoPost) &&
        Objects.equals(this.comment, creditMemoFromInvoiceRequest.comment) &&
        Objects.equals(this.effectiveDate, creditMemoFromInvoiceRequest.effectiveDate) &&
        Objects.equals(this.excludeFromAutoApplyRules, creditMemoFromInvoiceRequest.excludeFromAutoApplyRules) &&
        Objects.equals(this.invoiceId, creditMemoFromInvoiceRequest.invoiceId) &&
        Objects.equals(this.items, creditMemoFromInvoiceRequest.items) &&
        Objects.equals(this.reasonCode, creditMemoFromInvoiceRequest.reasonCode) &&
        Objects.equals(this.taxAutoCalculation, creditMemoFromInvoiceRequest.taxAutoCalculation) &&
        Objects.equals(this.integrationIdNS, creditMemoFromInvoiceRequest.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, creditMemoFromInvoiceRequest.integrationStatusNS) &&
        Objects.equals(this.originNS, creditMemoFromInvoiceRequest.originNS) &&
        Objects.equals(this.syncDateNS, creditMemoFromInvoiceRequest.syncDateNS) &&
        Objects.equals(this.transactionNS, creditMemoFromInvoiceRequest.transactionNS)&&
        Objects.equals(this.additionalProperties, creditMemoFromInvoiceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoApplyToInvoiceUponPosting, autoPost, comment, effectiveDate, excludeFromAutoApplyRules, invoiceId, items, reasonCode, taxAutoCalculation, integrationIdNS, integrationStatusNS, originNS, syncDateNS, transactionNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreditMemoFromInvoiceRequest {\n");
    sb.append("    autoApplyToInvoiceUponPosting: ").append(toIndentedString(autoApplyToInvoiceUponPosting)).append("\n");
  ...
  static {
    ...
    openapiFields.add("autoApplyToInvoiceUponPosting");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreditMemoFromInvoiceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreditMemoFromInvoiceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreditMemoFromInvoiceRequest is not found in the empty JSON string", CreditMemoFromInvoiceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            CreditMemoItemFromInvoiceItemType.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreditMemoFromInvoiceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreditMemoFromInvoiceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreditMemoFromInvoiceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreditMemoFromInvoiceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreditMemoFromInvoiceRequest>() {
           @Override
           public void write(JsonWriter out, CreditMemoFromInvoiceRequest value) throws IOException {
           ...
           @Override
           public CreditMemoFromInvoiceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreditMemoFromInvoiceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreditMemoFromInvoiceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreditMemoFromInvoiceRequest
  * @throws IOException if the JSON string is invalid with respect to CreditMemoFromInvoiceRequest
  */
  public static CreditMemoFromInvoiceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreditMemoFromInvoiceRequest.class);
  }

 /**
  * Convert an instance of CreditMemoFromInvoiceRequest to an JSON string
  *
  * @return JSON string
  */
