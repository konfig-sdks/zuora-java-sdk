...
public class POSTPublicEmailTemplateRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "user@example.com", value = "The email bcc address.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "user@example.com", value = "The email CC address.")
  ...
  public POSTPublicEmailTemplateRequest ccEmailType(CcEmailTypeEnum ccEmailType) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Dear user,<p>the account <Account.Name> has been edited. <p>Example Co. Ltd.", required = true, value = "The email body. You can add merge fields in the email body using angle brackets or double curly brackets. For more information, see <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/Events_and_Notifications/Create_Email_Templates/A_Merge_field_syntax_for_email_templates\" target=\"_blank\">Merge field syntax for email templates</a>.  You can also embed HTML tags if `isHtml` is `true`. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Account <Account.Number> has been edited", required = true, value = "The email subject. You can add merge fields in the email subject using angle brackets or double curly brackets. For more information, see <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/Events_and_Notifications/Create_Email_Templates/A_Merge_field_syntax_for_email_templates\" target=\"_blank\">Merge field syntax for email templates</a>. ")
  ...
  public POSTPublicEmailTemplateRequest encodingType(EncodingTypeEnum encodingType) {
  ...
  **/
  ...
  public POSTPublicEmailTemplateRequest eventCategory(Double eventCategory) {
  ...
  public POSTPublicEmailTemplateRequest eventCategory(Integer eventCategory) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "AccountEdit", value = "The name of the custom event or custom scheduled event. If you specify this field, the email template is created based on the corresponding custom event or custom scheduled event. ")
  ...
  **/
  ...
  public POSTPublicEmailTemplateRequest fromEmailType(FromEmailTypeEnum fromEmailType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "TENANTEMAIL", required = true, value = "The type of the email.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Example Co. Ltd.", value = "The name of the email sender.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Account Edit Email", required = true, value = "The name of the email template, a unique name in a tenant.")
  ...
  **/
  ...
  public POSTPublicEmailTemplateRequest replyToEmailType(ReplyToEmailTypeEnum replyToEmailType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "TENANTEMAIL", value = "Type of the replyTo email.")
  ...
  **/
  ...
  public POSTPublicEmailTemplateRequest toEmailType(ToEmailTypeEnum toEmailType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "BILLTOCONTACT", required = true, value = "Email receive type. * When the base object for the event is associated with `Account`, `toEmailType` can be any values in the enum list.  * When the base object for the event is not associated with `Account`, `toEmailType` must be `TenantAdmin`, `RunOwner`, or `SpecificEmail`. ")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, poSTPublicEmailTemplateRequest.description) &&
        Objects.equals(this.active, poSTPublicEmailTemplateRequest.active) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, active, bccEmailAddress, ccEmailAddress, ccEmailType, emailBody, emailSubject, encodingType, eventCategory, eventTypeName, eventTypeNamespace, fromEmailAddress, fromEmailType, fromName, isHtml, name, replyToEmailAddress, replyToEmailType, toEmailAddress, toEmailType, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTPublicEmailTemplateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTPublicEmailTemplateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<POSTPublicEmailTemplateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTPublicEmailTemplateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTPublicEmailTemplateRequest>() {
           @Override
