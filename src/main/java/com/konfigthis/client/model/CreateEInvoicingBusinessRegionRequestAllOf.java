...
public class CreateEInvoicingBusinessRegionRequestAllOf {
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf() {
  }

  public CreateEInvoicingBusinessRegionRequestAllOf addressLine1(String addressLine1) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf addressLine2(String addressLine2) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf businessName(String businessName) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf businessNumber(String businessNumber) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf businessNumberSchemaId(String businessNumberSchemaId) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf city(String city) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf contactName(String contactName) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf country(String country) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf digitalSignatureEnable(Boolean digitalSignatureEnable) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf digitalSignatureBoxEnable(Boolean digitalSignatureBoxEnable) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf digitalSignatureBoxPosX(Double digitalSignatureBoxPosX) {
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf digitalSignatureBoxPosX(Integer digitalSignatureBoxPosX) {
    if (digitalSignatureBoxPosX != null && digitalSignatureBoxPosX < 0) {
      throw new IllegalArgumentException("Invalid value for digitalSignatureBoxPosX. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf digitalSignatureBoxPosY(Double digitalSignatureBoxPosY) {
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf digitalSignatureBoxPosY(Integer digitalSignatureBoxPosY) {
    if (digitalSignatureBoxPosY != null && digitalSignatureBoxPosY < 0) {
      throw new IllegalArgumentException("Invalid value for digitalSignatureBoxPosY. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf email(String email) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf endpointId(String endpointId) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf endpointSchemeId(String endpointSchemeId) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf phoneNumber(String phoneNumber) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf postalCode(String postalCode) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf serviceProviderId(String serviceProviderId) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf state(String state) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf taxRegisterNumber(String taxRegisterNumber) {
  ...
  **/
  ...
  public CreateEInvoicingBusinessRegionRequestAllOf tradeName(String tradeName) {
  ...
  **/
   ...
   * @return the CreateEInvoicingBusinessRegionRequestAllOf instance itself
   */
  public CreateEInvoicingBusinessRegionRequestAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateEInvoicingBusinessRegionRequestAllOf createEInvoicingBusinessRegionRequestAllOf = (CreateEInvoicingBusinessRegionRequestAllOf) o;
    return Objects.equals(this.addressLine1, createEInvoicingBusinessRegionRequestAllOf.addressLine1) &&
        Objects.equals(this.addressLine2, createEInvoicingBusinessRegionRequestAllOf.addressLine2) &&
        Objects.equals(this.businessName, createEInvoicingBusinessRegionRequestAllOf.businessName) &&
        Objects.equals(this.businessNumber, createEInvoicingBusinessRegionRequestAllOf.businessNumber) &&
        Objects.equals(this.businessNumberSchemaId, createEInvoicingBusinessRegionRequestAllOf.businessNumberSchemaId) &&
        Objects.equals(this.city, createEInvoicingBusinessRegionRequestAllOf.city) &&
        Objects.equals(this.contactName, createEInvoicingBusinessRegionRequestAllOf.contactName) &&
        Objects.equals(this.country, createEInvoicingBusinessRegionRequestAllOf.country) &&
        Objects.equals(this.digitalSignatureEnable, createEInvoicingBusinessRegionRequestAllOf.digitalSignatureEnable) &&
        Objects.equals(this.digitalSignatureBoxEnable, createEInvoicingBusinessRegionRequestAllOf.digitalSignatureBoxEnable) &&
        Objects.equals(this.digitalSignatureBoxPosX, createEInvoicingBusinessRegionRequestAllOf.digitalSignatureBoxPosX) &&
        Objects.equals(this.digitalSignatureBoxPosY, createEInvoicingBusinessRegionRequestAllOf.digitalSignatureBoxPosY) &&
        Objects.equals(this.email, createEInvoicingBusinessRegionRequestAllOf.email) &&
        Objects.equals(this.endpointId, createEInvoicingBusinessRegionRequestAllOf.endpointId) &&
        Objects.equals(this.endpointSchemeId, createEInvoicingBusinessRegionRequestAllOf.endpointSchemeId) &&
        Objects.equals(this.phoneNumber, createEInvoicingBusinessRegionRequestAllOf.phoneNumber) &&
        Objects.equals(this.postalCode, createEInvoicingBusinessRegionRequestAllOf.postalCode) &&
        Objects.equals(this.serviceProviderId, createEInvoicingBusinessRegionRequestAllOf.serviceProviderId) &&
        Objects.equals(this.state, createEInvoicingBusinessRegionRequestAllOf.state) &&
        Objects.equals(this.taxRegisterNumber, createEInvoicingBusinessRegionRequestAllOf.taxRegisterNumber) &&
        Objects.equals(this.tradeName, createEInvoicingBusinessRegionRequestAllOf.tradeName)&&
        Objects.equals(this.additionalProperties, createEInvoicingBusinessRegionRequestAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateEInvoicingBusinessRegionRequestAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateEInvoicingBusinessRegionRequestAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateEInvoicingBusinessRegionRequestAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEInvoicingBusinessRegionRequestAllOf is not found in the empty JSON string", CreateEInvoicingBusinessRegionRequestAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateEInvoicingBusinessRegionRequestAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEInvoicingBusinessRegionRequestAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEInvoicingBusinessRegionRequestAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEInvoicingBusinessRegionRequestAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEInvoicingBusinessRegionRequestAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEInvoicingBusinessRegionRequestAllOf>() {
           @Override
           public void write(JsonWriter out, CreateEInvoicingBusinessRegionRequestAllOf value) throws IOException {
           ...
           @Override
           public CreateEInvoicingBusinessRegionRequestAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateEInvoicingBusinessRegionRequestAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateEInvoicingBusinessRegionRequestAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateEInvoicingBusinessRegionRequestAllOf
  * @throws IOException if the JSON string is invalid with respect to CreateEInvoicingBusinessRegionRequestAllOf
  */
  public static CreateEInvoicingBusinessRegionRequestAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateEInvoicingBusinessRegionRequestAllOf.class);
  }

 /**
  * Convert an instance of CreateEInvoicingBusinessRegionRequestAllOf to an JSON string
  *
  * @return JSON string
  */
