...
import com.konfigthis.client.model.SignUpResponseReasons;
...
public class SignUpResponse {
  ...
  private List<SignUpResponseReasons> reasons = null;
 ...
 public enum StatusEnum {
  ...
  public SignUpResponse accountId(String accountId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The account id for the order.")
  ...
  public SignUpResponse accountNumber(String accountNumber) {
  ...
  **/
  ...
  public SignUpResponse creditMemoId(String creditMemoId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of the credit memo id generated in this order request. The credit memo is only available if you have the Invoice Settlement feature enabled.")
  ...
  public SignUpResponse creditMemoNumber(String creditMemoNumber) {
  ...
  **/
  ...
  public SignUpResponse invoiceId(String invoiceId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The invoice id generated in this order request")
  ...
  public SignUpResponse invoiceNumber(String invoiceNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The invoice number generated in this order request")
  ...
  public SignUpResponse orderNumber(String orderNumber) {
  ...
  **/
  ...
  public SignUpResponse paidAmount(String paidAmount) {
  ...
  **/
  ...
  public SignUpResponse paymentId(String paymentId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The payment id that is collected in this order request.")
  ...
  public SignUpResponse paymentNumber(String paymentNumber) {
  ...
  **/
  ...
  public SignUpResponse processId(String processId) {
  ...
  **/
  ...
  public SignUpResponse reasons(List<SignUpResponseReasons> reasons) {
  ...
  public SignUpResponse addReasonsItem(SignUpResponseReasons reasonsItem) {
  ...
  **/
  ...
  public List<SignUpResponseReasons> getReasons() {
    return reasons;
  }


  public void setReasons(List<SignUpResponseReasons> reasons) {
  ...
  public SignUpResponse status(StatusEnum status) {
  ...
  **/
  ...
  public SignUpResponse subscriptionId(String subscriptionId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The subscription id of the order.")
  ...
  public SignUpResponse subscriptionNumber(String subscriptionNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The subscription number of the order.")
  ...
  public SignUpResponse success(Boolean success) {
  ...
  **/
   ...
   * @return the SignUpResponse instance itself
   */
  public SignUpResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, signUpResponse.accountId) &&
        Objects.equals(this.accountNumber, signUpResponse.accountNumber) &&
        Objects.equals(this.creditMemoId, signUpResponse.creditMemoId) &&
        Objects.equals(this.creditMemoNumber, signUpResponse.creditMemoNumber) &&
        Objects.equals(this.invoiceId, signUpResponse.invoiceId) &&
        Objects.equals(this.invoiceNumber, signUpResponse.invoiceNumber) &&
        Objects.equals(this.orderNumber, signUpResponse.orderNumber) &&
        Objects.equals(this.paidAmount, signUpResponse.paidAmount) &&
        Objects.equals(this.paymentId, signUpResponse.paymentId) &&
        Objects.equals(this.paymentNumber, signUpResponse.paymentNumber) &&
        Objects.equals(this.processId, signUpResponse.processId) &&
        Objects.equals(this.reasons, signUpResponse.reasons) &&
        Objects.equals(this.status, signUpResponse.status) &&
        Objects.equals(this.subscriptionId, signUpResponse.subscriptionId) &&
        Objects.equals(this.subscriptionNumber, signUpResponse.subscriptionNumber) &&
        Objects.equals(this.success, signUpResponse.success)&&
        Objects.equals(this.additionalProperties, signUpResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, accountNumber, creditMemoId, creditMemoNumber, invoiceId, invoiceNumber, orderNumber, paidAmount, paymentId, paymentNumber, processId, reasons, status, subscriptionId, subscriptionNumber, success, additionalProperties);
  }
      ...
      if (jsonObj.get("reasons") != null && !jsonObj.get("reasons").isJsonNull()) {
        ...
        if (jsonArrayreasons != null) {
          ...
          for (int i = 0; i < jsonArrayreasons.size(); i++) {
            SignUpResponseReasons.validateJsonObject(jsonArrayreasons.get(i).getAsJsonObject());
          };
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SignUpResponse>() {
           ...
           public SignUpResponse read(JsonReader in) throws IOException {
             ...
             SignUpResponse instance = thisAdapter.fromJsonTree(jsonObj);
