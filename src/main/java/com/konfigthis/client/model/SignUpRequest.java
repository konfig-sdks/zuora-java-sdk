...
public class SignUpRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CustomerUserId__c", value = "Specify the name of the field that holds external account id")
  ...
  **/
   ...
   * @return the SignUpRequest instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountData, signUpRequest.accountData) &&
        Objects.equals(this.accountIdentifierField, signUpRequest.accountIdentifierField) &&
        Objects.equals(this.customFields, signUpRequest.customFields) &&
        Objects.equals(this.options, signUpRequest.options) &&
        Objects.equals(this.paymentData, signUpRequest.paymentData) &&
        Objects.equals(this.subscriptionData, signUpRequest.subscriptionData)&&
        Objects.equals(this.additionalProperties, signUpRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountData, accountIdentifierField, customFields, options, paymentData, subscriptionData, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    accountIdentifierField: ").append(toIndentedString(accountIdentifierField)).append("\n");
  ...
  static {
    ...
    openapiFields.add("accountData");
    openapiFields.add("accountIdentifierField");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      // validate the optional field `accountData`
      if (jsonObj.get("accountData") != null && !jsonObj.get("accountData").isJsonNull()) {
        AccountData.validateJsonObject(jsonObj.getAsJsonObject("accountData"));
      }
      if ((jsonObj.get("accountIdentifierField") != null && !jsonObj.get("accountIdentifierField").isJsonNull()) && !jsonObj.get("accountIdentifierField").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `accountIdentifierField` to be a primitive type in the JSON string but got `%s`", jsonObj.get("accountIdentifierField").toString()));
      }
      ...
      if (jsonObj.get("paymentData") != null && !jsonObj.get("paymentData").isJsonNull()) {
        PaymentData.validateJsonObject(jsonObj.getAsJsonObject("paymentData"));
      }
      // validate the optional field `subscriptionData`
      if (jsonObj.get("subscriptionData") != null && !jsonObj.get("subscriptionData").isJsonNull()) {
        SubscriptionData.validateJsonObject(jsonObj.getAsJsonObject("subscriptionData"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SignUpRequest>() {
           ...
           public SignUpRequest read(JsonReader in) throws IOException {
             ...
             SignUpRequest instance = thisAdapter.fromJsonTree(jsonObj);
