...
import com.konfigthis.client.model.SignUpPaymentMethod;
import com.konfigthis.client.model.SignUpTaxInfo;
 ...
 */
@ApiModel(description = "The information of the account that you are to create through the \"Sign up\" operation. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AccountData {
  ...
  public AccountData accountNumber(String accountNumber) {
  ...
  **/
  ...
  public AccountData autoPay(Boolean autoPay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Specifies whether future payments are to be automatically billed when they are due. Possible values are `true`, `false`.")
  ...
  public AccountData batch(String batch) {
  ...
  **/
  ...
  public AccountData billCycleDay(Integer billCycleDay) {
  ...
  **/
  ...
  @ApiModelProperty(example = "15", required = true, value = "Day of the month that the account prefers billing periods to begin on. If set to 0, the bill cycle day will be set as \"AutoSet\".")
  ...
  public AccountData billToContact(ContactInfo billToContact) {
  ...
  **/
  ...
  public void setBillToContact(ContactInfo billToContact) {
  ...
  public AccountData communicationProfileId(String communicationProfileId) {
  ...
  **/
  ...
  public AccountData creditMemoTemplateId(String creditMemoTemplateId) {
  ...
  **/
  ...
  public AccountData crmId(String crmId) {
  ...
  **/
  ...
  public AccountData currency(String currency) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "USD", required = true, value = "3 uppercase character currency code.  For payment method authorization, if the `paymentMethod` > `currencyCode` field is specified, `currencyCode` is used. Otherwise, this `currency` field is used for payment method authorization. If no currency is specified for the account, the default currency of the account is then used. ")
  ...
  public AccountData customFields(Map<String, Object> customFields) {
  ...
  public AccountData putCustomFieldsItem(String key, Object customFieldsItem) {
  ...
  **/
  ...
  public AccountData debitMemoTemplateId(String debitMemoTemplateId) {
  ...
  **/
  ...
  public AccountData invoiceTemplateId(String invoiceTemplateId) {
  ...
  **/
  ...
  public AccountData notes(String notes) {
  ...
  **/
  ...
  public AccountData paymentMethod(SignUpPaymentMethod paymentMethod) {
  ...
  **/
  ...
  public void setPaymentMethod(SignUpPaymentMethod paymentMethod) {
  ...
  public AccountData paymentTerm(String paymentTerm) {
  ...
  **/
  ...
  public AccountData purchaseOrderNumber(String purchaseOrderNumber) {
  ...
  **/
  ...
  public AccountData sequenceSetId(String sequenceSetId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the billing document sequence set to assign to the customer account.   The billing documents to generate for this account will adopt the prefix and starting document number configured in the sequence set. ")
  ...
  public AccountData soldToContact(ContactInfo soldToContact) {
  ...
  **/
  ...
  public void setSoldToContact(ContactInfo soldToContact) {
  ...
  public AccountData taxInfo(SignUpTaxInfo taxInfo) {
  ...
  **/
  ...
  public void setTaxInfo(SignUpTaxInfo taxInfo) {
   ...
   * @return the AccountData instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountNumber, accountData.accountNumber) &&
        Objects.equals(this.autoPay, accountData.autoPay) &&
        Objects.equals(this.batch, accountData.batch) &&
        Objects.equals(this.billCycleDay, accountData.billCycleDay) &&
        Objects.equals(this.billToContact, accountData.billToContact) &&
        Objects.equals(this.communicationProfileId, accountData.communicationProfileId) &&
        Objects.equals(this.creditMemoTemplateId, accountData.creditMemoTemplateId) &&
        Objects.equals(this.crmId, accountData.crmId) &&
        Objects.equals(this.currency, accountData.currency) &&
        Objects.equals(this.customFields, accountData.customFields) &&
        Objects.equals(this.debitMemoTemplateId, accountData.debitMemoTemplateId) &&
        Objects.equals(this.invoiceTemplateId, accountData.invoiceTemplateId) &&
        Objects.equals(this.name, accountData.name) &&
        Objects.equals(this.notes, accountData.notes) &&
        Objects.equals(this.paymentMethod, accountData.paymentMethod) &&
        Objects.equals(this.paymentTerm, accountData.paymentTerm) &&
        Objects.equals(this.purchaseOrderNumber, accountData.purchaseOrderNumber) &&
        Objects.equals(this.sequenceSetId, accountData.sequenceSetId) &&
        Objects.equals(this.soldToContact, accountData.soldToContact) &&
        Objects.equals(this.taxInfo, accountData.taxInfo)&&
        Objects.equals(this.additionalProperties, accountData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, autoPay, batch, billCycleDay, billToContact, communicationProfileId, creditMemoTemplateId, crmId, currency, customFields, debitMemoTemplateId, invoiceTemplateId, name, notes, paymentMethod, paymentTerm, purchaseOrderNumber, sequenceSetId, soldToContact, taxInfo, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      ContactInfo.validateJsonObject(jsonObj.getAsJsonObject("billToContact"));
      ...
      if (jsonObj.get("paymentMethod") != null && !jsonObj.get("paymentMethod").isJsonNull()) {
        SignUpPaymentMethod.validateJsonObject(jsonObj.getAsJsonObject("paymentMethod"));
      }
      ...
      if (jsonObj.get("soldToContact") != null && !jsonObj.get("soldToContact").isJsonNull()) {
        ContactInfo.validateJsonObject(jsonObj.getAsJsonObject("soldToContact"));
      }
      // validate the optional field `taxInfo`
      if (jsonObj.get("taxInfo") != null && !jsonObj.get("taxInfo").isJsonNull()) {
        SignUpTaxInfo.validateJsonObject(jsonObj.getAsJsonObject("taxInfo"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AccountData>() {
           ...
           public AccountData read(JsonReader in) throws IOException {
             ...
             AccountData instance = thisAdapter.fromJsonTree(jsonObj);
