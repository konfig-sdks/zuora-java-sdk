...
public class OrderActionRatePlanRecurringTieredPricingOverride {
  /**
 ...
 public enum ListPriceBaseEnum {
  ...
  public OrderActionRatePlanRecurringTieredPricingOverride() {
  }

  public OrderActionRatePlanRecurringTieredPricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public OrderActionRatePlanRecurringTieredPricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public OrderActionRatePlanRecurringTieredPricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanRecurringTieredPricingOverride listPriceBase(ListPriceBaseEnum listPriceBase) {
  ...
  **/
  ...
  public OrderActionRatePlanRecurringTieredPricingOverride quantity(Double quantity) {
  ...
  public OrderActionRatePlanRecurringTieredPricingOverride quantity(Integer quantity) {
    if (quantity != null && quantity < 0) {
      throw new IllegalArgumentException("Invalid value for quantity. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanRecurringTieredPricingOverride specificListPriceBase(Integer specificListPriceBase) {
  ...
  **/
  ...
  public OrderActionRatePlanRecurringTieredPricingOverride tiers(List<OrderActionRatePlanChargeTier> tiers) {
  ...
  public OrderActionRatePlanRecurringTieredPricingOverride addTiersItem(OrderActionRatePlanChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the OrderActionRatePlanRecurringTieredPricingOverride instance itself
   */
  public OrderActionRatePlanRecurringTieredPricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanRecurringTieredPricingOverride orderActionRatePlanRecurringTieredPricingOverride = (OrderActionRatePlanRecurringTieredPricingOverride) o;
    return Objects.equals(this.priceChangeOption, orderActionRatePlanRecurringTieredPricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, orderActionRatePlanRecurringTieredPricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.listPriceBase, orderActionRatePlanRecurringTieredPricingOverride.listPriceBase) &&
        Objects.equals(this.quantity, orderActionRatePlanRecurringTieredPricingOverride.quantity) &&
        Objects.equals(this.specificListPriceBase, orderActionRatePlanRecurringTieredPricingOverride.specificListPriceBase) &&
        Objects.equals(this.tiers, orderActionRatePlanRecurringTieredPricingOverride.tiers)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanRecurringTieredPricingOverride.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderActionRatePlanRecurringTieredPricingOverride {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanRecurringTieredPricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanRecurringTieredPricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanRecurringTieredPricingOverride is not found in the empty JSON string", OrderActionRatePlanRecurringTieredPricingOverride.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanRecurringTieredPricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanRecurringTieredPricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanRecurringTieredPricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanRecurringTieredPricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanRecurringTieredPricingOverride>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanRecurringTieredPricingOverride value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanRecurringTieredPricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanRecurringTieredPricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanRecurringTieredPricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanRecurringTieredPricingOverride
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanRecurringTieredPricingOverride
  */
  public static OrderActionRatePlanRecurringTieredPricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanRecurringTieredPricingOverride.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanRecurringTieredPricingOverride to an JSON string
  *
  * @return JSON string
  */
