...
public class POSTSubscriptionPreviewTypeAllOf {
  ...
  public POSTSubscriptionPreviewTypeAllOf() {
  }

  public POSTSubscriptionPreviewTypeAllOf accountKey(String accountKey) {
  ...
  **/
  ...
  @ApiModelProperty(value = " Customer account number or ID.  You must specify the account information either in this field or in the `previewAccountInfo` field with the following conditions:           * If you already have a customer account, specify the account number or ID in this field. * If you do not have a customer account, provide account information in the `previewAccountInfo` field. ")
  ...
  public POSTSubscriptionPreviewTypeAllOf contractEffectiveDate(LocalDate contractEffectiveDate) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf customerAcceptanceDate(LocalDate customerAcceptanceDate) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf documentDate(LocalDate documentDate) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf includeExistingDraftDocItems(Boolean includeExistingDraftDocItems) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf includeExistingDraftInvoiceItems(Boolean includeExistingDraftInvoiceItems) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies whether to include draft invoice items in previews. Values are:  * `true` (default). Includes draft invoice items in the preview result. * `false`. Excludes draft invoice items in the preview result.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 186.0, 187.0, 188.0, 189.0, 196.0, and 206.0. ")
  ...
  public POSTSubscriptionPreviewTypeAllOf initialTerm(Long initialTerm) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Duration of the first term of the subscription, in whole months. If `termType` is `TERMED`, then this field is required, and the value must be greater than `0`. If `termType` is `EVERGREEN`, this field is ignored.     ")
  ...
  public POSTSubscriptionPreviewTypeAllOf initialTermPeriodType(String initialTermPeriodType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The period type of the initial term.   Supported values are:  * `Month` * `Year` * `Day` * `Week`   The default period type is `Month`.  ")
  ...
  public POSTSubscriptionPreviewTypeAllOf invoiceOwnerAccountKey(String invoiceOwnerAccountKey) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf invoiceTargetDate(LocalDate invoiceTargetDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date through which to calculate charges if an invoice is generated, as yyyy-mm-dd. Default is current date.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 186.0, 187.0, 188.0, 189.0, 196.0, and 206.0. . ")
  ...
  public POSTSubscriptionPreviewTypeAllOf notes(String notes) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf previewAccountInfo(POSTSubscriptionPreviewTypePreviewAccountInfo previewAccountInfo) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf previewType(String previewType) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf serviceActivationDate(LocalDate serviceActivationDate) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf subscribeToRatePlans(List<POSTSrpCreateType> subscribeToRatePlans) {
  ...
  public POSTSubscriptionPreviewTypeAllOf addSubscribeToRatePlansItem(POSTSrpCreateType subscribeToRatePlansItem) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf targetDate(LocalDate targetDate) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf termStartDate(LocalDate termStartDate) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypeAllOf termType(String termType) {
  ...
  **/
   ...
   * @return the POSTSubscriptionPreviewTypeAllOf instance itself
   */
  public POSTSubscriptionPreviewTypeAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTSubscriptionPreviewTypeAllOf poSTSubscriptionPreviewTypeAllOf = (POSTSubscriptionPreviewTypeAllOf) o;
    return Objects.equals(this.accountKey, poSTSubscriptionPreviewTypeAllOf.accountKey) &&
        Objects.equals(this.contractEffectiveDate, poSTSubscriptionPreviewTypeAllOf.contractEffectiveDate) &&
        Objects.equals(this.customerAcceptanceDate, poSTSubscriptionPreviewTypeAllOf.customerAcceptanceDate) &&
        Objects.equals(this.documentDate, poSTSubscriptionPreviewTypeAllOf.documentDate) &&
        Objects.equals(this.includeExistingDraftDocItems, poSTSubscriptionPreviewTypeAllOf.includeExistingDraftDocItems) &&
        Objects.equals(this.includeExistingDraftInvoiceItems, poSTSubscriptionPreviewTypeAllOf.includeExistingDraftInvoiceItems) &&
        Objects.equals(this.initialTerm, poSTSubscriptionPreviewTypeAllOf.initialTerm) &&
        Objects.equals(this.initialTermPeriodType, poSTSubscriptionPreviewTypeAllOf.initialTermPeriodType) &&
        Objects.equals(this.invoiceOwnerAccountKey, poSTSubscriptionPreviewTypeAllOf.invoiceOwnerAccountKey) &&
        Objects.equals(this.invoiceTargetDate, poSTSubscriptionPreviewTypeAllOf.invoiceTargetDate) &&
        Objects.equals(this.notes, poSTSubscriptionPreviewTypeAllOf.notes) &&
        Objects.equals(this.previewAccountInfo, poSTSubscriptionPreviewTypeAllOf.previewAccountInfo) &&
        Objects.equals(this.previewType, poSTSubscriptionPreviewTypeAllOf.previewType) &&
        Objects.equals(this.serviceActivationDate, poSTSubscriptionPreviewTypeAllOf.serviceActivationDate) &&
        Objects.equals(this.subscribeToRatePlans, poSTSubscriptionPreviewTypeAllOf.subscribeToRatePlans) &&
        Objects.equals(this.targetDate, poSTSubscriptionPreviewTypeAllOf.targetDate) &&
        Objects.equals(this.termStartDate, poSTSubscriptionPreviewTypeAllOf.termStartDate) &&
        Objects.equals(this.termType, poSTSubscriptionPreviewTypeAllOf.termType)&&
        Objects.equals(this.additionalProperties, poSTSubscriptionPreviewTypeAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class POSTSubscriptionPreviewTypeAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTSubscriptionPreviewTypeAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTSubscriptionPreviewTypeAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTSubscriptionPreviewTypeAllOf is not found in the empty JSON string", POSTSubscriptionPreviewTypeAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : POSTSubscriptionPreviewTypeAllOf.openapiRequiredFields) {
      ...
      if (jsonObj.get("previewAccountInfo") != null && !jsonObj.get("previewAccountInfo").isJsonNull()) {
        POSTSubscriptionPreviewTypePreviewAccountInfo.validateJsonObject(jsonObj.getAsJsonObject("previewAccountInfo"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTSubscriptionPreviewTypeAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTSubscriptionPreviewTypeAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTSubscriptionPreviewTypeAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTSubscriptionPreviewTypeAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTSubscriptionPreviewTypeAllOf>() {
           @Override
           public void write(JsonWriter out, POSTSubscriptionPreviewTypeAllOf value) throws IOException {
           ...
           @Override
           public POSTSubscriptionPreviewTypeAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTSubscriptionPreviewTypeAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTSubscriptionPreviewTypeAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTSubscriptionPreviewTypeAllOf
  * @throws IOException if the JSON string is invalid with respect to POSTSubscriptionPreviewTypeAllOf
  */
  public static POSTSubscriptionPreviewTypeAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTSubscriptionPreviewTypeAllOf.class);
  }

 /**
  * Convert an instance of POSTSubscriptionPreviewTypeAllOf to an JSON string
  *
  * @return JSON string
  */
