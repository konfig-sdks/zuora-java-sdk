 ...
 */
@ApiModel(description = "Container for Product fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProductObjectNSFields {
 ...
 public enum ItemTypeNSEnum {
  ...
  public ProductObjectNSFields() {
  }

  public ProductObjectNSFields integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public ProductObjectNSFields integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public ProductObjectNSFields itemTypeNS(ItemTypeNSEnum itemTypeNS) {
  ...
  **/
  ...
  public ProductObjectNSFields syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the ProductObjectNSFields instance itself
   */
  public ProductObjectNSFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductObjectNSFields productObjectNSFields = (ProductObjectNSFields) o;
    return Objects.equals(this.integrationIdNS, productObjectNSFields.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, productObjectNSFields.integrationStatusNS) &&
        Objects.equals(this.itemTypeNS, productObjectNSFields.itemTypeNS) &&
        Objects.equals(this.syncDateNS, productObjectNSFields.syncDateNS)&&
        Objects.equals(this.additionalProperties, productObjectNSFields.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(integrationIdNS, integrationStatusNS, itemTypeNS, syncDateNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProductObjectNSFields {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductObjectNSFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductObjectNSFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductObjectNSFields is not found in the empty JSON string", ProductObjectNSFields.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductObjectNSFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductObjectNSFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductObjectNSFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductObjectNSFields.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductObjectNSFields>() {
           @Override
           public void write(JsonWriter out, ProductObjectNSFields value) throws IOException {
           ...
           @Override
           public ProductObjectNSFields read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductObjectNSFields instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductObjectNSFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductObjectNSFields
  * @throws IOException if the JSON string is invalid with respect to ProductObjectNSFields
  */
  public static ProductObjectNSFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductObjectNSFields.class);
  }

 /**
  * Convert an instance of ProductObjectNSFields to an JSON string
  *
  * @return JSON string
  */
