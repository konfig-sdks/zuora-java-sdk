...
/**
 * PaymentScheduleCommonResponseAllOf
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PaymentScheduleCommonResponseAllOf {
 ...
 public enum StatusEnum {
  ...
  public PaymentScheduleCommonResponseAllOf() {
  }

  public PaymentScheduleCommonResponseAllOf description(String description) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf accountId(String accountId) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf accountNumber(String accountNumber) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf billingDocument(GETPaymentScheduleItemResponseAllOfBillingDocument billingDocument) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf createdById(String createdById) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf createdDate(LocalDate createdDate) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf id(String id) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf isCustom(Boolean isCustom) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf items(List<PaymentScheduleItemCommonResponse> items) {
  ...
  public PaymentScheduleCommonResponseAllOf addItemsItem(PaymentScheduleItemCommonResponse itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf nextPaymentDate(LocalDate nextPaymentDate) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf occurrences(Integer occurrences) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf paymentOption(List<PaymentSchedulePaymentOptionFields> paymentOption) {
  ...
  public PaymentScheduleCommonResponseAllOf addPaymentOptionItem(PaymentSchedulePaymentOptionFields paymentOptionItem) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf paymentScheduleNumber(String paymentScheduleNumber) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf period(String period) {
   ...
   /**
   * For recurring payment schedule only. The period of payment generation. Available values include: &#x60;Monthly&#x60;, &#x60;Weekly&#x60;, &#x60;BiWeekly&#x60;. Returns &#x60;null&#x60; for custom payment schedules. 
   * @return period
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "For recurring payment schedule only. The period of payment generation. Available values include: `Monthly`, `Weekly`, `BiWeekly`. Returns `null` for custom payment schedules. ")
  ...
  public PaymentScheduleCommonResponseAllOf prepayment(Boolean prepayment) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf recentPaymentDate(LocalDate recentPaymentDate) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf runHour(Integer runHour) {
   ...
   /**
   * [0,1,2,~,22,23]  At which hour in the day in the tenant’s timezone the recurring payment schedule items will be collected. Return &#x60;0&#x60; for custom payment schedules. 
   * @return runHour
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "[0,1,2,~,22,23]  At which hour in the day in the tenant’s timezone the recurring payment schedule items will be collected. Return `0` for custom payment schedules. ")
  ...
  public PaymentScheduleCommonResponseAllOf standalone(Boolean standalone) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf startDate(LocalDate startDate) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf status(StatusEnum status) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf totalAmount(Double totalAmount) {
  ...
  public PaymentScheduleCommonResponseAllOf totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf totalPaymentsErrored(Integer totalPaymentsErrored) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf totalPaymentsProcessed(Integer totalPaymentsProcessed) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf updatedById(String updatedById) {
  ...
  **/
  ...
  public PaymentScheduleCommonResponseAllOf updatedDate(LocalDate updatedDate) {
  ...
  **/
   ...
   * @return the PaymentScheduleCommonResponseAllOf instance itself
   */
  public PaymentScheduleCommonResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentScheduleCommonResponseAllOf paymentScheduleCommonResponseAllOf = (PaymentScheduleCommonResponseAllOf) o;
    return Objects.equals(this.description, paymentScheduleCommonResponseAllOf.description) &&
        Objects.equals(this.accountId, paymentScheduleCommonResponseAllOf.accountId) &&
        Objects.equals(this.accountNumber, paymentScheduleCommonResponseAllOf.accountNumber) &&
        Objects.equals(this.billingDocument, paymentScheduleCommonResponseAllOf.billingDocument) &&
        Objects.equals(this.createdById, paymentScheduleCommonResponseAllOf.createdById) &&
        Objects.equals(this.createdDate, paymentScheduleCommonResponseAllOf.createdDate) &&
        Objects.equals(this.id, paymentScheduleCommonResponseAllOf.id) &&
        Objects.equals(this.isCustom, paymentScheduleCommonResponseAllOf.isCustom) &&
        Objects.equals(this.items, paymentScheduleCommonResponseAllOf.items) &&
        Objects.equals(this.nextPaymentDate, paymentScheduleCommonResponseAllOf.nextPaymentDate) &&
        Objects.equals(this.occurrences, paymentScheduleCommonResponseAllOf.occurrences) &&
        Objects.equals(this.paymentOption, paymentScheduleCommonResponseAllOf.paymentOption) &&
        Objects.equals(this.paymentScheduleNumber, paymentScheduleCommonResponseAllOf.paymentScheduleNumber) &&
        Objects.equals(this.period, paymentScheduleCommonResponseAllOf.period) &&
        Objects.equals(this.prepayment, paymentScheduleCommonResponseAllOf.prepayment) &&
        Objects.equals(this.recentPaymentDate, paymentScheduleCommonResponseAllOf.recentPaymentDate) &&
        Objects.equals(this.runHour, paymentScheduleCommonResponseAllOf.runHour) &&
        Objects.equals(this.standalone, paymentScheduleCommonResponseAllOf.standalone) &&
        Objects.equals(this.startDate, paymentScheduleCommonResponseAllOf.startDate) &&
        Objects.equals(this.status, paymentScheduleCommonResponseAllOf.status) &&
        Objects.equals(this.totalAmount, paymentScheduleCommonResponseAllOf.totalAmount) &&
        Objects.equals(this.totalPaymentsErrored, paymentScheduleCommonResponseAllOf.totalPaymentsErrored) &&
        Objects.equals(this.totalPaymentsProcessed, paymentScheduleCommonResponseAllOf.totalPaymentsProcessed) &&
        Objects.equals(this.updatedById, paymentScheduleCommonResponseAllOf.updatedById) &&
        Objects.equals(this.updatedDate, paymentScheduleCommonResponseAllOf.updatedDate)&&
        Objects.equals(this.additionalProperties, paymentScheduleCommonResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, accountId, accountNumber, billingDocument, createdById, createdDate, id, isCustom, items, nextPaymentDate, occurrences, paymentOption, paymentScheduleNumber, period, prepayment, recentPaymentDate, runHour, standalone, startDate, status, totalAmount, totalPaymentsErrored, totalPaymentsProcessed, updatedById, updatedDate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentScheduleCommonResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentScheduleCommonResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentScheduleCommonResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentScheduleCommonResponseAllOf is not found in the empty JSON string", PaymentScheduleCommonResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentScheduleCommonResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentScheduleCommonResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentScheduleCommonResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentScheduleCommonResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentScheduleCommonResponseAllOf>() {
           @Override
           public void write(JsonWriter out, PaymentScheduleCommonResponseAllOf value) throws IOException {
           ...
           @Override
           public PaymentScheduleCommonResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentScheduleCommonResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentScheduleCommonResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentScheduleCommonResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to PaymentScheduleCommonResponseAllOf
  */
  public static PaymentScheduleCommonResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentScheduleCommonResponseAllOf.class);
  }

 /**
  * Convert an instance of PaymentScheduleCommonResponseAllOf to an JSON string
  *
  * @return JSON string
  */
