...
public class WorkflowDefinitionAndVersions {
  ...
  private List<Workflow> latestInactiveVerisons = null;
  ...
  **/
  ...
  public WorkflowDefinitionAndVersions activeVersion(WorkflowDefinitionAndVersionsActiveVersion activeVersion) {
  ...
  **/
  ...
  public WorkflowDefinitionAndVersions latestInactiveVerisons(List<Workflow> latestInactiveVerisons) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The list of inactive workflow versions retrieved. Maximum number of versions retrieved is 10.   ")

  public List<Workflow> getLatestInactiveVerisons() {
    return latestInactiveVerisons;
  }


  public void setLatestInactiveVerisons(List<Workflow> latestInactiveVerisons) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, workflowDefinitionAndVersions.description) &&
        Objects.equals(this.activeVersion, workflowDefinitionAndVersions.activeVersion) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, activeVersion, calloutTrigger, createdAt, id, interval, latestInactiveVerisons, name, ondemandTrigger, scheduledTrigger, status, timezone, updatedAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowDefinitionAndVersions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowDefinitionAndVersions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("latest_inactive_verisons") != null && !jsonObj.get("latest_inactive_verisons").isJsonNull()) {
        ...
        if (jsonArraylatestInactiveVerisons != null) {
          ...
          for (int i = 0; i < jsonArraylatestInactiveVerisons.size(); i++) {
            Workflow.validateJsonObject(jsonArraylatestInactiveVerisons.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<WorkflowDefinitionAndVersions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowDefinitionAndVersions.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowDefinitionAndVersions>() {
           @Override
