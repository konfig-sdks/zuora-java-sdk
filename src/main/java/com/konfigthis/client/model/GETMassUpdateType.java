...
public class GETMassUpdateType {
  ...
  **/
  ...
  @ApiModelProperty(value = "Type of mass action. ")
  ...
  public GETMassUpdateType endedOn(OffsetDateTime endedOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date and time that the mass action was completed. The format is `yyyy-MM-dd hh:mm:ss`. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total number of failed records.  This field is updated in real time. When the mass action **status** is Processing, this field returns the number of records that have failed so far. When the mass action **status** is Pending, this field is null. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Size of the input file in bytes. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Size of the response file in bytes. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Type of output for the response file. The following table describes the output type.  | Output Type    | Description                         | |----------------|-------------------------------------| | (url:.csv.zip) | URL pointing to a zipped .csv file. | ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "URL to download the response file. The response file is a zipped .csv file.  The response file is identical to the file you uploaded to perform the mass action, with additional columns providing information about the outcome of each record.  This field only returns a value when the mass action **status** is Completed or Stopped. Otherwise, this field is null. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total number of processed records. This field is equal to the sum of `errorCount` and `successCount`.  This field is updated in real time. When the mass action **status** is Processing, this field returns the number of records that have been processed so far. When the mass action **status** is Pending, this field is null. ")
  ...
  public GETMassUpdateType startedOn(OffsetDateTime startedOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date and time that Zuora started processing the mass action. The format is `yyyy-MM-dd hh:mm:ss`. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Status of the mass action. The following table describes the mass action statuses.  | Status     | Description                                                                | |------------|----------------------------------------------------------------------------| | Pending    | Mass action has not yet started being processed.                           | | Processing | Mass action is in progress.                                                | | Stopping   | Mass action is in the process of stopping, but has not yet stopped.        | | Stopped    | Mass action has stopped.                                                   | | Completed  | Mass action was successfully completed. There may still be failed records. | | Failed     | Mass action failed. No records are processed. No response file is created. | ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total number of successful records. This field is updated in real time. When the mass action **status** is Processing, this field returns the number of records that have succeeded so far. When the mass action **status** is Pending, this field is null. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total number of records in the uploaded mass action file. When the mass action **status** is Pending, this field is null. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Email of the person who uploaded the mass action file. ")
  ...
  public GETMassUpdateType uploadedOn(OffsetDateTime uploadedOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date and time that the mass action file was uploaded. The format is `yyyy-MM-dd hh:mm:ss`. ")
   ...
   * @return the GETMassUpdateType instance itself
   */
  public GETMassUpdateType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionType, geTMassUpdateType.actionType) &&
        ...
        Objects.equals(this.additionalProperties, geTMassUpdateType.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETMassUpdateType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETMassUpdateType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETMassUpdateType is not found in the empty JSON string", GETMassUpdateType.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETMassUpdateType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETMassUpdateType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETMassUpdateType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETMassUpdateType.class));

       return (TypeAdapter<T>) new TypeAdapter<GETMassUpdateType>() {
           @Override
           public void write(JsonWriter out, GETMassUpdateType value) throws IOException {
           ...
           @Override
           public GETMassUpdateType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETMassUpdateType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETMassUpdateType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETMassUpdateType
  * @throws IOException if the JSON string is invalid with respect to GETMassUpdateType
  */
  public static GETMassUpdateType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETMassUpdateType.class);
  }

 /**
  * Convert an instance of GETMassUpdateType to an JSON string
  *
  * @return JSON string
  */
