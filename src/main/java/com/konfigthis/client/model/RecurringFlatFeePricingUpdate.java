...
public class RecurringFlatFeePricingUpdate {
 ...
 public enum PriceChangeOptionEnum {
  ...
  public RecurringFlatFeePricingUpdate() {
  }

  public RecurringFlatFeePricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public RecurringFlatFeePricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public RecurringFlatFeePricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public RecurringFlatFeePricingUpdate listPrice(Double listPrice) {
  ...
  public RecurringFlatFeePricingUpdate listPrice(Integer listPrice) {
  ...
  **/
  ...
  public RecurringFlatFeePricingUpdate originalListPrice(Double originalListPrice) {
  ...
  public RecurringFlatFeePricingUpdate originalListPrice(Integer originalListPrice) {
  ...
  **/
   ...
   * @return the RecurringFlatFeePricingUpdate instance itself
   */
  public RecurringFlatFeePricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecurringFlatFeePricingUpdate recurringFlatFeePricingUpdate = (RecurringFlatFeePricingUpdate) o;
    return Objects.equals(this.priceChangeOption, recurringFlatFeePricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, recurringFlatFeePricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.listPrice, recurringFlatFeePricingUpdate.listPrice) &&
        Objects.equals(this.originalListPrice, recurringFlatFeePricingUpdate.originalListPrice)&&
        Objects.equals(this.additionalProperties, recurringFlatFeePricingUpdate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecurringFlatFeePricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecurringFlatFeePricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecurringFlatFeePricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurringFlatFeePricingUpdate is not found in the empty JSON string", RecurringFlatFeePricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurringFlatFeePricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurringFlatFeePricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurringFlatFeePricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurringFlatFeePricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurringFlatFeePricingUpdate>() {
           @Override
           public void write(JsonWriter out, RecurringFlatFeePricingUpdate value) throws IOException {
           ...
           @Override
           public RecurringFlatFeePricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecurringFlatFeePricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecurringFlatFeePricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecurringFlatFeePricingUpdate
  * @throws IOException if the JSON string is invalid with respect to RecurringFlatFeePricingUpdate
  */
  public static RecurringFlatFeePricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurringFlatFeePricingUpdate.class);
  }

 /**
  * Convert an instance of RecurringFlatFeePricingUpdate to an JSON string
  *
  * @return JSON string
  */
