...
public class RecurringPerUnitPricingUpdate {
 ...
 public enum PriceChangeOptionEnum {
  ...
  public RecurringPerUnitPricingUpdate() {
  }

  public RecurringPerUnitPricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public RecurringPerUnitPricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public RecurringPerUnitPricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public RecurringPerUnitPricingUpdate listPrice(Double listPrice) {
  ...
  public RecurringPerUnitPricingUpdate listPrice(Integer listPrice) {
  ...
  **/
  ...
  public RecurringPerUnitPricingUpdate originalListPrice(Double originalListPrice) {
  ...
  public RecurringPerUnitPricingUpdate originalListPrice(Integer originalListPrice) {
  ...
  **/
  ...
  public RecurringPerUnitPricingUpdate quantity(Double quantity) {
  ...
  public RecurringPerUnitPricingUpdate quantity(Integer quantity) {
    if (quantity != null && quantity < 0) {
      throw new IllegalArgumentException("Invalid value for quantity. Must be greater than or equal to 0.");
    }
  ...
  **/
   ...
   * @return the RecurringPerUnitPricingUpdate instance itself
   */
  public RecurringPerUnitPricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecurringPerUnitPricingUpdate recurringPerUnitPricingUpdate = (RecurringPerUnitPricingUpdate) o;
    return Objects.equals(this.priceChangeOption, recurringPerUnitPricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, recurringPerUnitPricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.listPrice, recurringPerUnitPricingUpdate.listPrice) &&
        Objects.equals(this.originalListPrice, recurringPerUnitPricingUpdate.originalListPrice) &&
        Objects.equals(this.quantity, recurringPerUnitPricingUpdate.quantity)&&
        Objects.equals(this.additionalProperties, recurringPerUnitPricingUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, listPrice, originalListPrice, quantity, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RecurringPerUnitPricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecurringPerUnitPricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecurringPerUnitPricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurringPerUnitPricingUpdate is not found in the empty JSON string", RecurringPerUnitPricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurringPerUnitPricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurringPerUnitPricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurringPerUnitPricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurringPerUnitPricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurringPerUnitPricingUpdate>() {
           @Override
           public void write(JsonWriter out, RecurringPerUnitPricingUpdate value) throws IOException {
           ...
           @Override
           public RecurringPerUnitPricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecurringPerUnitPricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecurringPerUnitPricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecurringPerUnitPricingUpdate
  * @throws IOException if the JSON string is invalid with respect to RecurringPerUnitPricingUpdate
  */
  public static RecurringPerUnitPricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurringPerUnitPricingUpdate.class);
  }

 /**
  * Convert an instance of RecurringPerUnitPricingUpdate to an JSON string
  *
  * @return JSON string
  */
