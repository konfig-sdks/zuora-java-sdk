...
public class OrderActionRatePlanRecurringVolumePricingOverride {
  /**
 ...
 public enum PriceChangeOptionEnum {
  ...
  /**
   * Specifies the duration of each recurring period.  **Note**: The &#x60;Per_Year&#x60; and &#x60;Per_Specific_Months&#x60; enum values are available only if you have the &lt;a href&#x3D;\&quot;https://knowledgecenter.zuora.com/Billing/Subscriptions/Product_Catalog/I_Annual_List_Price\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Annual List Price&lt;/a&gt; feature enabled. 
   */
 ...
 public enum ListPriceBaseEnum {
  ...
  public OrderActionRatePlanRecurringVolumePricingOverride() {
  }

  public OrderActionRatePlanRecurringVolumePricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public OrderActionRatePlanRecurringVolumePricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public OrderActionRatePlanRecurringVolumePricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanRecurringVolumePricingOverride listPriceBase(ListPriceBaseEnum listPriceBase) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the duration of each recurring period.  **Note**: The `Per_Year` and `Per_Specific_Months` enum values are available only if you have the <a href=\"https://knowledgecenter.zuora.com/Billing/Subscriptions/Product_Catalog/I_Annual_List_Price\" target=\"_blank\">Annual List Price</a> feature enabled. ")
  ...
  public OrderActionRatePlanRecurringVolumePricingOverride quantity(Double quantity) {
  ...
  public OrderActionRatePlanRecurringVolumePricingOverride quantity(Integer quantity) {
    if (quantity != null && quantity < 0) {
      throw new IllegalArgumentException("Invalid value for quantity. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanRecurringVolumePricingOverride specificListPriceBase(Integer specificListPriceBase) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of months for the list price base of the charge. This field is required if you set the value of the `listPriceBase` field to `Per_Specific_Months`. ")
  ...
  public OrderActionRatePlanRecurringVolumePricingOverride tiers(List<OrderActionRatePlanChargeTier> tiers) {
  ...
  public OrderActionRatePlanRecurringVolumePricingOverride addTiersItem(OrderActionRatePlanChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the OrderActionRatePlanRecurringVolumePricingOverride instance itself
   */
  public OrderActionRatePlanRecurringVolumePricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanRecurringVolumePricingOverride orderActionRatePlanRecurringVolumePricingOverride = (OrderActionRatePlanRecurringVolumePricingOverride) o;
    return Objects.equals(this.priceChangeOption, orderActionRatePlanRecurringVolumePricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, orderActionRatePlanRecurringVolumePricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.listPriceBase, orderActionRatePlanRecurringVolumePricingOverride.listPriceBase) &&
        Objects.equals(this.quantity, orderActionRatePlanRecurringVolumePricingOverride.quantity) &&
        Objects.equals(this.specificListPriceBase, orderActionRatePlanRecurringVolumePricingOverride.specificListPriceBase) &&
        Objects.equals(this.tiers, orderActionRatePlanRecurringVolumePricingOverride.tiers)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanRecurringVolumePricingOverride.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, listPriceBase, quantity, specificListPriceBase, tiers, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderActionRatePlanRecurringVolumePricingOverride {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanRecurringVolumePricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanRecurringVolumePricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanRecurringVolumePricingOverride is not found in the empty JSON string", OrderActionRatePlanRecurringVolumePricingOverride.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanRecurringVolumePricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanRecurringVolumePricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanRecurringVolumePricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanRecurringVolumePricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanRecurringVolumePricingOverride>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanRecurringVolumePricingOverride value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanRecurringVolumePricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanRecurringVolumePricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanRecurringVolumePricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanRecurringVolumePricingOverride
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanRecurringVolumePricingOverride
  */
  public static OrderActionRatePlanRecurringVolumePricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanRecurringVolumePricingOverride.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanRecurringVolumePricingOverride to an JSON string
  *
  * @return JSON string
  */
