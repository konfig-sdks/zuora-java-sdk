...
import com.konfigthis.client.model.ChargeUpdate;
...
public class RatePlanUpdate {
  ...
  private List<ChargeUpdate> chargeUpdates = null;
  ...
  public RatePlanUpdate() {
  }

  public RatePlanUpdate chargeUpdates(List<ChargeUpdate> chargeUpdates) {
  ...
  public RatePlanUpdate addChargeUpdatesItem(ChargeUpdate chargeUpdatesItem) {
  ...
  **/
  ...
  public List<ChargeUpdate> getChargeUpdates() {
    return chargeUpdates;
  }


  public void setChargeUpdates(List<ChargeUpdate> chargeUpdates) {
  ...
  public RatePlanUpdate clearingExistingFeatures(Boolean clearingExistingFeatures) {
  ...
  **/
  ...
  public RatePlanUpdate customFields(Map<String, Object> customFields) {
  ...
  public RatePlanUpdate putCustomFieldsItem(String key, Object customFieldsItem) {
  ...
  **/
  ...
  public RatePlanUpdate externallyManagedPlanId(String externallyManagedPlanId) {
  ...
  **/
  ...
  public RatePlanUpdate newRatePlanId(String newRatePlanId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Internal identifier of the updated rate plan in the new subscription version. ")
  ...
  public RatePlanUpdate productRatePlanNumber(String productRatePlanNumber) {
  ...
  **/
  ...
  public RatePlanUpdate ratePlanId(String ratePlanId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Internal identifier of the rate plan that was updated. It can be the latest version or any history version id. ")
  ...
  public RatePlanUpdate specificUpdateDate(LocalDate specificUpdateDate) {
  ...
  **/
  ...
  public RatePlanUpdate subscriptionProductFeatures(List<RatePlanFeatureOverride> subscriptionProductFeatures) {
  ...
  public RatePlanUpdate addSubscriptionProductFeaturesItem(RatePlanFeatureOverride subscriptionProductFeaturesItem) {
  ...
  **/
  ...
  public RatePlanUpdate subscriptionRatePlanNumber(String subscriptionRatePlanNumber) {
  ...
  **/
  ...
  public RatePlanUpdate uniqueToken(String uniqueToken) {
  ...
  **/
   ...
   * @return the RatePlanUpdate instance itself
   */
  public RatePlanUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RatePlanUpdate ratePlanUpdate = (RatePlanUpdate) o;
    return Objects.equals(this.chargeUpdates, ratePlanUpdate.chargeUpdates) &&
        Objects.equals(this.clearingExistingFeatures, ratePlanUpdate.clearingExistingFeatures) &&
        Objects.equals(this.customFields, ratePlanUpdate.customFields) &&
        Objects.equals(this.externallyManagedPlanId, ratePlanUpdate.externallyManagedPlanId) &&
        Objects.equals(this.newRatePlanId, ratePlanUpdate.newRatePlanId) &&
        Objects.equals(this.productRatePlanNumber, ratePlanUpdate.productRatePlanNumber) &&
        Objects.equals(this.ratePlanId, ratePlanUpdate.ratePlanId) &&
        Objects.equals(this.specificUpdateDate, ratePlanUpdate.specificUpdateDate) &&
        Objects.equals(this.subscriptionProductFeatures, ratePlanUpdate.subscriptionProductFeatures) &&
        Objects.equals(this.subscriptionRatePlanNumber, ratePlanUpdate.subscriptionRatePlanNumber) &&
        Objects.equals(this.uniqueToken, ratePlanUpdate.uniqueToken)&&
        Objects.equals(this.additionalProperties, ratePlanUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chargeUpdates, clearingExistingFeatures, customFields, externallyManagedPlanId, newRatePlanId, productRatePlanNumber, ratePlanId, specificUpdateDate, subscriptionProductFeatures, subscriptionRatePlanNumber, uniqueToken, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RatePlanUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RatePlanUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RatePlanUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RatePlanUpdate is not found in the empty JSON string", RatePlanUpdate.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("chargeUpdates") != null && !jsonObj.get("chargeUpdates").isJsonNull()) {
        ...
        if (jsonArraychargeUpdates != null) {
          ...
          for (int i = 0; i < jsonArraychargeUpdates.size(); i++) {
            ChargeUpdate.validateJsonObject(jsonArraychargeUpdates.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RatePlanUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RatePlanUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RatePlanUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RatePlanUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<RatePlanUpdate>() {
           @Override
           public void write(JsonWriter out, RatePlanUpdate value) throws IOException {
           ...
           @Override
           public RatePlanUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RatePlanUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RatePlanUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RatePlanUpdate
  * @throws IOException if the JSON string is invalid with respect to RatePlanUpdate
  */
  public static RatePlanUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RatePlanUpdate.class);
  }

 /**
  * Convert an instance of RatePlanUpdate to an JSON string
  *
  * @return JSON string
  */
