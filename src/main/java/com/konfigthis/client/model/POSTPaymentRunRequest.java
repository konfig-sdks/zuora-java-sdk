...
public class POSTPaymentRunRequest {
  ...
  private List<POSTPaymentRunDataElementRequest> data = null;
  ...
  public POSTPaymentRunRequest() {
  }

  public POSTPaymentRunRequest accountId(UUID accountId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the customer account associated with the payment run.  This field conflicts with each of the `batch`, `billCycleDay`, `currency`, `paymentGatewayId`, and `billingRunId` fields. If there are such conflicts, an error occurs and an error message is returned. ")
  ...
  public POSTPaymentRunRequest applyCreditBalance(Boolean applyCreditBalance) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If `applyCreditBalance` is true, the credit memo or unapplied payment on the order account will be automatically applied to the invoices generated by this order. The credit memo generated by this order will not be automatically applied to any invoices. ")
  ...
  public POSTPaymentRunRequest autoApplyCreditMemo(Boolean autoApplyCreditMemo) {
  ...
  **/
  ...
  public POSTPaymentRunRequest autoApplyUnappliedPayment(Boolean autoApplyUnappliedPayment) {
  ...
  **/
  ...
  public POSTPaymentRunRequest batch(String batch) {
  ...
  **/
  ...
  public POSTPaymentRunRequest billCycleDay(String billCycleDay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The billing cycle day (BCD), the day of the month when a bill run generates invoices for the account. The value must be equal to or less then 31, and 31 is mean the EOM.  This field conflicts with the `accountId` field. If they are both specified in the request body, an error occurs and an error message is returned. ")
  ...
  public POSTPaymentRunRequest billingRunId(UUID billingRunId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of a bill run.  This field conflicts with the `accountId` field. If they are both specified in the request body, an error occurs and an error message is returned. ")
  ...
  public POSTPaymentRunRequest collectPayment(Boolean collectPayment) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether to process electronic payments during the execution of payment runs.   If the Payment user permission \"Process Electronic Payment\" is disabled, this field will be ignored. ")
  ...
  public POSTPaymentRunRequest consolidatedPayment(Boolean consolidatedPayment) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "**Note:** The **Process Electronic Payment** permission also needs to be allowed for a Manage Payment Runs role to work. See [Payments Roles](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/A_Administrator_Settings/User_Roles/e_Payments_Roles) for more information.   Whether to process a single payment for all receivables that are due on an account. ")
  ...
  public POSTPaymentRunRequest currency(String currency) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A currency defined in the web-based UI administrative settings.  This field conflicts with the `accountId` field. If they are both specified in the request body, an error occurs and an error message is returned. ")
  ...
  public POSTPaymentRunRequest data(List<POSTPaymentRunDataElementRequest> data) {
  ...
  public POSTPaymentRunRequest addDataItem(POSTPaymentRunDataElementRequest dataItem) {
    if (this.data == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The array of data for specifying records of accounts and invoices/debit memos that will be collected and processed by a payment run.  When you specify the data array, ensure that at least one record is passed in. If an empty array is specified, `accountId`, `batch`, `billCycleDay`, `currency`, `paymentGatewayId`, and `billingRunId` fields will be used to define the billing documents to be collected. If the [Multiple Currencies](https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Flexible_Billing/Multiple_Currencies) feature is enabled, you can filter the accounts by `currency` based on the customer's billing document.  A maximum of 50K records are allowed to be passed into the `data` array.  Here is an example: ```   {     \"accountId\": \"60c81b5bc51649e8a7d1b48303194790\",     \"documentId\": \"2c9081a03c63c94c013c6894af5602dd\",     \"documentType\": \"Invoice\",     \"amount\": 80,     \"paymentMethodId\": \"2c9081a03c6d7b51013c6d7e4ada0a1c\",     \"paymentGatewayId\": \"d2abe8342e1811ea80e774b9452e17ea\",     \"comment\": \"Payment Comments\",     \"customField1__c\": \"cf_value1\",     \"customField2__c\": \"cf_value2\"   } ```  Here is another example for a standalone payment: ```   {     \"accountId\": \"account2\",     \"amount\": 100,     \"currency\": \"GBP\",     \"standalone\": true   } ``` ")

  public List<POSTPaymentRunDataElementRequest> getData() {
    return data;
  }


  public void setData(List<POSTPaymentRunDataElementRequest> data) {
  ...
  public POSTPaymentRunRequest organizationLabels(List<GETCatalogGroupProductRatePlanResponseOrganizationLabelsInner> organizationLabels) {
  ...
  public POSTPaymentRunRequest addOrganizationLabelsItem(GETCatalogGroupProductRatePlanResponseOrganizationLabelsInner organizationLabelsItem) {
   ...
   /**
   * The organizations that the run is created for.   For each item in the array, either the &#x60;organizationId&#x60; or the &#x60;organizationName&#x60; field is required.  This field is only required when you have already turned on Multi-Org feature. 
   * @return organizationLabels
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The organizations that the run is created for.   For each item in the array, either the `organizationId` or the `organizationName` field is required.  This field is only required when you have already turned on Multi-Org feature. ")
  ...
  public POSTPaymentRunRequest paymentGatewayId(UUID paymentGatewayId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the gateway instance that processes the payment.  This field conflicts with the `accountId` field. If they are both specified in the request body, an error occurs and an error message is returned. ")
  ...
  public void setPaymentGatewayId(UUID paymentGatewayId) {
  ...
  public POSTPaymentRunRequest processPaymentWithClosedPM(Boolean processPaymentWithClosedPM) {
  ...
  **/
  ...
  public POSTPaymentRunRequest runDate(OffsetDateTime runDate) {
  ...
  **/
  ...
  public POSTPaymentRunRequest targetDate(LocalDate targetDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Mon Oct 09 17:00:00 PDT 2017", value = "The target date used to determine which receivables to be paid in the payment run. The payments are collected for all receivables with the due date no later than the target date.  You must specify either the `runDate` field or the `targetDate` field in the request body. If you specify the `runDate` field, the scheduced payment run is to be executed on the run date. If you specify the `targetDate` field, the payment run is executed immediately after it is created.  ")
   ...
   * @return the POSTPaymentRunRequest instance itself
   */
  public POSTPaymentRunRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTPaymentRunRequest poSTPaymentRunRequest = (POSTPaymentRunRequest) o;
    return Objects.equals(this.accountId, poSTPaymentRunRequest.accountId) &&
        Objects.equals(this.applyCreditBalance, poSTPaymentRunRequest.applyCreditBalance) &&
        Objects.equals(this.autoApplyCreditMemo, poSTPaymentRunRequest.autoApplyCreditMemo) &&
        Objects.equals(this.autoApplyUnappliedPayment, poSTPaymentRunRequest.autoApplyUnappliedPayment) &&
        Objects.equals(this.batch, poSTPaymentRunRequest.batch) &&
        Objects.equals(this.billCycleDay, poSTPaymentRunRequest.billCycleDay) &&
        Objects.equals(this.billingRunId, poSTPaymentRunRequest.billingRunId) &&
        Objects.equals(this.collectPayment, poSTPaymentRunRequest.collectPayment) &&
        Objects.equals(this.consolidatedPayment, poSTPaymentRunRequest.consolidatedPayment) &&
        Objects.equals(this.currency, poSTPaymentRunRequest.currency) &&
        Objects.equals(this.data, poSTPaymentRunRequest.data) &&
        Objects.equals(this.organizationLabels, poSTPaymentRunRequest.organizationLabels) &&
        Objects.equals(this.paymentGatewayId, poSTPaymentRunRequest.paymentGatewayId) &&
        Objects.equals(this.processPaymentWithClosedPM, poSTPaymentRunRequest.processPaymentWithClosedPM) &&
        Objects.equals(this.runDate, poSTPaymentRunRequest.runDate) &&
        Objects.equals(this.targetDate, poSTPaymentRunRequest.targetDate)&&
        Objects.equals(this.additionalProperties, poSTPaymentRunRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, applyCreditBalance, autoApplyCreditMemo, autoApplyUnappliedPayment, batch, billCycleDay, billingRunId, collectPayment, consolidatedPayment, currency, data, organizationLabels, paymentGatewayId, processPaymentWithClosedPM, runDate, targetDate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class POSTPaymentRunRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTPaymentRunRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTPaymentRunRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTPaymentRunRequest is not found in the empty JSON string", POSTPaymentRunRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            POSTPaymentRunDataElementRequest.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTPaymentRunRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTPaymentRunRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTPaymentRunRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTPaymentRunRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTPaymentRunRequest>() {
           @Override
           public void write(JsonWriter out, POSTPaymentRunRequest value) throws IOException {
           ...
           @Override
           public POSTPaymentRunRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTPaymentRunRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTPaymentRunRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTPaymentRunRequest
  * @throws IOException if the JSON string is invalid with respect to POSTPaymentRunRequest
  */
  public static POSTPaymentRunRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTPaymentRunRequest.class);
  }

 /**
  * Convert an instance of POSTPaymentRunRequest to an JSON string
  *
  * @return JSON string
  */
