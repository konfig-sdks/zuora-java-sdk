 ...
 */
@ApiModel(description = "Pricing information about a usage charge that uses the \"tiered pricing\" charge model. In this charge model, the charge has cumulative pricing tiers that become effective as units are consumed. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UsageTieredPricingOverride {
 ...
 public enum RatingGroupEnum {
  ...
  public UsageTieredPricingOverride() {
  }

  public UsageTieredPricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public UsageTieredPricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public UsageTieredPricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public UsageTieredPricingOverride ratingGroup(RatingGroupEnum ratingGroup) {
  ...
  **/
  ...
  public UsageTieredPricingOverride tiers(List<ChargeTier> tiers) {
  ...
  public UsageTieredPricingOverride addTiersItem(ChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
  ...
  public UsageTieredPricingOverride uom(String uom) {
  ...
  **/
   ...
   * @return the UsageTieredPricingOverride instance itself
   */
  public UsageTieredPricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UsageTieredPricingOverride usageTieredPricingOverride = (UsageTieredPricingOverride) o;
    return Objects.equals(this.priceChangeOption, usageTieredPricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, usageTieredPricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.ratingGroup, usageTieredPricingOverride.ratingGroup) &&
        Objects.equals(this.tiers, usageTieredPricingOverride.tiers) &&
        Objects.equals(this.uom, usageTieredPricingOverride.uom)&&
        Objects.equals(this.additionalProperties, usageTieredPricingOverride.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UsageTieredPricingOverride {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsageTieredPricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsageTieredPricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsageTieredPricingOverride is not found in the empty JSON string", UsageTieredPricingOverride.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsageTieredPricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsageTieredPricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsageTieredPricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsageTieredPricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<UsageTieredPricingOverride>() {
           @Override
           public void write(JsonWriter out, UsageTieredPricingOverride value) throws IOException {
           ...
           @Override
           public UsageTieredPricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UsageTieredPricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UsageTieredPricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UsageTieredPricingOverride
  * @throws IOException if the JSON string is invalid with respect to UsageTieredPricingOverride
  */
  public static UsageTieredPricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsageTieredPricingOverride.class);
  }

 /**
  * Convert an instance of UsageTieredPricingOverride to an JSON string
  *
  * @return JSON string
  */
