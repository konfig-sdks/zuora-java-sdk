...
public class RecurringVolumePricingUpdate {
 ...
 public enum PriceChangeOptionEnum {
  ...
  public RecurringVolumePricingUpdate() {
  }

  public RecurringVolumePricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public RecurringVolumePricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public RecurringVolumePricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public RecurringVolumePricingUpdate quantity(Double quantity) {
  ...
  public RecurringVolumePricingUpdate quantity(Integer quantity) {
    if (quantity != null && quantity < 0) {
      throw new IllegalArgumentException("Invalid value for quantity. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public RecurringVolumePricingUpdate tiers(List<ChargeTier> tiers) {
  ...
  public RecurringVolumePricingUpdate addTiersItem(ChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the RecurringVolumePricingUpdate instance itself
   */
  public RecurringVolumePricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecurringVolumePricingUpdate recurringVolumePricingUpdate = (RecurringVolumePricingUpdate) o;
    return Objects.equals(this.priceChangeOption, recurringVolumePricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, recurringVolumePricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.quantity, recurringVolumePricingUpdate.quantity) &&
        Objects.equals(this.tiers, recurringVolumePricingUpdate.tiers)&&
        Objects.equals(this.additionalProperties, recurringVolumePricingUpdate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecurringVolumePricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecurringVolumePricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecurringVolumePricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurringVolumePricingUpdate is not found in the empty JSON string", RecurringVolumePricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurringVolumePricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurringVolumePricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurringVolumePricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurringVolumePricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurringVolumePricingUpdate>() {
           @Override
           public void write(JsonWriter out, RecurringVolumePricingUpdate value) throws IOException {
           ...
           @Override
           public RecurringVolumePricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecurringVolumePricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecurringVolumePricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecurringVolumePricingUpdate
  * @throws IOException if the JSON string is invalid with respect to RecurringVolumePricingUpdate
  */
  public static RecurringVolumePricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurringVolumePricingUpdate.class);
  }

 /**
  * Convert an instance of RecurringVolumePricingUpdate to an JSON string
  *
  * @return JSON string
  */
