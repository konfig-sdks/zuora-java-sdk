...
import com.konfigthis.client.model.BatchesQueries;
...
public class SubmitBatchQueryResponse {
 ...
 public enum EncryptedEnum {
    ...
    public static EncryptedEnum fromValue(String value) {
      for (EncryptedEnum b : EncryptedEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<EncryptedEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final EncryptedEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public EncryptedEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return EncryptedEnum.fromValue(value);
      }
    }
  }
 ...
 public enum FormatEnum {
  ...
  /**
   * The status of the AQuA job: - submitted: The AQuA job was submitted to the query executor for processing. - executing: The AQuA job is being processed. - completed: The AQuA job was successfully executed. - error: The AQuA job was not processed because of validation errors. - aborted: The AQuA job execution failed because one or more queries of this job failed. - cancelled: The AQuA job was cancelled. 
   */
 ...
 public enum StatusEnum {
  ...
  public SubmitBatchQueryResponse() {
  }

  public SubmitBatchQueryResponse version(Float version) {
  ...
  **/
  ...
  public SubmitBatchQueryResponse batches(List<BatchesQueries> batches) {
  ...
  public SubmitBatchQueryResponse addBatchesItem(BatchesQueries batchesItem) {
  ...
  **/
  ...
  public List<BatchesQueries> getBatches() {
    return batches;
  }


  public void setBatches(List<BatchesQueries> batches) {
  ...
  public SubmitBatchQueryResponse encrypted(EncryptedEnum encrypted) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If enabled, you must supply the formatting (zip or unzip) first and decrypt it to get the actual contents.       ")
  ...
  public SubmitBatchQueryResponse format(FormatEnum format) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The format of the query. The default value is `csv`. ")
  ...
  public SubmitBatchQueryResponse id(String id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The job ID created for the AQuA API request. The job ID can be used for querying for the query status.   The ID exists only if the JSON request can be parsed and validated successfully. Otherwise, the job ID is null. ")
  ...
  public SubmitBatchQueryResponse incrementalTime(String incrementalTime) {
  ...
  **/
  ...
  public SubmitBatchQueryResponse name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the job. 32 character limit. ")
  ...
  public SubmitBatchQueryResponse notifyUrl(String notifyUrl) {
  ...
  **/
  ...
  public SubmitBatchQueryResponse offset(Double offset) {
  ...
  public SubmitBatchQueryResponse offset(Integer offset) {
  ...
  **/
  ...
  public SubmitBatchQueryResponse partner(String partner) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The partner field indicates the unique ID of a data integration partner. The dropdown list of this field displays partner IDs for the past thirty days.  It must be used together with \"project\" field to uniquely identify a data integration target.  For example, if a continuous AQuA session is to retrieve data incrementally for a Salesforce.com Org 00170000011K3Ub, you can use partner as \"Salesforce\", and \"project\" as \"00170000011K3Ub.\"   This field is required only if you are using AQuA in stateful mode. Otherwise, if you are using AQuA in stateless mode, partner field can be null.  **Note**: Zuora highly recommends you use the stateless mode instead of the stateful mode to extract bulk data. See <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/API/AB_Aggregate_Query_API/Bulk_data__extraction_from_Zuora_using_AQuA\" target=\"_blank\">Bulk data extraction from Zuora using AQuA</a> for best practices.  **Note**: Submit a request at <a href=\"http://support.zuora.com\" target=\"_blank\">Zuora Global Support</a> to obtain a partner ID. ")
  ...
  public SubmitBatchQueryResponse project(String project) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The project field contains the unique ID of a data integration project for a particular partner. The dropdown list of this field displays project IDs for the past thirty days.  This field must be used together with partner field to uniquely identify a data integration target.   This field is required only if you are using AQuA in stateful mode. Otherwise, if you are using AQuA in stateless mode, partner field can be null. ")
  ...
  public SubmitBatchQueryResponse sourceData(String sourceData) {
   ...
   /**
   * Indicates the source this aggregate query runs against:  * &#x60;LIVE&#x60; represents the live transactional databases at Zuora (Data Query Live).  * &#x60;WAREHOUSE&#x60; represents Zuora Warehouse, which has better performance and fewer limitations than the live transactional database. For more information, see &lt;a href&#x3D;\&quot;https://knowledgecenter.zuora.com/Zuora_Central_Platform/Zuora_Warehouse/A_Zuora_Warehouse_overview\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Zuora Warehouse&lt;/a&gt;. 
   * @return sourceData
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates the source this aggregate query runs against:  * `LIVE` represents the live transactional databases at Zuora (Data Query Live).  * `WAREHOUSE` represents Zuora Warehouse, which has better performance and fewer limitations than the live transactional database. For more information, see <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/Zuora_Warehouse/A_Zuora_Warehouse_overview\" target=\"_blank\">Zuora Warehouse</a>. ")
  ...
  public SubmitBatchQueryResponse status(StatusEnum status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the AQuA job: - submitted: The AQuA job was submitted to the query executor for processing. - executing: The AQuA job is being processed. - completed: The AQuA job was successfully executed. - error: The AQuA job was not processed because of validation errors. - aborted: The AQuA job execution failed because one or more queries of this job failed. - cancelled: The AQuA job was cancelled. ")
  ...
  public SubmitBatchQueryResponse useLastCompletedJobQueries(Boolean useLastCompletedJobQueries) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If this flag is set to `true`, then all the previous queries are merged with existing queries.  If the flag is set to `false`, then the previous queries are ignored, and only the new query is executed. ")
   ...
   * @return the SubmitBatchQueryResponse instance itself
   */
  public SubmitBatchQueryResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SubmitBatchQueryResponse submitBatchQueryResponse = (SubmitBatchQueryResponse) o;
    return Objects.equals(this.version, submitBatchQueryResponse.version) &&
        Objects.equals(this.batches, submitBatchQueryResponse.batches) &&
        Objects.equals(this.encrypted, submitBatchQueryResponse.encrypted) &&
        Objects.equals(this.format, submitBatchQueryResponse.format) &&
        Objects.equals(this.id, submitBatchQueryResponse.id) &&
        Objects.equals(this.incrementalTime, submitBatchQueryResponse.incrementalTime) &&
        Objects.equals(this.name, submitBatchQueryResponse.name) &&
        Objects.equals(this.notifyUrl, submitBatchQueryResponse.notifyUrl) &&
        Objects.equals(this.offset, submitBatchQueryResponse.offset) &&
        Objects.equals(this.partner, submitBatchQueryResponse.partner) &&
        Objects.equals(this.project, submitBatchQueryResponse.project) &&
        Objects.equals(this.sourceData, submitBatchQueryResponse.sourceData) &&
        Objects.equals(this.status, submitBatchQueryResponse.status) &&
        Objects.equals(this.useLastCompletedJobQueries, submitBatchQueryResponse.useLastCompletedJobQueries)&&
        Objects.equals(this.additionalProperties, submitBatchQueryResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, batches, encrypted, format, id, incrementalTime, name, notifyUrl, offset, partner, project, sourceData, status, useLastCompletedJobQueries, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SubmitBatchQueryResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubmitBatchQueryResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubmitBatchQueryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubmitBatchQueryResponse is not found in the empty JSON string", SubmitBatchQueryResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("batches") != null && !jsonObj.get("batches").isJsonNull()) {
        ...
        if (jsonArraybatches != null) {
          ...
          for (int i = 0; i < jsonArraybatches.size(); i++) {
            BatchesQueries.validateJsonObject(jsonArraybatches.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubmitBatchQueryResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubmitBatchQueryResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubmitBatchQueryResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubmitBatchQueryResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SubmitBatchQueryResponse>() {
           @Override
           public void write(JsonWriter out, SubmitBatchQueryResponse value) throws IOException {
           ...
           @Override
           public SubmitBatchQueryResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SubmitBatchQueryResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SubmitBatchQueryResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SubmitBatchQueryResponse
  * @throws IOException if the JSON string is invalid with respect to SubmitBatchQueryResponse
  */
  public static SubmitBatchQueryResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubmitBatchQueryResponse.class);
  }

 /**
  * Convert an instance of SubmitBatchQueryResponse to an JSON string
  *
  * @return JSON string
  */
