...
public class POSTSubscriptionCancellationType {
 ...
 public enum RunBillingEnum {
  ...
  public POSTSubscriptionCancellationType() {
  }

  public POSTSubscriptionCancellationType applicationOrder(List<String> applicationOrder) {
  ...
  public POSTSubscriptionCancellationType addApplicationOrderItem(String applicationOrderItem) {
  ...
  **/
  ...
  public POSTSubscriptionCancellationType applyCredit(Boolean applyCredit) {
  ...
  **/
  ...
  public POSTSubscriptionCancellationType bookingDate(LocalDate bookingDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The booking date that you want to set for the amendment contract when you cancel the subscription. The default value is the current date when you make the API call. ")
  ...
  **/
  ...
  @ApiModelProperty(example = "SpecificDate", required = true, value = "Cancellation method. Possible values are: `EndOfCurrentTerm`, `EndOfLastInvoicePeriod`, `SpecificDate`. If using `SpecificDate`, the `cancellationEffectiveDate` field is required. ")
  ...
  **/
  ...
  public POSTSubscriptionCancellationType contractEffectiveDate(LocalDate contractEffectiveDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the customer notifies you that they want to cancel their subscription. ")
  ...
  public POSTSubscriptionCancellationType creditMemoReasonCode(String creditMemoReasonCode) {
  ...
  **/
  ...
  public POSTSubscriptionCancellationType documentDate(LocalDate documentDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "This field has been replaced by the `invoice` field and the `collect` field. `invoiceCollect` is available only for backward compatibility.  If this field is set to `true`, an invoice is generated and payment automatically collected.  **Note**: This field is only available if you set the `zuora-version` request header to `186.0`, `187.0`, `188.0`, or `189.0`. ")
  ...
  **/
  ...
  public POSTSubscriptionCancellationType orderDate(LocalDate orderDate) {
  ...
  **/
  ...
  public POSTSubscriptionCancellationType runBilling(RunBillingEnum runBilling) {
  ...
  **/
  ...
  public POSTSubscriptionCancellationType targetDate(LocalDate targetDate) {
  ...
  **/
   ...
   * @return the POSTSubscriptionCancellationType instance itself
   */
  public POSTSubscriptionCancellationType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applicationOrder, poSTSubscriptionCancellationType.applicationOrder) &&
        Objects.equals(this.applyCredit, poSTSubscriptionCancellationType.applyCredit) &&
        Objects.equals(this.applyCreditBalance, poSTSubscriptionCancellationType.applyCreditBalance) &&
        Objects.equals(this.bookingDate, poSTSubscriptionCancellationType.bookingDate) &&
        ...
        Objects.equals(this.contractEffectiveDate, poSTSubscriptionCancellationType.contractEffectiveDate) &&
        Objects.equals(this.creditMemoReasonCode, poSTSubscriptionCancellationType.creditMemoReasonCode) &&
        Objects.equals(this.documentDate, poSTSubscriptionCancellationType.documentDate) &&
        ...
        Objects.equals(this.orderDate, poSTSubscriptionCancellationType.orderDate) &&
        Objects.equals(this.runBilling, poSTSubscriptionCancellationType.runBilling) &&
        Objects.equals(this.targetDate, poSTSubscriptionCancellationType.targetDate)&&
        Objects.equals(this.additionalProperties, poSTSubscriptionCancellationType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicationOrder, applyCredit, applyCreditBalance, bookingDate, cancellationEffectiveDate, cancellationPolicy, collect, contractEffectiveDate, creditMemoReasonCode, documentDate, invoice, invoiceCollect, invoiceTargetDate, orderDate, runBilling, targetDate, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTSubscriptionCancellationType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTSubscriptionCancellationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTSubscriptionCancellationType is not found in the empty JSON string", POSTSubscriptionCancellationType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : POSTSubscriptionCancellationType.openapiRequiredFields) {
      ...
      if (!jsonObj.get("cancellationPolicy").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTSubscriptionCancellationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTSubscriptionCancellationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTSubscriptionCancellationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTSubscriptionCancellationType.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTSubscriptionCancellationType>() {
           @Override
           public void write(JsonWriter out, POSTSubscriptionCancellationType value) throws IOException {
           ...
           @Override
           public POSTSubscriptionCancellationType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTSubscriptionCancellationType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTSubscriptionCancellationType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTSubscriptionCancellationType
  * @throws IOException if the JSON string is invalid with respect to POSTSubscriptionCancellationType
  */
  public static POSTSubscriptionCancellationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTSubscriptionCancellationType.class);
  }

 /**
  * Convert an instance of POSTSubscriptionCancellationType to an JSON string
  *
  * @return JSON string
  */
