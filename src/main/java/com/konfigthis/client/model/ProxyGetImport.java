...
public class ProxyGetImport {
  ...
  **/
  ...
  @ApiModelProperty(value = " The user ID of the person who created the import.  **Character limit**: 32  **Values**: automatically generated ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The date when the import was created.  **Character limit**: 29  **Values**: automatically generated ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The type of item imported.  **Character limit**: 7  **Values**: Usage ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of records successfully imported.  **Values**: automatically generated ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " A check to validate the import file's integrity.  **Character limit:** 32  **System-generated:** no  **Values**: a string of 32 characters or fewer ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " A descriptive name for the import.  **Character limit:** 100  **Values:** one of the following:  - a string of 100 characters or fewer - if NULL default is: `import <ImportType_value>` ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The URL for your import file, which contains your records for upload. When you upload the file, Zuora assigns it to this address.  **Values:** automatic dynamically-generated URL ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The URL for the import result file, which is a zipped CSV file.  **Values**: automatic dynamically-generated URL ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the import process.  **Values**: automatically generated using one of the following values:  - Pending - Processing - Completed - Failed ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The reason for the system-generated status. Use this information if the import fails.  **Character limit**: 2000  **Values**: automatically generated error message ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The number of records in the import file.  **Character limit**:  **Values**: automatically generated ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The ID of the user who last updated the import.  **Character limit**: 32  **Values**: automatically generated ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The date when the import was last updated. **Character limit**: 29 **Values**: automatically generated ")
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProxyGetImport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProxyGetImport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<ProxyGetImport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProxyGetImport.class));

       return (TypeAdapter<T>) new TypeAdapter<ProxyGetImport>() {
           @Override
