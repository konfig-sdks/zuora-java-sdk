...
import com.konfigthis.client.model.GetScheduledEventResponseParametersValue;
...
public class GetScheduledEventResponse {
  ...
  private Map<String, GetScheduledEventResponseParametersValue> parameters = null;
  ...
  **/
  ...
  public GetScheduledEventResponse parameters(Map<String, GetScheduledEventResponseParametersValue> parameters) {
  ...
  **/
  ...
  public Map<String, GetScheduledEventResponseParametersValue> getParameters() {
    return parameters;
  }


  public void setParameters(Map<String, GetScheduledEventResponseParametersValue> parameters) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "TermEndDate", value = "The base field of the base object in the `apiObject` field, should be in date or timestamp format. The scheduled event notifications are triggered based on this date and the event parameters (before or after a specified number of days) from notification definitions. Should be specified in the pattern: ^[A-Z][\\\\w\\\\-]*$")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Subscription", value = "The base object that the scheduled event is defined upon. The base object should contain a date or timestamp format field. Should be specified in the pattern: ^[A-Z][\\\\w\\\\-]*$")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0 30 10 ? * *", value = "The cron expression defines the time when scheduled event notifications will be sent.")
  ...
  **/
  ...
  public GetScheduledEventResponse id(UUID id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Scheduled event ID.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "TermEndDateScheduledEvent", value = "The name of the scheduled event.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "user.notification", value = "The namespace of the scheduled event name in the `name` field.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, getScheduledEventResponse.description) &&
        Objects.equals(this.parameters, getScheduledEventResponse.parameters) &&
        Objects.equals(this.active, getScheduledEventResponse.active) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, parameters, active, apiField, apiObject, condition, cronExpression, displayName, id, name, namespace, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetScheduledEventResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetScheduledEventResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<GetScheduledEventResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetScheduledEventResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetScheduledEventResponse>() {
           @Override
