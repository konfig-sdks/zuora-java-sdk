...
public class InvoiceItems2 {
 ...
 public enum TaxModeEnum {
  ...
  public InvoiceItems2() {
  }

  public InvoiceItems2 description(String description) {
  ...
  **/
  ...
  public InvoiceItems2 accountingCode(String accountingCode) {
  ...
  **/
  ...
  public InvoiceItems2 adjustmentLiabilityAccountingCode(String adjustmentLiabilityAccountingCode) {
  ...
  **/
  ...
  public InvoiceItems2 adjustmentRevenueAccountingCode(String adjustmentRevenueAccountingCode) {
  ...
  **/
  ...
  public InvoiceItems2 amount(BigDecimal amount) {
  ...
  **/
  ...
  public InvoiceItems2 bookingReference(String bookingReference) {
  ...
  **/
  ...
  public InvoiceItems2 chargeDate(OffsetDateTime chargeDate) {
  ...
  **/
  ...
  public InvoiceItems2 chargeName(String chargeName) {
  ...
  **/
  ...
  public InvoiceItems2 contractAssetAccountingCode(String contractAssetAccountingCode) {
  ...
  **/
  ...
  public InvoiceItems2 contractLiabilityAccountingCode(String contractLiabilityAccountingCode) {
  ...
  **/
  ...
  public InvoiceItems2 contractRecognizedRevenueAccountingCode(String contractRecognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public InvoiceItems2 deferredRevenueAccountingCode(String deferredRevenueAccountingCode) {
  ...
  **/
  ...
  public InvoiceItems2 discountItems(List<PostDiscountItemType> discountItems) {
  ...
  public InvoiceItems2 addDiscountItemsItem(PostDiscountItemType discountItemsItem) {
  ...
  **/
  ...
  public InvoiceItems2 excludeItemBillingFromRevenueAccounting(Boolean excludeItemBillingFromRevenueAccounting) {
  ...
  **/
  ...
  public InvoiceItems2 itemType(String itemType) {
  ...
  **/
  ...
  public InvoiceItems2 productRatePlanChargeId(String productRatePlanChargeId) {
  ...
  **/
  ...
  public InvoiceItems2 purchaseOrderNumber(String purchaseOrderNumber) {
  ...
  **/
  ...
  public InvoiceItems2 quantity(BigDecimal quantity) {
  ...
  **/
  ...
  public InvoiceItems2 recognizedRevenueAccountingCode(String recognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public InvoiceItems2 revRecCode(String revRecCode) {
  ...
  **/
  ...
  public InvoiceItems2 revRecTriggerCondition(RevRecTriggerConditionEnum revRecTriggerCondition) {
  ...
  **/
  ...
  public InvoiceItems2 revenueRecognitionRuleName(String revenueRecognitionRuleName) {
  ...
  **/
  ...
  public InvoiceItems2 serviceEndDate(LocalDate serviceEndDate) {
  ...
  **/
  ...
  public InvoiceItems2 serviceStartDate(LocalDate serviceStartDate) {
  ...
  **/
  ...
  public InvoiceItems2 sku(String sku) {
  ...
  **/
  ...
  public InvoiceItems2 taxCode(String taxCode) {
  ...
  **/
  ...
  public InvoiceItems2 taxItems(List<PostTaxationItemType> taxItems) {
  ...
  public InvoiceItems2 addTaxItemsItem(PostTaxationItemType taxItemsItem) {
  ...
  **/
  ...
  public InvoiceItems2 taxMode(TaxModeEnum taxMode) {
  ...
  **/
  ...
  public InvoiceItems2 unbilledReceivablesAccountingCode(String unbilledReceivablesAccountingCode) {
  ...
  **/
  ...
  public InvoiceItems2 unitPrice(BigDecimal unitPrice) {
  ...
  **/
  ...
  public InvoiceItems2 uom(String uom) {
  ...
  **/
   ...
   * @return the InvoiceItems2 instance itself
   */
  public InvoiceItems2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InvoiceItems2 invoiceItems2 = (InvoiceItems2) o;
    return Objects.equals(this.description, invoiceItems2.description) &&
        Objects.equals(this.accountingCode, invoiceItems2.accountingCode) &&
        Objects.equals(this.adjustmentLiabilityAccountingCode, invoiceItems2.adjustmentLiabilityAccountingCode) &&
        Objects.equals(this.adjustmentRevenueAccountingCode, invoiceItems2.adjustmentRevenueAccountingCode) &&
        Objects.equals(this.amount, invoiceItems2.amount) &&
        Objects.equals(this.bookingReference, invoiceItems2.bookingReference) &&
        Objects.equals(this.chargeDate, invoiceItems2.chargeDate) &&
        Objects.equals(this.chargeName, invoiceItems2.chargeName) &&
        Objects.equals(this.contractAssetAccountingCode, invoiceItems2.contractAssetAccountingCode) &&
        Objects.equals(this.contractLiabilityAccountingCode, invoiceItems2.contractLiabilityAccountingCode) &&
        Objects.equals(this.contractRecognizedRevenueAccountingCode, invoiceItems2.contractRecognizedRevenueAccountingCode) &&
        Objects.equals(this.deferredRevenueAccountingCode, invoiceItems2.deferredRevenueAccountingCode) &&
        Objects.equals(this.discountItems, invoiceItems2.discountItems) &&
        Objects.equals(this.excludeItemBillingFromRevenueAccounting, invoiceItems2.excludeItemBillingFromRevenueAccounting) &&
        Objects.equals(this.itemType, invoiceItems2.itemType) &&
        Objects.equals(this.productRatePlanChargeId, invoiceItems2.productRatePlanChargeId) &&
        Objects.equals(this.purchaseOrderNumber, invoiceItems2.purchaseOrderNumber) &&
        Objects.equals(this.quantity, invoiceItems2.quantity) &&
        Objects.equals(this.recognizedRevenueAccountingCode, invoiceItems2.recognizedRevenueAccountingCode) &&
        Objects.equals(this.revRecCode, invoiceItems2.revRecCode) &&
        Objects.equals(this.revRecTriggerCondition, invoiceItems2.revRecTriggerCondition) &&
        Objects.equals(this.revenueRecognitionRuleName, invoiceItems2.revenueRecognitionRuleName) &&
        Objects.equals(this.serviceEndDate, invoiceItems2.serviceEndDate) &&
        Objects.equals(this.serviceStartDate, invoiceItems2.serviceStartDate) &&
        Objects.equals(this.sku, invoiceItems2.sku) &&
        Objects.equals(this.taxCode, invoiceItems2.taxCode) &&
        Objects.equals(this.taxItems, invoiceItems2.taxItems) &&
        Objects.equals(this.taxMode, invoiceItems2.taxMode) &&
        Objects.equals(this.unbilledReceivablesAccountingCode, invoiceItems2.unbilledReceivablesAccountingCode) &&
        Objects.equals(this.unitPrice, invoiceItems2.unitPrice) &&
        Objects.equals(this.uom, invoiceItems2.uom)&&
        Objects.equals(this.additionalProperties, invoiceItems2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceItems2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceItems2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceItems2 is not found in the empty JSON string", InvoiceItems2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InvoiceItems2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceItems2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceItems2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceItems2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceItems2.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceItems2>() {
           @Override
           public void write(JsonWriter out, InvoiceItems2 value) throws IOException {
           ...
           @Override
           public InvoiceItems2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoiceItems2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoiceItems2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoiceItems2
  * @throws IOException if the JSON string is invalid with respect to InvoiceItems2
  */
  public static InvoiceItems2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceItems2.class);
  }

 /**
  * Convert an instance of InvoiceItems2 to an JSON string
  *
  * @return JSON string
  */
