...
import com.konfigthis.client.model.SettingItemHttpRequestParameter;
...
public class SettingItemHttpOperation {
  ...
  private List<SettingItemHttpRequestParameter> parameters = null;
 ...
 public enum MethodEnum {
  ...
  public SettingItemHttpOperation parameters(List<SettingItemHttpRequestParameter> parameters) {
  ...
  **/
  ...
  @ApiModelProperty(value = "An array of paramters required by this operation.")

  public List<SettingItemHttpRequestParameter> getParameters() {
    return parameters;
  }


  public void setParameters(List<SettingItemHttpRequestParameter> parameters) {
  ...
  public SettingItemHttpOperation method(MethodEnum method) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "JSON Schema for the request body of this operation.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "JSON Schema for the response body of this operation.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The endpoint url of the operation method. For example, `/settings/billing-rules`.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.parameters, settingItemHttpOperation.parameters) &&
        Objects.equals(this.method, settingItemHttpOperation.method) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(parameters, method, requestType, responseType, url, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SettingItemHttpOperation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SettingItemHttpOperation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("parameters") != null && !jsonObj.get("parameters").isJsonNull()) {
        ...
        if (jsonArrayparameters != null) {
          ...
          for (int i = 0; i < jsonArrayparameters.size(); i++) {
            SettingItemHttpRequestParameter.validateJsonObject(jsonArrayparameters.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<SettingItemHttpOperation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SettingItemHttpOperation.class));

       return (TypeAdapter<T>) new TypeAdapter<SettingItemHttpOperation>() {
           @Override
