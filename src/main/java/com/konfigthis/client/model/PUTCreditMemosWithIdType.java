...
public class PUTCreditMemosWithIdType {
  ...
  private List<PUTCreditMemoItemType> items = null;
 ...
 public enum TransferredToAccountingEnum {
  ...
  public PUTCreditMemosWithIdType() {
  }

  public PUTCreditMemosWithIdType id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the credit memo. ")
  ...
  public PUTCreditMemosWithIdType autoApplyUponPosting(Boolean autoApplyUponPosting) {
  ...
  **/
  ...
  public PUTCreditMemosWithIdType comment(String comment) {
  ...
  **/
  ...
  public PUTCreditMemosWithIdType effectiveDate(LocalDate effectiveDate) {
  ...
  **/
  ...
  public PUTCreditMemosWithIdType excludeFromAutoApplyRules(Boolean excludeFromAutoApplyRules) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the credit memo is excluded from the rule of automatically applying unapplied credit memos to invoices and debit memos during payment runs. If you set this field to `true`, a payment run does not pick up this credit memo or apply it to other invoices or debit memos. ")
  ...
  public PUTCreditMemosWithIdType items(List<PUTCreditMemoItemType> items) {
  ...
  public PUTCreditMemosWithIdType addItemsItem(PUTCreditMemoItemType itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public List<PUTCreditMemoItemType> getItems() {
    return items;
  }


  public void setItems(List<PUTCreditMemoItemType> items) {
  ...
  public PUTCreditMemosWithIdType reasonCode(String reasonCode) {
  ...
  **/
  ...
  public PUTCreditMemosWithIdType transferredToAccounting(TransferredToAccountingEnum transferredToAccounting) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the credit memo is transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite.  ")
  ...
  public PUTCreditMemosWithIdType integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public PUTCreditMemosWithIdType integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public PUTCreditMemosWithIdType originNS(String originNS) {
  ...
  **/
  ...
  public PUTCreditMemosWithIdType syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public PUTCreditMemosWithIdType transactionNS(String transactionNS) {
  ...
  **/
   ...
   * @return the PUTCreditMemosWithIdType instance itself
   */
  public PUTCreditMemosWithIdType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PUTCreditMemosWithIdType puTCreditMemosWithIdType = (PUTCreditMemosWithIdType) o;
    return Objects.equals(this.id, puTCreditMemosWithIdType.id) &&
        Objects.equals(this.autoApplyUponPosting, puTCreditMemosWithIdType.autoApplyUponPosting) &&
        Objects.equals(this.comment, puTCreditMemosWithIdType.comment) &&
        Objects.equals(this.effectiveDate, puTCreditMemosWithIdType.effectiveDate) &&
        Objects.equals(this.excludeFromAutoApplyRules, puTCreditMemosWithIdType.excludeFromAutoApplyRules) &&
        Objects.equals(this.items, puTCreditMemosWithIdType.items) &&
        Objects.equals(this.reasonCode, puTCreditMemosWithIdType.reasonCode) &&
        Objects.equals(this.transferredToAccounting, puTCreditMemosWithIdType.transferredToAccounting) &&
        Objects.equals(this.integrationIdNS, puTCreditMemosWithIdType.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, puTCreditMemosWithIdType.integrationStatusNS) &&
        Objects.equals(this.originNS, puTCreditMemosWithIdType.originNS) &&
        Objects.equals(this.syncDateNS, puTCreditMemosWithIdType.syncDateNS) &&
        Objects.equals(this.transactionNS, puTCreditMemosWithIdType.transactionNS)&&
        Objects.equals(this.additionalProperties, puTCreditMemosWithIdType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, autoApplyUponPosting, comment, effectiveDate, excludeFromAutoApplyRules, items, reasonCode, transferredToAccounting, integrationIdNS, integrationStatusNS, originNS, syncDateNS, transactionNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PUTCreditMemosWithIdType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTCreditMemosWithIdType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTCreditMemosWithIdType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTCreditMemosWithIdType is not found in the empty JSON string", PUTCreditMemosWithIdType.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            PUTCreditMemoItemType.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTCreditMemosWithIdType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTCreditMemosWithIdType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTCreditMemosWithIdType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTCreditMemosWithIdType.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTCreditMemosWithIdType>() {
           @Override
           public void write(JsonWriter out, PUTCreditMemosWithIdType value) throws IOException {
           ...
           @Override
           public PUTCreditMemosWithIdType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTCreditMemosWithIdType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTCreditMemosWithIdType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTCreditMemosWithIdType
  * @throws IOException if the JSON string is invalid with respect to PUTCreditMemosWithIdType
  */
  public static PUTCreditMemosWithIdType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTCreditMemosWithIdType.class);
  }

 /**
  * Convert an instance of PUTCreditMemosWithIdType to an JSON string
  *
  * @return JSON string
  */
