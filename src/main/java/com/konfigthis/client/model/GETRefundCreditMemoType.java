...
public class GETRefundCreditMemoType {
 ...
 public enum TypeEnum {
  ...
  public GETRefundCreditMemoType() {
  }

  public GETRefundCreditMemoType accountId(String accountId) {
  ...
  **/
  ...
  public GETRefundCreditMemoType amount(Double amount) {
  ...
  **/
  ...
  public GETRefundCreditMemoType cancelledOn(OffsetDateTime cancelledOn) {
  ...
  **/
  ...
  public GETRefundCreditMemoType comment(String comment) {
  ...
  **/
  ...
  public GETRefundCreditMemoType createdById(String createdById) {
  ...
  **/
  ...
  public GETRefundCreditMemoType createdDate(OffsetDateTime createdDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the refund was created, in `yyyy-mm-dd hh:mm:ss` format. For example, 2017-03-06 15:31:10. ")
  ...
  public GETRefundCreditMemoType creditMemoId(String creditMemoId) {
  ...
  **/
  ...
  public GETRefundCreditMemoType financeInformation(GETRefundCreditMemoTypeAllOfFinanceInformation financeInformation) {
  ...
  **/
  ...
  public GETRefundCreditMemoType gatewayId(String gatewayId) {
  ...
  **/
  ...
  public GETRefundCreditMemoType gatewayResponse(String gatewayResponse) {
  ...
  **/
  ...
  public GETRefundCreditMemoType gatewayResponseCode(String gatewayResponseCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The response code returned from the payment gateway for the refund. This code is gateway-dependent. ")
  ...
  public GETRefundCreditMemoType gatewayState(GatewayStateEnum gatewayState) {
  ...
  **/
  ...
  public GETRefundCreditMemoType id(String id) {
  ...
  **/
  ...
  public GETRefundCreditMemoType markedForSubmissionOn(OffsetDateTime markedForSubmissionOn) {
  ...
  **/
  ...
  public GETRefundCreditMemoType methodType(MethodTypeEnum methodType) {
  ...
  **/
  ...
  public GETRefundCreditMemoType number(String number) {
  ...
  **/
  ...
  public GETRefundCreditMemoType organizationLabel(String organizationLabel) {
  ...
  **/
  ...
  public GETRefundCreditMemoType paymentId(String paymentId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the payment associated with the refund. ")
  ...
  public GETRefundCreditMemoType paymentMethodId(String paymentMethodId) {
  ...
  **/
  ...
  public GETRefundCreditMemoType paymentMethodSnapshotId(String paymentMethodSnapshotId) {
  ...
  **/
  ...
  public GETRefundCreditMemoType reasonCode(String reasonCode) {
  ...
  **/
  ...
  public GETRefundCreditMemoType referenceId(String referenceId) {
  ...
  **/
  ...
  public GETRefundCreditMemoType refundDate(LocalDate refundDate) {
  ...
  **/
  ...
  public GETRefundCreditMemoType refundTransactionTime(OffsetDateTime refundTransactionTime) {
  ...
  **/
  ...
  public GETRefundCreditMemoType secondRefundReferenceId(String secondRefundReferenceId) {
  ...
  **/
  ...
  public GETRefundCreditMemoType settledOn(OffsetDateTime settledOn) {
  ...
  **/
  ...
  public GETRefundCreditMemoType softDescriptor(String softDescriptor) {
  ...
  **/
  ...
  public GETRefundCreditMemoType softDescriptorPhone(String softDescriptorPhone) {
  ...
  **/
  ...
  public GETRefundCreditMemoType status(StatusEnum status) {
  ...
  **/
  ...
  public GETRefundCreditMemoType submittedOn(OffsetDateTime submittedOn) {
  ...
  **/
  ...
  public GETRefundCreditMemoType success(Boolean success) {
  ...
  **/
  ...
  public GETRefundCreditMemoType type(TypeEnum type) {
  ...
  **/
  ...
  public GETRefundCreditMemoType updatedById(String updatedById) {
  ...
  **/
  ...
  public GETRefundCreditMemoType updatedDate(OffsetDateTime updatedDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the refund was last updated, in `yyyy-mm-dd hh:mm:ss` format. For example, 2017-03-07 15:36:10. ")
  ...
  public GETRefundCreditMemoType integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public GETRefundCreditMemoType integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public GETRefundCreditMemoType originNS(String originNS) {
  ...
  **/
  ...
  public GETRefundCreditMemoType syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public GETRefundCreditMemoType synctoNetSuiteNS(String synctoNetSuiteNS) {
  ...
  **/
   ...
   * @return the GETRefundCreditMemoType instance itself
   */
  public GETRefundCreditMemoType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GETRefundCreditMemoType geTRefundCreditMemoType = (GETRefundCreditMemoType) o;
    return Objects.equals(this.accountId, geTRefundCreditMemoType.accountId) &&
        Objects.equals(this.amount, geTRefundCreditMemoType.amount) &&
        Objects.equals(this.cancelledOn, geTRefundCreditMemoType.cancelledOn) &&
        Objects.equals(this.comment, geTRefundCreditMemoType.comment) &&
        Objects.equals(this.createdById, geTRefundCreditMemoType.createdById) &&
        Objects.equals(this.createdDate, geTRefundCreditMemoType.createdDate) &&
        Objects.equals(this.creditMemoId, geTRefundCreditMemoType.creditMemoId) &&
        Objects.equals(this.financeInformation, geTRefundCreditMemoType.financeInformation) &&
        Objects.equals(this.gatewayId, geTRefundCreditMemoType.gatewayId) &&
        Objects.equals(this.gatewayResponse, geTRefundCreditMemoType.gatewayResponse) &&
        Objects.equals(this.gatewayResponseCode, geTRefundCreditMemoType.gatewayResponseCode) &&
        Objects.equals(this.gatewayState, geTRefundCreditMemoType.gatewayState) &&
        Objects.equals(this.id, geTRefundCreditMemoType.id) &&
        Objects.equals(this.markedForSubmissionOn, geTRefundCreditMemoType.markedForSubmissionOn) &&
        Objects.equals(this.methodType, geTRefundCreditMemoType.methodType) &&
        Objects.equals(this.number, geTRefundCreditMemoType.number) &&
        Objects.equals(this.organizationLabel, geTRefundCreditMemoType.organizationLabel) &&
        Objects.equals(this.paymentId, geTRefundCreditMemoType.paymentId) &&
        Objects.equals(this.paymentMethodId, geTRefundCreditMemoType.paymentMethodId) &&
        Objects.equals(this.paymentMethodSnapshotId, geTRefundCreditMemoType.paymentMethodSnapshotId) &&
        Objects.equals(this.reasonCode, geTRefundCreditMemoType.reasonCode) &&
        Objects.equals(this.referenceId, geTRefundCreditMemoType.referenceId) &&
        Objects.equals(this.refundDate, geTRefundCreditMemoType.refundDate) &&
        Objects.equals(this.refundTransactionTime, geTRefundCreditMemoType.refundTransactionTime) &&
        Objects.equals(this.secondRefundReferenceId, geTRefundCreditMemoType.secondRefundReferenceId) &&
        Objects.equals(this.settledOn, geTRefundCreditMemoType.settledOn) &&
        Objects.equals(this.softDescriptor, geTRefundCreditMemoType.softDescriptor) &&
        Objects.equals(this.softDescriptorPhone, geTRefundCreditMemoType.softDescriptorPhone) &&
        Objects.equals(this.status, geTRefundCreditMemoType.status) &&
        Objects.equals(this.submittedOn, geTRefundCreditMemoType.submittedOn) &&
        Objects.equals(this.success, geTRefundCreditMemoType.success) &&
        Objects.equals(this.type, geTRefundCreditMemoType.type) &&
        Objects.equals(this.updatedById, geTRefundCreditMemoType.updatedById) &&
        Objects.equals(this.updatedDate, geTRefundCreditMemoType.updatedDate) &&
        Objects.equals(this.integrationIdNS, geTRefundCreditMemoType.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, geTRefundCreditMemoType.integrationStatusNS) &&
        Objects.equals(this.originNS, geTRefundCreditMemoType.originNS) &&
        Objects.equals(this.syncDateNS, geTRefundCreditMemoType.syncDateNS) &&
        Objects.equals(this.synctoNetSuiteNS, geTRefundCreditMemoType.synctoNetSuiteNS)&&
        Objects.equals(this.additionalProperties, geTRefundCreditMemoType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, amount, cancelledOn, comment, createdById, createdDate, creditMemoId, financeInformation, gatewayId, gatewayResponse, gatewayResponseCode, gatewayState, id, markedForSubmissionOn, methodType, number, organizationLabel, paymentId, paymentMethodId, paymentMethodSnapshotId, reasonCode, referenceId, refundDate, refundTransactionTime, secondRefundReferenceId, settledOn, softDescriptor, softDescriptorPhone, status, submittedOn, success, type, updatedById, updatedDate, integrationIdNS, integrationStatusNS, originNS, syncDateNS, synctoNetSuiteNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GETRefundCreditMemoType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETRefundCreditMemoType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETRefundCreditMemoType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETRefundCreditMemoType is not found in the empty JSON string", GETRefundCreditMemoType.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETRefundCreditMemoType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETRefundCreditMemoType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETRefundCreditMemoType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETRefundCreditMemoType.class));

       return (TypeAdapter<T>) new TypeAdapter<GETRefundCreditMemoType>() {
           @Override
           public void write(JsonWriter out, GETRefundCreditMemoType value) throws IOException {
           ...
           @Override
           public GETRefundCreditMemoType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETRefundCreditMemoType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETRefundCreditMemoType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETRefundCreditMemoType
  * @throws IOException if the JSON string is invalid with respect to GETRefundCreditMemoType
  */
  public static GETRefundCreditMemoType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETRefundCreditMemoType.class);
  }

 /**
  * Convert an instance of GETRefundCreditMemoType to an JSON string
  *
  * @return JSON string
  */
