...
public class OrderActionRatePlanRecurringVolumePricingUpdate {
  /**
 ...
 public enum PriceChangeOptionEnum {
  ...
  public OrderActionRatePlanRecurringVolumePricingUpdate() {
  }

  public OrderActionRatePlanRecurringVolumePricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public OrderActionRatePlanRecurringVolumePricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public OrderActionRatePlanRecurringVolumePricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanRecurringVolumePricingUpdate quantity(Double quantity) {
  ...
  public OrderActionRatePlanRecurringVolumePricingUpdate quantity(Integer quantity) {
    if (quantity != null && quantity < 0) {
      throw new IllegalArgumentException("Invalid value for quantity. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanRecurringVolumePricingUpdate tiers(List<OrderActionRatePlanChargeTier> tiers) {
  ...
  public OrderActionRatePlanRecurringVolumePricingUpdate addTiersItem(OrderActionRatePlanChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the OrderActionRatePlanRecurringVolumePricingUpdate instance itself
   */
  public OrderActionRatePlanRecurringVolumePricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanRecurringVolumePricingUpdate orderActionRatePlanRecurringVolumePricingUpdate = (OrderActionRatePlanRecurringVolumePricingUpdate) o;
    return Objects.equals(this.priceChangeOption, orderActionRatePlanRecurringVolumePricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, orderActionRatePlanRecurringVolumePricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.quantity, orderActionRatePlanRecurringVolumePricingUpdate.quantity) &&
        Objects.equals(this.tiers, orderActionRatePlanRecurringVolumePricingUpdate.tiers)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanRecurringVolumePricingUpdate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderActionRatePlanRecurringVolumePricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanRecurringVolumePricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanRecurringVolumePricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanRecurringVolumePricingUpdate is not found in the empty JSON string", OrderActionRatePlanRecurringVolumePricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanRecurringVolumePricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanRecurringVolumePricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanRecurringVolumePricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanRecurringVolumePricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanRecurringVolumePricingUpdate>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanRecurringVolumePricingUpdate value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanRecurringVolumePricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanRecurringVolumePricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanRecurringVolumePricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanRecurringVolumePricingUpdate
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanRecurringVolumePricingUpdate
  */
  public static OrderActionRatePlanRecurringVolumePricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanRecurringVolumePricingUpdate.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanRecurringVolumePricingUpdate to an JSON string
  *
  * @return JSON string
  */
