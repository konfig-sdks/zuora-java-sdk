...
public class OrderActionRatePlanUsageOveragePricingUpdate {
  /**
 ...
 public enum PriceChangeOptionEnum {
  ...
  public OrderActionRatePlanUsageOveragePricingUpdate() {
  }

  public OrderActionRatePlanUsageOveragePricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public OrderActionRatePlanUsageOveragePricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public OrderActionRatePlanUsageOveragePricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanUsageOveragePricingUpdate includedUnits(Double includedUnits) {
  ...
  public OrderActionRatePlanUsageOveragePricingUpdate includedUnits(Integer includedUnits) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A certain quantity of units for free in the overage charge model. It cannot be negative. It must be 0 and above. Decimals are allowed. ")
  ...
  public OrderActionRatePlanUsageOveragePricingUpdate overagePrice(Double overagePrice) {
  ...
  public OrderActionRatePlanUsageOveragePricingUpdate overagePrice(Integer overagePrice) {
  ...
  **/
   ...
   * @return the OrderActionRatePlanUsageOveragePricingUpdate instance itself
   */
  public OrderActionRatePlanUsageOveragePricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanUsageOveragePricingUpdate orderActionRatePlanUsageOveragePricingUpdate = (OrderActionRatePlanUsageOveragePricingUpdate) o;
    return Objects.equals(this.priceChangeOption, orderActionRatePlanUsageOveragePricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, orderActionRatePlanUsageOveragePricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.includedUnits, orderActionRatePlanUsageOveragePricingUpdate.includedUnits) &&
        Objects.equals(this.overagePrice, orderActionRatePlanUsageOveragePricingUpdate.overagePrice)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanUsageOveragePricingUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, includedUnits, overagePrice, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderActionRatePlanUsageOveragePricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanUsageOveragePricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanUsageOveragePricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanUsageOveragePricingUpdate is not found in the empty JSON string", OrderActionRatePlanUsageOveragePricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanUsageOveragePricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanUsageOveragePricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanUsageOveragePricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanUsageOveragePricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanUsageOveragePricingUpdate>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanUsageOveragePricingUpdate value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanUsageOveragePricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanUsageOveragePricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanUsageOveragePricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanUsageOveragePricingUpdate
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanUsageOveragePricingUpdate
  */
  public static OrderActionRatePlanUsageOveragePricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanUsageOveragePricingUpdate.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanUsageOveragePricingUpdate to an JSON string
  *
  * @return JSON string
  */
