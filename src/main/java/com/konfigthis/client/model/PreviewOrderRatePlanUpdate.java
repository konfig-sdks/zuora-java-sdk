...
import com.konfigthis.client.model.PreviewOrderChargeUpdate;
...
public class PreviewOrderRatePlanUpdate {
  ...
  private List<PreviewOrderChargeUpdate> chargeUpdates = null;
  ...
  public PreviewOrderRatePlanUpdate() {
  }

  public PreviewOrderRatePlanUpdate chargeUpdates(List<PreviewOrderChargeUpdate> chargeUpdates) {
  ...
  public PreviewOrderRatePlanUpdate addChargeUpdatesItem(PreviewOrderChargeUpdate chargeUpdatesItem) {
   ...
   /**
   * Array of the JSON objects containing the information for a charge update in the &#x60;updateProduct&#x60; type of order action.  When previewing an &#x60;updateProduct&#x60; order action, either the &#x60;chargeNumber&#x60; or &#x60;uniqueToken&#x60; field is required to specify the charge to update. 
   * @return chargeUpdates
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array of the JSON objects containing the information for a charge update in the `updateProduct` type of order action.  When previewing an `updateProduct` order action, either the `chargeNumber` or `uniqueToken` field is required to specify the charge to update. ")

  public List<PreviewOrderChargeUpdate> getChargeUpdates() {
    return chargeUpdates;
  }


  public void setChargeUpdates(List<PreviewOrderChargeUpdate> chargeUpdates) {
  ...
  public PreviewOrderRatePlanUpdate clearingExistingFeatures(Boolean clearingExistingFeatures) {
  ...
  **/
  ...
  public PreviewOrderRatePlanUpdate customFields(Map<String, Object> customFields) {
  ...
  public PreviewOrderRatePlanUpdate putCustomFieldsItem(String key, Object customFieldsItem) {
  ...
  **/
  ...
  public PreviewOrderRatePlanUpdate productRatePlanNumber(String productRatePlanNumber) {
  ...
  **/
  ...
  public PreviewOrderRatePlanUpdate ratePlanId(String ratePlanId) {
  ...
  **/
  ...
  public PreviewOrderRatePlanUpdate specificUpdateDate(LocalDate specificUpdateDate) {
  ...
  **/
  ...
  public PreviewOrderRatePlanUpdate subscriptionProductFeatures(List<CreateOrderRatePlanFeatureOverride> subscriptionProductFeatures) {
  ...
  public PreviewOrderRatePlanUpdate addSubscriptionProductFeaturesItem(CreateOrderRatePlanFeatureOverride subscriptionProductFeaturesItem) {
  ...
  **/
  ...
  public PreviewOrderRatePlanUpdate subscriptionRatePlanNumber(String subscriptionRatePlanNumber) {
  ...
  **/
  ...
  public PreviewOrderRatePlanUpdate uniqueToken(String uniqueToken) {
  ...
  **/
   ...
   * @return the PreviewOrderRatePlanUpdate instance itself
   */
  public PreviewOrderRatePlanUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PreviewOrderRatePlanUpdate previewOrderRatePlanUpdate = (PreviewOrderRatePlanUpdate) o;
    return Objects.equals(this.chargeUpdates, previewOrderRatePlanUpdate.chargeUpdates) &&
        Objects.equals(this.clearingExistingFeatures, previewOrderRatePlanUpdate.clearingExistingFeatures) &&
        Objects.equals(this.customFields, previewOrderRatePlanUpdate.customFields) &&
        Objects.equals(this.productRatePlanNumber, previewOrderRatePlanUpdate.productRatePlanNumber) &&
        Objects.equals(this.ratePlanId, previewOrderRatePlanUpdate.ratePlanId) &&
        Objects.equals(this.specificUpdateDate, previewOrderRatePlanUpdate.specificUpdateDate) &&
        Objects.equals(this.subscriptionProductFeatures, previewOrderRatePlanUpdate.subscriptionProductFeatures) &&
        Objects.equals(this.subscriptionRatePlanNumber, previewOrderRatePlanUpdate.subscriptionRatePlanNumber) &&
        Objects.equals(this.uniqueToken, previewOrderRatePlanUpdate.uniqueToken)&&
        Objects.equals(this.additionalProperties, previewOrderRatePlanUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chargeUpdates, clearingExistingFeatures, customFields, productRatePlanNumber, ratePlanId, specificUpdateDate, subscriptionProductFeatures, subscriptionRatePlanNumber, uniqueToken, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PreviewOrderRatePlanUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PreviewOrderRatePlanUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PreviewOrderRatePlanUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PreviewOrderRatePlanUpdate is not found in the empty JSON string", PreviewOrderRatePlanUpdate.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("chargeUpdates") != null && !jsonObj.get("chargeUpdates").isJsonNull()) {
        ...
        if (jsonArraychargeUpdates != null) {
          ...
          for (int i = 0; i < jsonArraychargeUpdates.size(); i++) {
            PreviewOrderChargeUpdate.validateJsonObject(jsonArraychargeUpdates.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PreviewOrderRatePlanUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PreviewOrderRatePlanUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PreviewOrderRatePlanUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PreviewOrderRatePlanUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<PreviewOrderRatePlanUpdate>() {
           @Override
           public void write(JsonWriter out, PreviewOrderRatePlanUpdate value) throws IOException {
           ...
           @Override
           public PreviewOrderRatePlanUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PreviewOrderRatePlanUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PreviewOrderRatePlanUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PreviewOrderRatePlanUpdate
  * @throws IOException if the JSON string is invalid with respect to PreviewOrderRatePlanUpdate
  */
  public static PreviewOrderRatePlanUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PreviewOrderRatePlanUpdate.class);
  }

 /**
  * Convert an instance of PreviewOrderRatePlanUpdate to an JSON string
  *
  * @return JSON string
  */
