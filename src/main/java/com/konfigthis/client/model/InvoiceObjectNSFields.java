 ...
 */
@ApiModel(description = "Container for Invoice fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class InvoiceObjectNSFields {
  ...
  public InvoiceObjectNSFields() {
  }

  public InvoiceObjectNSFields integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public InvoiceObjectNSFields integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public InvoiceObjectNSFields syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the InvoiceObjectNSFields instance itself
   */
  public InvoiceObjectNSFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InvoiceObjectNSFields invoiceObjectNSFields = (InvoiceObjectNSFields) o;
    return Objects.equals(this.integrationIdNS, invoiceObjectNSFields.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, invoiceObjectNSFields.integrationStatusNS) &&
        Objects.equals(this.syncDateNS, invoiceObjectNSFields.syncDateNS)&&
        Objects.equals(this.additionalProperties, invoiceObjectNSFields.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvoiceObjectNSFields {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceObjectNSFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceObjectNSFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceObjectNSFields is not found in the empty JSON string", InvoiceObjectNSFields.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceObjectNSFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceObjectNSFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceObjectNSFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceObjectNSFields.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceObjectNSFields>() {
           @Override
           public void write(JsonWriter out, InvoiceObjectNSFields value) throws IOException {
           ...
           @Override
           public InvoiceObjectNSFields read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoiceObjectNSFields instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoiceObjectNSFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoiceObjectNSFields
  * @throws IOException if the JSON string is invalid with respect to InvoiceObjectNSFields
  */
  public static InvoiceObjectNSFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceObjectNSFields.class);
  }

 /**
  * Convert an instance of InvoiceObjectNSFields to an JSON string
  *
  * @return JSON string
  */
