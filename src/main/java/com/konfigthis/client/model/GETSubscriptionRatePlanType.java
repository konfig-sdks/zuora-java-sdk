...
public class GETSubscriptionRatePlanType {
  ...
  public GETSubscriptionRatePlanType() {
  }

  public GETSubscriptionRatePlanType externallyManagedPlanId(String externallyManagedPlanId) {
  ...
  **/
   ...
   * @return the GETSubscriptionRatePlanType instance itself
   */
  public GETSubscriptionRatePlanType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.externallyManagedPlanId, geTSubscriptionRatePlanType.externallyManagedPlanId) &&
        ...
        Objects.equals(this.additionalProperties, geTSubscriptionRatePlanType.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETSubscriptionRatePlanType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETSubscriptionRatePlanType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETSubscriptionRatePlanType is not found in the empty JSON string", GETSubscriptionRatePlanType.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETSubscriptionRatePlanType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETSubscriptionRatePlanType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETSubscriptionRatePlanType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETSubscriptionRatePlanType.class));

       return (TypeAdapter<T>) new TypeAdapter<GETSubscriptionRatePlanType>() {
           @Override
           public void write(JsonWriter out, GETSubscriptionRatePlanType value) throws IOException {
           ...
           @Override
           public GETSubscriptionRatePlanType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETSubscriptionRatePlanType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETSubscriptionRatePlanType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETSubscriptionRatePlanType
  * @throws IOException if the JSON string is invalid with respect to GETSubscriptionRatePlanType
  */
  public static GETSubscriptionRatePlanType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETSubscriptionRatePlanType.class);
  }

 /**
  * Convert an instance of GETSubscriptionRatePlanType to an JSON string
  *
  * @return JSON string
  */
