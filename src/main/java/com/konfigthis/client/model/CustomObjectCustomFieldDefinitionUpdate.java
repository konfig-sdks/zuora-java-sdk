...
public class CustomObjectCustomFieldDefinitionUpdate {
  ...
  **/
  ...
  @ApiModelProperty(example = "Address zip code", value = "Applicable if the `type` of the action is  `updateField`")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Applicable if the `type` of the action is  `updateField`")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Zip code", value = "The UI label of the custom field")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10", value = "The maximum length of string that can be stored in the custom field.  This field applies only to the following custom field types:  - Text:   - The `type` field is `string`.   - The `format` field is not specified or is `url`.   - The `enum` field is not specified. - Picklist:   - The `type` field is `string`.   - The `enum` field is specified.   - The `multiselect` field is not specified or is `false`. - Multiselect:   - The `type` field is `string`.   - The `enum` field is specified.   - The `multiselect` field is `true`.  If the custom field is filterable, the value of `maxLength` must be 512 or less. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether this is a multiselect custom field.  This field applies only to the creation of Picklist or Multiselect custom fields:  - The action `type` field is `addField`. - The definition `type` field is `string`. - The `maxLength` field is specified. - The `enum` field is specified. ")
  ...
  public CustomObjectCustomFieldDefinitionUpdate origin(OriginEnum origin) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "string", value = "The data type of the custom field")
  ...
  public CustomObjectCustomFieldDefinitionUpdate example(String example) {
  ...
  **/
  ...
  public CustomObjectCustomFieldDefinitionUpdate xKonfigOriginalExample(String xKonfigOriginalExample) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, customObjectCustomFieldDefinitionUpdate.description) &&
        Objects.equals(this._default, customObjectCustomFieldDefinitionUpdate._default) &&
        ...
        Objects.equals(this.example, customObjectCustomFieldDefinitionUpdate.example) &&
        Objects.equals(this.xKonfigOriginalExample, customObjectCustomFieldDefinitionUpdate.xKonfigOriginalExample)&&
        Objects.equals(this.additionalProperties, customObjectCustomFieldDefinitionUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, _default, displayName, format, label, maxLength, multiselect, origin, type, example, xKonfigOriginalExample, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomObjectCustomFieldDefinitionUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomObjectCustomFieldDefinitionUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CustomObjectCustomFieldDefinitionUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomObjectCustomFieldDefinitionUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomObjectCustomFieldDefinitionUpdate>() {
           @Override
