...
import com.konfigthis.client.model.LastTerm;
...
public class CreateOrderTermsAndConditions {
  ...
  **/
  ...
  public CreateOrderTermsAndConditions clearingExistingInvoiceGroupNumber(Boolean clearingExistingInvoiceGroupNumber) {
  ...
  **/
  ...
  public CreateOrderTermsAndConditions invoiceGroupNumber(String invoiceGroupNumber) {
  ...
  **/
  ...
  public CreateOrderTermsAndConditions renewalSetting(RenewalSettingEnum renewalSetting) {
  ...
  **/
  ...
  public CreateOrderTermsAndConditions renewalTerms(List<RenewalTerm> renewalTerms) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.autoRenew, createOrderTermsAndConditions.autoRenew) &&
        ...
        Objects.equals(this.clearingExistingInvoiceGroupNumber, createOrderTermsAndConditions.clearingExistingInvoiceGroupNumber) &&
        ...
        Objects.equals(this.invoiceGroupNumber, createOrderTermsAndConditions.invoiceGroupNumber) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autoRenew, billToContactId, clearingExistingBillToContact, clearingExistingInvoiceGroupNumber, clearingExistingInvoiceTemplate, clearingExistingPaymentTerm, clearingExistingSequenceSet, clearingExistingSoldToContact, invoiceGroupNumber, invoiceTemplateId, lastTerm, paymentTerm, renewalSetting, renewalTerms, sequenceSetId, soldToContactId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateOrderTermsAndConditions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateOrderTermsAndConditions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("lastTerm") != null && !jsonObj.get("lastTerm").isJsonNull()) {
        LastTerm.validateJsonObject(jsonObj.getAsJsonObject("lastTerm"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CreateOrderTermsAndConditions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOrderTermsAndConditions.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOrderTermsAndConditions>() {
           @Override
