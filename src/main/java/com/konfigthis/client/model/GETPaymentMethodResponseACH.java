...
public class GETPaymentMethodResponseACH {
 ...
 public enum BankAccountTypeEnum {
  ...
  public GETPaymentMethodResponseACH() {
  }

  public GETPaymentMethodResponseACH bankABACode(String bankABACode) {
  ...
  **/
  ...
  public GETPaymentMethodResponseACH bankAccountName(String bankAccountName) {
  ...
  **/
  ...
  public GETPaymentMethodResponseACH bankAccountNumber(String bankAccountNumber) {
  ...
  **/
  ...
  public GETPaymentMethodResponseACH bankAccountType(BankAccountTypeEnum bankAccountType) {
  ...
  **/
  ...
  public GETPaymentMethodResponseACH bankName(String bankName) {
  ...
  **/
   ...
   * @return the GETPaymentMethodResponseACH instance itself
   */
  public GETPaymentMethodResponseACH putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GETPaymentMethodResponseACH geTPaymentMethodResponseACH = (GETPaymentMethodResponseACH) o;
    return Objects.equals(this.bankABACode, geTPaymentMethodResponseACH.bankABACode) &&
        Objects.equals(this.bankAccountName, geTPaymentMethodResponseACH.bankAccountName) &&
        Objects.equals(this.bankAccountNumber, geTPaymentMethodResponseACH.bankAccountNumber) &&
        Objects.equals(this.bankAccountType, geTPaymentMethodResponseACH.bankAccountType) &&
        Objects.equals(this.bankName, geTPaymentMethodResponseACH.bankName)&&
        Objects.equals(this.additionalProperties, geTPaymentMethodResponseACH.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankABACode, bankAccountName, bankAccountNumber, bankAccountType, bankName, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GETPaymentMethodResponseACH {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETPaymentMethodResponseACH
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETPaymentMethodResponseACH.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETPaymentMethodResponseACH is not found in the empty JSON string", GETPaymentMethodResponseACH.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETPaymentMethodResponseACH.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETPaymentMethodResponseACH' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETPaymentMethodResponseACH> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETPaymentMethodResponseACH.class));

       return (TypeAdapter<T>) new TypeAdapter<GETPaymentMethodResponseACH>() {
           @Override
           public void write(JsonWriter out, GETPaymentMethodResponseACH value) throws IOException {
           ...
           @Override
           public GETPaymentMethodResponseACH read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETPaymentMethodResponseACH instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETPaymentMethodResponseACH given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETPaymentMethodResponseACH
  * @throws IOException if the JSON string is invalid with respect to GETPaymentMethodResponseACH
  */
  public static GETPaymentMethodResponseACH fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETPaymentMethodResponseACH.class);
  }

 /**
  * Convert an instance of GETPaymentMethodResponseACH to an JSON string
  *
  * @return JSON string
  */
