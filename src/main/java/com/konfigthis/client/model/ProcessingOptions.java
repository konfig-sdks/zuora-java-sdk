...
import com.konfigthis.client.model.BillingOptions;
 ...
 */
@ApiModel(description = "Processing options for generating billing documents.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProcessingOptions {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Indicates if the current request needs to generate a billing document. The billing document will be generated against all Order Line Items included in this order.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billingOptions, processingOptions.billingOptions) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingOptions, runBilling, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProcessingOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProcessingOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("billingOptions") != null && !jsonObj.get("billingOptions").isJsonNull()) {
        BillingOptions.validateJsonObject(jsonObj.getAsJsonObject("billingOptions"));
      }
  }
