 ...
 */
@ApiModel(description = "The mandate information for the Credit Card, Apple Pay, Google Pay, Credit Card Reference Transaction, ACH, or Bank Transfer payment method.  The following mandate fields are common to all supported payment methods: * `mandateId` * `mandateReason` * `mandateStatus`  The following mandate fields are specific to the ACH and Bank Transfer payment methods: * `mandateReceivedStatus` * `existingMandateStatus` * `mandateCreationDate` * `mandateUpdateDate`  The following mandate fields are specific to the Credit Card, Apple Pay, and Google Pay payment methods: * `mitTransactionId` * `mitProfileAgreedOn` * `mitConsentAgreementRef` * `mitConsentAgreementSrc` * `mitProfileType` * `mitProfileAction` ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class POSTAccountPMMandateInfo {
  /**
   * Indicates whether the mandate is an existing mandate. 
   */
  @JsonAdapter(ExistingMandateStatusEnum.Adapter.class)
 public enum ExistingMandateStatusEnum {
    TRUE("true"),
    ...
    ExistingMandateStatusEnum(String value) {
      this.value = value;
    }
    ...
    public static ExistingMandateStatusEnum fromValue(String value) {
      for (ExistingMandateStatusEnum b : ExistingMandateStatusEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ExistingMandateStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ExistingMandateStatusEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ExistingMandateStatusEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ExistingMandateStatusEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_EXISTING_MANDATE_STATUS = "existingMandateStatus";
  @SerializedName(SERIALIZED_NAME_EXISTING_MANDATE_STATUS)
  private ExistingMandateStatusEnum existingMandateStatus;
   ...
   */
  @JsonAdapter(MandateReceivedStatusEnum.Adapter.class)
 public enum MandateReceivedStatusEnum {
    TRUE("true"),
    ...
    MandateReceivedStatusEnum(String value) {
      this.value = value;
    }
    ...
    public static MandateReceivedStatusEnum fromValue(String value) {
      for (MandateReceivedStatusEnum b : MandateReceivedStatusEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<MandateReceivedStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final MandateReceivedStatusEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public MandateReceivedStatusEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return MandateReceivedStatusEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_MANDATE_RECEIVED_STATUS = "mandateReceivedStatus";
  @SerializedName(SERIALIZED_NAME_MANDATE_RECEIVED_STATUS)
  private MandateReceivedStatusEnum mandateReceivedStatus;
 ...
 public enum MitProfileActionEnum {
  ...
  @SerializedName(SERIALIZED_NAME_MIT_TRANSACTION_ID)
  private String mitTransactionId;

  public POSTAccountPMMandateInfo() {
  }

  public POSTAccountPMMandateInfo existingMandateStatus(ExistingMandateStatusEnum existingMandateStatus) {
   ...
   /**
   * Indicates whether the mandate is an existing mandate. 
   * @return existingMandateStatus
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the mandate is an existing mandate. ")

  public ExistingMandateStatusEnum getExistingMandateStatus() {
    return existingMandateStatus;
  }


  public void setExistingMandateStatus(ExistingMandateStatusEnum existingMandateStatus) {
  ...
  public POSTAccountPMMandateInfo mandateCreationDate(LocalDate mandateCreationDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date on which the mandate was created. ")
  ...
  public POSTAccountPMMandateInfo mandateId(String mandateId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The mandate ID. ")
  ...
  public POSTAccountPMMandateInfo mandateReason(String mandateReason) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The reason of the mandate from the gateway side. ")
  ...
  public POSTAccountPMMandateInfo mandateReceivedStatus(MandateReceivedStatusEnum mandateReceivedStatus) {
   ...
   /**
   * Indicates whether the mandate is received from the gateway 
   * @return mandateReceivedStatus
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the mandate is received from the gateway ")

  public MandateReceivedStatusEnum getMandateReceivedStatus() {
    return mandateReceivedStatus;
  }


  public void setMandateReceivedStatus(MandateReceivedStatusEnum mandateReceivedStatus) {
  ...
  public POSTAccountPMMandateInfo mandateStatus(String mandateStatus) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the mandate from the gateway side. ")
  ...
  public POSTAccountPMMandateInfo mandateUpdateDate(LocalDate mandateUpdateDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date on which the mandate was updated. ")
  ...
  public POSTAccountPMMandateInfo mitConsentAgreementRef(String mitConsentAgreementRef) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Reference for the consent agreement that you have established with the customer.   ")
  ...
  public POSTAccountPMMandateInfo mitConsentAgreementSrc(MitConsentAgreementSrcEnum mitConsentAgreementSrc) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Required if you set the `mitProfileAction` field. Specify how the consent agreement has been established with the customer. The allowed value is `External`. If you do not specify the `mitProfileAction` field, Zuora will automatically create a stored credential profile for the payment method, with the default value `External` set to this field. ")
  ...
  public POSTAccountPMMandateInfo mitProfileAction(MitProfileActionEnum mitProfileAction) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies how Zuora creates and activates the stored credential profile. Only applicable if you set the `status` field to `Active`.  * `Activate` (default) - Use this value if you are creating the stored credential profile after receiving the customer's consent.    Zuora will create the stored credential profile then send a cardholder-initiated transaction (CIT) to the payment gateway to validate the stored credential profile. If the CIT succeeds, the status of the stored credential profile will be `Active`. If the CIT does not succeed, Zuora will not create a stored credential profile.      If the payment gateway does not support the stored credential transaction framework, the status of the stored credential profile will be `Agreed`.   * `Persist` - Use this value if the stored credential profile represents a stored credential profile in an external system. The status of the payment method's stored credential profile will be `Active`.  If you do not specify this field, Zuora will automatically create a stored credential profile for the payment method, with the default value `Activate` set to this field. ")
  ...
  public POSTAccountPMMandateInfo mitProfileAgreedOn(LocalDate mitProfileAgreedOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date on which the stored credential profile is agreed. The date format is `yyyy-mm-dd`. ")
  ...
  public POSTAccountPMMandateInfo mitProfileType(String mitProfileType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates the type of the stored credential profile. If you do not specify the `mitProfileAction` field, Zuora will automatically create a stored credential profile for the payment method, with the default value `Recurring` set to this field. ")
  ...
  public void setMitProfileType(String mitProfileType) {
  ...
  public POSTAccountPMMandateInfo mitTransactionId(String mitTransactionId) {
   ...
   * @return mitTransactionId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the ID of the transaction. Only applicable if you set the `mitProfileAction` field to `Persist`. ")
  ...
  public void setMitTransactionId(String mitTransactionId) {
   ...
   * @return the POSTAccountPMMandateInfo instance itself
   */
  public POSTAccountPMMandateInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTAccountPMMandateInfo poSTAccountPMMandateInfo = (POSTAccountPMMandateInfo) o;
    return Objects.equals(this.existingMandateStatus, poSTAccountPMMandateInfo.existingMandateStatus) &&
        Objects.equals(this.mandateCreationDate, poSTAccountPMMandateInfo.mandateCreationDate) &&
        Objects.equals(this.mandateId, poSTAccountPMMandateInfo.mandateId) &&
        Objects.equals(this.mandateReason, poSTAccountPMMandateInfo.mandateReason) &&
        Objects.equals(this.mandateReceivedStatus, poSTAccountPMMandateInfo.mandateReceivedStatus) &&
        Objects.equals(this.mandateStatus, poSTAccountPMMandateInfo.mandateStatus) &&
        Objects.equals(this.mandateUpdateDate, poSTAccountPMMandateInfo.mandateUpdateDate) &&
        Objects.equals(this.mitConsentAgreementRef, poSTAccountPMMandateInfo.mitConsentAgreementRef) &&
        Objects.equals(this.mitConsentAgreementSrc, poSTAccountPMMandateInfo.mitConsentAgreementSrc) &&
        Objects.equals(this.mitProfileAction, poSTAccountPMMandateInfo.mitProfileAction) &&
        Objects.equals(this.mitProfileAgreedOn, poSTAccountPMMandateInfo.mitProfileAgreedOn) &&
        Objects.equals(this.mitProfileType, poSTAccountPMMandateInfo.mitProfileType) &&
        Objects.equals(this.mitTransactionId, poSTAccountPMMandateInfo.mitTransactionId)&&
        Objects.equals(this.additionalProperties, poSTAccountPMMandateInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(existingMandateStatus, mandateCreationDate, mandateId, mandateReason, mandateReceivedStatus, mandateStatus, mandateUpdateDate, mitConsentAgreementRef, mitConsentAgreementSrc, mitProfileAction, mitProfileAgreedOn, mitProfileType, mitTransactionId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class POSTAccountPMMandateInfo {\n");
    sb.append("    existingMandateStatus: ").append(toIndentedString(existingMandateStatus)).append("\n");
    ...
    sb.append("    mandateReceivedStatus: ").append(toIndentedString(mandateReceivedStatus)).append("\n");
    ...
    sb.append("    mitTransactionId: ").append(toIndentedString(mitTransactionId)).append("\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTAccountPMMandateInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTAccountPMMandateInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTAccountPMMandateInfo is not found in the empty JSON string", POSTAccountPMMandateInfo.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("existingMandateStatus") != null && !jsonObj.get("existingMandateStatus").isJsonNull()) && !jsonObj.get("existingMandateStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `existingMandateStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("existingMandateStatus").toString()));
      }
      ...
      if ((jsonObj.get("mandateReceivedStatus") != null && !jsonObj.get("mandateReceivedStatus").isJsonNull()) && !jsonObj.get("mandateReceivedStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `mandateReceivedStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mandateReceivedStatus").toString()));
      }
      ...
      if ((jsonObj.get("mitTransactionId") != null && !jsonObj.get("mitTransactionId").isJsonNull()) && !jsonObj.get("mitTransactionId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `mitTransactionId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mitTransactionId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTAccountPMMandateInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTAccountPMMandateInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTAccountPMMandateInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTAccountPMMandateInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTAccountPMMandateInfo>() {
           @Override
           public void write(JsonWriter out, POSTAccountPMMandateInfo value) throws IOException {
           ...
           @Override
           public POSTAccountPMMandateInfo read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTAccountPMMandateInfo instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTAccountPMMandateInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTAccountPMMandateInfo
  * @throws IOException if the JSON string is invalid with respect to POSTAccountPMMandateInfo
  */
  public static POSTAccountPMMandateInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTAccountPMMandateInfo.class);
  }

 /**
  * Convert an instance of POSTAccountPMMandateInfo to an JSON string
  *
  * @return JSON string
  */
