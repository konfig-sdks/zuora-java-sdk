...
import com.konfigthis.client.model.CustomObjectCustomFieldDefinition;
 ...
 */
@ApiModel(description = "The definitions of all the fields in the custom object definition")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CustomObjectAllFieldsDefinition {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomObjectAllFieldsDefinition
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomObjectAllFieldsDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CustomObjectAllFieldsDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomObjectAllFieldsDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomObjectAllFieldsDefinition>() {
           @Override
