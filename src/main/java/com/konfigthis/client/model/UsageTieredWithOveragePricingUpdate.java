...
public class UsageTieredWithOveragePricingUpdate {
 ...
 public enum PriceChangeOptionEnum {
  ...
  public UsageTieredWithOveragePricingUpdate() {
  }

  public UsageTieredWithOveragePricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public UsageTieredWithOveragePricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public UsageTieredWithOveragePricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public UsageTieredWithOveragePricingUpdate overagePrice(Double overagePrice) {
  ...
  public UsageTieredWithOveragePricingUpdate overagePrice(Integer overagePrice) {
  ...
  **/
  ...
  public UsageTieredWithOveragePricingUpdate tiers(List<ChargeTier> tiers) {
  ...
  public UsageTieredWithOveragePricingUpdate addTiersItem(ChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the UsageTieredWithOveragePricingUpdate instance itself
   */
  public UsageTieredWithOveragePricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UsageTieredWithOveragePricingUpdate usageTieredWithOveragePricingUpdate = (UsageTieredWithOveragePricingUpdate) o;
    return Objects.equals(this.priceChangeOption, usageTieredWithOveragePricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, usageTieredWithOveragePricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.overagePrice, usageTieredWithOveragePricingUpdate.overagePrice) &&
        Objects.equals(this.tiers, usageTieredWithOveragePricingUpdate.tiers)&&
        Objects.equals(this.additionalProperties, usageTieredWithOveragePricingUpdate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UsageTieredWithOveragePricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsageTieredWithOveragePricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsageTieredWithOveragePricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsageTieredWithOveragePricingUpdate is not found in the empty JSON string", UsageTieredWithOveragePricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsageTieredWithOveragePricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsageTieredWithOveragePricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsageTieredWithOveragePricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsageTieredWithOveragePricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<UsageTieredWithOveragePricingUpdate>() {
           @Override
           public void write(JsonWriter out, UsageTieredWithOveragePricingUpdate value) throws IOException {
           ...
           @Override
           public UsageTieredWithOveragePricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UsageTieredWithOveragePricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UsageTieredWithOveragePricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UsageTieredWithOveragePricingUpdate
  * @throws IOException if the JSON string is invalid with respect to UsageTieredWithOveragePricingUpdate
  */
  public static UsageTieredWithOveragePricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsageTieredWithOveragePricingUpdate.class);
  }

 /**
  * Convert an instance of UsageTieredWithOveragePricingUpdate to an JSON string
  *
  * @return JSON string
  */
