...
public class PUTWriteOffInvoiceRequest {
  ...
  private List<CreditMemoItemFromWriteOffInvoice> items = null;
  ...
  public PUTWriteOffInvoiceRequest() {
  }

  public PUTWriteOffInvoiceRequest memoDate(String memoDate) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2019-01-02", value = "")
  ...
  public PUTWriteOffInvoiceRequest comment(String comment) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Comments about the write-off. The comment is used as the comment of the credit memo generated by writing off the specified invoice. ")
  ...
  public PUTWriteOffInvoiceRequest items(List<CreditMemoItemFromWriteOffInvoice> items) {
  ...
  public PUTWriteOffInvoiceRequest addItemsItem(CreditMemoItemFromWriteOffInvoice itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for items. This field is optional.  **Note:** If specified, you must specify ALL the items of the invoice. The entire balance of the invoice will be written off, you cannot just write off some items of the invoice. ")

  public List<CreditMemoItemFromWriteOffInvoice> getItems() {
    return items;
  }


  public void setItems(List<CreditMemoItemFromWriteOffInvoice> items) {
  ...
  public PUTWriteOffInvoiceRequest reasonCode(String reasonCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A code identifying the reason for the transaction. The value must be an existing reason code or empty. If you do not specify a value, Zuora uses the default reason code `Write-off`. ")
  ...
  public PUTWriteOffInvoiceRequest integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public PUTWriteOffInvoiceRequest integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public PUTWriteOffInvoiceRequest originNS(String originNS) {
  ...
  **/
  ...
  public PUTWriteOffInvoiceRequest syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public PUTWriteOffInvoiceRequest transactionNS(String transactionNS) {
  ...
  **/
   ...
   * @return the PUTWriteOffInvoiceRequest instance itself
   */
  public PUTWriteOffInvoiceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PUTWriteOffInvoiceRequest puTWriteOffInvoiceRequest = (PUTWriteOffInvoiceRequest) o;
    return Objects.equals(this.memoDate, puTWriteOffInvoiceRequest.memoDate) &&
        Objects.equals(this.comment, puTWriteOffInvoiceRequest.comment) &&
        Objects.equals(this.items, puTWriteOffInvoiceRequest.items) &&
        Objects.equals(this.reasonCode, puTWriteOffInvoiceRequest.reasonCode) &&
        Objects.equals(this.integrationIdNS, puTWriteOffInvoiceRequest.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, puTWriteOffInvoiceRequest.integrationStatusNS) &&
        Objects.equals(this.originNS, puTWriteOffInvoiceRequest.originNS) &&
        Objects.equals(this.syncDateNS, puTWriteOffInvoiceRequest.syncDateNS) &&
        Objects.equals(this.transactionNS, puTWriteOffInvoiceRequest.transactionNS)&&
        Objects.equals(this.additionalProperties, puTWriteOffInvoiceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(memoDate, comment, items, reasonCode, integrationIdNS, integrationStatusNS, originNS, syncDateNS, transactionNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PUTWriteOffInvoiceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTWriteOffInvoiceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTWriteOffInvoiceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTWriteOffInvoiceRequest is not found in the empty JSON string", PUTWriteOffInvoiceRequest.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("memoDate") != null && !jsonObj.get("memoDate").isJsonNull()) && !jsonObj.get("memoDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `memoDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("memoDate").toString()));
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            CreditMemoItemFromWriteOffInvoice.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTWriteOffInvoiceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTWriteOffInvoiceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTWriteOffInvoiceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTWriteOffInvoiceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTWriteOffInvoiceRequest>() {
           @Override
           public void write(JsonWriter out, PUTWriteOffInvoiceRequest value) throws IOException {
           ...
           @Override
           public PUTWriteOffInvoiceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTWriteOffInvoiceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTWriteOffInvoiceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTWriteOffInvoiceRequest
  * @throws IOException if the JSON string is invalid with respect to PUTWriteOffInvoiceRequest
  */
  public static PUTWriteOffInvoiceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTWriteOffInvoiceRequest.class);
  }

 /**
  * Convert an instance of PUTWriteOffInvoiceRequest to an JSON string
  *
  * @return JSON string
  */
