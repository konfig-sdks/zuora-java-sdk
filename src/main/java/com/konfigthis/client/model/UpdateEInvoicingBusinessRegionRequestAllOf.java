...
public class UpdateEInvoicingBusinessRegionRequestAllOf {
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf() {
  }

  public UpdateEInvoicingBusinessRegionRequestAllOf addressLine1(String addressLine1) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf addressLine2(String addressLine2) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf businessName(String businessName) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf businessNumber(String businessNumber) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf businessNumberSchemaId(String businessNumberSchemaId) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf city(String city) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf contactName(String contactName) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf country(String country) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf digitalSignatureEnable(Boolean digitalSignatureEnable) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf digitalSignatureBoxEnable(Boolean digitalSignatureBoxEnable) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf digitalSignatureBoxPosX(Double digitalSignatureBoxPosX) {
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf digitalSignatureBoxPosX(Integer digitalSignatureBoxPosX) {
    if (digitalSignatureBoxPosX != null && digitalSignatureBoxPosX < 0) {
      throw new IllegalArgumentException("Invalid value for digitalSignatureBoxPosX. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf digitalSignatureBoxPosY(Double digitalSignatureBoxPosY) {
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf digitalSignatureBoxPosY(Integer digitalSignatureBoxPosY) {
    if (digitalSignatureBoxPosY != null && digitalSignatureBoxPosY < 0) {
      throw new IllegalArgumentException("Invalid value for digitalSignatureBoxPosY. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf email(String email) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf endpointId(String endpointId) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf endpointSchemeId(String endpointSchemeId) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf phoneNumber(String phoneNumber) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf postalCode(String postalCode) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf serviceProviderId(String serviceProviderId) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf state(String state) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf taxRegisterNumber(String taxRegisterNumber) {
  ...
  **/
  ...
  public UpdateEInvoicingBusinessRegionRequestAllOf tradeName(String tradeName) {
  ...
  **/
   ...
   * @return the UpdateEInvoicingBusinessRegionRequestAllOf instance itself
   */
  public UpdateEInvoicingBusinessRegionRequestAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateEInvoicingBusinessRegionRequestAllOf updateEInvoicingBusinessRegionRequestAllOf = (UpdateEInvoicingBusinessRegionRequestAllOf) o;
    return Objects.equals(this.addressLine1, updateEInvoicingBusinessRegionRequestAllOf.addressLine1) &&
        Objects.equals(this.addressLine2, updateEInvoicingBusinessRegionRequestAllOf.addressLine2) &&
        Objects.equals(this.businessName, updateEInvoicingBusinessRegionRequestAllOf.businessName) &&
        Objects.equals(this.businessNumber, updateEInvoicingBusinessRegionRequestAllOf.businessNumber) &&
        Objects.equals(this.businessNumberSchemaId, updateEInvoicingBusinessRegionRequestAllOf.businessNumberSchemaId) &&
        Objects.equals(this.city, updateEInvoicingBusinessRegionRequestAllOf.city) &&
        Objects.equals(this.contactName, updateEInvoicingBusinessRegionRequestAllOf.contactName) &&
        Objects.equals(this.country, updateEInvoicingBusinessRegionRequestAllOf.country) &&
        Objects.equals(this.digitalSignatureEnable, updateEInvoicingBusinessRegionRequestAllOf.digitalSignatureEnable) &&
        Objects.equals(this.digitalSignatureBoxEnable, updateEInvoicingBusinessRegionRequestAllOf.digitalSignatureBoxEnable) &&
        Objects.equals(this.digitalSignatureBoxPosX, updateEInvoicingBusinessRegionRequestAllOf.digitalSignatureBoxPosX) &&
        Objects.equals(this.digitalSignatureBoxPosY, updateEInvoicingBusinessRegionRequestAllOf.digitalSignatureBoxPosY) &&
        Objects.equals(this.email, updateEInvoicingBusinessRegionRequestAllOf.email) &&
        Objects.equals(this.endpointId, updateEInvoicingBusinessRegionRequestAllOf.endpointId) &&
        Objects.equals(this.endpointSchemeId, updateEInvoicingBusinessRegionRequestAllOf.endpointSchemeId) &&
        Objects.equals(this.phoneNumber, updateEInvoicingBusinessRegionRequestAllOf.phoneNumber) &&
        Objects.equals(this.postalCode, updateEInvoicingBusinessRegionRequestAllOf.postalCode) &&
        Objects.equals(this.serviceProviderId, updateEInvoicingBusinessRegionRequestAllOf.serviceProviderId) &&
        Objects.equals(this.state, updateEInvoicingBusinessRegionRequestAllOf.state) &&
        Objects.equals(this.taxRegisterNumber, updateEInvoicingBusinessRegionRequestAllOf.taxRegisterNumber) &&
        Objects.equals(this.tradeName, updateEInvoicingBusinessRegionRequestAllOf.tradeName)&&
        Objects.equals(this.additionalProperties, updateEInvoicingBusinessRegionRequestAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateEInvoicingBusinessRegionRequestAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateEInvoicingBusinessRegionRequestAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateEInvoicingBusinessRegionRequestAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateEInvoicingBusinessRegionRequestAllOf is not found in the empty JSON string", UpdateEInvoicingBusinessRegionRequestAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEInvoicingBusinessRegionRequestAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEInvoicingBusinessRegionRequestAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEInvoicingBusinessRegionRequestAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEInvoicingBusinessRegionRequestAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEInvoicingBusinessRegionRequestAllOf>() {
           @Override
           public void write(JsonWriter out, UpdateEInvoicingBusinessRegionRequestAllOf value) throws IOException {
           ...
           @Override
           public UpdateEInvoicingBusinessRegionRequestAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateEInvoicingBusinessRegionRequestAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateEInvoicingBusinessRegionRequestAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateEInvoicingBusinessRegionRequestAllOf
  * @throws IOException if the JSON string is invalid with respect to UpdateEInvoicingBusinessRegionRequestAllOf
  */
  public static UpdateEInvoicingBusinessRegionRequestAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateEInvoicingBusinessRegionRequestAllOf.class);
  }

 /**
  * Convert an instance of UpdateEInvoicingBusinessRegionRequestAllOf to an JSON string
  *
  * @return JSON string
  */
