...
public class POSTReconcileRefundRequest {
 ...
 public enum ActionEnum {
  ...
  public POSTReconcileRefundRequest() {
  }

  public POSTReconcileRefundRequest action(ActionEnum action) {
  ...
  **/
  ...
  @ApiModelProperty(example = "SETTLE", value = "The action of the refund reconciliation.   - `settle`: Sets Gateway State to \"Settled\" and returns the refund object as response.   - `reject`: Sets Gateway State to \"FailedToSettle\" and handle the event according to the settings configured in the Gateway Reconciliation Configuration in Payments Settings through Zuora UI. See [Configure how to handle refund rejected events](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/M_Payment_Gateways/Gateway_Reconciliation#Configure_how_to_handle_refund_rejected_events) for details. ")
  ...
  public POSTReconcileRefundRequest actionDate(String actionDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2020-10-25 11:11:11", value = "The date and time of the refund reconciliation action, in `yyyy-mm-dd hh:mm:ss` format. ")
  ...
  public POSTReconcileRefundRequest gatewayReconciliationReason(String gatewayReconciliationReason) {
  ...
  **/
  ...
  public POSTReconcileRefundRequest gatewayReconciliationStatus(String gatewayReconciliationStatus) {
  ...
  **/
  ...
  public POSTReconcileRefundRequest payoutId(String payoutId) {
  ...
  **/
   ...
   * @return the POSTReconcileRefundRequest instance itself
   */
  public POSTReconcileRefundRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTReconcileRefundRequest poSTReconcileRefundRequest = (POSTReconcileRefundRequest) o;
    return Objects.equals(this.action, poSTReconcileRefundRequest.action) &&
        Objects.equals(this.actionDate, poSTReconcileRefundRequest.actionDate) &&
        Objects.equals(this.gatewayReconciliationReason, poSTReconcileRefundRequest.gatewayReconciliationReason) &&
        Objects.equals(this.gatewayReconciliationStatus, poSTReconcileRefundRequest.gatewayReconciliationStatus) &&
        Objects.equals(this.payoutId, poSTReconcileRefundRequest.payoutId)&&
        Objects.equals(this.additionalProperties, poSTReconcileRefundRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, actionDate, gatewayReconciliationReason, gatewayReconciliationStatus, payoutId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class POSTReconcileRefundRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTReconcileRefundRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTReconcileRefundRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTReconcileRefundRequest is not found in the empty JSON string", POSTReconcileRefundRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTReconcileRefundRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTReconcileRefundRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTReconcileRefundRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTReconcileRefundRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTReconcileRefundRequest>() {
           @Override
           public void write(JsonWriter out, POSTReconcileRefundRequest value) throws IOException {
           ...
           @Override
           public POSTReconcileRefundRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTReconcileRefundRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTReconcileRefundRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTReconcileRefundRequest
  * @throws IOException if the JSON string is invalid with respect to POSTReconcileRefundRequest
  */
  public static POSTReconcileRefundRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTReconcileRefundRequest.class);
  }

 /**
  * Convert an instance of POSTReconcileRefundRequest to an JSON string
  *
  * @return JSON string
  */
