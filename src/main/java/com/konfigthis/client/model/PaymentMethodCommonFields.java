...
public class PaymentMethodCommonFields {
 ...
 public enum TypeEnum {
  ...
  public PaymentMethodCommonFields() {
  }

  public PaymentMethodCommonFields accountKey(String accountKey) {
  ...
  **/
  ...
  public PaymentMethodCommonFields authGateway(String authGateway) {
  ...
  **/
  ...
  public PaymentMethodCommonFields currencyCode(String currencyCode) {
  ...
  **/
  ...
  public PaymentMethodCommonFields gatewayOptions(PaymentMethodCommonFieldsGatewayOptions gatewayOptions) {
  ...
  **/
  ...
  public PaymentMethodCommonFields ipAddress(String ipAddress) {
  ...
  **/
  ...
  public PaymentMethodCommonFields makeDefault(Boolean makeDefault) {
  ...
  **/
  ...
  public PaymentMethodCommonFields skipValidation(Boolean skipValidation) {
  ...
  **/
  ...
  public PaymentMethodCommonFields type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Type of the payment method. The following types of the payment methods are supported:    * `CreditCard`    * `CreditCardReferenceTransaction`    * `ACH`    * `SEPA`    * `Betalingsservice`    * `Autogiro`    * `Bacs`    * `Becs`    * `Becsnz`    * `PAD`    * `PayPalCP`    * `PayPalEC`    * `PayPalNativeEC`    * `PayPalAdaptive`    * `AdyenApplePay`    * `AdyenGooglePay`    * `GooglePay`   To view the schema and example applicable to a specific payment method type, select the corresponding option from the following list. ")
   ...
   * @return the PaymentMethodCommonFields instance itself
   */
  public PaymentMethodCommonFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentMethodCommonFields paymentMethodCommonFields = (PaymentMethodCommonFields) o;
    return Objects.equals(this.accountKey, paymentMethodCommonFields.accountKey) &&
        Objects.equals(this.authGateway, paymentMethodCommonFields.authGateway) &&
        Objects.equals(this.currencyCode, paymentMethodCommonFields.currencyCode) &&
        Objects.equals(this.gatewayOptions, paymentMethodCommonFields.gatewayOptions) &&
        Objects.equals(this.ipAddress, paymentMethodCommonFields.ipAddress) &&
        Objects.equals(this.makeDefault, paymentMethodCommonFields.makeDefault) &&
        Objects.equals(this.skipValidation, paymentMethodCommonFields.skipValidation) &&
        Objects.equals(this.type, paymentMethodCommonFields.type)&&
        Objects.equals(this.additionalProperties, paymentMethodCommonFields.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountKey, authGateway, currencyCode, gatewayOptions, ipAddress, makeDefault, skipValidation, type, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentMethodCommonFields {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentMethodCommonFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentMethodCommonFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentMethodCommonFields is not found in the empty JSON string", PaymentMethodCommonFields.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentMethodCommonFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentMethodCommonFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentMethodCommonFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentMethodCommonFields.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentMethodCommonFields>() {
           @Override
           public void write(JsonWriter out, PaymentMethodCommonFields value) throws IOException {
           ...
           @Override
           public PaymentMethodCommonFields read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentMethodCommonFields instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentMethodCommonFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentMethodCommonFields
  * @throws IOException if the JSON string is invalid with respect to PaymentMethodCommonFields
  */
  public static PaymentMethodCommonFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentMethodCommonFields.class);
  }

 /**
  * Convert an instance of PaymentMethodCommonFields to an JSON string
  *
  * @return JSON string
  */
