...
import com.konfigthis.client.model.POSTAuthorizeResponsePaymentGatewayResponse;
import com.konfigthis.client.model.POSTAuthorizeResponseReasonsInner;
...
public class POSTAuthorizeResponse {
  ...
  private POSTAuthorizeResponsePaymentGatewayResponse paymentGatewayResponse;
  ...
  private List<POSTAuthorizeResponseReasonsInner> reasons = null;
  ...
  public POSTAuthorizeResponse gatewayOrderId(String gatewayOrderId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "A001", value = "The order ID for the specific gateway.  The specified order ID will be used in transaction authorization. If you specify an empty value for this field, Zuora will generate an ID and you will have to associate this ID with your order ID by yourself if needed. It is recommended to specify an ID for this field. ")
  ...
  public POSTAuthorizeResponse paymentGatewayResponse(POSTAuthorizeResponsePaymentGatewayResponse paymentGatewayResponse) {
  ...
  **/
  ...
  public POSTAuthorizeResponsePaymentGatewayResponse getPaymentGatewayResponse() {
    return paymentGatewayResponse;
  }


  public void setPaymentGatewayResponse(POSTAuthorizeResponsePaymentGatewayResponse paymentGatewayResponse) {
  ...
  public POSTAuthorizeResponse processId(String processId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the running process when the exception occurs. This field is available only if the `success` field is `false`. ")
  ...
  public POSTAuthorizeResponse reasons(List<POSTAuthorizeResponseReasonsInner> reasons) {
  ...
  public POSTAuthorizeResponse addReasonsItem(POSTAuthorizeResponseReasonsInner reasonsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The container of the error code and message. This field is available only if the `success` field is `false`. ")

  public List<POSTAuthorizeResponseReasonsInner> getReasons() {
    return reasons;
  }


  public void setReasons(List<POSTAuthorizeResponseReasonsInner> reasons) {
  ...
  public POSTAuthorizeResponse requestId(String requestId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the request. This field is available only if the `success` field is `false` ")
  ...
  public POSTAuthorizeResponse resultCode(String resultCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "The result code of the request.   0 indicates that the request succeeded, and the following values indicate that the request failed:   - 1: The request is declined.   - 7: The field format is not correct.   - 10: Client connection has timed out.   - 11: Host connection has timed out.   - 12: Processor connection has timed out.   - 13: Gateway server is busy.   - 20: The card type is not supported.   - 21: The merchant account information is invalid.   - 22: A generic error occurred on the processor.   - 40: The card type has not been set up yet.   - 41: The limit for a single transaction is exceeded.   - 42: Address checking failed.   - 43: Card security code checking failed.   - 44: Failed due to the gateway security setting.   - 45: Fraud protection is declined.   - 46: Address checking or card security code checking failed (for Authorize.net gateway only).   - 47: The maximum amount is exceeded (for Authorize.net gateway only).   - 48: The IP address is blocked by the gateway (for Authorize.net gateway only).   - 49: Card security code checking failed (for Authorize.net gateway only).   - 60: User authentication failed.   - 61: The currency code is invalid.   - 62: The transaction ID is invalid.   - 63: The credit card number is invalid.   - 64: The card expiration date is invalid.   - 65: The transaction is duplicated.   - 66: Credit transaction error.   - 67: Void transaction error.   - 90: A valid amount is required.   - 91: The BA code is invalid.   - 92: The account number is invalid.   - 93: The ACH transaction is not accepted by the merchant.   - 94: An error occurred for the ACH transaction.   - 95: The version parameter is invalid.   - 96: The transaction type is invalid.   - 97: The transaction method is invalid.   - 98: The bank account type is invalid.   - 99: The authorization code is invalid.   - 200: General transaction error.   - 500: The transaction is queued for submission.   - 999: Unknown error.   - -1: An error occurred in gateway communication.   - -2: Idempotency is not supported.   - -3: Inquiry call is not supported. ")
  ...
  public POSTAuthorizeResponse resultMessage(String resultMessage) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Request ID: 5231719060426316203012", value = "The corresponding request ID.")
  ...
  public POSTAuthorizeResponse success(Boolean success) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Indicates whether the call succeeded.")
  ...
  public POSTAuthorizeResponse transactionId(String transactionId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5231719060426316203012", value = "The ID of the transaction.")
   ...
   * @return the POSTAuthorizeResponse instance itself
   */
  public POSTAuthorizeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTAuthorizeResponse poSTAuthorizeResponse = (POSTAuthorizeResponse) o;
    return Objects.equals(this.gatewayOrderId, poSTAuthorizeResponse.gatewayOrderId) &&
        Objects.equals(this.paymentGatewayResponse, poSTAuthorizeResponse.paymentGatewayResponse) &&
        Objects.equals(this.processId, poSTAuthorizeResponse.processId) &&
        Objects.equals(this.reasons, poSTAuthorizeResponse.reasons) &&
        Objects.equals(this.requestId, poSTAuthorizeResponse.requestId) &&
        Objects.equals(this.resultCode, poSTAuthorizeResponse.resultCode) &&
        Objects.equals(this.resultMessage, poSTAuthorizeResponse.resultMessage) &&
        Objects.equals(this.success, poSTAuthorizeResponse.success) &&
        Objects.equals(this.transactionId, poSTAuthorizeResponse.transactionId)&&
        Objects.equals(this.additionalProperties, poSTAuthorizeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class POSTAuthorizeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTAuthorizeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTAuthorizeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTAuthorizeResponse is not found in the empty JSON string", POSTAuthorizeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("paymentGatewayResponse") != null && !jsonObj.get("paymentGatewayResponse").isJsonNull()) {
        POSTAuthorizeResponsePaymentGatewayResponse.validateJsonObject(jsonObj.getAsJsonObject("paymentGatewayResponse"));
      }
      ...
      if (jsonObj.get("reasons") != null && !jsonObj.get("reasons").isJsonNull()) {
        ...
        if (jsonArrayreasons != null) {
          ...
          for (int i = 0; i < jsonArrayreasons.size(); i++) {
            POSTAuthorizeResponseReasonsInner.validateJsonObject(jsonArrayreasons.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTAuthorizeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTAuthorizeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTAuthorizeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTAuthorizeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTAuthorizeResponse>() {
           @Override
           public void write(JsonWriter out, POSTAuthorizeResponse value) throws IOException {
           ...
           @Override
           public POSTAuthorizeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTAuthorizeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTAuthorizeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTAuthorizeResponse
  * @throws IOException if the JSON string is invalid with respect to POSTAuthorizeResponse
  */
  public static POSTAuthorizeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTAuthorizeResponse.class);
  }

 /**
  * Convert an instance of POSTAuthorizeResponse to an JSON string
  *
  * @return JSON string
  */
