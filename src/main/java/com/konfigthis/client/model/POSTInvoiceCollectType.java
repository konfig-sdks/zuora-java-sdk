...
public class POSTInvoiceCollectType {
  ...
  **/
  ...
  @ApiModelProperty(example = "4028925a4cb74ec9014cb7520fc00005", required = true, value = "Customer account ID or account number. ")
  ...
  public POSTInvoiceCollectType documentDate(LocalDate documentDate) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The date that should appear on the invoice and credit memo being generated, in `yyyy-mm-dd` format. If this field is omitted and `invoiceId` is not specified, the current date is used by default.    **Note:** The credit memo is only available if you have the Invoice Settlement feature enabled.   This field is in Zuora REST API version control. Supported minor versions are `215.0` and later [available versions](https://developer.zuora.com/api-references/api/overview/#section/API-Versions/Minor-Version). To use this field in the method, you must set the  `zuora-version` parameter to the minor version number in the request header. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4028925a4cb74ec9014cb7540988002e", value = "The ID of an existing invoice for which to collect payment using the account's default payment method. If this value is specified, no new invoice is generated, and the following fields are ignored:   - `invoiceDate` and `invoiceTargetDate` (if the Zuora REST API version is 214.0 or earlier)   - `documentDate` and `targetDate` (if the Zuora REST API version is 215.0 or later [available versions](https://developer.zuora.com/api-references/api/overview/#section/API-Versions/Minor-Version)) ")
  ...
  public POSTInvoiceCollectType invoiceNumber(String invoiceNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of an existing invoice for which to collect payment using the account's default payment method. If this value is specified, no new invoice is generated, and the following fields are ignored:   - `invoiceDate` and `invoiceTargetDate` (if the Zuora REST API version is 214.0 or earlier)   - `documentDate` and `targetDate` (if the Zuora REST API version is 215.0 or later [available versions](https://developer.zuora.com/api-references/api/overview/#section/API-Versions/Minor-Version)) ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "TestGateway", value = "The name of the gateway that will be used for the payment. Must be a valid gateway name and the gateway must support the specific payment method. If a value is not specified, the default gateway on the Account will be used. ")
  ...
  public POSTInvoiceCollectType targetDate(LocalDate targetDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date through which to calculate charges on this account if an invoice or a credit memo is generated,  in `yyyy-mm-dd` format. If this field is omitted and `invoiceId` is not specified, the current date is used by default.    **Note:** The credit memo is only available if you have the Invoice Settlement feature enabled.   This field is in Zuora REST API version control. Supported minor versions are `215.0` and later [available versions](https://developer.zuora.com/api-references/api/overview/#section/API-Versions/Minor-Version). To use this field in the method, you must set the  `zuora-version` parameter to the minor version number in the request header. ")
   ...
   * @return the POSTInvoiceCollectType instance itself
   */
  public POSTInvoiceCollectType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountKey, poSTInvoiceCollectType.accountKey) &&
        Objects.equals(this.documentDate, poSTInvoiceCollectType.documentDate) &&
        ...
        Objects.equals(this.invoiceNumber, poSTInvoiceCollectType.invoiceNumber) &&
        ...
        Objects.equals(this.targetDate, poSTInvoiceCollectType.targetDate)&&
        Objects.equals(this.additionalProperties, poSTInvoiceCollectType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountKey, documentDate, invoiceDate, invoiceId, invoiceNumber, invoiceTargetDate, paymentGateway, targetDate, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTInvoiceCollectType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTInvoiceCollectType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTInvoiceCollectType is not found in the empty JSON string", POSTInvoiceCollectType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : POSTInvoiceCollectType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTInvoiceCollectType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTInvoiceCollectType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTInvoiceCollectType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTInvoiceCollectType.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTInvoiceCollectType>() {
           @Override
           public void write(JsonWriter out, POSTInvoiceCollectType value) throws IOException {
           ...
           @Override
           public POSTInvoiceCollectType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTInvoiceCollectType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTInvoiceCollectType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTInvoiceCollectType
  * @throws IOException if the JSON string is invalid with respect to POSTInvoiceCollectType
  */
  public static POSTInvoiceCollectType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTInvoiceCollectType.class);
  }

 /**
  * Convert an instance of POSTInvoiceCollectType to an JSON string
  *
  * @return JSON string
  */
