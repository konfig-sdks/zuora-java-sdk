...
public class ProxyCreateProduct {
  ...
  **/
  ...
  public ProxyCreateProduct productNumber(String productNumber) {
  ...
  **/
  ...
  public ProxyCreateProduct integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public ProxyCreateProduct integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public ProxyCreateProduct itemTypeNS(ItemTypeNSEnum itemTypeNS) {
  ...
  **/
  ...
  public ProxyCreateProduct syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the ProxyCreateProduct instance itself
   */
  public ProxyCreateProduct putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowFeatureChanges, proxyCreateProduct.allowFeatureChanges) &&
        ...
        Objects.equals(this.productNumber, proxyCreateProduct.productNumber) &&
        Objects.equals(this.SKU, proxyCreateProduct.SKU) &&
        Objects.equals(this.integrationIdNS, proxyCreateProduct.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, proxyCreateProduct.integrationStatusNS) &&
        Objects.equals(this.itemTypeNS, proxyCreateProduct.itemTypeNS) &&
        Objects.equals(this.syncDateNS, proxyCreateProduct.syncDateNS)&&
        Objects.equals(this.additionalProperties, proxyCreateProduct.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowFeatureChanges, category, description, effectiveEndDate, effectiveStartDate, name, productNumber, SKU, integrationIdNS, integrationStatusNS, itemTypeNS, syncDateNS, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProxyCreateProduct
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProxyCreateProduct.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProxyCreateProduct is not found in the empty JSON string", ProxyCreateProduct.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProxyCreateProduct.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProxyCreateProduct.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProxyCreateProduct' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProxyCreateProduct> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProxyCreateProduct.class));

       return (TypeAdapter<T>) new TypeAdapter<ProxyCreateProduct>() {
           @Override
           public void write(JsonWriter out, ProxyCreateProduct value) throws IOException {
           ...
           @Override
           public ProxyCreateProduct read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProxyCreateProduct instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProxyCreateProduct given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProxyCreateProduct
  * @throws IOException if the JSON string is invalid with respect to ProxyCreateProduct
  */
  public static ProxyCreateProduct fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProxyCreateProduct.class);
  }

 /**
  * Convert an instance of ProxyCreateProduct to an JSON string
  *
  * @return JSON string
  */
