...
public class PostBillingPreviewParam {
  ...
  public PostBillingPreviewParam() {
  }

  public PostBillingPreviewParam accountId(String accountId) {
   ...
   /**
   * The ID of the customer account to which the billing preview applies.  **Note**: When posting billing preview, you must specify either &#x60;accountId&#x60; or &#x60;accountNumber&#x60; in the request body. 
   * @return accountId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the customer account to which the billing preview applies.  **Note**: When posting billing preview, you must specify either `accountId` or `accountNumber` in the request body. ")
  ...
  public PostBillingPreviewParam accountNumber(String accountNumber) {
   ...
   /**
   * The number of the customer account to which the billing preview applies.  **Note**: When posting billing preview, you must specify either &#x60;accountId&#x60; or &#x60;accountNumber&#x60; in the request body. 
   * @return accountNumber
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "A00000001", value = "The number of the customer account to which the billing preview applies.  **Note**: When posting billing preview, you must specify either `accountId` or `accountNumber` in the request body. ")
  ...
  public PostBillingPreviewParam assumeRenewal(String assumeRenewal) {
  ...
  **/
  ...
  public PostBillingPreviewParam chargeTypeToExclude(String chargeTypeToExclude) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "", value = "The charge types to exclude from the billing preview.  **Possible values:** OneTime, Recurring, Usage, and any combination of these values. ")
  ...
  public PostBillingPreviewParam includingDraftItems(Boolean includingDraftItems) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether draft document items are included in the billing preview run. By default, draft document items are not included.  This field loads draft invoice items and credit memo items. The `chargeTypeToExclude`, `targetDate`, `includingEvergreenSubscription`, and `assumeRenewal` fields do not affect the behavior of the `includingDraftItems` field.           ")
  ...
  public PostBillingPreviewParam includingEvergreenSubscription(Boolean includingEvergreenSubscription) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Indicates if evergreen subscriptions are included in the billingPreview call. ")
  ...
  public PostBillingPreviewParam targetDate(LocalDate targetDate) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Tue May 09 17:00:00 PDT 2017", required = true, value = "The target date for the billingPreview call. The billingPreview call generates preview invoice item data and credit memo item data from the first day of the customer's next billing period to the TargetDate.   If the TargetDate is later than the subscription current term end date, the preview invoice item data and credit memo item data is generated from the first day of the customer's next billing period to the current term end date. If you want to generate preview invoice item data and credit memo item data past the end of the subscription current term, specify the `AssumeRenewal` field in the request.   **Note:** The credit memo item data is only available if you have Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. ")
   ...
   * @return the PostBillingPreviewParam instance itself
   */
  public PostBillingPreviewParam putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PostBillingPreviewParam postBillingPreviewParam = (PostBillingPreviewParam) o;
    return Objects.equals(this.accountId, postBillingPreviewParam.accountId) &&
        Objects.equals(this.accountNumber, postBillingPreviewParam.accountNumber) &&
        Objects.equals(this.assumeRenewal, postBillingPreviewParam.assumeRenewal) &&
        Objects.equals(this.chargeTypeToExclude, postBillingPreviewParam.chargeTypeToExclude) &&
        Objects.equals(this.includingDraftItems, postBillingPreviewParam.includingDraftItems) &&
        Objects.equals(this.includingEvergreenSubscription, postBillingPreviewParam.includingEvergreenSubscription) &&
        Objects.equals(this.targetDate, postBillingPreviewParam.targetDate)&&
        Objects.equals(this.additionalProperties, postBillingPreviewParam.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, accountNumber, assumeRenewal, chargeTypeToExclude, includingDraftItems, includingEvergreenSubscription, targetDate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostBillingPreviewParam {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PostBillingPreviewParam
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PostBillingPreviewParam.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostBillingPreviewParam is not found in the empty JSON string", PostBillingPreviewParam.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostBillingPreviewParam.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostBillingPreviewParam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostBillingPreviewParam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostBillingPreviewParam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostBillingPreviewParam.class));

       return (TypeAdapter<T>) new TypeAdapter<PostBillingPreviewParam>() {
           @Override
           public void write(JsonWriter out, PostBillingPreviewParam value) throws IOException {
           ...
           @Override
           public PostBillingPreviewParam read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PostBillingPreviewParam instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PostBillingPreviewParam given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PostBillingPreviewParam
  * @throws IOException if the JSON string is invalid with respect to PostBillingPreviewParam
  */
  public static PostBillingPreviewParam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostBillingPreviewParam.class);
  }

 /**
  * Convert an instance of PostBillingPreviewParam to an JSON string
  *
  * @return JSON string
  */
