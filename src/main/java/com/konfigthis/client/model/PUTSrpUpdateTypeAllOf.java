...
import com.konfigthis.client.model.PUTScUpdateType;
...
public class PUTSrpUpdateTypeAllOf {
  ...
  private List<PUTScUpdateType> chargeUpdateDetails = null;
  ...
  public PUTSrpUpdateTypeAllOf() {
  }

  public PUTSrpUpdateTypeAllOf bookingDate(LocalDate bookingDate) {
  ...
  **/
  ...
  public PUTSrpUpdateTypeAllOf chargeUpdateDetails(List<PUTScUpdateType> chargeUpdateDetails) {
  ...
  public PUTSrpUpdateTypeAllOf addChargeUpdateDetailsItem(PUTScUpdateType chargeUpdateDetailsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for one or more product rate plan charges.  ")
  ...
  public PUTSrpUpdateTypeAllOf contractEffectiveDate(LocalDate contractEffectiveDate) {
  ...
  **/
  ...
  public PUTSrpUpdateTypeAllOf customerAcceptanceDate(LocalDate customerAcceptanceDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the customer accepts the contract in yyyy-mm-dd format.  If this field is not set:  * If the `serviceActivationDate` field is not set, the value of this field is set to be the contract effective date. * If the `serviceActivationDate` field is set, the value of this field is set to be the service activation date.  The billing trigger dates must follow this rule:  contractEffectiveDate <= serviceActivationDate <= contractAcceptanceDate ")
  ...
  public PUTSrpUpdateTypeAllOf externalCatalogPlanId(String externalCatalogPlanId) {
  ...
  **/
  ...
  public PUTSrpUpdateTypeAllOf externalIdSourceSystem(String externalIdSourceSystem) {
  ...
  **/
  ...
  public PUTSrpUpdateTypeAllOf externallyManagedPlanId(String externallyManagedPlanId) {
  ...
  **/
  ...
  public PUTSrpUpdateTypeAllOf productRatePlanNumber(String productRatePlanNumber) {
  ...
  **/
  ...
  public PUTSrpUpdateTypeAllOf ratePlanId(String ratePlanId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of a rate plan for this subscription. This can be the latest version or any history version of ID. ")
  ...
  public PUTSrpUpdateTypeAllOf serviceActivationDate(LocalDate serviceActivationDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the update amendment is activated in yyyy-mm-dd format.  You must specify a Service Activation date if the Customer Acceptance date is set. If the Customer Acceptance date is not set, the value of the `serviceActivationDate` field defaults to be the Contract Effective Date.  The billing trigger dates must follow this rule:  contractEffectiveDate <= serviceActivationDate <= contractAcceptanceDate ")
  ...
  public PUTSrpUpdateTypeAllOf specificUpdateDate(LocalDate specificUpdateDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the Update Product amendment takes effect. This field is only applicable if there is already a future-dated Update Product amendment on the subscription. The format of the date is yyyy-mm-dd.  Required only for Update Product amendments if there is already a future-dated Update Product amendment on the subscription. ")
  ...
  public PUTSrpUpdateTypeAllOf subscriptionRatePlanNumber(String subscriptionRatePlanNumber) {
  ...
  **/
   ...
   * @return the PUTSrpUpdateTypeAllOf instance itself
   */
  public PUTSrpUpdateTypeAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PUTSrpUpdateTypeAllOf puTSrpUpdateTypeAllOf = (PUTSrpUpdateTypeAllOf) o;
    return Objects.equals(this.bookingDate, puTSrpUpdateTypeAllOf.bookingDate) &&
        Objects.equals(this.chargeUpdateDetails, puTSrpUpdateTypeAllOf.chargeUpdateDetails) &&
        Objects.equals(this.contractEffectiveDate, puTSrpUpdateTypeAllOf.contractEffectiveDate) &&
        Objects.equals(this.customerAcceptanceDate, puTSrpUpdateTypeAllOf.customerAcceptanceDate) &&
        Objects.equals(this.externalCatalogPlanId, puTSrpUpdateTypeAllOf.externalCatalogPlanId) &&
        Objects.equals(this.externalIdSourceSystem, puTSrpUpdateTypeAllOf.externalIdSourceSystem) &&
        Objects.equals(this.externallyManagedPlanId, puTSrpUpdateTypeAllOf.externallyManagedPlanId) &&
        Objects.equals(this.productRatePlanNumber, puTSrpUpdateTypeAllOf.productRatePlanNumber) &&
        Objects.equals(this.ratePlanId, puTSrpUpdateTypeAllOf.ratePlanId) &&
        Objects.equals(this.serviceActivationDate, puTSrpUpdateTypeAllOf.serviceActivationDate) &&
        Objects.equals(this.specificUpdateDate, puTSrpUpdateTypeAllOf.specificUpdateDate) &&
        Objects.equals(this.subscriptionRatePlanNumber, puTSrpUpdateTypeAllOf.subscriptionRatePlanNumber)&&
        Objects.equals(this.additionalProperties, puTSrpUpdateTypeAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PUTSrpUpdateTypeAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTSrpUpdateTypeAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTSrpUpdateTypeAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTSrpUpdateTypeAllOf is not found in the empty JSON string", PUTSrpUpdateTypeAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PUTSrpUpdateTypeAllOf.openapiRequiredFields) {
      ...
      if (jsonObj.get("chargeUpdateDetails") != null && !jsonObj.get("chargeUpdateDetails").isJsonNull()) {
        ...
        if (jsonArraychargeUpdateDetails != null) {
          ...
          for (int i = 0; i < jsonArraychargeUpdateDetails.size(); i++) {
            PUTScUpdateType.validateJsonObject(jsonArraychargeUpdateDetails.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTSrpUpdateTypeAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTSrpUpdateTypeAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTSrpUpdateTypeAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTSrpUpdateTypeAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTSrpUpdateTypeAllOf>() {
           @Override
           public void write(JsonWriter out, PUTSrpUpdateTypeAllOf value) throws IOException {
           ...
           @Override
           public PUTSrpUpdateTypeAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTSrpUpdateTypeAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTSrpUpdateTypeAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTSrpUpdateTypeAllOf
  * @throws IOException if the JSON string is invalid with respect to PUTSrpUpdateTypeAllOf
  */
  public static PUTSrpUpdateTypeAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTSrpUpdateTypeAllOf.class);
  }

 /**
  * Convert an instance of PUTSrpUpdateTypeAllOf to an JSON string
  *
  * @return JSON string
  */
