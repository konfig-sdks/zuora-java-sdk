 ...
 */
@ApiModel(description = "Container for optional sold-to contact; uses the same field structure as the bill-to contact (above). If a sold-to contact is not specified, one is created from the bill-to contact. Once created, these are two separate data entities, and future changes to one do not affect the other. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class POSTAccountTypeSoldToContact {
  ...
  public POSTAccountTypeSoldToContact() {
  }
  ...
  **/
   ...
   * @return the POSTAccountTypeSoldToContact instance itself
   */
  public POSTAccountTypeSoldToContact putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address1, poSTAccountTypeSoldToContact.address1) &&
        ...
        Objects.equals(this.additionalProperties, poSTAccountTypeSoldToContact.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTAccountTypeSoldToContact
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTAccountTypeSoldToContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTAccountTypeSoldToContact is not found in the empty JSON string", POSTAccountTypeSoldToContact.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : POSTAccountTypeSoldToContact.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTAccountTypeSoldToContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTAccountTypeSoldToContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTAccountTypeSoldToContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTAccountTypeSoldToContact.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTAccountTypeSoldToContact>() {
           @Override
           public void write(JsonWriter out, POSTAccountTypeSoldToContact value) throws IOException {
           ...
           @Override
           public POSTAccountTypeSoldToContact read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTAccountTypeSoldToContact instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTAccountTypeSoldToContact given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTAccountTypeSoldToContact
  * @throws IOException if the JSON string is invalid with respect to POSTAccountTypeSoldToContact
  */
  public static POSTAccountTypeSoldToContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTAccountTypeSoldToContact.class);
  }

 /**
  * Convert an instance of POSTAccountTypeSoldToContact to an JSON string
  *
  * @return JSON string
  */
