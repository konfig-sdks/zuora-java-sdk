...
public class PreviewOptions {
   ...
   */
  @JsonAdapter(PreviewThruTypeEnum.Adapter.class)
 public enum PreviewThruTypeEnum {
    ...
    PreviewThruTypeEnum(String value) {
      this.value = value;
    }
    ...
    public static PreviewThruTypeEnum fromValue(String value) {
      for (PreviewThruTypeEnum b : PreviewThruTypeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<PreviewThruTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PreviewThruTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public PreviewThruTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return PreviewThruTypeEnum.fromValue(value);
      }
    }
  }
  ...
  private PreviewThruTypeEnum previewThruType;
 ...
 public enum PreviewTypesEnum {
    ...
    public static class Adapter extends TypeAdapter<PreviewTypesEnum> {
      @Override
  ...
  private List<PreviewTypesEnum> previewTypes = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "The number of periods to preview when the value of the `previewThroughType` field is set to `NumberOfPeriods`. ")
  ...
  public PreviewOptions previewThruType(PreviewThruTypeEnum previewThruType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SPECIFICDATE", value = "The options on how the preview through date is calculated. Available for preview only.  - If you set this field to `SpecificDate`, you must specify a specific date in the `specificPreviewThruDate` field. If you also set `billTargetDate` in the `orderLineItems` field, order line items whose `billTargetDate` is no later than `specificPreviewThruDate` are returned.  - If you set this field to `NumberOfPeriods`, you must use the `previewNumberOfPeriods` field to specify how many periods you want to preview. In case the order only contains an order line item but not contains a subscription, if you also set `billTargetDate` in the `orderLineItems` field, order line items whose `billTargetDate` is no later than today are returned.  - The `TermEnd` option is invalid when any subscription included in this order is evergreen. In case the order only contains an order line item but not contains a subscription, if you set this field to `TermEnd` and set `billTargetDate` in the `orderLineItems` field, order line items whose `billTargetDate` is no later than today are returned. ")

  public PreviewThruTypeEnum getPreviewThruType() {
    return previewThruType;
  }


  public void setPreviewThruType(PreviewThruTypeEnum previewThruType) {
  ...
  public PreviewOptions previewTypes(List<PreviewTypesEnum> previewTypes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "One or more types of the preview. It can include:  * ChargeMetrics: charge level metrics will be returned in the response, including: `cmrr`, `tcv`, `tcb`, and `tax`. * BillingDocs: `invoices` and `creditMemos` will be returned in the response. Note `creditMemos` is only available if the Invoice Settlement feature is enabled. * OrderDeltaMetrics: order delta metrics will be returned in the response, including: `orderDeltaMrr`, `orderDeltaTcb` and  `orderDeltaTcv`. * OrderMetrics: order metrics will be returned in the response, including: `quantity`, `mrr`, `tcb`, `tcv`, and `elp`. **Note:** As of Zuora Billing Release 306, Zuora has upgraded the methodologies for calculating metrics in [Orders](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders). The new methodologies are reflected in the OrderDeltaMetrics. It is recommended that all customers use the [Order Delta Metrics](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Delta_Metrics/AA_Overview_of_Order_Delta_Metrics). If you are an existing [Order Metrics](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/AA_Overview_of_Orders/Key_Metrics_for_Orders) customer and want to migrate to Order Delta Metrics, submit a request at [Zuora Global Support](https://support.zuora.com/). Whereas new customers, and existing customers not currently on [Order Metrics](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/AA_Overview_of_Orders/Key_Metrics_for_Orders), will no longer have access to Order Metrics, existing customers currently using Order Metrics will continue to be supported. * RampMetrics: ramp metrics will be returned in the response, including: `quantity`, `mrr`, `tcb`, `tcv` metrics for each charge and each ramp interval. * RampDeltaMetrics: ramp metrics changes will be returned in the response, including: `deltaQuantity`, `deltaMrr`, `deltaTcb`, `deltaTcv` metrics for each charge and each ramp interval. ")

  public List<PreviewTypesEnum> getPreviewTypes() {
    return previewTypes;
  }


  public void setPreviewTypes(List<PreviewTypesEnum> previewTypes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Mon Dec 31 16:00:00 PST 2018", value = "The end date of the order preview. You can preview the invoice charges through the preview through date. (Invoice preview only)   **Note:** This field is only applicable if the 'previewThruType' field is set to 'SpecificDate'. ")
  ...
  * @throws IOException if the JSON Object is invalid with respect to PreviewOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PreviewOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("previewTypes") != null && !jsonObj.get("previewTypes").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<PreviewOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PreviewOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<PreviewOptions>() {
           @Override
