...
public class POSTPaymentScheduleResponseAllOf {
  ...
  /**
   * The status of the payment schedule.  - &#x60;Active&#x60;: There are still pament schedule items to process. - &#x60;Canceled&#x60;: After a payment schedule is canceled by the user, the schedule is marked as &#x60;Canceled&#x60;. - &#x60;Completed&#x60;: After all payment schedule items are processed, the schedule is marked as &#x60;Completed&#x60;. 
   */
 ...
 public enum StatusEnum {
  ...
  public POSTPaymentScheduleResponseAllOf() {
  }

  public POSTPaymentScheduleResponseAllOf description(String description) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf accountId(String accountId) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf accountNumber(String accountNumber) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf billingDocument(PaymentScheduleItemCommonResponseAllOfBillingDocument billingDocument) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf createdById(String createdById) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of the user who created this payment schedule. ")
  ...
  public POSTPaymentScheduleResponseAllOf createdDate(LocalDate createdDate) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf id(String id) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf isCustom(Boolean isCustom) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf items(List<PaymentScheduleItemCommonResponse> items) {
  ...
  public POSTPaymentScheduleResponseAllOf addItemsItem(PaymentScheduleItemCommonResponse itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf nextPaymentDate(LocalDate nextPaymentDate) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf occurrences(Integer occurrences) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf paymentOption(List<PaymentSchedulePaymentOptionFields> paymentOption) {
  ...
  public POSTPaymentScheduleResponseAllOf addPaymentOptionItem(PaymentSchedulePaymentOptionFields paymentOptionItem) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf paymentScheduleNumber(String paymentScheduleNumber) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf period(String period) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf prepayment(Boolean prepayment) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf recentPaymentDate(LocalDate recentPaymentDate) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf runHour(Integer runHour) {
   ...
   /**
   * [0,1,2,~,22,23]  At which hour in the day in the tenant’s timezone this payment will be collected. If the payment &#x60;runHour&#x60; and &#x60;scheduledDate&#x60; are backdated, the system will collect the payment when the next runHour occurs. Return &#x60;0&#x60; for custom payment schedules. 
   * @return runHour
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "[0,1,2,~,22,23]  At which hour in the day in the tenant’s timezone this payment will be collected. If the payment `runHour` and `scheduledDate` are backdated, the system will collect the payment when the next runHour occurs. Return `0` for custom payment schedules. ")
  ...
  public POSTPaymentScheduleResponseAllOf standalone(Boolean standalone) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates if the payments that the payment schedule created are standalone payments or not. ")
  ...
  public POSTPaymentScheduleResponseAllOf startDate(LocalDate startDate) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf status(StatusEnum status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the payment schedule.  - `Active`: There are still pament schedule items to process. - `Canceled`: After a payment schedule is canceled by the user, the schedule is marked as `Canceled`. - `Completed`: After all payment schedule items are processed, the schedule is marked as `Completed`. ")
  ...
  public POSTPaymentScheduleResponseAllOf success(Boolean success) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf totalAmount(Double totalAmount) {
  ...
  public POSTPaymentScheduleResponseAllOf totalAmount(Integer totalAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The total amount that will be collected by this payment schedule. This field will contain a null value if the `standalone` value is `true`. ")
  ...
  public POSTPaymentScheduleResponseAllOf totalPaymentsErrored(Integer totalPaymentsErrored) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf totalPaymentsProcessed(Integer totalPaymentsProcessed) {
  ...
  **/
  ...
  public POSTPaymentScheduleResponseAllOf updatedById(String updatedById) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of the user who last updated this payment schedule. ")
  ...
  public POSTPaymentScheduleResponseAllOf updatedDate(LocalDate updatedDate) {
  ...
  **/
   ...
   * @return the POSTPaymentScheduleResponseAllOf instance itself
   */
  public POSTPaymentScheduleResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTPaymentScheduleResponseAllOf poSTPaymentScheduleResponseAllOf = (POSTPaymentScheduleResponseAllOf) o;
    return Objects.equals(this.description, poSTPaymentScheduleResponseAllOf.description) &&
        Objects.equals(this.accountId, poSTPaymentScheduleResponseAllOf.accountId) &&
        Objects.equals(this.accountNumber, poSTPaymentScheduleResponseAllOf.accountNumber) &&
        Objects.equals(this.billingDocument, poSTPaymentScheduleResponseAllOf.billingDocument) &&
        Objects.equals(this.createdById, poSTPaymentScheduleResponseAllOf.createdById) &&
        Objects.equals(this.createdDate, poSTPaymentScheduleResponseAllOf.createdDate) &&
        Objects.equals(this.id, poSTPaymentScheduleResponseAllOf.id) &&
        Objects.equals(this.isCustom, poSTPaymentScheduleResponseAllOf.isCustom) &&
        Objects.equals(this.items, poSTPaymentScheduleResponseAllOf.items) &&
        Objects.equals(this.nextPaymentDate, poSTPaymentScheduleResponseAllOf.nextPaymentDate) &&
        Objects.equals(this.occurrences, poSTPaymentScheduleResponseAllOf.occurrences) &&
        Objects.equals(this.paymentOption, poSTPaymentScheduleResponseAllOf.paymentOption) &&
        Objects.equals(this.paymentScheduleNumber, poSTPaymentScheduleResponseAllOf.paymentScheduleNumber) &&
        Objects.equals(this.period, poSTPaymentScheduleResponseAllOf.period) &&
        Objects.equals(this.prepayment, poSTPaymentScheduleResponseAllOf.prepayment) &&
        Objects.equals(this.recentPaymentDate, poSTPaymentScheduleResponseAllOf.recentPaymentDate) &&
        Objects.equals(this.runHour, poSTPaymentScheduleResponseAllOf.runHour) &&
        Objects.equals(this.standalone, poSTPaymentScheduleResponseAllOf.standalone) &&
        Objects.equals(this.startDate, poSTPaymentScheduleResponseAllOf.startDate) &&
        Objects.equals(this.status, poSTPaymentScheduleResponseAllOf.status) &&
        Objects.equals(this.success, poSTPaymentScheduleResponseAllOf.success) &&
        Objects.equals(this.totalAmount, poSTPaymentScheduleResponseAllOf.totalAmount) &&
        Objects.equals(this.totalPaymentsErrored, poSTPaymentScheduleResponseAllOf.totalPaymentsErrored) &&
        Objects.equals(this.totalPaymentsProcessed, poSTPaymentScheduleResponseAllOf.totalPaymentsProcessed) &&
        Objects.equals(this.updatedById, poSTPaymentScheduleResponseAllOf.updatedById) &&
        Objects.equals(this.updatedDate, poSTPaymentScheduleResponseAllOf.updatedDate)&&
        Objects.equals(this.additionalProperties, poSTPaymentScheduleResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class POSTPaymentScheduleResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTPaymentScheduleResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTPaymentScheduleResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTPaymentScheduleResponseAllOf is not found in the empty JSON string", POSTPaymentScheduleResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTPaymentScheduleResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTPaymentScheduleResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTPaymentScheduleResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTPaymentScheduleResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTPaymentScheduleResponseAllOf>() {
           @Override
           public void write(JsonWriter out, POSTPaymentScheduleResponseAllOf value) throws IOException {
           ...
           @Override
           public POSTPaymentScheduleResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTPaymentScheduleResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTPaymentScheduleResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTPaymentScheduleResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to POSTPaymentScheduleResponseAllOf
  */
  public static POSTPaymentScheduleResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTPaymentScheduleResponseAllOf.class);
  }

 /**
  * Convert an instance of POSTPaymentScheduleResponseAllOf to an JSON string
  *
  * @return JSON string
  */
