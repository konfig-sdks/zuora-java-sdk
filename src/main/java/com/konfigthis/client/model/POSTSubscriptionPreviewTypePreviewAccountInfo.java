...
import com.konfigthis.client.model.POSTSubscriptionPreviewTypePreviewAccountInfoAllOfBillToContact;
 ...
 */
@ApiModel(description = "A container for providing a customer account information if you do not have an existing customer account. This customer account information is only used for subscription preview.  You must specify the account information either in this field or in the `accountKey` field with the following conditions:  * If you already have a customer account, specify the account number or ID in the accountKey field. * If you do not have a customer account, provide account information in this field. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class POSTSubscriptionPreviewTypePreviewAccountInfo {
  ...
  private POSTSubscriptionPreviewTypePreviewAccountInfoAllOfBillToContact billToContact;
 ...
 public enum SynctoNetSuiteNSEnum {
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfo() {
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The account's bill cycle day (BCD), when bill runs generate invoices for the account. Specify any day of the month (`1`-`31`, where `31` = end-of-month), or `0` for auto-set. ")
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfo billToContact(POSTSubscriptionPreviewTypePreviewAccountInfoAllOfBillToContact billToContact) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfoAllOfBillToContact getBillToContact() {
    return billToContact;
  }


  public void setBillToContact(POSTSubscriptionPreviewTypePreviewAccountInfoAllOfBillToContact billToContact) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A currency as defined in Billing Settings. ")
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfo classNS(String classNS) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfo customerTypeNS(CustomerTypeNSEnum customerTypeNS) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfo departmentNS(String departmentNS) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfo integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfo integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfo locationNS(String locationNS) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfo subsidiaryNS(String subsidiaryNS) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfo syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewTypePreviewAccountInfo synctoNetSuiteNS(SynctoNetSuiteNSEnum synctoNetSuiteNS) {
  ...
  **/
   ...
   * @return the POSTSubscriptionPreviewTypePreviewAccountInfo instance itself
   */
  public POSTSubscriptionPreviewTypePreviewAccountInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billCycleDay, poSTSubscriptionPreviewTypePreviewAccountInfo.billCycleDay) &&
        ...
        Objects.equals(this.classNS, poSTSubscriptionPreviewTypePreviewAccountInfo.classNS) &&
        Objects.equals(this.customerTypeNS, poSTSubscriptionPreviewTypePreviewAccountInfo.customerTypeNS) &&
        Objects.equals(this.departmentNS, poSTSubscriptionPreviewTypePreviewAccountInfo.departmentNS) &&
        Objects.equals(this.integrationIdNS, poSTSubscriptionPreviewTypePreviewAccountInfo.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, poSTSubscriptionPreviewTypePreviewAccountInfo.integrationStatusNS) &&
        Objects.equals(this.locationNS, poSTSubscriptionPreviewTypePreviewAccountInfo.locationNS) &&
        Objects.equals(this.subsidiaryNS, poSTSubscriptionPreviewTypePreviewAccountInfo.subsidiaryNS) &&
        Objects.equals(this.syncDateNS, poSTSubscriptionPreviewTypePreviewAccountInfo.syncDateNS) &&
        Objects.equals(this.synctoNetSuiteNS, poSTSubscriptionPreviewTypePreviewAccountInfo.synctoNetSuiteNS)&&
        Objects.equals(this.additionalProperties, poSTSubscriptionPreviewTypePreviewAccountInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(billCycleDay, billToContact, currency, classNS, customerTypeNS, departmentNS, integrationIdNS, integrationStatusNS, locationNS, subsidiaryNS, syncDateNS, synctoNetSuiteNS, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTSubscriptionPreviewTypePreviewAccountInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTSubscriptionPreviewTypePreviewAccountInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTSubscriptionPreviewTypePreviewAccountInfo is not found in the empty JSON string", POSTSubscriptionPreviewTypePreviewAccountInfo.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : POSTSubscriptionPreviewTypePreviewAccountInfo.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `billToContact`
      POSTSubscriptionPreviewTypePreviewAccountInfoAllOfBillToContact.validateJsonObject(jsonObj.getAsJsonObject("billToContact"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTSubscriptionPreviewTypePreviewAccountInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTSubscriptionPreviewTypePreviewAccountInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTSubscriptionPreviewTypePreviewAccountInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTSubscriptionPreviewTypePreviewAccountInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTSubscriptionPreviewTypePreviewAccountInfo>() {
           @Override
           public void write(JsonWriter out, POSTSubscriptionPreviewTypePreviewAccountInfo value) throws IOException {
           ...
           @Override
           public POSTSubscriptionPreviewTypePreviewAccountInfo read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTSubscriptionPreviewTypePreviewAccountInfo instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTSubscriptionPreviewTypePreviewAccountInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTSubscriptionPreviewTypePreviewAccountInfo
  * @throws IOException if the JSON string is invalid with respect to POSTSubscriptionPreviewTypePreviewAccountInfo
  */
  public static POSTSubscriptionPreviewTypePreviewAccountInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTSubscriptionPreviewTypePreviewAccountInfo.class);
  }

 /**
  * Convert an instance of POSTSubscriptionPreviewTypePreviewAccountInfo to an JSON string
  *
  * @return JSON string
  */
