...
public class PUTPublicNotificationDefinitionRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The account on which the histories of this notification will be displayed. The associated account does not enforce where the merge fields come from. Available values are as follows: * `Account.Id`: ID of the primary customer account related to the notification. It is also the default value. * `ParentAccount.Id`: this option is available only if you have <a href=\"https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_Customer_Account_Introduction#Customer_Hierarchy\" target=\"_blank\">Customer Hierarchy</a> enabled for your tenant. * `SubscriptionOwnerAccount.Id`: this option is available if the base object of the notification is Order Action.  **Note:** before specifying this field, we recommend that you use [Data Source](https://knowledgecenter.zuora.com/Billing/Reporting/D_Data_Sources_and_Exports/C_Data_Source_Reference) to check the available types of accounts for the current notification.   ")
  ...
  public PUTPublicNotificationDefinitionRequest callout(Object callout) {
  ...
  **/
  ...
  public PUTPublicNotificationDefinitionRequest communicationProfileId(UUID communicationProfileId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The profile that notification definition belongs to. If you want to update the notification to a system notification, you should pass 'SystemNotification'. ' ")
  ...
  **/
  ...
  public PUTPublicNotificationDefinitionRequest emailTemplateId(UUID emailTemplateId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the email template. If emailActive is updated from false to true, an email template is required, and the EventType of the email template MUST be the same as the EventType of the notification definition. ")
  ...
  **/
  ...
  public PUTPublicNotificationDefinitionRequest filterRuleParams(Map<String, String> filterRuleParams) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Account Edit Notification", value = "The name of the notification definition, which is unique in the profile.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, puTPublicNotificationDefinitionRequest.description) &&
        Objects.equals(this.active, puTPublicNotificationDefinitionRequest.active) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, active, associatedAccount, callout, calloutActive, communicationProfileId, emailActive, emailTemplateId, filterRule, filterRuleParams, name, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTPublicNotificationDefinitionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTPublicNotificationDefinitionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("filterRule") != null && !jsonObj.get("filterRule").isJsonNull()) {
        PUTPublicNotificationDefinitionRequestFilterRule.validateJsonObject(jsonObj.getAsJsonObject("filterRule"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<PUTPublicNotificationDefinitionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTPublicNotificationDefinitionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTPublicNotificationDefinitionRequest>() {
           @Override
