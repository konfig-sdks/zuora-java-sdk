 ...
 */
@ApiModel(description = "Pricing information about a usage charge that uses the \"per unit\" charge model. In this charge model, the charge has a fixed price per unit consumed. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UsagePerUnitPricingOverride {
 ...
 public enum RatingGroupEnum {
  ...
  public UsagePerUnitPricingOverride() {
  }

  public UsagePerUnitPricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public UsagePerUnitPricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public UsagePerUnitPricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public UsagePerUnitPricingOverride listPrice(Double listPrice) {
  ...
  public UsagePerUnitPricingOverride listPrice(Integer listPrice) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Per-unit price of the charge. ")
  ...
  public UsagePerUnitPricingOverride originalListPrice(Double originalListPrice) {
  ...
  public UsagePerUnitPricingOverride originalListPrice(Integer originalListPrice) {
  ...
  **/
  ...
  public UsagePerUnitPricingOverride ratingGroup(RatingGroupEnum ratingGroup) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies how Zuora groups usage records when rating usage. See [Usage Rating by Group](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/J_Billing_Operations/Usage/Usage_Rating_by_Group) for more information.   * ByBillingPeriod (default): The rating is based on all the usages in a billing period.   * ByUsageStartDate: The rating is based on all the usages on the same usage start date.    * ByUsageRecord: The rating is based on each usage record.   * ByUsageUpload: The rating is based on all the usages in a uploaded usage file (.xls or .csv). If you import a mass usage in a single upload, which contains multiple usage files in .xls or .csv format, usage records are grouped for each usage file. ")
  ...
  public UsagePerUnitPricingOverride uom(Double uom) {
  ...
  public UsagePerUnitPricingOverride uom(Integer uom) {
  ...
  **/
   ...
   * @return the UsagePerUnitPricingOverride instance itself
   */
  public UsagePerUnitPricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UsagePerUnitPricingOverride usagePerUnitPricingOverride = (UsagePerUnitPricingOverride) o;
    return Objects.equals(this.priceChangeOption, usagePerUnitPricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, usagePerUnitPricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.listPrice, usagePerUnitPricingOverride.listPrice) &&
        Objects.equals(this.originalListPrice, usagePerUnitPricingOverride.originalListPrice) &&
        Objects.equals(this.ratingGroup, usagePerUnitPricingOverride.ratingGroup) &&
        Objects.equals(this.uom, usagePerUnitPricingOverride.uom)&&
        Objects.equals(this.additionalProperties, usagePerUnitPricingOverride.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, listPrice, originalListPrice, ratingGroup, uom, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UsagePerUnitPricingOverride {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsagePerUnitPricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsagePerUnitPricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsagePerUnitPricingOverride is not found in the empty JSON string", UsagePerUnitPricingOverride.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsagePerUnitPricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsagePerUnitPricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsagePerUnitPricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsagePerUnitPricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<UsagePerUnitPricingOverride>() {
           @Override
           public void write(JsonWriter out, UsagePerUnitPricingOverride value) throws IOException {
           ...
           @Override
           public UsagePerUnitPricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UsagePerUnitPricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UsagePerUnitPricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UsagePerUnitPricingOverride
  * @throws IOException if the JSON string is invalid with respect to UsagePerUnitPricingOverride
  */
  public static UsagePerUnitPricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsagePerUnitPricingOverride.class);
  }

 /**
  * Convert an instance of UsagePerUnitPricingOverride to an JSON string
  *
  * @return JSON string
  */
