...
public class DiscountPricingUpdate {
 ...
 public enum PriceChangeOptionEnum {
  ...
  public DiscountPricingUpdate() {
  }

  public DiscountPricingUpdate applyDiscountTo(ApplyDiscountToEnum applyDiscountTo) {
  ...
  **/
  ...
  public DiscountPricingUpdate discountLevel(DiscountLevelEnum discountLevel) {
  ...
  **/
  ...
  public DiscountPricingUpdate discountPercentage(Double discountPercentage) {
  ...
  public DiscountPricingUpdate discountPercentage(Integer discountPercentage) {
  ...
  **/
  ...
  public DiscountPricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
   ...
   * @return the DiscountPricingUpdate instance itself
   */
  public DiscountPricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DiscountPricingUpdate discountPricingUpdate = (DiscountPricingUpdate) o;
    return Objects.equals(this.applyDiscountTo, discountPricingUpdate.applyDiscountTo) &&
        Objects.equals(this.discountLevel, discountPricingUpdate.discountLevel) &&
        Objects.equals(this.discountPercentage, discountPricingUpdate.discountPercentage) &&
        Objects.equals(this.priceChangeOption, discountPricingUpdate.priceChangeOption)&&
        Objects.equals(this.additionalProperties, discountPricingUpdate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DiscountPricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DiscountPricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DiscountPricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DiscountPricingUpdate is not found in the empty JSON string", DiscountPricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiscountPricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiscountPricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiscountPricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiscountPricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<DiscountPricingUpdate>() {
           @Override
           public void write(JsonWriter out, DiscountPricingUpdate value) throws IOException {
           ...
           @Override
           public DiscountPricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DiscountPricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DiscountPricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DiscountPricingUpdate
  * @throws IOException if the JSON string is invalid with respect to DiscountPricingUpdate
  */
  public static DiscountPricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiscountPricingUpdate.class);
  }

 /**
  * Convert an instance of DiscountPricingUpdate to an JSON string
  *
  * @return JSON string
  */
