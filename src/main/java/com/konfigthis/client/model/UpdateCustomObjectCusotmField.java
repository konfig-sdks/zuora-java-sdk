...
import com.konfigthis.client.model.CustomObjectCustomFieldDefinitionUpdate;
 ...
 */
@ApiModel(description = "A reference to a field.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UpdateCustomObjectCusotmField {
  ...
  **/
  ...
  @ApiModelProperty(value = "Indicates whether Audit Trail will record changes of this custom field. You can change auditable fields to non-auditable, and vice versa. One custom object can have a maximum of five auditable fields. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the field is filterable or not. Applicable to `addField` and `updateField` actions.  You can change a filterable field to non-filterable and vice versa. You can also add a filterable field. One custom object can have a maximum of 10 filterable fields.  Note that changing filterable fields triggers reindexing. It will take 12-24 hours before all your data are reindexed and available to query. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "zip__c", value = "The name of the custom field to be updated")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the field is required or optional.  You can update a required field to optional. On the other hand, you can only update an optional field to required on the custom object with no records.  You can only add a required field to the custom object with no records. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Required if the `type` of the action is `renameField`")
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateCustomObjectCusotmField
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateCustomObjectCusotmField.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("definition") != null && !jsonObj.get("definition").isJsonNull()) {
        CustomObjectCustomFieldDefinitionUpdate.validateJsonObject(jsonObj.getAsJsonObject("definition"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<UpdateCustomObjectCusotmField> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCustomObjectCusotmField.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCustomObjectCusotmField>() {
           @Override
