...
public class GETPaymentMethodResponseGooglePay {
  ...
  public GETPaymentMethodResponseGooglePay() {
  }

  public GETPaymentMethodResponseGooglePay googleBIN(String googleBIN) {
  ...
  **/
  ...
  public GETPaymentMethodResponseGooglePay googleCardNumber(String googleCardNumber) {
  ...
  **/
  ...
  public GETPaymentMethodResponseGooglePay googleCardType(String googleCardType) {
  ...
  **/
  ...
  public GETPaymentMethodResponseGooglePay googleExpiryDate(String googleExpiryDate) {
  ...
  **/
  ...
  public GETPaymentMethodResponseGooglePay googleGatewayToken(String googleGatewayToken) {
  ...
  **/
   ...
   * @return the GETPaymentMethodResponseGooglePay instance itself
   */
  public GETPaymentMethodResponseGooglePay putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GETPaymentMethodResponseGooglePay geTPaymentMethodResponseGooglePay = (GETPaymentMethodResponseGooglePay) o;
    return Objects.equals(this.googleBIN, geTPaymentMethodResponseGooglePay.googleBIN) &&
        Objects.equals(this.googleCardNumber, geTPaymentMethodResponseGooglePay.googleCardNumber) &&
        Objects.equals(this.googleCardType, geTPaymentMethodResponseGooglePay.googleCardType) &&
        Objects.equals(this.googleExpiryDate, geTPaymentMethodResponseGooglePay.googleExpiryDate) &&
        Objects.equals(this.googleGatewayToken, geTPaymentMethodResponseGooglePay.googleGatewayToken)&&
        Objects.equals(this.additionalProperties, geTPaymentMethodResponseGooglePay.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GETPaymentMethodResponseGooglePay {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETPaymentMethodResponseGooglePay
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETPaymentMethodResponseGooglePay.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETPaymentMethodResponseGooglePay is not found in the empty JSON string", GETPaymentMethodResponseGooglePay.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETPaymentMethodResponseGooglePay.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETPaymentMethodResponseGooglePay' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETPaymentMethodResponseGooglePay> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETPaymentMethodResponseGooglePay.class));

       return (TypeAdapter<T>) new TypeAdapter<GETPaymentMethodResponseGooglePay>() {
           @Override
           public void write(JsonWriter out, GETPaymentMethodResponseGooglePay value) throws IOException {
           ...
           @Override
           public GETPaymentMethodResponseGooglePay read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETPaymentMethodResponseGooglePay instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETPaymentMethodResponseGooglePay given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETPaymentMethodResponseGooglePay
  * @throws IOException if the JSON string is invalid with respect to GETPaymentMethodResponseGooglePay
  */
  public static GETPaymentMethodResponseGooglePay fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETPaymentMethodResponseGooglePay.class);
  }

 /**
  * Convert an instance of GETPaymentMethodResponseGooglePay to an JSON string
  *
  * @return JSON string
  */
