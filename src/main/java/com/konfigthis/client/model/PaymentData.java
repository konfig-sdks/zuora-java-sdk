...
public class PaymentData {
  ...
  public static final String SERIALIZED_NAME_AUTHORIZED_CURRENCY = "authorizedCurrency";
  @SerializedName(SERIALIZED_NAME_AUTHORIZED_CURRENCY)
  private String authorizedCurrency;

  public PaymentData() {
  }

  public PaymentData authTransactionId(String authTransactionId) {
  ...
  **/
  ...
  public PaymentData authorizedAmount(Double authorizedAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount that is authorized before this API call. Only used for the Delay Capture function. ")
  ...
  public PaymentData authorizedCurrency(String authorizedCurrency) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The authorization of currency code that occurs before this API call. We will verify whether it is same as the account's currency.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authTransactionId, paymentData.authTransactionId) &&
        Objects.equals(this.authorizedAmount, paymentData.authorizedAmount) &&
        Objects.equals(this.authorizedCurrency, paymentData.authorizedCurrency)&&
        Objects.equals(this.additionalProperties, paymentData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authTransactionId, authorizedAmount, authorizedCurrency, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    authorizedCurrency: ").append(toIndentedString(authorizedCurrency)).append("\n");
  ...
  static {
    ...
    openapiFields.add("authorizedCurrency");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("authorizedCurrency") != null && !jsonObj.get("authorizedCurrency").isJsonNull()) && !jsonObj.get("authorizedCurrency").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `authorizedCurrency` to be a primitive type in the JSON string but got `%s`", jsonObj.get("authorizedCurrency").toString()));
      }
  }
