...
public class UsageTieredWithOveragePricingOverride {
 ...
 public enum OverageUnusedUnitsCreditOptionEnum {
  ...
  public UsageTieredWithOveragePricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public UsageTieredWithOveragePricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public UsageTieredWithOveragePricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public UsageTieredWithOveragePricingOverride overagePrice(Double overagePrice) {
  ...
  public UsageTieredWithOveragePricingOverride overagePrice(Integer overagePrice) {
  ...
  **/
  ...
  public UsageTieredWithOveragePricingOverride tiers(List<ChargeTier> tiers) {
  ...
  **/
  ...
  public UsageTieredWithOveragePricingOverride unusedUnitsCreditRates(Double unusedUnitsCreditRates) {
  ...
  public UsageTieredWithOveragePricingOverride unusedUnitsCreditRates(Integer unusedUnitsCreditRates) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsageTieredWithOveragePricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsageTieredWithOveragePricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<UsageTieredWithOveragePricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsageTieredWithOveragePricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<UsageTieredWithOveragePricingOverride>() {
           @Override
