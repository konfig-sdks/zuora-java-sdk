 ...
 */
@ApiModel(description = "Container for finance information of the rate plan charge. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FinanceInformationProperty1 {
  ...
  public static final String SERIALIZED_NAME_ACCOUNTS_RECEIVABLE_ACCOUNTING_CODE_TYPE = "accountsReceivableAccountingCodeType";
  @SerializedName(SERIALIZED_NAME_ACCOUNTS_RECEIVABLE_ACCOUNTING_CODE_TYPE)
  private String accountsReceivableAccountingCodeType;
  ...
  public FinanceInformationProperty1() {
  }

  public FinanceInformationProperty1 accountsReceivableAccountingCode(String accountsReceivableAccountingCode) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The accounting code for accounts receivable. ")
  ...
  public FinanceInformationProperty1 accountsReceivableAccountingCodeType(String accountsReceivableAccountingCodeType) {
    
    
    
    
    this.accountsReceivableAccountingCodeType = accountsReceivableAccountingCodeType;
    return this;
  }

   /**
   * The type of the accounting code for accounts receivable. 
   * @return accountsReceivableAccountingCodeType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the accounting code for accounts receivable. ")

  public String getAccountsReceivableAccountingCodeType() {
    return accountsReceivableAccountingCodeType;
  }


  public void setAccountsReceivableAccountingCodeType(String accountsReceivableAccountingCodeType) {
  ...
  public FinanceInformationProperty1 adjustmentLiabilityAccountingCode(String adjustmentLiabilityAccountingCode) {
   ...
   /**
   * The accounting code for adjustment liability.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return adjustmentLiabilityAccountingCode
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The accounting code for adjustment liability.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
  ...
  public FinanceInformationProperty1 adjustmentLiabilityAccountingCodeType(String adjustmentLiabilityAccountingCodeType) {
   ...
   /**
   * The type associated with the adjustment liability accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return adjustmentLiabilityAccountingCodeType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type associated with the adjustment liability accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
  ...
  public FinanceInformationProperty1 adjustmentRevenueAccountingCode(String adjustmentRevenueAccountingCode) {
   ...
   /**
   * The accounting code for adjustment revenue.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return adjustmentRevenueAccountingCode
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The accounting code for adjustment revenue.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
  ...
  public FinanceInformationProperty1 adjustmentRevenueAccountingCodeType(String adjustmentRevenueAccountingCodeType) {
   ...
   /**
   * The type associated with the adjustment revenue accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return adjustmentRevenueAccountingCodeType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type associated with the adjustment revenue accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
  ...
  public FinanceInformationProperty1 contractAssetAccountingCode(String contractAssetAccountingCode) {
   ...
   /**
   * The accounting code for contract asset.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return contractAssetAccountingCode
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The accounting code for contract asset.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
  ...
  public FinanceInformationProperty1 contractAssetAccountingCodeType(String contractAssetAccountingCodeType) {
   ...
   /**
   * The type associated with the contract asset accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return contractAssetAccountingCodeType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type associated with the contract asset accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
  ...
  public FinanceInformationProperty1 contractLiabilityAccountingCode(String contractLiabilityAccountingCode) {
   ...
   /**
   * The accounting code for contract liability.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return contractLiabilityAccountingCode
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The accounting code for contract liability.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
  ...
  public FinanceInformationProperty1 contractLiabilityAccountingCodeType(String contractLiabilityAccountingCodeType) {
   ...
   /**
   * The type associated with the contract liability accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return contractLiabilityAccountingCodeType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type associated with the contract liability accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
  ...
  public FinanceInformationProperty1 contractRecognizedRevenueAccountingCode(String contractRecognizedRevenueAccountingCode) {
   ...
   /**
   * The accounting code for contract recognized revenue.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return contractRecognizedRevenueAccountingCode
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The accounting code for contract recognized revenue.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
  ...
  public FinanceInformationProperty1 contractRecognizedRevenueAccountingCodeType(String contractRecognizedRevenueAccountingCodeType) {
   ...
   /**
   * The type associated with the contract recognized revenue accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return contractRecognizedRevenueAccountingCodeType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type associated with the contract recognized revenue accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
  ...
  public FinanceInformationProperty1 deferredRevenueAccountingCode(String deferredRevenueAccountingCode) {
  ...
  **/
  ...
  public FinanceInformationProperty1 deferredRevenueAccountingCodeType(String deferredRevenueAccountingCodeType) {
  ...
  **/
  ...
  public FinanceInformationProperty1 recognizedRevenueAccountingCode(String recognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public FinanceInformationProperty1 recognizedRevenueAccountingCodeType(String recognizedRevenueAccountingCodeType) {
  ...
  **/
  ...
  public FinanceInformationProperty1 unbilledReceivablesAccountingCode(String unbilledReceivablesAccountingCode) {
   ...
   /**
   * The accounting code for unbilled receivables.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return unbilledReceivablesAccountingCode
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The accounting code for unbilled receivables.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
  ...
  public FinanceInformationProperty1 unbilledReceivablesAccountingCodeType(String unbilledReceivablesAccountingCodeType) {
   ...
   /**
   * The type associated with the unbilled receivables accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. 
   * @return unbilledReceivablesAccountingCodeType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type associated with the unbilled receivables accounting code.   **Note**: This field is only available if you have the Zuora Billing - Revenue Integration feature enabled. ")
   ...
   * @return the FinanceInformationProperty1 instance itself
   */
  public FinanceInformationProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FinanceInformationProperty1 financeInformationProperty1 = (FinanceInformationProperty1) o;
    return Objects.equals(this.accountsReceivableAccountingCode, financeInformationProperty1.accountsReceivableAccountingCode) &&
        Objects.equals(this.accountsReceivableAccountingCodeType, financeInformationProperty1.accountsReceivableAccountingCodeType) &&
        Objects.equals(this.adjustmentLiabilityAccountingCode, financeInformationProperty1.adjustmentLiabilityAccountingCode) &&
        Objects.equals(this.adjustmentLiabilityAccountingCodeType, financeInformationProperty1.adjustmentLiabilityAccountingCodeType) &&
        Objects.equals(this.adjustmentRevenueAccountingCode, financeInformationProperty1.adjustmentRevenueAccountingCode) &&
        Objects.equals(this.adjustmentRevenueAccountingCodeType, financeInformationProperty1.adjustmentRevenueAccountingCodeType) &&
        Objects.equals(this.contractAssetAccountingCode, financeInformationProperty1.contractAssetAccountingCode) &&
        Objects.equals(this.contractAssetAccountingCodeType, financeInformationProperty1.contractAssetAccountingCodeType) &&
        Objects.equals(this.contractLiabilityAccountingCode, financeInformationProperty1.contractLiabilityAccountingCode) &&
        Objects.equals(this.contractLiabilityAccountingCodeType, financeInformationProperty1.contractLiabilityAccountingCodeType) &&
        Objects.equals(this.contractRecognizedRevenueAccountingCode, financeInformationProperty1.contractRecognizedRevenueAccountingCode) &&
        Objects.equals(this.contractRecognizedRevenueAccountingCodeType, financeInformationProperty1.contractRecognizedRevenueAccountingCodeType) &&
        Objects.equals(this.deferredRevenueAccountingCode, financeInformationProperty1.deferredRevenueAccountingCode) &&
        Objects.equals(this.deferredRevenueAccountingCodeType, financeInformationProperty1.deferredRevenueAccountingCodeType) &&
        Objects.equals(this.recognizedRevenueAccountingCode, financeInformationProperty1.recognizedRevenueAccountingCode) &&
        Objects.equals(this.recognizedRevenueAccountingCodeType, financeInformationProperty1.recognizedRevenueAccountingCodeType) &&
        Objects.equals(this.unbilledReceivablesAccountingCode, financeInformationProperty1.unbilledReceivablesAccountingCode) &&
        Objects.equals(this.unbilledReceivablesAccountingCodeType, financeInformationProperty1.unbilledReceivablesAccountingCodeType)&&
        Objects.equals(this.additionalProperties, financeInformationProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FinanceInformationProperty1 {\n");
    sb.append("    accountsReceivableAccountingCode: ").append(toIndentedString(accountsReceivableAccountingCode)).append("\n");
    sb.append("    accountsReceivableAccountingCodeType: ").append(toIndentedString(accountsReceivableAccountingCodeType)).append("\n");
  ...
  static {
    ...
    openapiFields.add("accountsReceivableAccountingCodeType");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FinanceInformationProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FinanceInformationProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FinanceInformationProperty1 is not found in the empty JSON string", FinanceInformationProperty1.openapiRequiredFields.toString()));
        }
      }
      if (!jsonObj.get("accountsReceivableAccountingCode").isJsonNull() && (jsonObj.get("accountsReceivableAccountingCode") != null && !jsonObj.get("accountsReceivableAccountingCode").isJsonNull()) && !jsonObj.get("accountsReceivableAccountingCode").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("accountsReceivableAccountingCodeType").isJsonNull() && (jsonObj.get("accountsReceivableAccountingCodeType") != null && !jsonObj.get("accountsReceivableAccountingCodeType").isJsonNull()) && !jsonObj.get("accountsReceivableAccountingCodeType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `accountsReceivableAccountingCodeType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("accountsReceivableAccountingCodeType").toString()));
      }
      ...
      if (!jsonObj.get("adjustmentLiabilityAccountingCodeType").isJsonNull() && (jsonObj.get("adjustmentLiabilityAccountingCodeType") != null && !jsonObj.get("adjustmentLiabilityAccountingCodeType").isJsonNull()) && !jsonObj.get("adjustmentLiabilityAccountingCodeType").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("adjustmentRevenueAccountingCodeType").isJsonNull() && (jsonObj.get("adjustmentRevenueAccountingCodeType") != null && !jsonObj.get("adjustmentRevenueAccountingCodeType").isJsonNull()) && !jsonObj.get("adjustmentRevenueAccountingCodeType").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FinanceInformationProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FinanceInformationProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FinanceInformationProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FinanceInformationProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<FinanceInformationProperty1>() {
           @Override
           public void write(JsonWriter out, FinanceInformationProperty1 value) throws IOException {
           ...
           @Override
           public FinanceInformationProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FinanceInformationProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FinanceInformationProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FinanceInformationProperty1
  * @throws IOException if the JSON string is invalid with respect to FinanceInformationProperty1
  */
  public static FinanceInformationProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FinanceInformationProperty1.class);
  }

 /**
  * Convert an instance of FinanceInformationProperty1 to an JSON string
  *
  * @return JSON string
  */
