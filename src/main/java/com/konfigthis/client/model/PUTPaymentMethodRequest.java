...
public class PUTPaymentMethodRequest {
  ...
  public PUTPaymentMethodRequest() {
  }

  public PUTPaymentMethodRequest accountHolderInfo(PUTPMAccountHolderInfo accountHolderInfo) {
  ...
  **/
  ...
  public PUTPMAccountHolderInfo getAccountHolderInfo() {
    return accountHolderInfo;
  }


  public void setAccountHolderInfo(PUTPMAccountHolderInfo accountHolderInfo) {
  ...
  public PUTPaymentMethodRequest accountKey(String accountKey) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the customer account associated with this payment method, such as `2x92c0f859b0480f0159d3a4a6ee5bb6`.  **Note:** You can use this field to associate an orphan payment method with a customer account. If a payment method is already associated with a customer account, you cannot change the associated payment method through this operation. You cannot remove the previous account ID and leave this field empty, either. ")
  ...
  public PUTPaymentMethodRequest authGateway(String authGateway) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the ID of the payment gateway that Zuora will use to authorize the payments that are made with the payment method.   This field is not supported in updating Credit Card Reference Transaction payment methods. ")
  ...
  public PUTPaymentMethodRequest currencyCode(String currencyCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The currency used for payment method authorization. ")
  ...
  public PUTPaymentMethodRequest gatewayOptions(PUTPaymentMethodRequestAllOfGatewayOptions gatewayOptions) {
  ...
  **/
  ...
  public PUTPaymentMethodRequestAllOfGatewayOptions getGatewayOptions() {
    return gatewayOptions;
  }


  public void setGatewayOptions(PUTPaymentMethodRequestAllOfGatewayOptions gatewayOptions) {
  ...
  public PUTPaymentMethodRequest ipAddress(String ipAddress) {
  ...
  **/
  ...
  public PUTPaymentMethodRequest mandateInfo(PUTPaymentMethodRequestAllOfMandateInfo mandateInfo) {
  ...
  **/
  ...
  public PUTPaymentMethodRequestAllOfMandateInfo getMandateInfo() {
    return mandateInfo;
  }


  public void setMandateInfo(PUTPaymentMethodRequestAllOfMandateInfo mandateInfo) {
  ...
  public PUTPaymentMethodRequest processingOptions(PUTPaymentMethodRequestAllOfProcessingOptions processingOptions) {
  ...
  **/
  ...
  public PUTPaymentMethodRequestAllOfProcessingOptions getProcessingOptions() {
    return processingOptions;
  }


  public void setProcessingOptions(PUTPaymentMethodRequestAllOfProcessingOptions processingOptions) {
  ...
  public PUTPaymentMethodRequest expirationMonth(Integer expirationMonth) {
  ...
  **/
  ...
  public PUTPaymentMethodRequest expirationYear(Integer expirationYear) {
  ...
  **/
  ...
  public PUTPaymentMethodRequest securityCode(String securityCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Optional. It is the CVV or CVV2 security code specific for the credit card or debit card. To ensure PCI compliance, this value is not stored and cannot be queried.   If securityCode code is not passed in the request payload, this operation only updates related fields in the payload. It does not validate the payment method through the gateway.  If securityCode is passed in the request payload, this operation retrieves the credit card information from payload and validates them through the gateway. ")
   ...
   * @return the PUTPaymentMethodRequest instance itself
   */
  public PUTPaymentMethodRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PUTPaymentMethodRequest puTPaymentMethodRequest = (PUTPaymentMethodRequest) o;
    return Objects.equals(this.accountHolderInfo, puTPaymentMethodRequest.accountHolderInfo) &&
        Objects.equals(this.accountKey, puTPaymentMethodRequest.accountKey) &&
        Objects.equals(this.authGateway, puTPaymentMethodRequest.authGateway) &&
        Objects.equals(this.currencyCode, puTPaymentMethodRequest.currencyCode) &&
        Objects.equals(this.gatewayOptions, puTPaymentMethodRequest.gatewayOptions) &&
        Objects.equals(this.ipAddress, puTPaymentMethodRequest.ipAddress) &&
        Objects.equals(this.mandateInfo, puTPaymentMethodRequest.mandateInfo) &&
        Objects.equals(this.processingOptions, puTPaymentMethodRequest.processingOptions) &&
        Objects.equals(this.expirationMonth, puTPaymentMethodRequest.expirationMonth) &&
        Objects.equals(this.expirationYear, puTPaymentMethodRequest.expirationYear) &&
        Objects.equals(this.securityCode, puTPaymentMethodRequest.securityCode)&&
        Objects.equals(this.additionalProperties, puTPaymentMethodRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountHolderInfo, accountKey, authGateway, currencyCode, gatewayOptions, ipAddress, mandateInfo, processingOptions, expirationMonth, expirationYear, securityCode, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PUTPaymentMethodRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTPaymentMethodRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTPaymentMethodRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTPaymentMethodRequest is not found in the empty JSON string", PUTPaymentMethodRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("accountHolderInfo") != null && !jsonObj.get("accountHolderInfo").isJsonNull()) {
        PUTPMAccountHolderInfo.validateJsonObject(jsonObj.getAsJsonObject("accountHolderInfo"));
      }
      ...
      if (jsonObj.get("gatewayOptions") != null && !jsonObj.get("gatewayOptions").isJsonNull()) {
        PUTPaymentMethodRequestAllOfGatewayOptions.validateJsonObject(jsonObj.getAsJsonObject("gatewayOptions"));
      }
      ...
      if (jsonObj.get("mandateInfo") != null && !jsonObj.get("mandateInfo").isJsonNull()) {
        PUTPaymentMethodRequestAllOfMandateInfo.validateJsonObject(jsonObj.getAsJsonObject("mandateInfo"));
      }
      ...
      if (jsonObj.get("processingOptions") != null && !jsonObj.get("processingOptions").isJsonNull()) {
        PUTPaymentMethodRequestAllOfProcessingOptions.validateJsonObject(jsonObj.getAsJsonObject("processingOptions"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTPaymentMethodRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTPaymentMethodRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTPaymentMethodRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTPaymentMethodRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTPaymentMethodRequest>() {
           @Override
           public void write(JsonWriter out, PUTPaymentMethodRequest value) throws IOException {
           ...
           @Override
           public PUTPaymentMethodRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTPaymentMethodRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTPaymentMethodRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTPaymentMethodRequest
  * @throws IOException if the JSON string is invalid with respect to PUTPaymentMethodRequest
  */
  public static PUTPaymentMethodRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTPaymentMethodRequest.class);
  }

 /**
  * Convert an instance of PUTPaymentMethodRequest to an JSON string
  *
  * @return JSON string
  */
