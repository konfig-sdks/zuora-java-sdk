...
public class OrderLineItemCommonPostOrder {
 ...
 public enum TaxModeEnum {
  ...
  public OrderLineItemCommonPostOrder() {
  }

  public OrderLineItemCommonPostOrder description(String description) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder UOM(String UOM) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder accountingCode(String accountingCode) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder adjustmentLiabilityAccountingCode(String adjustmentLiabilityAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder adjustmentRevenueAccountingCode(String adjustmentRevenueAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder amountPerUnit(Double amountPerUnit) {
  ...
  public OrderLineItemCommonPostOrder amountPerUnit(Integer amountPerUnit) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The actual charged amount per unit for the Order Line Item.  If you set the `inlineDiscountType`, `inlineDiscountPerUnit`, and `listPricePerUnit` fields, the system will automatically generate the `amountPerUnit` field. You shall not set the `amountPerUnit` field by yourself. ")
  ...
  public OrderLineItemCommonPostOrder billTargetDate(LocalDate billTargetDate) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder billTo(String billTo) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder billingRule(BillingRuleEnum billingRule) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "TRIGGERWITHOUTFULFILLMENT", value = "The billing rule for the Order Line Item. ")
  ...
  public OrderLineItemCommonPostOrder contractAssetAccountingCode(String contractAssetAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder contractLiabilityAccountingCode(String contractLiabilityAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder contractRecognizedRevenueAccountingCode(String contractRecognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder currency(String currency) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder customFields(Map<String, Object> customFields) {
  ...
  public OrderLineItemCommonPostOrder putCustomFieldsItem(String key, Object customFieldsItem) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder deferredRevenueAccountingCode(String deferredRevenueAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder excludeItemBillingFromRevenueAccounting(Boolean excludeItemBillingFromRevenueAccounting) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "The flag to exclude Order Line Item related invoice items, invoice item adjustments, credit memo items, and debit memo items from revenue accounting.  **Note**: This field is only available if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Enable_Order_to_Revenue\" target=\"_blank\">Order to Revenue</a> or [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration) feature enabled.  ")
  ...
  public OrderLineItemCommonPostOrder excludeItemBookingFromRevenueAccounting(Boolean excludeItemBookingFromRevenueAccounting) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "The flag to exclude Order Line Item from revenue accounting.  **Note**: This field is only available if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Enable_Order_to_Revenue\" target=\"_blank\">Order to Revenue</a> or [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration) feature enabled. ")
  ...
  public OrderLineItemCommonPostOrder inlineDiscountPerUnit(Double inlineDiscountPerUnit) {
  ...
  public OrderLineItemCommonPostOrder inlineDiscountPerUnit(Integer inlineDiscountPerUnit) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Use this field in accordance with the `inlineDiscountType` field, in the following manner: * If the `inlineDiscountType` field is set as `Percentage`, this field specifies the discount percentage for each unit of the order line item. For exmaple, if you specify `5` in this field, the discount percentage is 5%. * If the `inlineDiscountType` field is set as `FixedAmount`, this field specifies the discount amount on each unit of the order line item. For exmaple, if you specify `10` in this field, the discount amount on each unit of the order line item is 10.  Once you set the `inlineDiscountType`, `inlineDiscountPerUnit`, and `listPricePerUnit` fields, the system will automatically generate the `amountPerUnit` field. You shall not set the `amountPerUnit` field by yourself. ")
  ...
  public OrderLineItemCommonPostOrder invoiceGroupNumber(String invoiceGroupNumber) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder inlineDiscountType(InlineDiscountTypeEnum inlineDiscountType) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder isAllocationEligible(Boolean isAllocationEligible) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder isUnbilled(Boolean isUnbilled) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder itemCategory(ItemCategoryEnum itemCategory) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SALES", value = "The category for the Order Line Item, to indicate a product sale or return. ")
  ...
  public OrderLineItemCommonPostOrder itemName(String itemName) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder itemNumber(String itemNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of the Order Line Item. Use this field to specify a custom item number for your Order Line Item. If you are to use this field,  you must set all the item numbers in an order when there are several order line items in the order. ")
  ...
  public OrderLineItemCommonPostOrder itemState(ItemStateEnum itemState) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The state of an Order Line Item. If you want to generate billing documents for order line items, you must set this field to `SentToBilling`. For invoice preview, you do not need to set this field.  See [State transitions for an order, order line item, and fulfillment](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AB_Order_Line_Item_States_and_Order_States) for more information. ")
  ...
  public OrderLineItemCommonPostOrder itemType(ItemTypeEnum itemType) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder listPricePerUnit(Double listPricePerUnit) {
  ...
  public OrderLineItemCommonPostOrder listPricePerUnit(Integer listPricePerUnit) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder originalOrderLineItemNumber(String originalOrderLineItemNumber) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder originalOrderNumber(String originalOrderNumber) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder ownerAccountNumber(String ownerAccountNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Use this field to assign an existing account as the owner of an order line item. ")
  ...
  public OrderLineItemCommonPostOrder productCode(String productCode) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder productRatePlanChargeId(String productRatePlanChargeId) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder purchaseOrderNumber(String purchaseOrderNumber) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder quantity(Double quantity) {
  ...
  public OrderLineItemCommonPostOrder quantity(Integer quantity) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder recognizedRevenueAccountingCode(String recognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder relatedSubscriptionNumber(String relatedSubscriptionNumber) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder revenueRecognitionRule(String revenueRecognitionRule) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder revenueRecognitionTiming(RevenueRecognitionTimingEnum revenueRecognitionTiming) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder revenueAmortizationMethod(RevenueAmortizationMethodEnum revenueAmortizationMethod) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder sequenceSetId(String sequenceSetId) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder soldTo(String soldTo) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder taxCode(String taxCode) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder taxMode(TaxModeEnum taxMode) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder transactionEndDate(LocalDate transactionEndDate) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder transactionStartDate(LocalDate transactionStartDate) {
  ...
  **/
  ...
  public OrderLineItemCommonPostOrder unbilledReceivablesAccountingCode(String unbilledReceivablesAccountingCode) {
  ...
  **/
   ...
   * @return the OrderLineItemCommonPostOrder instance itself
   */
  public OrderLineItemCommonPostOrder putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderLineItemCommonPostOrder orderLineItemCommonPostOrder = (OrderLineItemCommonPostOrder) o;
    return Objects.equals(this.description, orderLineItemCommonPostOrder.description) &&
        Objects.equals(this.UOM, orderLineItemCommonPostOrder.UOM) &&
        Objects.equals(this.accountingCode, orderLineItemCommonPostOrder.accountingCode) &&
        Objects.equals(this.adjustmentLiabilityAccountingCode, orderLineItemCommonPostOrder.adjustmentLiabilityAccountingCode) &&
        Objects.equals(this.adjustmentRevenueAccountingCode, orderLineItemCommonPostOrder.adjustmentRevenueAccountingCode) &&
        Objects.equals(this.amountPerUnit, orderLineItemCommonPostOrder.amountPerUnit) &&
        Objects.equals(this.billTargetDate, orderLineItemCommonPostOrder.billTargetDate) &&
        Objects.equals(this.billTo, orderLineItemCommonPostOrder.billTo) &&
        Objects.equals(this.billingRule, orderLineItemCommonPostOrder.billingRule) &&
        Objects.equals(this.contractAssetAccountingCode, orderLineItemCommonPostOrder.contractAssetAccountingCode) &&
        Objects.equals(this.contractLiabilityAccountingCode, orderLineItemCommonPostOrder.contractLiabilityAccountingCode) &&
        Objects.equals(this.contractRecognizedRevenueAccountingCode, orderLineItemCommonPostOrder.contractRecognizedRevenueAccountingCode) &&
        Objects.equals(this.currency, orderLineItemCommonPostOrder.currency) &&
        Objects.equals(this.customFields, orderLineItemCommonPostOrder.customFields) &&
        Objects.equals(this.deferredRevenueAccountingCode, orderLineItemCommonPostOrder.deferredRevenueAccountingCode) &&
        Objects.equals(this.excludeItemBillingFromRevenueAccounting, orderLineItemCommonPostOrder.excludeItemBillingFromRevenueAccounting) &&
        Objects.equals(this.excludeItemBookingFromRevenueAccounting, orderLineItemCommonPostOrder.excludeItemBookingFromRevenueAccounting) &&
        Objects.equals(this.inlineDiscountPerUnit, orderLineItemCommonPostOrder.inlineDiscountPerUnit) &&
        Objects.equals(this.invoiceGroupNumber, orderLineItemCommonPostOrder.invoiceGroupNumber) &&
        Objects.equals(this.inlineDiscountType, orderLineItemCommonPostOrder.inlineDiscountType) &&
        Objects.equals(this.isAllocationEligible, orderLineItemCommonPostOrder.isAllocationEligible) &&
        Objects.equals(this.isUnbilled, orderLineItemCommonPostOrder.isUnbilled) &&
        Objects.equals(this.itemCategory, orderLineItemCommonPostOrder.itemCategory) &&
        Objects.equals(this.itemName, orderLineItemCommonPostOrder.itemName) &&
        Objects.equals(this.itemNumber, orderLineItemCommonPostOrder.itemNumber) &&
        Objects.equals(this.itemState, orderLineItemCommonPostOrder.itemState) &&
        Objects.equals(this.itemType, orderLineItemCommonPostOrder.itemType) &&
        Objects.equals(this.listPricePerUnit, orderLineItemCommonPostOrder.listPricePerUnit) &&
        Objects.equals(this.originalOrderLineItemNumber, orderLineItemCommonPostOrder.originalOrderLineItemNumber) &&
        Objects.equals(this.originalOrderNumber, orderLineItemCommonPostOrder.originalOrderNumber) &&
        Objects.equals(this.ownerAccountNumber, orderLineItemCommonPostOrder.ownerAccountNumber) &&
        Objects.equals(this.productCode, orderLineItemCommonPostOrder.productCode) &&
        Objects.equals(this.productRatePlanChargeId, orderLineItemCommonPostOrder.productRatePlanChargeId) &&
        Objects.equals(this.purchaseOrderNumber, orderLineItemCommonPostOrder.purchaseOrderNumber) &&
        Objects.equals(this.quantity, orderLineItemCommonPostOrder.quantity) &&
        Objects.equals(this.recognizedRevenueAccountingCode, orderLineItemCommonPostOrder.recognizedRevenueAccountingCode) &&
        Objects.equals(this.relatedSubscriptionNumber, orderLineItemCommonPostOrder.relatedSubscriptionNumber) &&
        Objects.equals(this.revenueRecognitionRule, orderLineItemCommonPostOrder.revenueRecognitionRule) &&
        Objects.equals(this.revenueRecognitionTiming, orderLineItemCommonPostOrder.revenueRecognitionTiming) &&
        Objects.equals(this.revenueAmortizationMethod, orderLineItemCommonPostOrder.revenueAmortizationMethod) &&
        Objects.equals(this.sequenceSetId, orderLineItemCommonPostOrder.sequenceSetId) &&
        Objects.equals(this.soldTo, orderLineItemCommonPostOrder.soldTo) &&
        Objects.equals(this.taxCode, orderLineItemCommonPostOrder.taxCode) &&
        Objects.equals(this.taxMode, orderLineItemCommonPostOrder.taxMode) &&
        Objects.equals(this.transactionEndDate, orderLineItemCommonPostOrder.transactionEndDate) &&
        Objects.equals(this.transactionStartDate, orderLineItemCommonPostOrder.transactionStartDate) &&
        Objects.equals(this.unbilledReceivablesAccountingCode, orderLineItemCommonPostOrder.unbilledReceivablesAccountingCode)&&
        Objects.equals(this.additionalProperties, orderLineItemCommonPostOrder.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, UOM, accountingCode, adjustmentLiabilityAccountingCode, adjustmentRevenueAccountingCode, amountPerUnit, billTargetDate, billTo, billingRule, contractAssetAccountingCode, contractLiabilityAccountingCode, contractRecognizedRevenueAccountingCode, currency, customFields, deferredRevenueAccountingCode, excludeItemBillingFromRevenueAccounting, excludeItemBookingFromRevenueAccounting, inlineDiscountPerUnit, invoiceGroupNumber, inlineDiscountType, isAllocationEligible, isUnbilled, itemCategory, itemName, itemNumber, itemState, itemType, listPricePerUnit, originalOrderLineItemNumber, originalOrderNumber, ownerAccountNumber, productCode, productRatePlanChargeId, purchaseOrderNumber, quantity, recognizedRevenueAccountingCode, relatedSubscriptionNumber, revenueRecognitionRule, revenueRecognitionTiming, revenueAmortizationMethod, sequenceSetId, soldTo, taxCode, taxMode, transactionEndDate, transactionStartDate, unbilledReceivablesAccountingCode, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderLineItemCommonPostOrder {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderLineItemCommonPostOrder
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderLineItemCommonPostOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderLineItemCommonPostOrder is not found in the empty JSON string", OrderLineItemCommonPostOrder.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderLineItemCommonPostOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderLineItemCommonPostOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderLineItemCommonPostOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderLineItemCommonPostOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderLineItemCommonPostOrder>() {
           @Override
           public void write(JsonWriter out, OrderLineItemCommonPostOrder value) throws IOException {
           ...
           @Override
           public OrderLineItemCommonPostOrder read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderLineItemCommonPostOrder instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderLineItemCommonPostOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderLineItemCommonPostOrder
  * @throws IOException if the JSON string is invalid with respect to OrderLineItemCommonPostOrder
  */
  public static OrderLineItemCommonPostOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderLineItemCommonPostOrder.class);
  }

 /**
  * Convert an instance of OrderLineItemCommonPostOrder to an JSON string
  *
  * @return JSON string
  */
