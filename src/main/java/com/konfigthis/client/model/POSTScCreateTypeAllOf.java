...
/**
 * POSTScCreateTypeAllOf
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class POSTScCreateTypeAllOf {
  ...
  public POSTScCreateTypeAllOf() {
  }

  public POSTScCreateTypeAllOf description(String description) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf amendedByOrderOn(String amendedByOrderOn) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf applyDiscountTo(String applyDiscountTo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the type of charges that you want a specific discount to apply to.  Values:  * `ONETIME` * `RECURRING` * `USAGE` * `ONETIMERECURRING` * `ONETIMEUSAGE` * `RECURRINGUSAGE` * `ONETIMERECURRINGUSAGE` ")
  ...
  public POSTScCreateTypeAllOf billCycleDay(String billCycleDay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Sets the bill cycle day (BCD) for the charge. The BCD determines which day of the month the customer is billed.  Values: `1`-`31` ")
  ...
  public POSTScCreateTypeAllOf billCycleType(String billCycleType) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf billingPeriod(String billingPeriod) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Billing period for the charge. The start day of the billing period is also called the bill cycle day (BCD). Values:  * `Month` * `Quarter` * `Semi_Annual` * `Annual` * `Eighteen_Months` * `Two_Years` * `Three_Years` * `Five_Years` * `Specific_Months` * `Subscription_Term` * `Week` * `Specific_Weeks` ")
  ...
  public POSTScCreateTypeAllOf billingPeriodAlignment(String billingPeriodAlignment) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Aligns charges within the same subscription if multiple charges begin on different dates.  Values:  * `AlignToCharge` * `AlignToSubscriptionStart` * `AlignToTermStart` ")
  ...
  public POSTScCreateTypeAllOf billingTiming(String billingTiming) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf chargeModelConfiguration(ChargeModelConfigurationType chargeModelConfiguration) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf discountAmount(Double discountAmount) {
  ...
  public POSTScCreateTypeAllOf discountAmount(Integer discountAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the amount of fixed-amount discount. ")
  ...
  public POSTScCreateTypeAllOf discountLevel(String discountLevel) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies if the discount applies to the product rate plan only, the entire subscription, or to any activity in the account.  Values:  * `rateplan` * `subscription` * `account` ")
  ...
  public POSTScCreateTypeAllOf discountPercentage(Double discountPercentage) {
  ...
  public POSTScCreateTypeAllOf discountPercentage(Integer discountPercentage) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Percentage of discount for a percentage discount.  ")
  ...
  public POSTScCreateTypeAllOf endDateCondition(String endDateCondition) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf excludeItemBillingFromRevenueAccounting(Boolean excludeItemBillingFromRevenueAccounting) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "The flag to exclude rate plan charge related invoice items, invoice item adjustments, credit memo items, and debit memo items from revenue accounting.  **Note**: This field is only available if you have the Order to Revenue or Billing - Revenue Integration feature enabled. ")
  ...
  public POSTScCreateTypeAllOf excludeItemBookingFromRevenueAccounting(Boolean excludeItemBookingFromRevenueAccounting) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "The flag to exclude rate plan charges from revenue accounting.  **Note**: This field is only available if you have the Order to Revenue or Billing - Revenue Integration feature enabled. ")
  ...
  public POSTScCreateTypeAllOf includedUnits(Double includedUnits) {
  ...
  public POSTScCreateTypeAllOf includedUnits(Integer includedUnits) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the number of units in the base set of units for this charge. Must be >=`0`. ")
  ...
  public POSTScCreateTypeAllOf isAllocationEligible(Boolean isAllocationEligible) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf isUnbilled(Boolean isUnbilled) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf listPriceBase(String listPriceBase) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The list price base for the product rate plan charge.  Values:  * `Per_Billing_Period` * `Per_Month` * `Per_Week` * `Per_Year` * `Per_Specific_Months` ")
  ...
  public POSTScCreateTypeAllOf number(String number) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unique number that identifies the charge. Max 50 characters. System-generated if not provided. ")
  ...
  public POSTScCreateTypeAllOf numberOfPeriods(Long numberOfPeriods) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf originalOrderDate(LocalDate originalOrderDate) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf overagePrice(Double overagePrice) {
  ...
  public POSTScCreateTypeAllOf overagePrice(Integer overagePrice) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Price for units over the allowed amount. ")
  ...
  public POSTScCreateTypeAllOf overageUnusedUnitsCreditOption(String overageUnusedUnitsCreditOption) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf price(Double price) {
  ...
  public POSTScCreateTypeAllOf price(Integer price) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Price for units in the subscription rate plan. ")
  ...
  public POSTScCreateTypeAllOf priceChangeOption(String priceChangeOption) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Applies an automatic price change when a termed subscription is renewed. The Billing Admin setting **Enable Automatic Price Change When Subscriptions are Renewed?** must be set to Yes to use this field. Values:  * `NoChange` (default) * `SpecificPercentageValue` * `UseLatestProductCatalogPricing` ")
  ...
  public POSTScCreateTypeAllOf priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public POSTScCreateTypeAllOf priceIncreasePercentage(Integer priceIncreasePercentage) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the percentage to increase or decrease the price of a termed subscription's renewal. Required if you set the `PriceChangeOption` field to `SpecificPercentageValue`.   Value must be a decimal between `-100` and `100`. ")
  ...
  public POSTScCreateTypeAllOf productRatePlanChargeId(String productRatePlanChargeId) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "ID of a product rate-plan charge for this subscription. ")
  ...
  public POSTScCreateTypeAllOf productRatePlanChargeNumber(String productRatePlanChargeNumber) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf quantity(Double quantity) {
  ...
  public POSTScCreateTypeAllOf quantity(Integer quantity) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of units. Must be a decimal >=`0`.   When using `chargeOverrides` for creating subscriptions with recurring charge types, the `quantity` field must be populated when the charge model is \"Tiered Pricing\" or \"Volume Pricing\". It is not required for \"Flat Fee Pricing\" charge model. ")
  ...
  public POSTScCreateTypeAllOf ratingGroup(String ratingGroup) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf specificBillingPeriod(Long specificBillingPeriod) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the number of month or week for the charges billing period. Required if you set the value of the `billingPeriod` field to `Specific_Months` or `Specific_Weeks`. ")
  ...
  public POSTScCreateTypeAllOf specificEndDate(LocalDate specificEndDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Defines when the charge ends after the charge trigger date.  **Note**:  * This field is only applicable when the `endDateCondition` field is set to `Specific_End_Date`.  * If the subscription ends before the specific end date, the charge ends when the subscription ends. But if the subscription end date is subsequently changed through a Renewal, or Terms and Conditions amendment, the charge will end on the specific end date. ")
  ...
  public POSTScCreateTypeAllOf specificListPriceBase(Integer specificListPriceBase) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf tiers(List<POSTTierType> tiers) {
  ...
  public POSTScCreateTypeAllOf addTiersItem(POSTTierType tiersItem) {
    if (this.tiers == null) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf triggerDate(LocalDate triggerDate) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf triggerEvent(String triggerEvent) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf unusedUnitsCreditRates(Double unusedUnitsCreditRates) {
  ...
  public POSTScCreateTypeAllOf unusedUnitsCreditRates(Integer unusedUnitsCreditRates) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the rate to credit a customer for unused units of usage. This field applies only for overage charge models when the `OverageUnusedUnitsCreditOption` field is set to `CreditBySpecificRate`. ")
  ...
  public POSTScCreateTypeAllOf upToPeriods(Long upToPeriods) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf upToPeriodsType(String upToPeriodsType) {
  ...
  **/
  ...
  public POSTScCreateTypeAllOf weeklyBillCycleDay(String weeklyBillCycleDay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies which day of the week is the bill cycle day (BCD) for the charge.   Values:  * `Sunday` * `Monday` * `Tuesday` * `Wednesday` * `Thursday` * `Friday` * `Saturday` ")
   ...
   * @return the POSTScCreateTypeAllOf instance itself
   */
  public POSTScCreateTypeAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTScCreateTypeAllOf poSTScCreateTypeAllOf = (POSTScCreateTypeAllOf) o;
    return Objects.equals(this.description, poSTScCreateTypeAllOf.description) &&
        Objects.equals(this.amendedByOrderOn, poSTScCreateTypeAllOf.amendedByOrderOn) &&
        Objects.equals(this.applyDiscountTo, poSTScCreateTypeAllOf.applyDiscountTo) &&
        Objects.equals(this.billCycleDay, poSTScCreateTypeAllOf.billCycleDay) &&
        Objects.equals(this.billCycleType, poSTScCreateTypeAllOf.billCycleType) &&
        Objects.equals(this.billingPeriod, poSTScCreateTypeAllOf.billingPeriod) &&
        Objects.equals(this.billingPeriodAlignment, poSTScCreateTypeAllOf.billingPeriodAlignment) &&
        Objects.equals(this.billingTiming, poSTScCreateTypeAllOf.billingTiming) &&
        Objects.equals(this.chargeModelConfiguration, poSTScCreateTypeAllOf.chargeModelConfiguration) &&
        Objects.equals(this.discountAmount, poSTScCreateTypeAllOf.discountAmount) &&
        Objects.equals(this.discountLevel, poSTScCreateTypeAllOf.discountLevel) &&
        Objects.equals(this.discountPercentage, poSTScCreateTypeAllOf.discountPercentage) &&
        Objects.equals(this.endDateCondition, poSTScCreateTypeAllOf.endDateCondition) &&
        Objects.equals(this.excludeItemBillingFromRevenueAccounting, poSTScCreateTypeAllOf.excludeItemBillingFromRevenueAccounting) &&
        Objects.equals(this.excludeItemBookingFromRevenueAccounting, poSTScCreateTypeAllOf.excludeItemBookingFromRevenueAccounting) &&
        Objects.equals(this.includedUnits, poSTScCreateTypeAllOf.includedUnits) &&
        Objects.equals(this.isAllocationEligible, poSTScCreateTypeAllOf.isAllocationEligible) &&
        Objects.equals(this.isUnbilled, poSTScCreateTypeAllOf.isUnbilled) &&
        Objects.equals(this.listPriceBase, poSTScCreateTypeAllOf.listPriceBase) &&
        Objects.equals(this.number, poSTScCreateTypeAllOf.number) &&
        Objects.equals(this.numberOfPeriods, poSTScCreateTypeAllOf.numberOfPeriods) &&
        Objects.equals(this.originalOrderDate, poSTScCreateTypeAllOf.originalOrderDate) &&
        Objects.equals(this.overagePrice, poSTScCreateTypeAllOf.overagePrice) &&
        Objects.equals(this.overageUnusedUnitsCreditOption, poSTScCreateTypeAllOf.overageUnusedUnitsCreditOption) &&
        Objects.equals(this.price, poSTScCreateTypeAllOf.price) &&
        Objects.equals(this.priceChangeOption, poSTScCreateTypeAllOf.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, poSTScCreateTypeAllOf.priceIncreasePercentage) &&
        Objects.equals(this.productRatePlanChargeId, poSTScCreateTypeAllOf.productRatePlanChargeId) &&
        Objects.equals(this.productRatePlanChargeNumber, poSTScCreateTypeAllOf.productRatePlanChargeNumber) &&
        Objects.equals(this.quantity, poSTScCreateTypeAllOf.quantity) &&
        Objects.equals(this.ratingGroup, poSTScCreateTypeAllOf.ratingGroup) &&
        Objects.equals(this.specificBillingPeriod, poSTScCreateTypeAllOf.specificBillingPeriod) &&
        Objects.equals(this.specificEndDate, poSTScCreateTypeAllOf.specificEndDate) &&
        Objects.equals(this.specificListPriceBase, poSTScCreateTypeAllOf.specificListPriceBase) &&
        Objects.equals(this.tiers, poSTScCreateTypeAllOf.tiers) &&
        Objects.equals(this.triggerDate, poSTScCreateTypeAllOf.triggerDate) &&
        Objects.equals(this.triggerEvent, poSTScCreateTypeAllOf.triggerEvent) &&
        Objects.equals(this.unusedUnitsCreditRates, poSTScCreateTypeAllOf.unusedUnitsCreditRates) &&
        Objects.equals(this.upToPeriods, poSTScCreateTypeAllOf.upToPeriods) &&
        Objects.equals(this.upToPeriodsType, poSTScCreateTypeAllOf.upToPeriodsType) &&
        Objects.equals(this.weeklyBillCycleDay, poSTScCreateTypeAllOf.weeklyBillCycleDay)&&
        Objects.equals(this.additionalProperties, poSTScCreateTypeAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class POSTScCreateTypeAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTScCreateTypeAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTScCreateTypeAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTScCreateTypeAllOf is not found in the empty JSON string", POSTScCreateTypeAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : POSTScCreateTypeAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTScCreateTypeAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTScCreateTypeAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTScCreateTypeAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTScCreateTypeAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTScCreateTypeAllOf>() {
           @Override
           public void write(JsonWriter out, POSTScCreateTypeAllOf value) throws IOException {
           ...
           @Override
           public POSTScCreateTypeAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTScCreateTypeAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTScCreateTypeAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTScCreateTypeAllOf
  * @throws IOException if the JSON string is invalid with respect to POSTScCreateTypeAllOf
  */
  public static POSTScCreateTypeAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTScCreateTypeAllOf.class);
  }

 /**
  * Convert an instance of POSTScCreateTypeAllOf to an JSON string
  *
  * @return JSON string
  */
