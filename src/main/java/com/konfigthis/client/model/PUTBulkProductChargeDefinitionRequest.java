...
public class PUTBulkProductChargeDefinitionRequest {
 ...
 public enum ListPriceBaseEnum {
  ...
  public static final String SERIALIZED_NAME_PRODUCT_CHARGE_DEFINITION_KEY = "productChargeDefinitionKey";
  @SerializedName(SERIALIZED_NAME_PRODUCT_CHARGE_DEFINITION_KEY)
  private String productChargeDefinitionKey;
  ...
  /**
   * Determines how to define taxation for the charge. This field is equired when the &#x60;taxable&#x60; field is set to &#x60;true&#x60;.  **Note**: This value affects the tax calculation of the charge. 
   */
 ...
 public enum TermTypeEnum {
  ...
  public PUTBulkProductChargeDefinitionRequest() {
  }

  public PUTBulkProductChargeDefinitionRequest billingPeriod(String billingPeriod) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The override value of the billingPeriod for the product charge definition. ")
  ...
  public PUTBulkProductChargeDefinitionRequest billingTiming(BillingTimingEnum billingTiming) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The override value of the billingTiming for the product charge definition. ")
  ...
  public PUTBulkProductChargeDefinitionRequest chargeModel(ChargeModelEnum chargeModel) {
  ...
  **/
  ...
  public PUTBulkProductChargeDefinitionRequest defaultQuantity(Double defaultQuantity) {
  ...
  public PUTBulkProductChargeDefinitionRequest defaultQuantity(Integer defaultQuantity) {
  ...
  **/
  ...
  public PUTBulkProductChargeDefinitionRequest listPriceBase(ListPriceBaseEnum listPriceBase) {
  ...
  **/
  ...
  public PUTBulkProductChargeDefinitionRequest prices(List<POSTProductChargeDefinitionPricing> prices) {
  ...
  public PUTBulkProductChargeDefinitionRequest addPricesItem(POSTProductChargeDefinitionPricing pricesItem) {
    if (this.prices == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for the new prices to override the existing prices of the product charge definition. ")
  ...
  public PUTBulkProductChargeDefinitionRequest productChargeDefinitionKey(String productChargeDefinitionKey) {
   ...
   * @return productChargeDefinitionKey
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique number or ID of the product charge definition to be updated. ")

  public String getProductChargeDefinitionKey() {
    return productChargeDefinitionKey;
  }


  public void setProductChargeDefinitionKey(String productChargeDefinitionKey) {
  ...
  public PUTBulkProductChargeDefinitionRequest specificBillingPeriod(Double specificBillingPeriod) {
  ...
  public PUTBulkProductChargeDefinitionRequest specificBillingPeriod(Integer specificBillingPeriod) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The override value of the specificBillingPeriod for the product charge definition. ")
  ...
  public PUTBulkProductChargeDefinitionRequest specificListPriceBase(Integer specificListPriceBase) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of months for the list price base of the charge definition.  The field is `null` if the `listPriceBase` field is not set to `Per_Specific_Months`. ")
  ...
  public PUTBulkProductChargeDefinitionRequest taxCode(String taxCode) {
   ...
   /**
   * Specifies the tax code for taxation rules. This field is equired when the &#x60;Taxable&#x60; field is set to &#x60;True&#x60;.  **Note**: This value affects the tax calculation of the charge. 
   * @return taxCode
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the tax code for taxation rules. This field is equired when the `Taxable` field is set to `True`.  **Note**: This value affects the tax calculation of the charge. ")
  ...
  public PUTBulkProductChargeDefinitionRequest taxMode(TaxModeEnum taxMode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Determines how to define taxation for the charge. This field is equired when the `taxable` field is set to `true`.  **Note**: This value affects the tax calculation of the charge. ")
  ...
  public PUTBulkProductChargeDefinitionRequest taxable(Boolean taxable) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Determines whether the charge definition is taxable. When this field is set to `true`, the `taxMode` and `taxCode` fields are required.  **Character limit**: 5  **Values**: `true`, `false`  **Note**: This value affects the tax calculation of the charge. ")
  ...
  public PUTBulkProductChargeDefinitionRequest term(Double term) {
  ...
  public PUTBulkProductChargeDefinitionRequest term(Integer term) {
  ...
  **/
  ...
  public PUTBulkProductChargeDefinitionRequest termPeriodType(TermPeriodTypeEnum termPeriodType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the period type for the subscription term that is eligible for this charge definition. ")
  ...
  public PUTBulkProductChargeDefinitionRequest termType(TermTypeEnum termType) {
  ...
  **/
  ...
  public PUTBulkProductChargeDefinitionRequest uom(String uom) {
   ...
   /**
   * Describes the unit of measure (UOM) configured in **Settings &gt; Billing**.  **Values**: &#x60;Each&#x60;, &#x60;License&#x60;, &#x60;Seat&#x60;, or &#x60;null&#x60; 
   * @return uom
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Describes the unit of measure (UOM) configured in **Settings > Billing**.  **Values**: `Each`, `License`, `Seat`, or `null` ")
   ...
   * @return the PUTBulkProductChargeDefinitionRequest instance itself
   */
  public PUTBulkProductChargeDefinitionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PUTBulkProductChargeDefinitionRequest puTBulkProductChargeDefinitionRequest = (PUTBulkProductChargeDefinitionRequest) o;
    return Objects.equals(this.billingPeriod, puTBulkProductChargeDefinitionRequest.billingPeriod) &&
        Objects.equals(this.billingTiming, puTBulkProductChargeDefinitionRequest.billingTiming) &&
        Objects.equals(this.chargeModel, puTBulkProductChargeDefinitionRequest.chargeModel) &&
        Objects.equals(this.defaultQuantity, puTBulkProductChargeDefinitionRequest.defaultQuantity) &&
        Objects.equals(this.listPriceBase, puTBulkProductChargeDefinitionRequest.listPriceBase) &&
        Objects.equals(this.prices, puTBulkProductChargeDefinitionRequest.prices) &&
        Objects.equals(this.productChargeDefinitionKey, puTBulkProductChargeDefinitionRequest.productChargeDefinitionKey) &&
        Objects.equals(this.specificBillingPeriod, puTBulkProductChargeDefinitionRequest.specificBillingPeriod) &&
        Objects.equals(this.specificListPriceBase, puTBulkProductChargeDefinitionRequest.specificListPriceBase) &&
        Objects.equals(this.taxCode, puTBulkProductChargeDefinitionRequest.taxCode) &&
        Objects.equals(this.taxMode, puTBulkProductChargeDefinitionRequest.taxMode) &&
        Objects.equals(this.taxable, puTBulkProductChargeDefinitionRequest.taxable) &&
        Objects.equals(this.term, puTBulkProductChargeDefinitionRequest.term) &&
        Objects.equals(this.termPeriodType, puTBulkProductChargeDefinitionRequest.termPeriodType) &&
        Objects.equals(this.termType, puTBulkProductChargeDefinitionRequest.termType) &&
        Objects.equals(this.uom, puTBulkProductChargeDefinitionRequest.uom)&&
        Objects.equals(this.additionalProperties, puTBulkProductChargeDefinitionRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingPeriod, billingTiming, chargeModel, defaultQuantity, listPriceBase, prices, productChargeDefinitionKey, specificBillingPeriod, specificListPriceBase, taxCode, taxMode, taxable, term, termPeriodType, termType, uom, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PUTBulkProductChargeDefinitionRequest {\n");
    ...
    sb.append("    productChargeDefinitionKey: ").append(toIndentedString(productChargeDefinitionKey)).append("\n");
  ...
  static {
    ...
    openapiFields.add("productChargeDefinitionKey");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTBulkProductChargeDefinitionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTBulkProductChargeDefinitionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTBulkProductChargeDefinitionRequest is not found in the empty JSON string", PUTBulkProductChargeDefinitionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("productChargeDefinitionKey") != null && !jsonObj.get("productChargeDefinitionKey").isJsonNull()) && !jsonObj.get("productChargeDefinitionKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `productChargeDefinitionKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("productChargeDefinitionKey").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTBulkProductChargeDefinitionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTBulkProductChargeDefinitionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTBulkProductChargeDefinitionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTBulkProductChargeDefinitionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTBulkProductChargeDefinitionRequest>() {
           @Override
           public void write(JsonWriter out, PUTBulkProductChargeDefinitionRequest value) throws IOException {
           ...
           @Override
           public PUTBulkProductChargeDefinitionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTBulkProductChargeDefinitionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTBulkProductChargeDefinitionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTBulkProductChargeDefinitionRequest
  * @throws IOException if the JSON string is invalid with respect to PUTBulkProductChargeDefinitionRequest
  */
  public static PUTBulkProductChargeDefinitionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTBulkProductChargeDefinitionRequest.class);
  }

 /**
  * Convert an instance of PUTBulkProductChargeDefinitionRequest to an JSON string
  *
  * @return JSON string
  */
