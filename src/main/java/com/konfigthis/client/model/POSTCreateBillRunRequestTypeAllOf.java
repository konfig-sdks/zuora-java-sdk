...
public class POSTCreateBillRunRequestTypeAllOf {
  ...
  private List<BillRunFilterRequestType> billRunFilters = null;
 ...
 public enum ChargeTypeToExcludeEnum {
  ...
  public POSTCreateBillRunRequestTypeAllOf() {
  }

  public POSTCreateBillRunRequestTypeAllOf autoEmail(Boolean autoEmail) {
  ...
  **/
  ...
  @ApiModelProperty(example = "false", value = "Whether to automatically send emails after Auto-Post is complete.  **Note:** To use this field, you must first set the <a href=\"https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Billing_Rules\" target=\"_blank\">Support Bill Run Auto-Post?</a> billing rule to **Yes** through the Zuora UI. ")
  ...
  public POSTCreateBillRunRequestTypeAllOf autoPost(Boolean autoPost) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to automatically post the bill run after the bill run is created.  **Note:** To use this field, you must first set the <a href=\"https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Billing_Rules\" target=\"_blank\">Support Bill Run Auto-Post?</a> billing rule to **Yes** through the Zuora UI. ")
  ...
  public POSTCreateBillRunRequestTypeAllOf autoRenewal(Boolean autoRenewal) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to automatically renew auto-renew subscriptions that are up for renewal. ")
  ...
  public POSTCreateBillRunRequestTypeAllOf batches(List<String> batches) {
  ...
  public POSTCreateBillRunRequestTypeAllOf addBatchesItem(String batchesItem) {
  ...
  **/
  ...
  public POSTCreateBillRunRequestTypeAllOf billCycleDay(String billCycleDay) {
  ...
  **/
  ...
  public POSTCreateBillRunRequestTypeAllOf billRunFilters(List<BillRunFilterRequestType> billRunFilters) {
  ...
  public POSTCreateBillRunRequestTypeAllOf addBillRunFiltersItem(BillRunFilterRequestType billRunFiltersItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The target account or subscriptions for this bill run. You can only specify either this field or the `batches` field. ")

  public List<BillRunFilterRequestType> getBillRunFilters() {
    return billRunFilters;
  }


  public void setBillRunFilters(List<BillRunFilterRequestType> billRunFilters) {
  ...
  public POSTCreateBillRunRequestTypeAllOf billRunType(String billRunType) {
   ...
   /**
   * The type of the bill run. If you do not specify any value for this field, the default value is &#x60;Regular&#x60;.  - You can use this field only if the \&quot;Catch-Up Bill Run\&quot; feature is enabled.  - You must specify this field to create a catch up bill run.  **Values:**  - &#x60;Regular&#x60; - &#x60;CatchUp&#x60; 
   * @return billRunType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the bill run. If you do not specify any value for this field, the default value is `Regular`.  - You can use this field only if the \"Catch-Up Bill Run\" feature is enabled.  - You must specify this field to create a catch up bill run.  **Values:**  - `Regular` - `CatchUp` ")
  ...
  public POSTCreateBillRunRequestTypeAllOf chargeTypeToExclude(List<ChargeTypeToExcludeEnum> chargeTypeToExclude) {
  ...
  public POSTCreateBillRunRequestTypeAllOf addChargeTypeToExcludeItem(ChargeTypeToExcludeEnum chargeTypeToExcludeItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The types of the charges to be excluded from the generation of billing documents. You can specify at most two charge types in the array. ")
  ...
  public POSTCreateBillRunRequestTypeAllOf invoiceDate(LocalDate invoiceDate) {
  ...
  **/
  ...
  public POSTCreateBillRunRequestTypeAllOf name(String name) {
  ...
  **/
  ...
  public POSTCreateBillRunRequestTypeAllOf noEmailForZeroAmountInvoice(Boolean noEmailForZeroAmountInvoice) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to suppress emails for invoices with zero total amount generated in this bill run after the bill run is complete.   It is best practice to not send emails for invoices with zero amount. ")
  ...
  public POSTCreateBillRunRequestTypeAllOf organizationLabels(List<GETProductTypeAllOfOrganizationLabels> organizationLabels) {
  ...
  public POSTCreateBillRunRequestTypeAllOf addOrganizationLabelsItem(GETProductTypeAllOfOrganizationLabels organizationLabelsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The organization(s) that the bill run is created for.   For each item in the array, either the `organizationId` or the `organizationName` field is required.  This field is only required when you have already turned on Multi-Org feature. ")
  ...
  public POSTCreateBillRunRequestTypeAllOf schedule(BillRunScheduleRequestType schedule) {
  ...
  **/
  ...
  public BillRunScheduleRequestType getSchedule() {
    return schedule;
  }


  public void setSchedule(BillRunScheduleRequestType schedule) {
  ...
  public POSTCreateBillRunRequestTypeAllOf targetDate(LocalDate targetDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The target date for this bill run.   - You must specify this field when creating an ad-hoc bill run. - For scheduled bill runs, if you do not specify any value for this field, the target date is the value of the `repeatFrom` field. ")
   ...
   * @return the POSTCreateBillRunRequestTypeAllOf instance itself
   */
  public POSTCreateBillRunRequestTypeAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTCreateBillRunRequestTypeAllOf poSTCreateBillRunRequestTypeAllOf = (POSTCreateBillRunRequestTypeAllOf) o;
    return Objects.equals(this.autoEmail, poSTCreateBillRunRequestTypeAllOf.autoEmail) &&
        Objects.equals(this.autoPost, poSTCreateBillRunRequestTypeAllOf.autoPost) &&
        Objects.equals(this.autoRenewal, poSTCreateBillRunRequestTypeAllOf.autoRenewal) &&
        Objects.equals(this.batches, poSTCreateBillRunRequestTypeAllOf.batches) &&
        Objects.equals(this.billCycleDay, poSTCreateBillRunRequestTypeAllOf.billCycleDay) &&
        Objects.equals(this.billRunFilters, poSTCreateBillRunRequestTypeAllOf.billRunFilters) &&
        Objects.equals(this.billRunType, poSTCreateBillRunRequestTypeAllOf.billRunType) &&
        Objects.equals(this.chargeTypeToExclude, poSTCreateBillRunRequestTypeAllOf.chargeTypeToExclude) &&
        Objects.equals(this.invoiceDate, poSTCreateBillRunRequestTypeAllOf.invoiceDate) &&
        Objects.equals(this.name, poSTCreateBillRunRequestTypeAllOf.name) &&
        Objects.equals(this.noEmailForZeroAmountInvoice, poSTCreateBillRunRequestTypeAllOf.noEmailForZeroAmountInvoice) &&
        Objects.equals(this.organizationLabels, poSTCreateBillRunRequestTypeAllOf.organizationLabels) &&
        Objects.equals(this.schedule, poSTCreateBillRunRequestTypeAllOf.schedule) &&
        Objects.equals(this.targetDate, poSTCreateBillRunRequestTypeAllOf.targetDate)&&
        Objects.equals(this.additionalProperties, poSTCreateBillRunRequestTypeAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoEmail, autoPost, autoRenewal, batches, billCycleDay, billRunFilters, billRunType, chargeTypeToExclude, invoiceDate, name, noEmailForZeroAmountInvoice, organizationLabels, schedule, targetDate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class POSTCreateBillRunRequestTypeAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTCreateBillRunRequestTypeAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTCreateBillRunRequestTypeAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTCreateBillRunRequestTypeAllOf is not found in the empty JSON string", POSTCreateBillRunRequestTypeAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("billRunFilters") != null && !jsonObj.get("billRunFilters").isJsonNull()) {
        ...
        if (jsonArraybillRunFilters != null) {
          ...
          for (int i = 0; i < jsonArraybillRunFilters.size(); i++) {
            BillRunFilterRequestType.validateJsonObject(jsonArraybillRunFilters.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("schedule") != null && !jsonObj.get("schedule").isJsonNull()) {
        BillRunScheduleRequestType.validateJsonObject(jsonObj.getAsJsonObject("schedule"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTCreateBillRunRequestTypeAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTCreateBillRunRequestTypeAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTCreateBillRunRequestTypeAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTCreateBillRunRequestTypeAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTCreateBillRunRequestTypeAllOf>() {
           @Override
           public void write(JsonWriter out, POSTCreateBillRunRequestTypeAllOf value) throws IOException {
           ...
           @Override
           public POSTCreateBillRunRequestTypeAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTCreateBillRunRequestTypeAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTCreateBillRunRequestTypeAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTCreateBillRunRequestTypeAllOf
  * @throws IOException if the JSON string is invalid with respect to POSTCreateBillRunRequestTypeAllOf
  */
  public static POSTCreateBillRunRequestTypeAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTCreateBillRunRequestTypeAllOf.class);
  }

 /**
  * Convert an instance of POSTCreateBillRunRequestTypeAllOf to an JSON string
  *
  * @return JSON string
  */
