 ...
 */
@ApiModel(description = "Container for bill-to contact information for this account. If you do not provide a sold-to contact, the bill-to contact is copied to sold-to contact. Once the sold-to contact is created, changes to billToContact will not affect soldToContact and vice versa. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class POSTAccountTypeBillToContact {
  ...
  public POSTAccountTypeBillToContact() {
  }
  ...
  **/
   ...
   * @return the POSTAccountTypeBillToContact instance itself
   */
  public POSTAccountTypeBillToContact putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address1, poSTAccountTypeBillToContact.address1) &&
        ...
        Objects.equals(this.additionalProperties, poSTAccountTypeBillToContact.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTAccountTypeBillToContact
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTAccountTypeBillToContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTAccountTypeBillToContact is not found in the empty JSON string", POSTAccountTypeBillToContact.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : POSTAccountTypeBillToContact.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTAccountTypeBillToContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTAccountTypeBillToContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTAccountTypeBillToContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTAccountTypeBillToContact.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTAccountTypeBillToContact>() {
           @Override
           public void write(JsonWriter out, POSTAccountTypeBillToContact value) throws IOException {
           ...
           @Override
           public POSTAccountTypeBillToContact read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTAccountTypeBillToContact instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTAccountTypeBillToContact given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTAccountTypeBillToContact
  * @throws IOException if the JSON string is invalid with respect to POSTAccountTypeBillToContact
  */
  public static POSTAccountTypeBillToContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTAccountTypeBillToContact.class);
  }

 /**
  * Convert an instance of POSTAccountTypeBillToContact to an JSON string
  *
  * @return JSON string
  */
