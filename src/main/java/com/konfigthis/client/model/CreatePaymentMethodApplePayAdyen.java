...
public class CreatePaymentMethodApplePayAdyen {
  /**
 ...
 public enum TypeEnum {
  ...
  public CreatePaymentMethodApplePayAdyen() {
  }

  public CreatePaymentMethodApplePayAdyen type(TypeEnum type) {
  ...
  **/
  ...
  public CreatePaymentMethodApplePayAdyen applePaymentData(String applePaymentData) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "This field is specific for setting up Apple Pay for Adyen to include payload with Apple Pay token or Apple payment data. This information should be stringified. For more information, see [Set up Adyen Apple Pay](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Payment_Method_Types/Apple_Pay_on_Web/Set_up_Adyen_Apple_Pay). ")
  ...
  public CreatePaymentMethodApplePayAdyen email(String email) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Email address associated with the payment method. This field is specific for setting up Apple Pay on Adyen v2.0. This field will be passed to Adyen as `shopperEmail`. ")
  ...
  public CreatePaymentMethodApplePayAdyen accountKey(String accountKey) {
  ...
  **/
  ...
  public CreatePaymentMethodApplePayAdyen authGateway(String authGateway) {
  ...
  **/
  ...
  public CreatePaymentMethodApplePayAdyen currencyCode(String currencyCode) {
  ...
  **/
  ...
  public CreatePaymentMethodApplePayAdyen gatewayOptions(PaymentMethodCommonFieldsGatewayOptions gatewayOptions) {
  ...
  **/
  ...
  public CreatePaymentMethodApplePayAdyen ipAddress(String ipAddress) {
  ...
  **/
  ...
  public CreatePaymentMethodApplePayAdyen makeDefault(Boolean makeDefault) {
  ...
  **/
  ...
  public CreatePaymentMethodApplePayAdyen skipValidation(Boolean skipValidation) {
  ...
  **/
   ...
   * @return the CreatePaymentMethodApplePayAdyen instance itself
   */
  public CreatePaymentMethodApplePayAdyen putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePaymentMethodApplePayAdyen createPaymentMethodApplePayAdyen = (CreatePaymentMethodApplePayAdyen) o;
    return Objects.equals(this.type, createPaymentMethodApplePayAdyen.type) &&
        Objects.equals(this.applePaymentData, createPaymentMethodApplePayAdyen.applePaymentData) &&
        Objects.equals(this.email, createPaymentMethodApplePayAdyen.email) &&
        Objects.equals(this.accountKey, createPaymentMethodApplePayAdyen.accountKey) &&
        Objects.equals(this.authGateway, createPaymentMethodApplePayAdyen.authGateway) &&
        Objects.equals(this.currencyCode, createPaymentMethodApplePayAdyen.currencyCode) &&
        Objects.equals(this.gatewayOptions, createPaymentMethodApplePayAdyen.gatewayOptions) &&
        Objects.equals(this.ipAddress, createPaymentMethodApplePayAdyen.ipAddress) &&
        Objects.equals(this.makeDefault, createPaymentMethodApplePayAdyen.makeDefault) &&
        Objects.equals(this.skipValidation, createPaymentMethodApplePayAdyen.skipValidation)&&
        Objects.equals(this.additionalProperties, createPaymentMethodApplePayAdyen.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, applePaymentData, email, accountKey, authGateway, currencyCode, gatewayOptions, ipAddress, makeDefault, skipValidation, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePaymentMethodApplePayAdyen {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("applePaymentData");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreatePaymentMethodApplePayAdyen
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreatePaymentMethodApplePayAdyen.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePaymentMethodApplePayAdyen is not found in the empty JSON string", CreatePaymentMethodApplePayAdyen.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePaymentMethodApplePayAdyen.openapiRequiredFields) {
      ...
      if (!jsonObj.get("applePaymentData").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePaymentMethodApplePayAdyen.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePaymentMethodApplePayAdyen' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePaymentMethodApplePayAdyen> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePaymentMethodApplePayAdyen.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePaymentMethodApplePayAdyen>() {
           @Override
           public void write(JsonWriter out, CreatePaymentMethodApplePayAdyen value) throws IOException {
           ...
           @Override
           public CreatePaymentMethodApplePayAdyen read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreatePaymentMethodApplePayAdyen instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreatePaymentMethodApplePayAdyen given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreatePaymentMethodApplePayAdyen
  * @throws IOException if the JSON string is invalid with respect to CreatePaymentMethodApplePayAdyen
  */
  public static CreatePaymentMethodApplePayAdyen fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePaymentMethodApplePayAdyen.class);
  }

 /**
  * Convert an instance of CreatePaymentMethodApplePayAdyen to an JSON string
  *
  * @return JSON string
  */
