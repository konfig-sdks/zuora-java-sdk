...
import com.konfigthis.client.model.ChangePlanRatePlanOverride;
 ...
 */
@ApiModel(description = "Information about an order action of type `ChangePlan`.  **Note**: The change plan type of order action is currently not supported for Billing - Revenue Integration. When Billing - Revenue Integration is enabled, the change plan type of order action will no longer be applicable in Zuora Billing. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ChangePlan {
  /**
   * * If the rate plan change (from old to new) is an upgrade, the effective policy is &#x60;EffectiveImmediately&#x60; by default. * If the rate plan change (from old to new) is a downgrade, the effective policy is &#x60;EffectiveEndOfBillingPeriod&#x60; by default. * Otherwise, the effective policy is &#x60;SpecificDate&#x60; by default. 
   */
 ...
 public enum EffectivePolicyEnum {
  ...
  private ChangePlanRatePlanOverride newProductRatePlan;
 ...
 public enum SubTypeEnum {
  ...
  public ChangePlan effectivePolicy(EffectivePolicyEnum effectivePolicy) {
  ...
  **/
  ...
  @ApiModelProperty(value = "* If the rate plan change (from old to new) is an upgrade, the effective policy is `EffectiveImmediately` by default. * If the rate plan change (from old to new) is a downgrade, the effective policy is `EffectiveEndOfBillingPeriod` by default. * Otherwise, the effective policy is `SpecificDate` by default. ")
  ...
  public ChangePlan newProductRatePlan(ChangePlanRatePlanOverride newProductRatePlan) {
  ...
  **/
  ...
  public ChangePlanRatePlanOverride getNewProductRatePlan() {
    return newProductRatePlan;
  }


  public void setNewProductRatePlan(ChangePlanRatePlanOverride newProductRatePlan) {
  ...
  public ChangePlan productRatePlanId(String productRatePlanId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of the rate plan to remove. This can be the latest version or any history version of ID. ")
  ...
  public ChangePlan productRatePlanNumber(String productRatePlanNumber) {
  ...
  **/
  ...
  public ChangePlan ratePlanId(String ratePlanId) {
  ...
  **/
  ...
  public ChangePlan subType(SubTypeEnum subType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This field is used to choose the sub type for your change plan order action.  However, if you do not set this field, the field will be automatically generated by the system according to the following rules:  When the old and new rate plans are within the same Grading catalog group: * If the grade of new plan is greater than that of the old plan, this is an \"Upgrade\". * If the grade of new plan is less than that of the old plan, this is a \"Downgrade\". * If the grade of new plan equals that of the old plan, this is a \"Crossgrade\".  When the old and new rate plans are not in the same Grading catalog group, or either has no group, this is \"PlanChanged\". ")
  ...
  public ChangePlan subscriptionRatePlanNumber(String subscriptionRatePlanNumber) {
  ...
  **/
   ...
   * @return the ChangePlan instance itself
   */
  public ChangePlan putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ChangePlan changePlan = (ChangePlan) o;
    return Objects.equals(this.effectivePolicy, changePlan.effectivePolicy) &&
        Objects.equals(this.newProductRatePlan, changePlan.newProductRatePlan) &&
        Objects.equals(this.productRatePlanId, changePlan.productRatePlanId) &&
        Objects.equals(this.productRatePlanNumber, changePlan.productRatePlanNumber) &&
        Objects.equals(this.ratePlanId, changePlan.ratePlanId) &&
        Objects.equals(this.subType, changePlan.subType) &&
        Objects.equals(this.subscriptionRatePlanNumber, changePlan.subscriptionRatePlanNumber)&&
        Objects.equals(this.additionalProperties, changePlan.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(effectivePolicy, newProductRatePlan, productRatePlanId, productRatePlanNumber, ratePlanId, subType, subscriptionRatePlanNumber, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChangePlan
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChangePlan.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangePlan is not found in the empty JSON string", ChangePlan.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the optional field `newProductRatePlan`
      if (jsonObj.get("newProductRatePlan") != null && !jsonObj.get("newProductRatePlan").isJsonNull()) {
        ChangePlanRatePlanOverride.validateJsonObject(jsonObj.getAsJsonObject("newProductRatePlan"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangePlan.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangePlan' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangePlan> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangePlan.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangePlan>() {
           @Override
           public void write(JsonWriter out, ChangePlan value) throws IOException {
           ...
           @Override
           public ChangePlan read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ChangePlan instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ChangePlan given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChangePlan
  * @throws IOException if the JSON string is invalid with respect to ChangePlan
  */
  public static ChangePlan fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangePlan.class);
  }

 /**
  * Convert an instance of ChangePlan to an JSON string
  *
  * @return JSON string
  */
