...
public class PostDiscountItemType {
 ...
 public enum RevRecTriggerConditionEnum {
  ...
  public PostDiscountItemType() {
  }

  public PostDiscountItemType description(String description) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The description of the discount item. ")
  ...
  public PostDiscountItemType accountingCode(String accountingCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The accounting code associated with the discount item. ")
  ...
  public PostDiscountItemType accountsReceivableAccountingCode(String accountsReceivableAccountingCode) {
  ...
  **/
  ...
  public PostDiscountItemType adjustmentLiabilityAccountingCode(String adjustmentLiabilityAccountingCode) {
  ...
  **/
  ...
  public PostDiscountItemType adjustmentRevenueAccountingCode(String adjustmentRevenueAccountingCode) {
  ...
  **/
  ...
  public PostDiscountItemType amount(BigDecimal amount) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The amount of the discount item. - Should be a negative number. For example, `-10`. - Always a fixed amount no matter whether the discount charge associated with the discount item uses the [fixed-amount model or percentage model](https://knowledgecenter.zuora.com/Billing/Subscriptions/Product_Catalog/B_Charge_Models/B_Discount_Charge_Models#Fixed_amount_model_and_percentage_model). - For tax-exclusive discount items, this amount indicates the discount item amount excluding tax. - For tax-inclusive discount items, this amount indicates the discount item amount including tax. ")
  ...
  public PostDiscountItemType bookingReference(String bookingReference) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The booking reference of the discount item. ")
  ...
  public PostDiscountItemType chargeDate(OffsetDateTime chargeDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the discount item is charged, in `yyyy-mm-dd hh:mm:ss` format. ")
  ...
  public PostDiscountItemType chargeName(String chargeName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the charge associated with the discount item. This field is required if the `productRatePlanChargeId` field is not specified in the request body. ")
  ...
  public PostDiscountItemType contractAssetAccountingCode(String contractAssetAccountingCode) {
  ...
  **/
  ...
  public PostDiscountItemType contractLiabilityAccountingCode(String contractLiabilityAccountingCode) {
  ...
  **/
  ...
  public PostDiscountItemType contractRecognizedRevenueAccountingCode(String contractRecognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public PostDiscountItemType deferredRevenueAccountingCode(String deferredRevenueAccountingCode) {
  ...
  **/
  ...
  public PostDiscountItemType itemType(String itemType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the discount item. ")
  ...
  public PostDiscountItemType productRatePlanChargeId(String productRatePlanChargeId) {
  ...
  **/
  ...
  public PostDiscountItemType purchaseOrderNumber(String purchaseOrderNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The purchase order number associated with the discount item. ")
  ...
  public PostDiscountItemType recognizedRevenueAccountingCode(String recognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public PostDiscountItemType revRecCode(String revRecCode) {
  ...
  **/
  ...
  public PostDiscountItemType revRecTriggerCondition(RevRecTriggerConditionEnum revRecTriggerCondition) {
  ...
  **/
  ...
  public PostDiscountItemType revenueRecognitionRuleName(String revenueRecognitionRuleName) {
  ...
  **/
  ...
  public PostDiscountItemType sku(String sku) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The SKU of the invoice item. The SKU of the discount item must be different from the SKU of any existing product. ")
  ...
  public PostDiscountItemType taxItems(List<PostTaxationItemType> taxItems) {
  ...
  public PostDiscountItemType addTaxItemsItem(PostTaxationItemType taxItemsItem) {
  ...
  **/
  ...
  public PostDiscountItemType unbilledReceivablesAccountingCode(String unbilledReceivablesAccountingCode) {
  ...
  **/
  ...
  public PostDiscountItemType unitPrice(BigDecimal unitPrice) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The per-unit price of the discount item. If the discount charge associated with the discount item uses the percentage model, the unit price will display as a percentage amount in PDF. For example: if unit price is 5.00, it will display as 5.00% in PDF. ")
  ...
  public PostDiscountItemType integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public PostDiscountItemType integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public PostDiscountItemType syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the PostDiscountItemType instance itself
   */
  public PostDiscountItemType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PostDiscountItemType postDiscountItemType = (PostDiscountItemType) o;
    return Objects.equals(this.description, postDiscountItemType.description) &&
        Objects.equals(this.accountingCode, postDiscountItemType.accountingCode) &&
        Objects.equals(this.accountsReceivableAccountingCode, postDiscountItemType.accountsReceivableAccountingCode) &&
        Objects.equals(this.adjustmentLiabilityAccountingCode, postDiscountItemType.adjustmentLiabilityAccountingCode) &&
        Objects.equals(this.adjustmentRevenueAccountingCode, postDiscountItemType.adjustmentRevenueAccountingCode) &&
        Objects.equals(this.amount, postDiscountItemType.amount) &&
        Objects.equals(this.bookingReference, postDiscountItemType.bookingReference) &&
        Objects.equals(this.chargeDate, postDiscountItemType.chargeDate) &&
        Objects.equals(this.chargeName, postDiscountItemType.chargeName) &&
        Objects.equals(this.contractAssetAccountingCode, postDiscountItemType.contractAssetAccountingCode) &&
        Objects.equals(this.contractLiabilityAccountingCode, postDiscountItemType.contractLiabilityAccountingCode) &&
        Objects.equals(this.contractRecognizedRevenueAccountingCode, postDiscountItemType.contractRecognizedRevenueAccountingCode) &&
        Objects.equals(this.deferredRevenueAccountingCode, postDiscountItemType.deferredRevenueAccountingCode) &&
        Objects.equals(this.itemType, postDiscountItemType.itemType) &&
        Objects.equals(this.productRatePlanChargeId, postDiscountItemType.productRatePlanChargeId) &&
        Objects.equals(this.purchaseOrderNumber, postDiscountItemType.purchaseOrderNumber) &&
        Objects.equals(this.recognizedRevenueAccountingCode, postDiscountItemType.recognizedRevenueAccountingCode) &&
        Objects.equals(this.revRecCode, postDiscountItemType.revRecCode) &&
        Objects.equals(this.revRecTriggerCondition, postDiscountItemType.revRecTriggerCondition) &&
        Objects.equals(this.revenueRecognitionRuleName, postDiscountItemType.revenueRecognitionRuleName) &&
        Objects.equals(this.sku, postDiscountItemType.sku) &&
        Objects.equals(this.taxItems, postDiscountItemType.taxItems) &&
        Objects.equals(this.unbilledReceivablesAccountingCode, postDiscountItemType.unbilledReceivablesAccountingCode) &&
        Objects.equals(this.unitPrice, postDiscountItemType.unitPrice) &&
        Objects.equals(this.integrationIdNS, postDiscountItemType.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, postDiscountItemType.integrationStatusNS) &&
        Objects.equals(this.syncDateNS, postDiscountItemType.syncDateNS)&&
        Objects.equals(this.additionalProperties, postDiscountItemType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, accountingCode, accountsReceivableAccountingCode, adjustmentLiabilityAccountingCode, adjustmentRevenueAccountingCode, amount, bookingReference, chargeDate, chargeName, contractAssetAccountingCode, contractLiabilityAccountingCode, contractRecognizedRevenueAccountingCode, deferredRevenueAccountingCode, itemType, productRatePlanChargeId, purchaseOrderNumber, recognizedRevenueAccountingCode, revRecCode, revRecTriggerCondition, revenueRecognitionRuleName, sku, taxItems, unbilledReceivablesAccountingCode, unitPrice, integrationIdNS, integrationStatusNS, syncDateNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostDiscountItemType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PostDiscountItemType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PostDiscountItemType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostDiscountItemType is not found in the empty JSON string", PostDiscountItemType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostDiscountItemType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostDiscountItemType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostDiscountItemType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostDiscountItemType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostDiscountItemType.class));

       return (TypeAdapter<T>) new TypeAdapter<PostDiscountItemType>() {
           @Override
           public void write(JsonWriter out, PostDiscountItemType value) throws IOException {
           ...
           @Override
           public PostDiscountItemType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PostDiscountItemType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PostDiscountItemType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PostDiscountItemType
  * @throws IOException if the JSON string is invalid with respect to PostDiscountItemType
  */
  public static PostDiscountItemType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostDiscountItemType.class);
  }

 /**
  * Convert an instance of PostDiscountItemType to an JSON string
  *
  * @return JSON string
  */
