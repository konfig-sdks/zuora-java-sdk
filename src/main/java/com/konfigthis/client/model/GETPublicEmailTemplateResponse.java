...
public class GETPublicEmailTemplateResponse {
 ...
 public enum ToEmailTypeEnum {
  ...
  public GETPublicEmailTemplateResponse() {
  }

  public GETPublicEmailTemplateResponse description(String description) {
  ...
  **/
  ...
  public GETPublicEmailTemplateResponse active(Boolean active) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the email template.")
  ...
  public GETPublicEmailTemplateResponse bccEmailAddress(String bccEmailAddress) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Email BCC address.")
  ...
  public GETPublicEmailTemplateResponse ccEmailAddress(String ccEmailAddress) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Email CC address.")
  ...
  public GETPublicEmailTemplateResponse ccEmailType(CcEmailTypeEnum ccEmailType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SPECIFICEMAILS", value = "Email cc type.")
  ...
  public GETPublicEmailTemplateResponse createdBy(UUID createdBy) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the user who created the email template.")
  ...
  public GETPublicEmailTemplateResponse createdOn(OffsetDateTime createdOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The time when the email template was created. Specified in the UTC timezone in the ISO860 format (YYYY-MM-DDThh:mm:ss.sTZD). E.g. 1997-07-16T19:20:30.45+00:00")
  ...
  public GETPublicEmailTemplateResponse emailBody(String emailBody) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The email body. You can add merge fields in the email body using angle brackets or double curly brackets. For more information, see <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/Events_and_Notifications/Create_Email_Templates/A_Merge_field_syntax_for_email_templates\" target=\"_blank\">Merge field syntax for email templates</a>.   User can also embed html tags if `isHtml` is `true`. ")
  ...
  public GETPublicEmailTemplateResponse emailSubject(String emailSubject) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The email subject. You can add merge fields in the email subject using angle brackets or double curly brackets. For more information, see <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/Events_and_Notifications/Create_Email_Templates/A_Merge_field_syntax_for_email_templates\" target=\"_blank\">Merge field syntax for email templates</a>. ")
  ...
  public GETPublicEmailTemplateResponse encodingType(EncodingTypeEnum encodingType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The endcode type of the email body.")
  ...
  public GETPublicEmailTemplateResponse eventCategory(Double eventCategory) {
  ...
  public GETPublicEmailTemplateResponse eventCategory(Integer eventCategory) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The event category code for a standard event. See [Standard Event Categories](https://knowledgecenter.zuora.com/Central_Platform/Notifications/A_Standard_Events/Standard_Event_Category_Code_for_Notification_Histories_API) for all event category codes.")
  ...
  public GETPublicEmailTemplateResponse eventTypeName(String eventTypeName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the custom event or custom scheduled event.")
  ...
  public GETPublicEmailTemplateResponse eventTypeNamespace(String eventTypeNamespace) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The namespace of the `eventTypeName` field for custom events and custom scheduled events.  ")
  ...
  public GETPublicEmailTemplateResponse fromEmailAddress(String fromEmailAddress) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If formEmailType is SpecificEmail, this field is required.")
  ...
  public GETPublicEmailTemplateResponse fromEmailType(FromEmailTypeEnum fromEmailType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The from email type.")
  ...
  public GETPublicEmailTemplateResponse fromName(String fromName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of email sender.")
  ...
  public GETPublicEmailTemplateResponse id(UUID id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The email template ID.")
  ...
  public GETPublicEmailTemplateResponse isHtml(Boolean isHtml) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the style of email body is HTML.")
  ...
  public GETPublicEmailTemplateResponse name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the email template.")
  ...
  public GETPublicEmailTemplateResponse replyToEmailAddress(String replyToEmailAddress) {
  ...
  **/
  ...
  public GETPublicEmailTemplateResponse replyToEmailType(ReplyToEmailTypeEnum replyToEmailType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The reply email type.")
  ...
  public GETPublicEmailTemplateResponse toEmailAddress(String toEmailAddress) {
  ...
  **/
  ...
  public GETPublicEmailTemplateResponse toEmailType(ToEmailTypeEnum toEmailType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Email receive type.")
  ...
  public GETPublicEmailTemplateResponse updatedBy(UUID updatedBy) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the user who updated the email template.")
  ...
  public GETPublicEmailTemplateResponse updatedOn(OffsetDateTime updatedOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The time when the email template was updated. Specified in the UTC timezone in the ISO860 format (YYYY-MM-DDThh:mm:ss.sTZD). E.g. 1997-07-16T19:20:30.45+00:00")
   ...
   * @return the GETPublicEmailTemplateResponse instance itself
   */
  public GETPublicEmailTemplateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GETPublicEmailTemplateResponse geTPublicEmailTemplateResponse = (GETPublicEmailTemplateResponse) o;
    return Objects.equals(this.description, geTPublicEmailTemplateResponse.description) &&
        Objects.equals(this.active, geTPublicEmailTemplateResponse.active) &&
        Objects.equals(this.bccEmailAddress, geTPublicEmailTemplateResponse.bccEmailAddress) &&
        Objects.equals(this.ccEmailAddress, geTPublicEmailTemplateResponse.ccEmailAddress) &&
        Objects.equals(this.ccEmailType, geTPublicEmailTemplateResponse.ccEmailType) &&
        Objects.equals(this.createdBy, geTPublicEmailTemplateResponse.createdBy) &&
        Objects.equals(this.createdOn, geTPublicEmailTemplateResponse.createdOn) &&
        Objects.equals(this.emailBody, geTPublicEmailTemplateResponse.emailBody) &&
        Objects.equals(this.emailSubject, geTPublicEmailTemplateResponse.emailSubject) &&
        Objects.equals(this.encodingType, geTPublicEmailTemplateResponse.encodingType) &&
        Objects.equals(this.eventCategory, geTPublicEmailTemplateResponse.eventCategory) &&
        Objects.equals(this.eventTypeName, geTPublicEmailTemplateResponse.eventTypeName) &&
        Objects.equals(this.eventTypeNamespace, geTPublicEmailTemplateResponse.eventTypeNamespace) &&
        Objects.equals(this.fromEmailAddress, geTPublicEmailTemplateResponse.fromEmailAddress) &&
        Objects.equals(this.fromEmailType, geTPublicEmailTemplateResponse.fromEmailType) &&
        Objects.equals(this.fromName, geTPublicEmailTemplateResponse.fromName) &&
        Objects.equals(this.id, geTPublicEmailTemplateResponse.id) &&
        Objects.equals(this.isHtml, geTPublicEmailTemplateResponse.isHtml) &&
        Objects.equals(this.name, geTPublicEmailTemplateResponse.name) &&
        Objects.equals(this.replyToEmailAddress, geTPublicEmailTemplateResponse.replyToEmailAddress) &&
        Objects.equals(this.replyToEmailType, geTPublicEmailTemplateResponse.replyToEmailType) &&
        Objects.equals(this.toEmailAddress, geTPublicEmailTemplateResponse.toEmailAddress) &&
        Objects.equals(this.toEmailType, geTPublicEmailTemplateResponse.toEmailType) &&
        Objects.equals(this.updatedBy, geTPublicEmailTemplateResponse.updatedBy) &&
        Objects.equals(this.updatedOn, geTPublicEmailTemplateResponse.updatedOn)&&
        Objects.equals(this.additionalProperties, geTPublicEmailTemplateResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, active, bccEmailAddress, ccEmailAddress, ccEmailType, createdBy, createdOn, emailBody, emailSubject, encodingType, eventCategory, eventTypeName, eventTypeNamespace, fromEmailAddress, fromEmailType, fromName, id, isHtml, name, replyToEmailAddress, replyToEmailType, toEmailAddress, toEmailType, updatedBy, updatedOn, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GETPublicEmailTemplateResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETPublicEmailTemplateResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETPublicEmailTemplateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETPublicEmailTemplateResponse is not found in the empty JSON string", GETPublicEmailTemplateResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETPublicEmailTemplateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETPublicEmailTemplateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETPublicEmailTemplateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETPublicEmailTemplateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GETPublicEmailTemplateResponse>() {
           @Override
           public void write(JsonWriter out, GETPublicEmailTemplateResponse value) throws IOException {
           ...
           @Override
           public GETPublicEmailTemplateResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETPublicEmailTemplateResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETPublicEmailTemplateResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETPublicEmailTemplateResponse
  * @throws IOException if the JSON string is invalid with respect to GETPublicEmailTemplateResponse
  */
  public static GETPublicEmailTemplateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETPublicEmailTemplateResponse.class);
  }

 /**
  * Convert an instance of GETPublicEmailTemplateResponse to an JSON string
  *
  * @return JSON string
  */
