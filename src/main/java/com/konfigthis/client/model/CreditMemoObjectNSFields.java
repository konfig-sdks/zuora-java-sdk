 ...
 */
@ApiModel(description = "Container for Credit Memo fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CreditMemoObjectNSFields {
  ...
  public CreditMemoObjectNSFields() {
  }

  public CreditMemoObjectNSFields integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public CreditMemoObjectNSFields integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public CreditMemoObjectNSFields originNS(String originNS) {
  ...
  **/
  ...
  public CreditMemoObjectNSFields syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public CreditMemoObjectNSFields transactionNS(String transactionNS) {
  ...
  **/
   ...
   * @return the CreditMemoObjectNSFields instance itself
   */
  public CreditMemoObjectNSFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreditMemoObjectNSFields creditMemoObjectNSFields = (CreditMemoObjectNSFields) o;
    return Objects.equals(this.integrationIdNS, creditMemoObjectNSFields.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, creditMemoObjectNSFields.integrationStatusNS) &&
        Objects.equals(this.originNS, creditMemoObjectNSFields.originNS) &&
        Objects.equals(this.syncDateNS, creditMemoObjectNSFields.syncDateNS) &&
        Objects.equals(this.transactionNS, creditMemoObjectNSFields.transactionNS)&&
        Objects.equals(this.additionalProperties, creditMemoObjectNSFields.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(integrationIdNS, integrationStatusNS, originNS, syncDateNS, transactionNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreditMemoObjectNSFields {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreditMemoObjectNSFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreditMemoObjectNSFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreditMemoObjectNSFields is not found in the empty JSON string", CreditMemoObjectNSFields.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreditMemoObjectNSFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreditMemoObjectNSFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreditMemoObjectNSFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreditMemoObjectNSFields.class));

       return (TypeAdapter<T>) new TypeAdapter<CreditMemoObjectNSFields>() {
           @Override
           public void write(JsonWriter out, CreditMemoObjectNSFields value) throws IOException {
           ...
           @Override
           public CreditMemoObjectNSFields read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreditMemoObjectNSFields instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreditMemoObjectNSFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreditMemoObjectNSFields
  * @throws IOException if the JSON string is invalid with respect to CreditMemoObjectNSFields
  */
  public static CreditMemoObjectNSFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreditMemoObjectNSFields.class);
  }

 /**
  * Convert an instance of CreditMemoObjectNSFields to an JSON string
  *
  * @return JSON string
  */
