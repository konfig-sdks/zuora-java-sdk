...
public class PutInvoiceType {
 ...
 public enum TransferredToAccountingEnum {
  ...
  public PutInvoiceType() {
  }

  public PutInvoiceType autoPay(Boolean autoPay) {
  ...
  **/
  ...
  public PutInvoiceType comments(String comments) {
  ...
  **/
  ...
  public PutInvoiceType dueDate(LocalDate dueDate) {
  ...
  **/
  ...
  public PutInvoiceType invoiceDate(LocalDate invoiceDate) {
  ...
  **/
  ...
  public PutInvoiceType invoiceItems(List<PutInvoiceItemType> invoiceItems) {
  ...
  public PutInvoiceType addInvoiceItemsItem(PutInvoiceItemType invoiceItemsItem) {
  ...
  **/
  ...
  public PutInvoiceType transferredToAccounting(TransferredToAccountingEnum transferredToAccounting) {
  ...
  **/
  ...
  public PutInvoiceType integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public PutInvoiceType integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public PutInvoiceType syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the PutInvoiceType instance itself
   */
  public PutInvoiceType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PutInvoiceType putInvoiceType = (PutInvoiceType) o;
    return Objects.equals(this.autoPay, putInvoiceType.autoPay) &&
        Objects.equals(this.comments, putInvoiceType.comments) &&
        Objects.equals(this.dueDate, putInvoiceType.dueDate) &&
        Objects.equals(this.invoiceDate, putInvoiceType.invoiceDate) &&
        Objects.equals(this.invoiceItems, putInvoiceType.invoiceItems) &&
        Objects.equals(this.transferredToAccounting, putInvoiceType.transferredToAccounting) &&
        Objects.equals(this.integrationIdNS, putInvoiceType.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, putInvoiceType.integrationStatusNS) &&
        Objects.equals(this.syncDateNS, putInvoiceType.syncDateNS)&&
        Objects.equals(this.additionalProperties, putInvoiceType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoPay, comments, dueDate, invoiceDate, invoiceItems, transferredToAccounting, integrationIdNS, integrationStatusNS, syncDateNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutInvoiceType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PutInvoiceType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PutInvoiceType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutInvoiceType is not found in the empty JSON string", PutInvoiceType.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutInvoiceType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutInvoiceType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutInvoiceType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutInvoiceType.class));

       return (TypeAdapter<T>) new TypeAdapter<PutInvoiceType>() {
           @Override
           public void write(JsonWriter out, PutInvoiceType value) throws IOException {
           ...
           @Override
           public PutInvoiceType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PutInvoiceType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PutInvoiceType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PutInvoiceType
  * @throws IOException if the JSON string is invalid with respect to PutInvoiceType
  */
  public static PutInvoiceType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutInvoiceType.class);
  }

 /**
  * Convert an instance of PutInvoiceType to an JSON string
  *
  * @return JSON string
  */
