...
public class OrderActionRatePlanRecurringTieredPricingUpdate {
  /**
 ...
 public enum PriceChangeOptionEnum {
  ...
  public OrderActionRatePlanRecurringTieredPricingUpdate() {
  }

  public OrderActionRatePlanRecurringTieredPricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public OrderActionRatePlanRecurringTieredPricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public OrderActionRatePlanRecurringTieredPricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanRecurringTieredPricingUpdate quantity(Double quantity) {
  ...
  public OrderActionRatePlanRecurringTieredPricingUpdate quantity(Integer quantity) {
    if (quantity != null && quantity < 0) {
      throw new IllegalArgumentException("Invalid value for quantity. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanRecurringTieredPricingUpdate tiers(List<OrderActionRatePlanChargeTier> tiers) {
  ...
  public OrderActionRatePlanRecurringTieredPricingUpdate addTiersItem(OrderActionRatePlanChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the OrderActionRatePlanRecurringTieredPricingUpdate instance itself
   */
  public OrderActionRatePlanRecurringTieredPricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanRecurringTieredPricingUpdate orderActionRatePlanRecurringTieredPricingUpdate = (OrderActionRatePlanRecurringTieredPricingUpdate) o;
    return Objects.equals(this.priceChangeOption, orderActionRatePlanRecurringTieredPricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, orderActionRatePlanRecurringTieredPricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.quantity, orderActionRatePlanRecurringTieredPricingUpdate.quantity) &&
        Objects.equals(this.tiers, orderActionRatePlanRecurringTieredPricingUpdate.tiers)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanRecurringTieredPricingUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, quantity, tiers, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderActionRatePlanRecurringTieredPricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanRecurringTieredPricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanRecurringTieredPricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanRecurringTieredPricingUpdate is not found in the empty JSON string", OrderActionRatePlanRecurringTieredPricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanRecurringTieredPricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanRecurringTieredPricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanRecurringTieredPricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanRecurringTieredPricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanRecurringTieredPricingUpdate>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanRecurringTieredPricingUpdate value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanRecurringTieredPricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanRecurringTieredPricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanRecurringTieredPricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanRecurringTieredPricingUpdate
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanRecurringTieredPricingUpdate
  */
  public static OrderActionRatePlanRecurringTieredPricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanRecurringTieredPricingUpdate.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanRecurringTieredPricingUpdate to an JSON string
  *
  * @return JSON string
  */
