...
public class PostBillingPreviewRunParam {
 ...
 public enum StorageOptionEnum {
  ...
  public PostBillingPreviewRunParam() {
  }

  public PostBillingPreviewRunParam assumeRenewal(String assumeRenewal) {
  ...
  **/
  ...
  @ApiModelProperty(example = "None", value = "Indicates whether to generate a preview of future invoice items and credit memo items with the assumption that the subscriptions are renewed.  Set one of the following values in this field to decide how the assumption is applied in the billing preview.    * **All:** The assumption is applied to all the subscriptions. Zuora generates preview invoice item data and credit memo item data from the first day of the customer's next billing period to the target date.      * **None:** (Default) The assumption is not applied to the subscriptions. Zuora generates preview invoice item data and credit memo item data based on the current term end date and the target date.        * If the target date is later than the current term end date, Zuora generates preview invoice item data and credit memo item data from the first day of the customer's next billing period to the current term end date.      * If the target date is earlier than the current term end date, Zuora generates preview invoice item data and credit memeo item data from the first day of the customer's next billing period to the target date.    * **Autorenew:** The assumption is applied to the subscriptions that have auto-renew enabled. Zuora generates preview invoice item data and credit memo item data from the first day of the customer's next billing period to the target date.      **Note:**    - This field can only be used if the subscription renewal term is not set to 0.           - The credit memo item data is only available if you have Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  ")
  ...
  public PostBillingPreviewRunParam batch(String batch) {
  ...
  **/
  ...
  public PostBillingPreviewRunParam batches(String batches) {
  ...
  **/
  ...
  public PostBillingPreviewRunParam chargeTypeToExclude(String chargeTypeToExclude) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "", value = "The charge types to exclude from the forecast run.  **Possible values:** OneTime, Recurring, Usage, and any comma-separated combination of these values. ")
  ...
  public PostBillingPreviewRunParam includingDraftItems(Boolean includingDraftItems) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether draft document items are included in the billing preview run. By default, draft document items are not included.  This field loads draft invoice items and credit memo items. The `chargeTypeToExclude`, `targetDate`, `includingEvergreenSubscription`, and `assumeRenewal` fields do not affect the behavior of the `includingDraftItems` field. ")
  ...
  public PostBillingPreviewRunParam includingEvergreenSubscription(Boolean includingEvergreenSubscription) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Whether evergreen subscriptions are included in the billing preview run. By default, evergreen subscriptions are not included. ")
  ...
  public PostBillingPreviewRunParam organizationLabels(List<GETCatalogGroupProductRatePlanResponseOrganizationLabelsInner> organizationLabels) {
  ...
  public PostBillingPreviewRunParam addOrganizationLabelsItem(GETCatalogGroupProductRatePlanResponseOrganizationLabelsInner organizationLabelsItem) {
   ...
   /**
   * The organization(s) that this billing preview run is created for.   For each item in the array, either the &#x60;organizationId&#x60; or the &#x60;organizationName&#x60; field is required.  This field is only required when you have already turned on Multi-Org feature. 
   * @return organizationLabels
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The organization(s) that this billing preview run is created for.   For each item in the array, either the `organizationId` or the `organizationName` field is required.  This field is only required when you have already turned on Multi-Org feature. ")
  ...
  public PostBillingPreviewRunParam storageOption(StorageOptionEnum storageOption) {
  ...
  **/
  ...
  public PostBillingPreviewRunParam targetDate(LocalDate targetDate) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Mon Jan 09 16:00:00 PST 2017", required = true, value = "The target date for the billing preview run. The billing preview run generates preview invoice item data and credit memo item data from the first day of the customer's next billing period to the target date.   The value for the `targetDate` field must be in _`YYYY-MM-DD`_ format.  If the target date is later than the subscription current term end date, the preview invoice item data and credit memo item data is generated from the first day of the customer's next billing period to the current term end date. If you want to generate preview invoice item data and credit memo item data past the end of the subscription current term, specify the AssumeRenewal field in the request.  **Note:** The credit memo item data is only available if you have Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. ")
   ...
   * @return the PostBillingPreviewRunParam instance itself
   */
  public PostBillingPreviewRunParam putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PostBillingPreviewRunParam postBillingPreviewRunParam = (PostBillingPreviewRunParam) o;
    return Objects.equals(this.assumeRenewal, postBillingPreviewRunParam.assumeRenewal) &&
        Objects.equals(this.batch, postBillingPreviewRunParam.batch) &&
        Objects.equals(this.batches, postBillingPreviewRunParam.batches) &&
        Objects.equals(this.chargeTypeToExclude, postBillingPreviewRunParam.chargeTypeToExclude) &&
        Objects.equals(this.includingDraftItems, postBillingPreviewRunParam.includingDraftItems) &&
        Objects.equals(this.includingEvergreenSubscription, postBillingPreviewRunParam.includingEvergreenSubscription) &&
        Objects.equals(this.organizationLabels, postBillingPreviewRunParam.organizationLabels) &&
        Objects.equals(this.storageOption, postBillingPreviewRunParam.storageOption) &&
        Objects.equals(this.targetDate, postBillingPreviewRunParam.targetDate)&&
        Objects.equals(this.additionalProperties, postBillingPreviewRunParam.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assumeRenewal, batch, batches, chargeTypeToExclude, includingDraftItems, includingEvergreenSubscription, organizationLabels, storageOption, targetDate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostBillingPreviewRunParam {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PostBillingPreviewRunParam
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PostBillingPreviewRunParam.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostBillingPreviewRunParam is not found in the empty JSON string", PostBillingPreviewRunParam.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostBillingPreviewRunParam.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostBillingPreviewRunParam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostBillingPreviewRunParam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostBillingPreviewRunParam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostBillingPreviewRunParam.class));

       return (TypeAdapter<T>) new TypeAdapter<PostBillingPreviewRunParam>() {
           @Override
           public void write(JsonWriter out, PostBillingPreviewRunParam value) throws IOException {
           ...
           @Override
           public PostBillingPreviewRunParam read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PostBillingPreviewRunParam instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PostBillingPreviewRunParam given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PostBillingPreviewRunParam
  * @throws IOException if the JSON string is invalid with respect to PostBillingPreviewRunParam
  */
  public static PostBillingPreviewRunParam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostBillingPreviewRunParam.class);
  }

 /**
  * Convert an instance of PostBillingPreviewRunParam to an JSON string
  *
  * @return JSON string
  */
