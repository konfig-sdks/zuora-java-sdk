...
public class UsageVolumePricingUpdate {
 ...
 public enum PriceChangeOptionEnum {
  ...
  public UsageVolumePricingUpdate() {
  }

  public UsageVolumePricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public UsageVolumePricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public UsageVolumePricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public UsageVolumePricingUpdate tiers(List<ChargeTier> tiers) {
  ...
  public UsageVolumePricingUpdate addTiersItem(ChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the UsageVolumePricingUpdate instance itself
   */
  public UsageVolumePricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UsageVolumePricingUpdate usageVolumePricingUpdate = (UsageVolumePricingUpdate) o;
    return Objects.equals(this.priceChangeOption, usageVolumePricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, usageVolumePricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.tiers, usageVolumePricingUpdate.tiers)&&
        Objects.equals(this.additionalProperties, usageVolumePricingUpdate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UsageVolumePricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsageVolumePricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsageVolumePricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsageVolumePricingUpdate is not found in the empty JSON string", UsageVolumePricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsageVolumePricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsageVolumePricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsageVolumePricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsageVolumePricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<UsageVolumePricingUpdate>() {
           @Override
           public void write(JsonWriter out, UsageVolumePricingUpdate value) throws IOException {
           ...
           @Override
           public UsageVolumePricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UsageVolumePricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UsageVolumePricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UsageVolumePricingUpdate
  * @throws IOException if the JSON string is invalid with respect to UsageVolumePricingUpdate
  */
  public static UsageVolumePricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsageVolumePricingUpdate.class);
  }

 /**
  * Convert an instance of UsageVolumePricingUpdate to an JSON string
  *
  * @return JSON string
  */
