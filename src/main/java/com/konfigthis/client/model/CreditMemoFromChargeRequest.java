...
public class CreditMemoFromChargeRequest {
  ...
  private List<CreditMemoFromChargeDetailType> charges = null;
  ...
  public CreditMemoFromChargeRequest() {
  }

  public CreditMemoFromChargeRequest accountId(String accountId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the account associated with the credit memo.  **Note**: When creating credit memos from product rate plan charges, you must specify `accountNumber`, `accountId`, or both in the request body. If both fields are specified, they must correspond to the same account. ")
  ...
  public CreditMemoFromChargeRequest accountNumber(String accountNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of the customer account associated with the credit memo.  **Note**: When creating credit memos from product rate plan charges, you must specify `accountNumber`, `accountId`, or both in the request body. If both fields are specified, they must correspond to the same account. ")
  ...
  public CreditMemoFromChargeRequest autoPost(Boolean autoPost) {
   ...
   /**
   * Whether to automatically post the credit memo after it is created.   Setting this field to &#x60;true&#x60;, you do not need to separately call the [Post a credit memo](https://developer.zuora.com/api-references/api/operation/PUT_PostCreditMemo) operation to post the credit memo. 
   * @return autoPost
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to automatically post the credit memo after it is created.   Setting this field to `true`, you do not need to separately call the [Post a credit memo](https://developer.zuora.com/api-references/api/operation/PUT_PostCreditMemo) operation to post the credit memo. ")
  ...
  public CreditMemoFromChargeRequest charges(List<CreditMemoFromChargeDetailType> charges) {
  ...
  public CreditMemoFromChargeRequest addChargesItem(CreditMemoFromChargeDetailType chargesItem) {
  ...
  **/
  ...
  public List<CreditMemoFromChargeDetailType> getCharges() {
    return charges;
  }


  public void setCharges(List<CreditMemoFromChargeDetailType> charges) {
  ...
  public CreditMemoFromChargeRequest comment(String comment) {
  ...
  **/
  ...
  public CreditMemoFromChargeRequest currency(String currency) {
  ...
  **/
  ...
  public CreditMemoFromChargeRequest customRates(List<CreditMemoFromChargeCustomRatesType> customRates) {
  ...
  public CreditMemoFromChargeRequest addCustomRatesItem(CreditMemoFromChargeCustomRatesType customRatesItem) {
  ...
  **/
  ...
  public CreditMemoFromChargeRequest effectiveDate(LocalDate effectiveDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the credit memo takes effect. ")
  ...
  public CreditMemoFromChargeRequest excludeFromAutoApplyRules(Boolean excludeFromAutoApplyRules) {
  ...
  **/
  ...
  public CreditMemoFromChargeRequest reasonCode(String reasonCode) {
  ...
  **/
  ...
  public CreditMemoFromChargeRequest integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public CreditMemoFromChargeRequest integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public CreditMemoFromChargeRequest originNS(String originNS) {
  ...
  **/
  ...
  public CreditMemoFromChargeRequest syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public CreditMemoFromChargeRequest transactionNS(String transactionNS) {
  ...
  **/
   ...
   * @return the CreditMemoFromChargeRequest instance itself
   */
  public CreditMemoFromChargeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreditMemoFromChargeRequest creditMemoFromChargeRequest = (CreditMemoFromChargeRequest) o;
    return Objects.equals(this.accountId, creditMemoFromChargeRequest.accountId) &&
        Objects.equals(this.accountNumber, creditMemoFromChargeRequest.accountNumber) &&
        Objects.equals(this.autoPost, creditMemoFromChargeRequest.autoPost) &&
        Objects.equals(this.charges, creditMemoFromChargeRequest.charges) &&
        Objects.equals(this.comment, creditMemoFromChargeRequest.comment) &&
        Objects.equals(this.currency, creditMemoFromChargeRequest.currency) &&
        Objects.equals(this.customRates, creditMemoFromChargeRequest.customRates) &&
        Objects.equals(this.effectiveDate, creditMemoFromChargeRequest.effectiveDate) &&
        Objects.equals(this.excludeFromAutoApplyRules, creditMemoFromChargeRequest.excludeFromAutoApplyRules) &&
        Objects.equals(this.reasonCode, creditMemoFromChargeRequest.reasonCode) &&
        Objects.equals(this.integrationIdNS, creditMemoFromChargeRequest.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, creditMemoFromChargeRequest.integrationStatusNS) &&
        Objects.equals(this.originNS, creditMemoFromChargeRequest.originNS) &&
        Objects.equals(this.syncDateNS, creditMemoFromChargeRequest.syncDateNS) &&
        Objects.equals(this.transactionNS, creditMemoFromChargeRequest.transactionNS)&&
        Objects.equals(this.additionalProperties, creditMemoFromChargeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, accountNumber, autoPost, charges, comment, currency, customRates, effectiveDate, excludeFromAutoApplyRules, reasonCode, integrationIdNS, integrationStatusNS, originNS, syncDateNS, transactionNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreditMemoFromChargeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreditMemoFromChargeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreditMemoFromChargeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreditMemoFromChargeRequest is not found in the empty JSON string", CreditMemoFromChargeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("charges") != null && !jsonObj.get("charges").isJsonNull()) {
        ...
        if (jsonArraycharges != null) {
          ...
          for (int i = 0; i < jsonArraycharges.size(); i++) {
            CreditMemoFromChargeDetailType.validateJsonObject(jsonArraycharges.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreditMemoFromChargeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreditMemoFromChargeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreditMemoFromChargeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreditMemoFromChargeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreditMemoFromChargeRequest>() {
           @Override
           public void write(JsonWriter out, CreditMemoFromChargeRequest value) throws IOException {
           ...
           @Override
           public CreditMemoFromChargeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreditMemoFromChargeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreditMemoFromChargeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreditMemoFromChargeRequest
  * @throws IOException if the JSON string is invalid with respect to CreditMemoFromChargeRequest
  */
  public static CreditMemoFromChargeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreditMemoFromChargeRequest.class);
  }

 /**
  * Convert an instance of CreditMemoFromChargeRequest to an JSON string
  *
  * @return JSON string
  */
