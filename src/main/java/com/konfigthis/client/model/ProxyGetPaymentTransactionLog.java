...
public class ProxyGetPaymentTransactionLog {
  ...
  @SerializedName(SERIALIZED_NAME_GATEWAY_REASON_CODE)
  ...
  @SerializedName(SERIALIZED_NAME_GATEWAY_REASON_CODE_DESCRIPTION)
 ...
 public enum GatewayStateEnum {
   ...
   */
  @JsonAdapter(GatewayTransactionTypeEnum.Adapter.class)
 public enum GatewayTransactionTypeEnum {
    ...
    GatewayTransactionTypeEnum(String value) {
      this.value = value;
    }
    ...
    public static GatewayTransactionTypeEnum fromValue(String value) {
      for (GatewayTransactionTypeEnum b : GatewayTransactionTypeEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<GatewayTransactionTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final GatewayTransactionTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public GatewayTransactionTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return GatewayTransactionTypeEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_GATEWAY_TRANSACTION_TYPE = "GatewayTransactionType";
  @SerializedName(SERIALIZED_NAME_GATEWAY_TRANSACTION_TYPE)
  private GatewayTransactionTypeEnum gatewayTransactionType;
  ...
  @SerializedName(SERIALIZED_NAME_REQUEST_STRING)
  ...
  public ProxyGetPaymentTransactionLog() {
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "The response code returned by the payment gateway referring to the AVS international response of the payment transaction. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the batch used to send the transaction if the request was sent in a batch. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The response code returned by the payment gateway referring to the CVV international response of the payment transaction. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the payment gateway used to transact the current payment transaction log. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The code returned by the payment gateway for the payment. This code is gateway-dependent. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The message returned by the payment gateway for the payment. This message is gateway-dependent.  ")
  ...
  public ProxyGetPaymentTransactionLog gatewayState(GatewayStateEnum gatewayState) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The state of the transaction at the payment gateway. ")
  ...
  public ProxyGetPaymentTransactionLog gatewayTransactionType(GatewayTransactionTypeEnum gatewayTransactionType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the transaction, either making a payment, or canceling a payment.  ")

  public GatewayTransactionTypeEnum getGatewayTransactionType() {
    return gatewayTransactionType;
  }


  public void setGatewayTransactionType(GatewayTransactionTypeEnum gatewayTransactionType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the payment transaction log. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the payment wherein the payment transaction log was recorded.  ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The payment transaction request string sent to the payment gateway.  ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The payment transaction response string returned by the payment gateway.  ")
  ...
  public ProxyGetPaymentTransactionLog transactionDate(OffsetDateTime transactionDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The transaction date when the payment was performed.  ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The transaction ID returned by the payment gateway. This field is used to reconcile payment transactions between the payment gateway and records in Zuora. ")
   ...
   * @return the ProxyGetPaymentTransactionLog instance itself
   */
  public ProxyGetPaymentTransactionLog putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avSResponseCode, proxyGetPaymentTransactionLog.avSResponseCode) &&
        ...
        Objects.equals(this.additionalProperties, proxyGetPaymentTransactionLog.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(avSResponseCode, batchId, cvVResponseCode, gateway, gatewayReasonCode, gatewayReasonCodeDescription, gatewayState, gatewayTransactionType, id, paymentId, requestString, responseString, transactionDate, transactionId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProxyGetPaymentTransactionLog
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProxyGetPaymentTransactionLog.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProxyGetPaymentTransactionLog is not found in the empty JSON string", ProxyGetPaymentTransactionLog.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("GatewayReasonCode") != null && !jsonObj.get("GatewayReasonCode").isJsonNull()) && !jsonObj.get("GatewayReasonCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `GatewayReasonCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("GatewayReasonCode").toString()));
      }
      if ((jsonObj.get("GatewayReasonCodeDescription") != null && !jsonObj.get("GatewayReasonCodeDescription").isJsonNull()) && !jsonObj.get("GatewayReasonCodeDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `GatewayReasonCodeDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("GatewayReasonCodeDescription").toString()));
      }
      ...
      if ((jsonObj.get("GatewayTransactionType") != null && !jsonObj.get("GatewayTransactionType").isJsonNull()) && !jsonObj.get("GatewayTransactionType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `GatewayTransactionType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("GatewayTransactionType").toString()));
      }
      ...
      if ((jsonObj.get("RequestString") != null && !jsonObj.get("RequestString").isJsonNull()) && !jsonObj.get("RequestString").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `RequestString` to be a primitive type in the JSON string but got `%s`", jsonObj.get("RequestString").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProxyGetPaymentTransactionLog.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProxyGetPaymentTransactionLog' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProxyGetPaymentTransactionLog> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProxyGetPaymentTransactionLog.class));

       return (TypeAdapter<T>) new TypeAdapter<ProxyGetPaymentTransactionLog>() {
           @Override
           public void write(JsonWriter out, ProxyGetPaymentTransactionLog value) throws IOException {
           ...
           @Override
           public ProxyGetPaymentTransactionLog read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProxyGetPaymentTransactionLog instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProxyGetPaymentTransactionLog given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProxyGetPaymentTransactionLog
  * @throws IOException if the JSON string is invalid with respect to ProxyGetPaymentTransactionLog
  */
  public static ProxyGetPaymentTransactionLog fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProxyGetPaymentTransactionLog.class);
  }

 /**
  * Convert an instance of ProxyGetPaymentTransactionLog to an JSON string
  *
  * @return JSON string
  */
