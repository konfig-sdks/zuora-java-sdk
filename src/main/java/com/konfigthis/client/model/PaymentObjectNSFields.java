 ...
 */
@ApiModel(description = "Container for Payment fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PaymentObjectNSFields {
  ...
  public PaymentObjectNSFields() {
  }

  public PaymentObjectNSFields integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public PaymentObjectNSFields integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public PaymentObjectNSFields originNS(String originNS) {
  ...
  **/
  ...
  public PaymentObjectNSFields syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public PaymentObjectNSFields transactionNS(String transactionNS) {
  ...
  **/
   ...
   * @return the PaymentObjectNSFields instance itself
   */
  public PaymentObjectNSFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentObjectNSFields paymentObjectNSFields = (PaymentObjectNSFields) o;
    return Objects.equals(this.integrationIdNS, paymentObjectNSFields.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, paymentObjectNSFields.integrationStatusNS) &&
        Objects.equals(this.originNS, paymentObjectNSFields.originNS) &&
        Objects.equals(this.syncDateNS, paymentObjectNSFields.syncDateNS) &&
        Objects.equals(this.transactionNS, paymentObjectNSFields.transactionNS)&&
        Objects.equals(this.additionalProperties, paymentObjectNSFields.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentObjectNSFields {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentObjectNSFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentObjectNSFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentObjectNSFields is not found in the empty JSON string", PaymentObjectNSFields.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentObjectNSFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentObjectNSFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentObjectNSFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentObjectNSFields.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentObjectNSFields>() {
           @Override
           public void write(JsonWriter out, PaymentObjectNSFields value) throws IOException {
           ...
           @Override
           public PaymentObjectNSFields read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentObjectNSFields instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentObjectNSFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentObjectNSFields
  * @throws IOException if the JSON string is invalid with respect to PaymentObjectNSFields
  */
  public static PaymentObjectNSFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentObjectNSFields.class);
  }

 /**
  * Convert an instance of PaymentObjectNSFields to an JSON string
  *
  * @return JSON string
  */
