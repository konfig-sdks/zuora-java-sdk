...
import com.konfigthis.client.model.POSTSubscriptionPreviewInvoiceItemsType;
import com.konfigthis.client.model.POSTSubscriptionPreviewResponseTypeChargeMetrics;
import com.konfigthis.client.model.POSTSubscriptionPreviewResponseTypeCreditMemo;
import com.konfigthis.client.model.POSTSubscriptionPreviewResponseTypeInvoice;
...
public class POSTSubscriptionPreviewResponseType {
  ...
  private POSTSubscriptionPreviewResponseTypeChargeMetrics chargeMetrics;
  ...
  private POSTSubscriptionPreviewResponseTypeCreditMemo creditMemo;
  ...
  private POSTSubscriptionPreviewResponseTypeInvoice invoice;

  public static final String SERIALIZED_NAME_INVOICE_ITEMS = "invoiceItems";
  @SerializedName(SERIALIZED_NAME_INVOICE_ITEMS)
  private List<POSTSubscriptionPreviewInvoiceItemsType> invoiceItems = null;
  ...
  public POSTSubscriptionPreviewResponseType() {
  }

  public POSTSubscriptionPreviewResponseType amount(Double amount) {
  ...
  public POSTSubscriptionPreviewResponseType amount(Integer amount) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewResponseType amountWithoutTax(Double amountWithoutTax) {
  ...
  public POSTSubscriptionPreviewResponseType amountWithoutTax(Integer amountWithoutTax) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewResponseType contractedMrr(Double contractedMrr) {
  ...
  public POSTSubscriptionPreviewResponseType contractedMrr(Integer contractedMrr) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewResponseType creditMemo(POSTSubscriptionPreviewResponseTypeCreditMemo creditMemo) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewResponseTypeCreditMemo getCreditMemo() {
    return creditMemo;
  }


  public void setCreditMemo(POSTSubscriptionPreviewResponseTypeCreditMemo creditMemo) {
  ...
  public POSTSubscriptionPreviewResponseType documentDate(LocalDate documentDate) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewResponseType invoice(POSTSubscriptionPreviewResponseTypeInvoice invoice) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewResponseTypeInvoice getInvoice() {
    return invoice;
  }


  public void setInvoice(POSTSubscriptionPreviewResponseTypeInvoice invoice) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewResponseType invoiceTargetDate(LocalDate invoiceTargetDate) {
   ...
   /**
   * Date through which charges are calculated on the invoice, as yyyy-mm-dd.  **Note:** This field is only available if you do not specify the Zuora REST API minor version or specify the minor version to 186.0, 187.0, 188.0, 189.0, 196.0, and 206.0. 
   * @return invoiceTargetDate
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date through which charges are calculated on the invoice, as yyyy-mm-dd.  **Note:** This field is only available if you do not specify the Zuora REST API minor version or specify the minor version to 186.0, 187.0, 188.0, 189.0, 196.0, and 206.0. ")
  ...
  **/
  ...
  public POSTSubscriptionPreviewResponseType targetDate(LocalDate targetDate) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewResponseType taxAmount(Double taxAmount) {
  ...
  public POSTSubscriptionPreviewResponseType taxAmount(Integer taxAmount) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewResponseType totalContractedValue(Double totalContractedValue) {
  ...
  public POSTSubscriptionPreviewResponseType totalContractedValue(Integer totalContractedValue) {
  ...
  **/
   ...
   * @return the POSTSubscriptionPreviewResponseType instance itself
   */
  public POSTSubscriptionPreviewResponseType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, poSTSubscriptionPreviewResponseType.amount) &&
        ...
        Objects.equals(this.creditMemo, poSTSubscriptionPreviewResponseType.creditMemo) &&
        Objects.equals(this.documentDate, poSTSubscriptionPreviewResponseType.documentDate) &&
        Objects.equals(this.invoice, poSTSubscriptionPreviewResponseType.invoice) &&
        ...
        Objects.equals(this.targetDate, poSTSubscriptionPreviewResponseType.targetDate) &&
        ...
        Objects.equals(this.additionalProperties, poSTSubscriptionPreviewResponseType.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTSubscriptionPreviewResponseType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTSubscriptionPreviewResponseType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTSubscriptionPreviewResponseType is not found in the empty JSON string", POSTSubscriptionPreviewResponseType.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `chargeMetrics`
      if (jsonObj.get("chargeMetrics") != null && !jsonObj.get("chargeMetrics").isJsonNull()) {
        POSTSubscriptionPreviewResponseTypeChargeMetrics.validateJsonObject(jsonObj.getAsJsonObject("chargeMetrics"));
      }
      // validate the optional field `creditMemo`
      if (jsonObj.get("creditMemo") != null && !jsonObj.get("creditMemo").isJsonNull()) {
        POSTSubscriptionPreviewResponseTypeCreditMemo.validateJsonObject(jsonObj.getAsJsonObject("creditMemo"));
      }
      // validate the optional field `invoice`
      if (jsonObj.get("invoice") != null && !jsonObj.get("invoice").isJsonNull()) {
        POSTSubscriptionPreviewResponseTypeInvoice.validateJsonObject(jsonObj.getAsJsonObject("invoice"));
      }
      if (jsonObj.get("invoiceItems") != null && !jsonObj.get("invoiceItems").isJsonNull()) {
        ...
        if (jsonArrayinvoiceItems != null) {
          ...
          for (int i = 0; i < jsonArrayinvoiceItems.size(); i++) {
            POSTSubscriptionPreviewInvoiceItemsType.validateJsonObject(jsonArrayinvoiceItems.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTSubscriptionPreviewResponseType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTSubscriptionPreviewResponseType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTSubscriptionPreviewResponseType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTSubscriptionPreviewResponseType.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTSubscriptionPreviewResponseType>() {
           @Override
           public void write(JsonWriter out, POSTSubscriptionPreviewResponseType value) throws IOException {
           ...
           @Override
           public POSTSubscriptionPreviewResponseType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTSubscriptionPreviewResponseType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTSubscriptionPreviewResponseType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTSubscriptionPreviewResponseType
  * @throws IOException if the JSON string is invalid with respect to POSTSubscriptionPreviewResponseType
  */
  public static POSTSubscriptionPreviewResponseType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTSubscriptionPreviewResponseType.class);
  }

 /**
  * Convert an instance of POSTSubscriptionPreviewResponseType to an JSON string
  *
  * @return JSON string
  */
