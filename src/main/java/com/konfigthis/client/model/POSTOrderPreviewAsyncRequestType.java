...
public class POSTOrderPreviewAsyncRequestType {
 ...
 public enum CategoryEnum {
  ...
  private List<POSTOrderPreviewRequestTypeSubscriptionsInner> subscriptions = null;

  public POSTOrderPreviewAsyncRequestType() {
  }

  public POSTOrderPreviewAsyncRequestType description(String description) {
  ...
  **/
  ...
  public POSTOrderPreviewAsyncRequestType category(CategoryEnum category) {
  ...
  **/
  ...
  public POSTOrderPreviewAsyncRequestType customFields(Map<String, Object> customFields) {
  ...
  public POSTOrderPreviewAsyncRequestType putCustomFieldsItem(String key, Object customFieldsItem) {
  ...
  **/
  ...
  public POSTOrderPreviewAsyncRequestType existingAccountNumber(String existingAccountNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "A00000101", value = "The account number that this order will be created under.  Note that invoice owner account of the subscriptions included in this order should be the same with the account of the order. ")
  ...
  public POSTOrderPreviewAsyncRequestType orderDate(LocalDate orderDate) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Sun Sep 30 17:00:00 PDT 2018", required = true, value = "The date when the order is signed. All of the order actions under this order will use this order date as the contract effective date.")
  ...
  public POSTOrderPreviewAsyncRequestType orderLineItems(List<OrderLineItemCommonPostOrder> orderLineItems) {
  ...
  public POSTOrderPreviewAsyncRequestType addOrderLineItemsItem(OrderLineItemCommonPostOrder orderLineItemsItem) {
  ...
  **/
  ...
  public POSTOrderPreviewAsyncRequestType orderNumber(String orderNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The order number of this order.    **Note:** Make sure the order number does not contain a slash. ")
  ...
  public POSTOrderPreviewAsyncRequestType previewAccountInfo(PreviewAccountInfo previewAccountInfo) {
  ...
  **/
  ...
  public POSTOrderPreviewAsyncRequestType previewOptions(PreviewOptions previewOptions) {
  ...
  **/
  ...
  public POSTOrderPreviewAsyncRequestType reasonCode(String reasonCode) {
  ...
  **/
  ...
  public POSTOrderPreviewAsyncRequestType subscriptions(List<POSTOrderPreviewRequestTypeSubscriptionsInner> subscriptions) {
  ...
  public POSTOrderPreviewAsyncRequestType addSubscriptionsItem(POSTOrderPreviewRequestTypeSubscriptionsInner subscriptionsItem) {
  ...
  **/
  ...
  public List<POSTOrderPreviewRequestTypeSubscriptionsInner> getSubscriptions() {
    return subscriptions;
  }


  public void setSubscriptions(List<POSTOrderPreviewRequestTypeSubscriptionsInner> subscriptions) {
   ...
   * @return the POSTOrderPreviewAsyncRequestType instance itself
   */
  public POSTOrderPreviewAsyncRequestType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTOrderPreviewAsyncRequestType poSTOrderPreviewAsyncRequestType = (POSTOrderPreviewAsyncRequestType) o;
    return Objects.equals(this.description, poSTOrderPreviewAsyncRequestType.description) &&
        Objects.equals(this.category, poSTOrderPreviewAsyncRequestType.category) &&
        Objects.equals(this.customFields, poSTOrderPreviewAsyncRequestType.customFields) &&
        Objects.equals(this.existingAccountNumber, poSTOrderPreviewAsyncRequestType.existingAccountNumber) &&
        Objects.equals(this.orderDate, poSTOrderPreviewAsyncRequestType.orderDate) &&
        Objects.equals(this.orderLineItems, poSTOrderPreviewAsyncRequestType.orderLineItems) &&
        Objects.equals(this.orderNumber, poSTOrderPreviewAsyncRequestType.orderNumber) &&
        Objects.equals(this.previewAccountInfo, poSTOrderPreviewAsyncRequestType.previewAccountInfo) &&
        Objects.equals(this.previewOptions, poSTOrderPreviewAsyncRequestType.previewOptions) &&
        Objects.equals(this.reasonCode, poSTOrderPreviewAsyncRequestType.reasonCode) &&
        Objects.equals(this.subscriptions, poSTOrderPreviewAsyncRequestType.subscriptions)&&
        Objects.equals(this.additionalProperties, poSTOrderPreviewAsyncRequestType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, category, customFields, existingAccountNumber, orderDate, orderLineItems, orderNumber, previewAccountInfo, previewOptions, reasonCode, subscriptions, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class POSTOrderPreviewAsyncRequestType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTOrderPreviewAsyncRequestType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTOrderPreviewAsyncRequestType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTOrderPreviewAsyncRequestType is not found in the empty JSON string", POSTOrderPreviewAsyncRequestType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : POSTOrderPreviewAsyncRequestType.openapiRequiredFields) {
      ...
      if (jsonObj.get("previewAccountInfo") != null && !jsonObj.get("previewAccountInfo").isJsonNull()) {
        PreviewAccountInfo.validateJsonObject(jsonObj.getAsJsonObject("previewAccountInfo"));
      }
      // validate the required field `previewOptions`
      PreviewOptions.validateJsonObject(jsonObj.getAsJsonObject("previewOptions"));
      ...
      if (jsonObj.get("subscriptions") != null && !jsonObj.get("subscriptions").isJsonNull()) {
        ...
        if (jsonArraysubscriptions != null) {
          ...
          for (int i = 0; i < jsonArraysubscriptions.size(); i++) {
            POSTOrderPreviewRequestTypeSubscriptionsInner.validateJsonObject(jsonArraysubscriptions.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTOrderPreviewAsyncRequestType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTOrderPreviewAsyncRequestType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTOrderPreviewAsyncRequestType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTOrderPreviewAsyncRequestType.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTOrderPreviewAsyncRequestType>() {
           @Override
           public void write(JsonWriter out, POSTOrderPreviewAsyncRequestType value) throws IOException {
           ...
           @Override
           public POSTOrderPreviewAsyncRequestType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTOrderPreviewAsyncRequestType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTOrderPreviewAsyncRequestType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTOrderPreviewAsyncRequestType
  * @throws IOException if the JSON string is invalid with respect to POSTOrderPreviewAsyncRequestType
  */
  public static POSTOrderPreviewAsyncRequestType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTOrderPreviewAsyncRequestType.class);
  }

 /**
  * Convert an instance of POSTOrderPreviewAsyncRequestType to an JSON string
  *
  * @return JSON string
  */
