 ...
 */
@ApiModel(description = "Container for discount Item fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DiscountItemObjectNSFields {
  ...
  public DiscountItemObjectNSFields() {
  }

  public DiscountItemObjectNSFields integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public DiscountItemObjectNSFields integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public DiscountItemObjectNSFields syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the DiscountItemObjectNSFields instance itself
   */
  public DiscountItemObjectNSFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DiscountItemObjectNSFields discountItemObjectNSFields = (DiscountItemObjectNSFields) o;
    return Objects.equals(this.integrationIdNS, discountItemObjectNSFields.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, discountItemObjectNSFields.integrationStatusNS) &&
        Objects.equals(this.syncDateNS, discountItemObjectNSFields.syncDateNS)&&
        Objects.equals(this.additionalProperties, discountItemObjectNSFields.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DiscountItemObjectNSFields {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DiscountItemObjectNSFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DiscountItemObjectNSFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DiscountItemObjectNSFields is not found in the empty JSON string", DiscountItemObjectNSFields.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiscountItemObjectNSFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiscountItemObjectNSFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiscountItemObjectNSFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiscountItemObjectNSFields.class));

       return (TypeAdapter<T>) new TypeAdapter<DiscountItemObjectNSFields>() {
           @Override
           public void write(JsonWriter out, DiscountItemObjectNSFields value) throws IOException {
           ...
           @Override
           public DiscountItemObjectNSFields read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DiscountItemObjectNSFields instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DiscountItemObjectNSFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DiscountItemObjectNSFields
  * @throws IOException if the JSON string is invalid with respect to DiscountItemObjectNSFields
  */
  public static DiscountItemObjectNSFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiscountItemObjectNSFields.class);
  }

 /**
  * Convert an instance of DiscountItemObjectNSFields to an JSON string
  *
  * @return JSON string
  */
