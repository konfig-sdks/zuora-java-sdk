...
public class PUTSubscriptionSuspendType {
 ...
 public enum RunBillingEnum {
  ...
  public static final String SERIALIZED_NAME_SUSPEND_PERIODS = "suspendPeriods";
  @SerializedName(SERIALIZED_NAME_SUSPEND_PERIODS)
  private String suspendPeriods;

  public static final String SERIALIZED_NAME_SUSPEND_PERIODS_TYPE = "suspendPeriodsType";
  @SerializedName(SERIALIZED_NAME_SUSPEND_PERIODS_TYPE)
  private String suspendPeriodsType;

  public static final String SERIALIZED_NAME_SUSPEND_POLICY = "suspendPolicy";
  @SerializedName(SERIALIZED_NAME_SUSPEND_POLICY)
  private String suspendPolicy;

  public static final String SERIALIZED_NAME_SUSPEND_SPECIFIC_DATE = "suspendSpecificDate";
  @SerializedName(SERIALIZED_NAME_SUSPEND_SPECIFIC_DATE)
  ...
  public PUTSubscriptionSuspendType applicationOrder(List<String> applicationOrder) {
  ...
  public PUTSubscriptionSuspendType addApplicationOrderItem(String applicationOrderItem) {
  ...
  **/
  ...
  public PUTSubscriptionSuspendType applyCredit(Boolean applyCredit) {
  ...
  **/
  ...
  public PUTSubscriptionSuspendType bookingDate(LocalDate bookingDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The booking date that you want to set for the amendment contract when you suspend the subscription. If `resume` is `true`, which means you also choose to resume the subscription at some point, then this field is also the booking date for the Resume amendment contract.  This field must be in the `yyyy-mm-dd` format. The default value of this field is the current date when you make the API call.  ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Thu Jan 31 16:00:00 PST 2019", value = "The date when the customer notifies you that they want to amend their subscription. ")
  ...
  public PUTSubscriptionSuspendType creditMemoReasonCode(String creditMemoReasonCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Unsatisfactory service", value = "A code identifying the reason for the credit memo transaction that is generated by the request. The value must be an existing reason code. If you do not pass the field or pass the field with empty value, Zuora uses the default reason code.")
  ...
  public PUTSubscriptionSuspendType documentDate(LocalDate documentDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Whether to extend the subscription term by the length of time the suspension is in effect. Values: `true`, `false`. ")
  ...
  **/
  ...
  public PUTSubscriptionSuspendType invoiceCollect(Boolean invoiceCollect) {
   ...
   /**
   * **Note:** This field has been replaced by the &#x60;invoice&#x60; field and the &#x60;collect&#x60; field. &#x60;invoiceCollect&#x60; is available only for backward compatibility.   **Note**: This field is only available if you set the &#x60;zuora-version&#x60; request header to &#x60;186.0&#x60;, &#x60;187.0&#x60;, &#x60;188.0&#x60;, or &#x60;189.0&#x60;. 
   * @return invoiceCollect
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "**Note:** This field has been replaced by the `invoice` field and the `collect` field. `invoiceCollect` is available only for backward compatibility.   **Note**: This field is only available if you set the `zuora-version` request header to `186.0`, `187.0`, `188.0`, or `189.0`. ")
  ...
  **/
  ...
  public PUTSubscriptionSuspendType orderDate(LocalDate orderDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the order is signed. If no additinal contractEffectiveDate is provided, this order will use this order date as the contract effective date. This field must be in the `yyyy-mm-dd` format. This field is required for Orders customers only, not applicable to Orders Harmonization customers. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Whether to set when to resume a subscription when creating a suspend amendment. Values: `true`, `false`. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The period type used to define when the subscription resumption takes effect. The subscription resumption takes effect after a specified period based on the suspend date or today's date. You must use this field together with the resumePeriods field to specify the period.  Values: `Day`, `Week`, `Month`, `Year`  **Note:** This field is only applicable when the `suspendPolicy` field is set to `FixedPeriodsFromToday` or `FixedPeriodsFromSuspendDate`. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SpecificDate", value = "Resume methods. Specify a way to resume a subscription. Values:  * `Today`: The subscription resumption takes effect on today's date.  * `FixedPeriodsFromSuspendDate`: The subscription resumption takes effect after a specified period based on the suspend date. You must specify the `resumePeriods` and `resumePeriodsType` fields to define the period.  * `SpecificDate`: The subscription resumption takes effect on a specific date. You must define the specific date in the `resumeSpecificDate` field.  * `FixedPeriodsFromToday`: The subscription resumption takes effect after a specified period based on the today's date. You must specify the `resumePeriods` and `resumePeriodsType` fields to define the period. * `suspendDate`: The subscription resumption takes effect on the date of suspension of the subscription. ")
  ...
  **/
  ...
  public PUTSubscriptionSuspendType runBilling(RunBillingEnum runBilling) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10", value = "The length of the period used to specify when the subscription suspension takes effect. The subscription suspension takes effect after a specified period based on today's date. You must use this field together with the `suspendPeriodsType` field to specify the period.  **Note:** This field is only applicable only when the suspendPolicy field is set to FixedPeriodsFromToday. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Day", value = "The period type used to define when the subscription suspension takes effect. The subscription suspension takes effect after a specified period based on today's date. You must use this field together with the suspendPeriods field to specify the period.  Type: string (enum)  Values: `Day`, `Week`, `Month`, `Year`  **Note:** This field is only applicable only when the suspendPolicy field is set to FixedPeriodsFromToday. ")
  ...
  **/
  ...
  @ApiModelProperty(example = "FixedPeriodsFromToday", required = true, value = "Suspend methods. Specify a way to suspend a subscription.   Value:  * `Today`: The subscription suspension takes effect on today's date. * `EndOfLastInvoicePeriod`: The subscription suspension takes effect at the end of the last invoice period. The suspend date defaults to a date that is one day after the last invoiced period. You can choose this option to avoid any negative invoices (credits) issued back to the customer after the subscription suspension.  * `SpecificDate`: The subscription suspension takes effect on a specific date. You must define the specific date in the `suspendSpecificDate` field. * `FixedPeriodsFromToday`: The subscription suspension takes effect after a specified period based on today's date. You must specify the `suspendPeriods` and `suspendPeriodsType` fields to define the period. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A specific date when the subscription suspension takes effect, in the format yyyy-mm-dd.  **Note:** This field is only applicable only when the suspendPolicy field is set to SpecificDate.  The value should not be earlier than the subscription contract effective date, later than the subscription term end date, or within a period for which the customer has been invoiced. ")
  ...
  public PUTSubscriptionSuspendType targetDate(LocalDate targetDate) {
  ...
  **/
   ...
   * @return the PUTSubscriptionSuspendType instance itself
   */
  public PUTSubscriptionSuspendType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applicationOrder, puTSubscriptionSuspendType.applicationOrder) &&
        Objects.equals(this.applyCredit, puTSubscriptionSuspendType.applyCredit) &&
        Objects.equals(this.applyCreditBalance, puTSubscriptionSuspendType.applyCreditBalance) &&
        Objects.equals(this.bookingDate, puTSubscriptionSuspendType.bookingDate) &&
        ...
        Objects.equals(this.creditMemoReasonCode, puTSubscriptionSuspendType.creditMemoReasonCode) &&
        Objects.equals(this.documentDate, puTSubscriptionSuspendType.documentDate) &&
        ...
        Objects.equals(this.orderDate, puTSubscriptionSuspendType.orderDate) &&
        ...
        Objects.equals(this.runBilling, puTSubscriptionSuspendType.runBilling) &&
        ...
        Objects.equals(this.targetDate, puTSubscriptionSuspendType.targetDate)&&
        Objects.equals(this.additionalProperties, puTSubscriptionSuspendType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicationOrder, applyCredit, applyCreditBalance, bookingDate, collect, contractEffectiveDate, creditMemoReasonCode, documentDate, extendsTerm, invoice, invoiceCollect, invoiceTargetDate, orderDate, resume, resumePeriods, resumePeriodsType, resumePolicy, resumeSpecificDate, runBilling, suspendPeriods, suspendPeriodsType, suspendPolicy, suspendSpecificDate, targetDate, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("suspendPeriods");
    openapiFields.add("suspendPeriodsType");
    openapiFields.add("suspendPolicy");
    openapiFields.add("suspendSpecificDate");
    openapiFields.add("targetDate");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("suspendPolicy");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTSubscriptionSuspendType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTSubscriptionSuspendType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTSubscriptionSuspendType is not found in the empty JSON string", PUTSubscriptionSuspendType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PUTSubscriptionSuspendType.openapiRequiredFields) {
      ...
      if ((jsonObj.get("resumePolicy") != null && !jsonObj.get("resumePolicy").isJsonNull()) && !jsonObj.get("resumePolicy").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("suspendPeriods") != null && !jsonObj.get("suspendPeriods").isJsonNull()) && !jsonObj.get("suspendPeriods").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `suspendPeriods` to be a primitive type in the JSON string but got `%s`", jsonObj.get("suspendPeriods").toString()));
      }
      if ((jsonObj.get("suspendPeriodsType") != null && !jsonObj.get("suspendPeriodsType").isJsonNull()) && !jsonObj.get("suspendPeriodsType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `suspendPeriodsType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("suspendPeriodsType").toString()));
      }
      if (!jsonObj.get("suspendPolicy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `suspendPolicy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("suspendPolicy").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTSubscriptionSuspendType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTSubscriptionSuspendType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTSubscriptionSuspendType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTSubscriptionSuspendType.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTSubscriptionSuspendType>() {
           @Override
           public void write(JsonWriter out, PUTSubscriptionSuspendType value) throws IOException {
           ...
           @Override
           public PUTSubscriptionSuspendType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTSubscriptionSuspendType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTSubscriptionSuspendType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTSubscriptionSuspendType
  * @throws IOException if the JSON string is invalid with respect to PUTSubscriptionSuspendType
  */
  public static PUTSubscriptionSuspendType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTSubscriptionSuspendType.class);
  }

 /**
  * Convert an instance of PUTSubscriptionSuspendType to an JSON string
  *
  * @return JSON string
  */
