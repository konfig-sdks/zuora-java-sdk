...
public class DocumentList {
  ...
  public DocumentList docType(String docType) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Invoice", value = "The Type of the Billing Document")
  ...
  public DocumentList objectIds(List<String> objectIds) {
  ...
  public DocumentList addObjectIdsItem(String objectIdsItem) {
   ...
   /**
   * Collection of Billing Document IDs
   * @return objectIds
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Collection of Billing Document IDs")
   ...
   * @return the DocumentList instance itself
   */
  public DocumentList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.docType, documentList.docType) &&
        Objects.equals(this.objectIds, documentList.objectIds)&&
        Objects.equals(this.additionalProperties, documentList.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(docType, objectIds, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DocumentList>() {
           ...
           public DocumentList read(JsonReader in) throws IOException {
             ...
             DocumentList instance = thisAdapter.fromJsonTree(jsonObj);
