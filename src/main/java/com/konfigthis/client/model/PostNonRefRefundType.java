...
public class PostNonRefRefundType {
  ...
  private List<CreditMemoFromChargeCustomRatesType> customRates = null;
  ...
  private List<RefundCreditMemoItemType> items = null;
 ...
 public enum TypeEnum {
  ...
  public PostNonRefRefundType() {
  }

  public PostNonRefRefundType comment(String comment) {
  ...
  **/
  ...
  public PostNonRefRefundType customRates(List<CreditMemoFromChargeCustomRatesType> customRates) {
  ...
  public PostNonRefRefundType addCustomRatesItem(CreditMemoFromChargeCustomRatesType customRatesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "It contains Home currency and Reporting currency custom rates currencies. The maximum number of items is 2 (you can pass the Home currency item, Reporting currency item, or both).  **Note**: The API custom rate feature is permission controlled. ")

  public List<CreditMemoFromChargeCustomRatesType> getCustomRates() {
    return customRates;
  }


  public void setCustomRates(List<CreditMemoFromChargeCustomRatesType> customRates) {
  ...
  public PostNonRefRefundType financeInformation(PostNonRefRefundTypeAllOfFinanceInformation financeInformation) {
  ...
  **/
  ...
  public PostNonRefRefundTypeAllOfFinanceInformation getFinanceInformation() {
    return financeInformation;
  }


  public void setFinanceInformation(PostNonRefRefundTypeAllOfFinanceInformation financeInformation) {
  ...
  public PostNonRefRefundType gatewayId(String gatewayId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the gateway instance that processes the refund. This field can be specified only for electronic refunds. The ID must be a valid gateway instance ID, and this gateway must support the specific payment method.   If no gateway ID is specified, the default gateway in the billing account configuration will be used. If no gateway is specified in the billing account, the default gateway of the corresponding tenant will be used. ")
  ...
  public PostNonRefRefundType gatewayOptions(PostNonRefRefundTypeAllOfGatewayOptions gatewayOptions) {
  ...
  **/
  ...
  public PostNonRefRefundTypeAllOfGatewayOptions getGatewayOptions() {
    return gatewayOptions;
  }


  public void setGatewayOptions(PostNonRefRefundTypeAllOfGatewayOptions gatewayOptions) {
  ...
  public PostNonRefRefundType items(List<RefundCreditMemoItemType> items) {
  ...
  public PostNonRefRefundType addItemsItem(RefundCreditMemoItemType itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for credit memo items. The maximum number of items is 1,000.  **Note:** This field is only available if you have the [Invoice Item Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/C_Invoice_Item_Settlement) feature enabled. Invoice Item Settlement must be used together with other Invoice Settlement features (Unapplied Payments, and Credit and Debit memos).  If you wish to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. ")

  public List<RefundCreditMemoItemType> getItems() {
    return items;
  }


  public void setItems(List<RefundCreditMemoItemType> items) {
  ...
  public PostNonRefRefundType methodType(MethodTypeEnum methodType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "How an external refund was issued to a customer. This field is required for an external refund and must be left empty for an electronic refund. You can issue an external refund on a credit memo. ")
  ...
  public PostNonRefRefundType paymentMethodId(String paymentMethodId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the payment method used for the refund. This field is required for an electronic refund, and the value must be an electronic payment method ID. This field must be left empty for an external refund.  ")
  ...
  public PostNonRefRefundType reasonCode(String reasonCode) {
  ...
  **/
  ...
  public PostNonRefRefundType referenceId(String referenceId) {
  ...
  **/
  ...
  public PostNonRefRefundType refundDate(LocalDate refundDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the refund takes effect, in `yyyy-mm-dd` format. The date of the refund cannot be before the credit memo date. Specify this field only for external refunds. Zuora automatically generates this field for electronic refunds. ")
  ...
  public PostNonRefRefundType secondRefundReferenceId(String secondRefundReferenceId) {
  ...
  **/
  ...
  public PostNonRefRefundType softDescriptor(String softDescriptor) {
  ...
  **/
  ...
  public PostNonRefRefundType softDescriptorPhone(String softDescriptorPhone) {
  ...
  **/
  ...
  public PostNonRefRefundType totalAmount(Double totalAmount) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The total amount of the refund. The amount cannot exceed the unapplied amount of the associated credit memo. If the original credit memo was applied to one or more invoices or debit memos, you have to unapply a full or partial credit memo from the invoices or debit memos, and then refund the full or partial unapplied credit memo to your customers. ")
  ...
  public PostNonRefRefundType type(TypeEnum type) {
  ...
  **/
  ...
  public PostNonRefRefundType integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public PostNonRefRefundType integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public PostNonRefRefundType originNS(String originNS) {
  ...
  **/
  ...
  public PostNonRefRefundType syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public PostNonRefRefundType synctoNetSuiteNS(String synctoNetSuiteNS) {
  ...
  **/
   ...
   * @return the PostNonRefRefundType instance itself
   */
  public PostNonRefRefundType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PostNonRefRefundType postNonRefRefundType = (PostNonRefRefundType) o;
    return Objects.equals(this.comment, postNonRefRefundType.comment) &&
        Objects.equals(this.customRates, postNonRefRefundType.customRates) &&
        Objects.equals(this.financeInformation, postNonRefRefundType.financeInformation) &&
        Objects.equals(this.gatewayId, postNonRefRefundType.gatewayId) &&
        Objects.equals(this.gatewayOptions, postNonRefRefundType.gatewayOptions) &&
        Objects.equals(this.items, postNonRefRefundType.items) &&
        Objects.equals(this.methodType, postNonRefRefundType.methodType) &&
        Objects.equals(this.paymentMethodId, postNonRefRefundType.paymentMethodId) &&
        Objects.equals(this.reasonCode, postNonRefRefundType.reasonCode) &&
        Objects.equals(this.referenceId, postNonRefRefundType.referenceId) &&
        Objects.equals(this.refundDate, postNonRefRefundType.refundDate) &&
        Objects.equals(this.secondRefundReferenceId, postNonRefRefundType.secondRefundReferenceId) &&
        Objects.equals(this.softDescriptor, postNonRefRefundType.softDescriptor) &&
        Objects.equals(this.softDescriptorPhone, postNonRefRefundType.softDescriptorPhone) &&
        Objects.equals(this.totalAmount, postNonRefRefundType.totalAmount) &&
        Objects.equals(this.type, postNonRefRefundType.type) &&
        Objects.equals(this.integrationIdNS, postNonRefRefundType.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, postNonRefRefundType.integrationStatusNS) &&
        Objects.equals(this.originNS, postNonRefRefundType.originNS) &&
        Objects.equals(this.syncDateNS, postNonRefRefundType.syncDateNS) &&
        Objects.equals(this.synctoNetSuiteNS, postNonRefRefundType.synctoNetSuiteNS)&&
        Objects.equals(this.additionalProperties, postNonRefRefundType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, customRates, financeInformation, gatewayId, gatewayOptions, items, methodType, paymentMethodId, reasonCode, referenceId, refundDate, secondRefundReferenceId, softDescriptor, softDescriptorPhone, totalAmount, type, integrationIdNS, integrationStatusNS, originNS, syncDateNS, synctoNetSuiteNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostNonRefRefundType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PostNonRefRefundType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PostNonRefRefundType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostNonRefRefundType is not found in the empty JSON string", PostNonRefRefundType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostNonRefRefundType.openapiRequiredFields) {
      ...
      if (jsonObj.get("customRates") != null && !jsonObj.get("customRates").isJsonNull()) {
        ...
        if (jsonArraycustomRates != null) {
          ...
          for (int i = 0; i < jsonArraycustomRates.size(); i++) {
            CreditMemoFromChargeCustomRatesType.validateJsonObject(jsonArraycustomRates.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("financeInformation") != null && !jsonObj.get("financeInformation").isJsonNull()) {
        PostNonRefRefundTypeAllOfFinanceInformation.validateJsonObject(jsonObj.getAsJsonObject("financeInformation"));
      }
      ...
      if (jsonObj.get("gatewayOptions") != null && !jsonObj.get("gatewayOptions").isJsonNull()) {
        PostNonRefRefundTypeAllOfGatewayOptions.validateJsonObject(jsonObj.getAsJsonObject("gatewayOptions"));
      }
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            RefundCreditMemoItemType.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostNonRefRefundType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostNonRefRefundType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostNonRefRefundType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostNonRefRefundType.class));

       return (TypeAdapter<T>) new TypeAdapter<PostNonRefRefundType>() {
           @Override
           public void write(JsonWriter out, PostNonRefRefundType value) throws IOException {
           ...
           @Override
           public PostNonRefRefundType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PostNonRefRefundType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PostNonRefRefundType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PostNonRefRefundType
  * @throws IOException if the JSON string is invalid with respect to PostNonRefRefundType
  */
  public static PostNonRefRefundType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostNonRefRefundType.class);
  }

 /**
  * Convert an instance of PostNonRefRefundType to an JSON string
  *
  * @return JSON string
  */
