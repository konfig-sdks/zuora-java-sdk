...
import com.konfigthis.client.model.SubmitDataQueryRequestOutput;
...
public class SubmitDataQueryRequest {
  ...
  **/
  ...
  @ApiModelProperty(value = "The column separator. Only applicable if the `outputFormat` is `DSV`. ")
  ...
  public SubmitDataQueryRequest compression(CompressionEnum compression) {
  ...
  **/
  ...
  @ApiModelProperty(example = "NONE", required = true, value = "Specifies whether Zuora compresses the query results. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Base-64 encoded public key of an RSA key-pair.   Note that Data Query only supports 1024-bit RSA keys.  If you set this field, Zuora encrypts the query results using the provided public key. You must use the corresponding private key to decrypt the query results. ")
  ...
  **/
  ...
  public SubmitDataQueryRequest outputFormat(OutputFormatEnum outputFormat) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "JSON", required = true, value = "Specifies the format of the query results.  * `JSON` - Each row in the query results will be a JSON object. The format of the query result file is [JSON Lines](http://jsonlines.org/). * `CSV` - Each row in the query results will be a comma-separated list of values. * `TSV` - Each row in the query results will be a tab-separated list of values. * `DSV` - Pass any character as your custom delimiter into the `columnSeparator` field. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "SELECT accountnumber, balance FROM Account WHERE Account.balance > 100", required = true, value = "The query to perform. See [SQL Queries in Data Query](https://knowledgecenter.zuora.com/DC_Developers/BA_Data_Query/BA_SQL_Queries_in_Data_Query) for more information. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Indicates whether the query will retrieve only the deleted record. If `readDeleted` is set to `false` or it is not included in the request body, the query will retrieve only the non-deleted records. If it is set to `true`, only the deleted records will be retrieved.  If you select the `deleted` column in the `query` field, both non-deleted and deleted records will be retrieved regardless of the value in the `readDeleted` field.  Note that Data Query is subject to Zuora Data Retention Policy. The retention period of deleted data is 30 days. You can only retrieve deleted data for 30 days through Data Query. ")
  ...
  public SubmitDataQueryRequest sourceData(SourceDataEnum sourceData) {
  ...
  **/
  ...
  public SubmitDataQueryRequest warehouseSize(WarehouseSizeEnum warehouseSize) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columnSeparator, submitDataQueryRequest.columnSeparator) &&
        ...
        Objects.equals(this.warehouseSize, submitDataQueryRequest.warehouseSize)&&
        Objects.equals(this.additionalProperties, submitDataQueryRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(columnSeparator, compression, Arrays.hashCode(encryptionKey), output, outputFormat, query, readDeleted, sourceData, useIndexJoin, warehouseSize, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubmitDataQueryRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubmitDataQueryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      SubmitDataQueryRequestOutput.validateJsonObject(jsonObj.getAsJsonObject("output"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<SubmitDataQueryRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubmitDataQueryRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SubmitDataQueryRequest>() {
           @Override
