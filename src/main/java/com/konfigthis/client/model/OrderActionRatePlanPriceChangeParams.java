...
public class OrderActionRatePlanPriceChangeParams {
  /**
 ...
 public enum PriceChangeOptionEnum {
  ...
  public OrderActionRatePlanPriceChangeParams() {
  }

  public OrderActionRatePlanPriceChangeParams priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public OrderActionRatePlanPriceChangeParams priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public OrderActionRatePlanPriceChangeParams priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
   ...
   * @return the OrderActionRatePlanPriceChangeParams instance itself
   */
  public OrderActionRatePlanPriceChangeParams putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanPriceChangeParams orderActionRatePlanPriceChangeParams = (OrderActionRatePlanPriceChangeParams) o;
    return Objects.equals(this.priceChangeOption, orderActionRatePlanPriceChangeParams.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, orderActionRatePlanPriceChangeParams.priceIncreasePercentage)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanPriceChangeParams.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderActionRatePlanPriceChangeParams {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanPriceChangeParams
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanPriceChangeParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanPriceChangeParams is not found in the empty JSON string", OrderActionRatePlanPriceChangeParams.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanPriceChangeParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanPriceChangeParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanPriceChangeParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanPriceChangeParams.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanPriceChangeParams>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanPriceChangeParams value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanPriceChangeParams read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanPriceChangeParams instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanPriceChangeParams given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanPriceChangeParams
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanPriceChangeParams
  */
  public static OrderActionRatePlanPriceChangeParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanPriceChangeParams.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanPriceChangeParams to an JSON string
  *
  * @return JSON string
  */
