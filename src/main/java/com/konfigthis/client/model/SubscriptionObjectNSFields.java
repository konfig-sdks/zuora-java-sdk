 ...
 */
@ApiModel(description = "Container for Subscription fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SubscriptionObjectNSFields {
  ...
  public SubscriptionObjectNSFields() {
  }

  public SubscriptionObjectNSFields integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public SubscriptionObjectNSFields integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public SubscriptionObjectNSFields projectNS(String projectNS) {
  ...
  **/
  ...
  public SubscriptionObjectNSFields salesOrderNS(String salesOrderNS) {
  ...
  **/
  ...
  public SubscriptionObjectNSFields syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the SubscriptionObjectNSFields instance itself
   */
  public SubscriptionObjectNSFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionObjectNSFields subscriptionObjectNSFields = (SubscriptionObjectNSFields) o;
    return Objects.equals(this.integrationIdNS, subscriptionObjectNSFields.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, subscriptionObjectNSFields.integrationStatusNS) &&
        Objects.equals(this.projectNS, subscriptionObjectNSFields.projectNS) &&
        Objects.equals(this.salesOrderNS, subscriptionObjectNSFields.salesOrderNS) &&
        Objects.equals(this.syncDateNS, subscriptionObjectNSFields.syncDateNS)&&
        Objects.equals(this.additionalProperties, subscriptionObjectNSFields.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(integrationIdNS, integrationStatusNS, projectNS, salesOrderNS, syncDateNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SubscriptionObjectNSFields {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubscriptionObjectNSFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubscriptionObjectNSFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscriptionObjectNSFields is not found in the empty JSON string", SubscriptionObjectNSFields.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscriptionObjectNSFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscriptionObjectNSFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscriptionObjectNSFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscriptionObjectNSFields.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscriptionObjectNSFields>() {
           @Override
           public void write(JsonWriter out, SubscriptionObjectNSFields value) throws IOException {
           ...
           @Override
           public SubscriptionObjectNSFields read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SubscriptionObjectNSFields instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SubscriptionObjectNSFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SubscriptionObjectNSFields
  * @throws IOException if the JSON string is invalid with respect to SubscriptionObjectNSFields
  */
  public static SubscriptionObjectNSFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscriptionObjectNSFields.class);
  }

 /**
  * Convert an instance of SubscriptionObjectNSFields to an JSON string
  *
  * @return JSON string
  */
