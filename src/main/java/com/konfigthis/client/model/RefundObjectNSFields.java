 ...
 */
@ApiModel(description = "Container for Refund fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class RefundObjectNSFields {
  ...
  public RefundObjectNSFields() {
  }

  public RefundObjectNSFields integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public RefundObjectNSFields integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public RefundObjectNSFields originNS(String originNS) {
  ...
  **/
  ...
  public RefundObjectNSFields syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public RefundObjectNSFields synctoNetSuiteNS(String synctoNetSuiteNS) {
  ...
  **/
   ...
   * @return the RefundObjectNSFields instance itself
   */
  public RefundObjectNSFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RefundObjectNSFields refundObjectNSFields = (RefundObjectNSFields) o;
    return Objects.equals(this.integrationIdNS, refundObjectNSFields.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, refundObjectNSFields.integrationStatusNS) &&
        Objects.equals(this.originNS, refundObjectNSFields.originNS) &&
        Objects.equals(this.syncDateNS, refundObjectNSFields.syncDateNS) &&
        Objects.equals(this.synctoNetSuiteNS, refundObjectNSFields.synctoNetSuiteNS)&&
        Objects.equals(this.additionalProperties, refundObjectNSFields.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(integrationIdNS, integrationStatusNS, originNS, syncDateNS, synctoNetSuiteNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RefundObjectNSFields {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RefundObjectNSFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RefundObjectNSFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RefundObjectNSFields is not found in the empty JSON string", RefundObjectNSFields.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RefundObjectNSFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RefundObjectNSFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RefundObjectNSFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RefundObjectNSFields.class));

       return (TypeAdapter<T>) new TypeAdapter<RefundObjectNSFields>() {
           @Override
           public void write(JsonWriter out, RefundObjectNSFields value) throws IOException {
           ...
           @Override
           public RefundObjectNSFields read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RefundObjectNSFields instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RefundObjectNSFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RefundObjectNSFields
  * @throws IOException if the JSON string is invalid with respect to RefundObjectNSFields
  */
  public static RefundObjectNSFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RefundObjectNSFields.class);
  }

 /**
  * Convert an instance of RefundObjectNSFields to an JSON string
  *
  * @return JSON string
  */
