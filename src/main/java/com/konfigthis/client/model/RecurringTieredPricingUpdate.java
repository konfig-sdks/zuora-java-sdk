...
public class RecurringTieredPricingUpdate {
 ...
 public enum PriceChangeOptionEnum {
  ...
  public RecurringTieredPricingUpdate() {
  }

  public RecurringTieredPricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public RecurringTieredPricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public RecurringTieredPricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public RecurringTieredPricingUpdate quantity(Double quantity) {
  ...
  public RecurringTieredPricingUpdate quantity(Integer quantity) {
    if (quantity != null && quantity < 0) {
      throw new IllegalArgumentException("Invalid value for quantity. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public RecurringTieredPricingUpdate tiers(List<ChargeTier> tiers) {
  ...
  public RecurringTieredPricingUpdate addTiersItem(ChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the RecurringTieredPricingUpdate instance itself
   */
  public RecurringTieredPricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecurringTieredPricingUpdate recurringTieredPricingUpdate = (RecurringTieredPricingUpdate) o;
    return Objects.equals(this.priceChangeOption, recurringTieredPricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, recurringTieredPricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.quantity, recurringTieredPricingUpdate.quantity) &&
        Objects.equals(this.tiers, recurringTieredPricingUpdate.tiers)&&
        Objects.equals(this.additionalProperties, recurringTieredPricingUpdate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecurringTieredPricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecurringTieredPricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecurringTieredPricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurringTieredPricingUpdate is not found in the empty JSON string", RecurringTieredPricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurringTieredPricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurringTieredPricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurringTieredPricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurringTieredPricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurringTieredPricingUpdate>() {
           @Override
           public void write(JsonWriter out, RecurringTieredPricingUpdate value) throws IOException {
           ...
           @Override
           public RecurringTieredPricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecurringTieredPricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecurringTieredPricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecurringTieredPricingUpdate
  * @throws IOException if the JSON string is invalid with respect to RecurringTieredPricingUpdate
  */
  public static RecurringTieredPricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurringTieredPricingUpdate.class);
  }

 /**
  * Convert an instance of RecurringTieredPricingUpdate to an JSON string
  *
  * @return JSON string
  */
