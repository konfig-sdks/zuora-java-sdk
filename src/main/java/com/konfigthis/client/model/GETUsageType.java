...
public class GETUsageType {
  ...
  **/
  ...
  public GETUsageType fileName(String fileName) {
  ...
  **/
  ...
  public GETUsageType organizationLabel(String organizationLabel) {
  ...
  **/
  ...
  public GETUsageType quantity(BigDecimal quantity) {
  ...
  **/
  ...
  public GETUsageType startDateTime(OffsetDateTime startDateTime) {
  ...
  **/
  ...
  public GETUsageType submissionDateTime(OffsetDateTime submissionDateTime) {
  ...
  **/
  ...
  public GETUsageType uniqueKey(String uniqueKey) {
  ...
  **/
   ...
   * @return the GETUsageType instance itself
   */
  public GETUsageType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, geTUsageType.accountId) &&
        ...
        Objects.equals(this.fileName, geTUsageType.fileName) &&
        Objects.equals(this.id, geTUsageType.id) &&
        Objects.equals(this.organizationLabel, geTUsageType.organizationLabel) &&
        ...
        Objects.equals(this.uniqueKey, geTUsageType.uniqueKey) &&
        Objects.equals(this.unitOfMeasure, geTUsageType.unitOfMeasure)&&
        Objects.equals(this.additionalProperties, geTUsageType.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETUsageType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETUsageType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETUsageType is not found in the empty JSON string", GETUsageType.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETUsageType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETUsageType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETUsageType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETUsageType.class));

       return (TypeAdapter<T>) new TypeAdapter<GETUsageType>() {
           @Override
           public void write(JsonWriter out, GETUsageType value) throws IOException {
           ...
           @Override
           public GETUsageType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETUsageType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETUsageType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETUsageType
  * @throws IOException if the JSON string is invalid with respect to GETUsageType
  */
  public static GETUsageType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETUsageType.class);
  }

 /**
  * Convert an instance of GETUsageType to an JSON string
  *
  * @return JSON string
  */
