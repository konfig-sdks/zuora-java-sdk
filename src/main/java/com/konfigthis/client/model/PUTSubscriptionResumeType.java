...
public class PUTSubscriptionResumeType {
 ...
 public enum RunBillingEnum {
  ...
  public PUTSubscriptionResumeType() {
  }

  public PUTSubscriptionResumeType applicationOrder(List<String> applicationOrder) {
  ...
  public PUTSubscriptionResumeType addApplicationOrderItem(String applicationOrderItem) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType applyCredit(Boolean applyCredit) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType bookingDate(LocalDate bookingDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The booking date that you want to set for the amendment contract when you resume the subscription. If `extendsTerm` is `true`, which means you also extend the term, then this field is also the booking date for the Terms and Conditions amendment contract.  This field must be in the `yyyy-mm-dd` format. The default value of this field is the current date when you make the API call.  ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Thu Jan 31 16:00:00 PST 2019", value = "The date when the customer notifies you that they want to resume their subscription. ")
  ...
  public PUTSubscriptionResumeType creditMemoReasonCode(String creditMemoReasonCode) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType documentDate(LocalDate documentDate) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType orderDate(LocalDate orderDate) {
  ...
  **/
  ...
  @ApiModelProperty(example = "SpecificDate", required = true, value = "Resume methods. Specify a way to resume a subscription.  Values:  * `Today`: The subscription resumption takes effect on today's date.  * `FixedPeriodsFromSuspendDate`: The subscription resumption takes effect after a specified period based on the suspend date. You must specify the `resumePeriods` and `resumePeriodsType` fields to define the period.  * `SpecificDate`: The subscription resumption takes effect on a specific date. You must define the specific date in the `resumeSpecificDate` field.  * `FixedPeriodsFromToday`: The subscription resumption takes effect after a specified period based on the today's date. You must specify the `resumePeriods` and `resumePeriodsType` fields to define the period. * `suspendDate`: The subscription resumption takes effect on the date of suspension of the subscription. ")
  ...
  **/
  ...
  public PUTSubscriptionResumeType runBilling(RunBillingEnum runBilling) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType targetDate(LocalDate targetDate) {
  ...
  **/
   ...
   * @return the PUTSubscriptionResumeType instance itself
   */
  public PUTSubscriptionResumeType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applicationOrder, puTSubscriptionResumeType.applicationOrder) &&
        Objects.equals(this.applyCredit, puTSubscriptionResumeType.applyCredit) &&
        Objects.equals(this.applyCreditBalance, puTSubscriptionResumeType.applyCreditBalance) &&
        Objects.equals(this.bookingDate, puTSubscriptionResumeType.bookingDate) &&
        ...
        Objects.equals(this.creditMemoReasonCode, puTSubscriptionResumeType.creditMemoReasonCode) &&
        Objects.equals(this.documentDate, puTSubscriptionResumeType.documentDate) &&
        ...
        Objects.equals(this.orderDate, puTSubscriptionResumeType.orderDate) &&
        ...
        Objects.equals(this.runBilling, puTSubscriptionResumeType.runBilling) &&
        Objects.equals(this.targetDate, puTSubscriptionResumeType.targetDate)&&
        Objects.equals(this.additionalProperties, puTSubscriptionResumeType.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTSubscriptionResumeType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTSubscriptionResumeType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTSubscriptionResumeType is not found in the empty JSON string", PUTSubscriptionResumeType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PUTSubscriptionResumeType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTSubscriptionResumeType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTSubscriptionResumeType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTSubscriptionResumeType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTSubscriptionResumeType.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTSubscriptionResumeType>() {
           @Override
           public void write(JsonWriter out, PUTSubscriptionResumeType value) throws IOException {
           ...
           @Override
           public PUTSubscriptionResumeType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTSubscriptionResumeType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTSubscriptionResumeType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTSubscriptionResumeType
  * @throws IOException if the JSON string is invalid with respect to PUTSubscriptionResumeType
  */
  public static PUTSubscriptionResumeType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTSubscriptionResumeType.class);
  }

 /**
  * Convert an instance of PUTSubscriptionResumeType to an JSON string
  *
  * @return JSON string
  */
