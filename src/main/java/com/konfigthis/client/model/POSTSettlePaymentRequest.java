...
public class POSTSettlePaymentRequest {
  ...
  public POSTSettlePaymentRequest() {
  }

  public POSTSettlePaymentRequest gatewayReconciliationReason(String gatewayReconciliationReason) {
  ...
  **/
  ...
  @ApiModelProperty(example = "paid", value = "The reason of gateway reconciliation. ")
  ...
  public POSTSettlePaymentRequest gatewayReconciliationStatus(String gatewayReconciliationStatus) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "succeeded", value = "The status of gateway reconciliation. ")
  ...
  public POSTSettlePaymentRequest payoutId(String payoutId) {
  ...
  **/
  ...
  public POSTSettlePaymentRequest settledOn(OffsetDateTime settledOn) {
  ...
  **/
   ...
   * @return the POSTSettlePaymentRequest instance itself
   */
  public POSTSettlePaymentRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTSettlePaymentRequest poSTSettlePaymentRequest = (POSTSettlePaymentRequest) o;
    return Objects.equals(this.gatewayReconciliationReason, poSTSettlePaymentRequest.gatewayReconciliationReason) &&
        Objects.equals(this.gatewayReconciliationStatus, poSTSettlePaymentRequest.gatewayReconciliationStatus) &&
        Objects.equals(this.payoutId, poSTSettlePaymentRequest.payoutId) &&
        Objects.equals(this.settledOn, poSTSettlePaymentRequest.settledOn)&&
        Objects.equals(this.additionalProperties, poSTSettlePaymentRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayReconciliationReason, gatewayReconciliationStatus, payoutId, settledOn, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class POSTSettlePaymentRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTSettlePaymentRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTSettlePaymentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTSettlePaymentRequest is not found in the empty JSON string", POSTSettlePaymentRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTSettlePaymentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTSettlePaymentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTSettlePaymentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTSettlePaymentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTSettlePaymentRequest>() {
           @Override
           public void write(JsonWriter out, POSTSettlePaymentRequest value) throws IOException {
           ...
           @Override
           public POSTSettlePaymentRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTSettlePaymentRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTSettlePaymentRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTSettlePaymentRequest
  * @throws IOException if the JSON string is invalid with respect to POSTSettlePaymentRequest
  */
  public static POSTSettlePaymentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTSettlePaymentRequest.class);
  }

 /**
  * Convert an instance of POSTSettlePaymentRequest to an JSON string
  *
  * @return JSON string
  */
