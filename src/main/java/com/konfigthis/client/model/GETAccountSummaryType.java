...
import com.konfigthis.client.model.GETAccountSummaryInvoiceType;
import com.konfigthis.client.model.GETAccountSummaryPaymentType;
import com.konfigthis.client.model.GETAccountSummarySubscriptionType;
import com.konfigthis.client.model.GETAccountSummaryTypeBasicInfo;
...
import com.konfigthis.client.model.GETAccountSummaryUsageType;
...
public class GETAccountSummaryType {
  ...
  private GETAccountSummaryTypeBasicInfo basicInfo;
  ...
  private List<GETAccountSummaryInvoiceType> invoices = null;

  public static final String SERIALIZED_NAME_PAYMENTS = "payments";
  @SerializedName(SERIALIZED_NAME_PAYMENTS)
  private List<GETAccountSummaryPaymentType> payments = null;
  ...
  private List<GETAccountSummarySubscriptionType> subscriptions = null;
  ...
  private List<GETAccountSummaryUsageType> usage = null;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for invoices. Only returns the last 6 invoices. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for payments. Only returns the last 6 payments. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for subscriptions. ")
  ...
  **/
  ...
  public GETAccountSummaryType taxInfo(GETAccountTypeTaxInfo taxInfo) {
  ...
  **/
  ...
  public GETAccountSummaryType addUsageItem(GETAccountSummaryUsageType usageItem) {
   ...
   /**
   * Container for usage data. Only returns the last 6 months of usage.  **Note:** If the Active Rating feature is enabled, no usage data is returned in the response body field. 
   * @return usage
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for usage data. Only returns the last 6 months of usage.  **Note:** If the Active Rating feature is enabled, no usage data is returned in the response body field. ")
   ...
   * @return the GETAccountSummaryType instance itself
   */
  public GETAccountSummaryType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.basicInfo, geTAccountSummaryType.basicInfo) &&
        ...
        Objects.equals(this.additionalProperties, geTAccountSummaryType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(basicInfo, billToContact, invoices, payments, soldToContact, subscriptions, success, taxInfo, usage, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETAccountSummaryType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETAccountSummaryType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETAccountSummaryType is not found in the empty JSON string", GETAccountSummaryType.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `basicInfo`
      if (jsonObj.get("basicInfo") != null && !jsonObj.get("basicInfo").isJsonNull()) {
        GETAccountSummaryTypeBasicInfo.validateJsonObject(jsonObj.getAsJsonObject("basicInfo"));
      }
      ...
      if (jsonObj.get("invoices") != null && !jsonObj.get("invoices").isJsonNull()) {
        ...
        if (jsonArrayinvoices != null) {
          ...
          for (int i = 0; i < jsonArrayinvoices.size(); i++) {
            GETAccountSummaryInvoiceType.validateJsonObject(jsonArrayinvoices.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("payments") != null && !jsonObj.get("payments").isJsonNull()) {
        ...
        if (jsonArraypayments != null) {
          ...
          for (int i = 0; i < jsonArraypayments.size(); i++) {
            GETAccountSummaryPaymentType.validateJsonObject(jsonArraypayments.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("subscriptions") != null && !jsonObj.get("subscriptions").isJsonNull()) {
        ...
        if (jsonArraysubscriptions != null) {
          ...
          for (int i = 0; i < jsonArraysubscriptions.size(); i++) {
            GETAccountSummarySubscriptionType.validateJsonObject(jsonArraysubscriptions.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("usage") != null && !jsonObj.get("usage").isJsonNull()) {
        ...
        if (jsonArrayusage != null) {
          ...
          for (int i = 0; i < jsonArrayusage.size(); i++) {
            GETAccountSummaryUsageType.validateJsonObject(jsonArrayusage.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETAccountSummaryType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETAccountSummaryType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETAccountSummaryType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETAccountSummaryType.class));

       return (TypeAdapter<T>) new TypeAdapter<GETAccountSummaryType>() {
           @Override
           public void write(JsonWriter out, GETAccountSummaryType value) throws IOException {
           ...
           @Override
           public GETAccountSummaryType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETAccountSummaryType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETAccountSummaryType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETAccountSummaryType
  * @throws IOException if the JSON string is invalid with respect to GETAccountSummaryType
  */
  public static GETAccountSummaryType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETAccountSummaryType.class);
  }

 /**
  * Convert an instance of GETAccountSummaryType to an JSON string
  *
  * @return JSON string
  */
