 ...
 */
@ApiModel(description = "Pricing information about a usage charge that uses the \"tiered with overage\" charge model. In this charge model, the charge has cumulative pricing tiers that become effective as units are consumed. The charge also has a fixed price per unit consumed beyond the limit of the final tier. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrderActionRatePlanUsageTieredWithOveragePricingOverride {
  /**
 ...
 public enum OverageUnusedUnitsCreditOptionEnum {
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride() {
  }

  public OrderActionRatePlanUsageTieredWithOveragePricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride numberOfPeriods(Integer numberOfPeriods) {
    if (numberOfPeriods != null && numberOfPeriods < 1) {
      throw new IllegalArgumentException("Invalid value for numberOfPeriods. Must be greater than or equal to 1.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of periods that Zuora considers when calculating overage charges with overage smoothing. ")
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride overagePrice(Double overagePrice) {
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride overagePrice(Integer overagePrice) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Price per overage unit consumed. ")
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride overageUnusedUnitsCreditOption(OverageUnusedUnitsCreditOptionEnum overageUnusedUnitsCreditOption) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies whether to credit the customer for unused units.  If the value of this field is `CreditBySpecificRate`, use the `unusedUnitsCreditRates` field to specify the rate at which to credit the customer for unused units. ")
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride tiers(List<OrderActionRatePlanChargeTier> tiers) {
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride addTiersItem(OrderActionRatePlanChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of cumulative pricing tiers in the charge. ")
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride unusedUnitsCreditRates(Double unusedUnitsCreditRates) {
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride unusedUnitsCreditRates(Integer unusedUnitsCreditRates) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Per-unit rate at which to credit the customer for unused units. Only applicable if the value of the `overageUnusedUnitsCreditOption` field is `CreditBySpecificRate`. ")
   ...
   * @return the OrderActionRatePlanUsageTieredWithOveragePricingOverride instance itself
   */
  public OrderActionRatePlanUsageTieredWithOveragePricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanUsageTieredWithOveragePricingOverride orderActionRatePlanUsageTieredWithOveragePricingOverride = (OrderActionRatePlanUsageTieredWithOveragePricingOverride) o;
    return Objects.equals(this.priceChangeOption, orderActionRatePlanUsageTieredWithOveragePricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, orderActionRatePlanUsageTieredWithOveragePricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.numberOfPeriods, orderActionRatePlanUsageTieredWithOveragePricingOverride.numberOfPeriods) &&
        Objects.equals(this.overagePrice, orderActionRatePlanUsageTieredWithOveragePricingOverride.overagePrice) &&
        Objects.equals(this.overageUnusedUnitsCreditOption, orderActionRatePlanUsageTieredWithOveragePricingOverride.overageUnusedUnitsCreditOption) &&
        Objects.equals(this.tiers, orderActionRatePlanUsageTieredWithOveragePricingOverride.tiers) &&
        Objects.equals(this.unusedUnitsCreditRates, orderActionRatePlanUsageTieredWithOveragePricingOverride.unusedUnitsCreditRates)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanUsageTieredWithOveragePricingOverride.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderActionRatePlanUsageTieredWithOveragePricingOverride {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanUsageTieredWithOveragePricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanUsageTieredWithOveragePricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanUsageTieredWithOveragePricingOverride is not found in the empty JSON string", OrderActionRatePlanUsageTieredWithOveragePricingOverride.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanUsageTieredWithOveragePricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanUsageTieredWithOveragePricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanUsageTieredWithOveragePricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanUsageTieredWithOveragePricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanUsageTieredWithOveragePricingOverride>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanUsageTieredWithOveragePricingOverride value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanUsageTieredWithOveragePricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanUsageTieredWithOveragePricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanUsageTieredWithOveragePricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanUsageTieredWithOveragePricingOverride
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanUsageTieredWithOveragePricingOverride
  */
  public static OrderActionRatePlanUsageTieredWithOveragePricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanUsageTieredWithOveragePricingOverride.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanUsageTieredWithOveragePricingOverride to an JSON string
  *
  * @return JSON string
  */
