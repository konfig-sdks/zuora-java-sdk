...
import com.konfigthis.client.model.GETRefundCreditMemoTypeAllOfFinanceInformation;
import com.konfigthis.client.model.GETRefundPaymentTypeAutoUnapplyAllOfWriteOffResults;
...
public class GETRefundPaymentTypeAutoUnapply {
  ...
  private GETRefundCreditMemoTypeAllOfFinanceInformation financeInformation;
 ...
 public enum TypeEnum {
  ...
  public static final String SERIALIZED_NAME_WRITE_OFF_RESULTS = "writeOffResults";
  @SerializedName(SERIALIZED_NAME_WRITE_OFF_RESULTS)
  private GETRefundPaymentTypeAutoUnapplyAllOfWriteOffResults writeOffResults;
  ...
  public GETRefundPaymentTypeAutoUnapply() {
  }

  public GETRefundPaymentTypeAutoUnapply accountId(String accountId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the account associated with this refund. Zuora associates the refund automatically with the account from the associated payment. ")
  ...
  public GETRefundPaymentTypeAutoUnapply amount(Double amount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The total amount of the refund. ")
  ...
  public GETRefundPaymentTypeAutoUnapply cancelledOn(OffsetDateTime cancelledOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the refund was cancelled, in `yyyy-mm-dd hh:mm:ss` format.  ")
  ...
  public GETRefundPaymentTypeAutoUnapply comment(String comment) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply createdById(String createdById) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply createdDate(OffsetDateTime createdDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the refund was created, in `yyyy-mm-dd hh:mm:ss` format. For example, 2017-03-01 15:31:10.  ")
  ...
  public GETRefundPaymentTypeAutoUnapply creditMemoId(String creditMemoId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the credit memo associated with the refund. ")
  ...
  public GETRefundPaymentTypeAutoUnapply financeInformation(GETRefundCreditMemoTypeAllOfFinanceInformation financeInformation) {
  ...
  **/
  ...
  public GETRefundCreditMemoTypeAllOfFinanceInformation getFinanceInformation() {
    return financeInformation;
  }


  public void setFinanceInformation(GETRefundCreditMemoTypeAllOfFinanceInformation financeInformation) {
  ...
  public GETRefundPaymentTypeAutoUnapply gatewayId(String gatewayId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the gateway instance that processes the refund. ")
  ...
  public GETRefundPaymentTypeAutoUnapply gatewayReconciliationReason(String gatewayReconciliationReason) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply gatewayReconciliationStatus(String gatewayReconciliationStatus) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply gatewayResponse(String gatewayResponse) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The message returned from the payment gateway for the refund. This message is gateway-dependent. ")
  ...
  public GETRefundPaymentTypeAutoUnapply gatewayResponseCode(String gatewayResponseCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The code returned from the payment gateway for the refund. This code is gateway-dependent. ")
  ...
  public GETRefundPaymentTypeAutoUnapply gatewayState(GatewayStateEnum gatewayState) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the refund in the gateway. ")
  ...
  public GETRefundPaymentTypeAutoUnapply id(String id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the created refund. ")
  ...
  public GETRefundPaymentTypeAutoUnapply markedForSubmissionOn(OffsetDateTime markedForSubmissionOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when a refund was marked and waiting for batch submission to the payment process, in `yyyy-mm-dd hh:mm:ss` format. ")
  ...
  public GETRefundPaymentTypeAutoUnapply methodType(MethodTypeEnum methodType) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply number(String number) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique identification number of the refund. ")
  ...
  public GETRefundPaymentTypeAutoUnapply paymentGatewayNumber(String paymentGatewayNumber) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply paymentId(String paymentId) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply paymentMethodId(String paymentMethodId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique ID of the payment method that the customer used to make the refund.  ")
  ...
  public GETRefundPaymentTypeAutoUnapply paymentMethodSnapshotId(String paymentMethodSnapshotId) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply payoutId(String payoutId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The payout ID of the refund from the gateway side. ")
  ...
  public GETRefundPaymentTypeAutoUnapply reasonCode(String reasonCode) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply referenceId(String referenceId) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply refundDate(LocalDate refundDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the refund takes effect, in `yyyy-mm-dd` format. ")
  ...
  public GETRefundPaymentTypeAutoUnapply refundTransactionTime(OffsetDateTime refundTransactionTime) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply secondRefundReferenceId(String secondRefundReferenceId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The transaction ID returned by the payment gateway if there is an additional transaction for the refund. Use this field to reconcile payments between your gateway and Zuora Payments. ")
  ...
  public GETRefundPaymentTypeAutoUnapply settledOn(OffsetDateTime settledOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the refund was settled in the payment processor, in `yyyy-mm-dd hh:mm:ss` format. This field is used by the Spectrum gateway only and not applicable to other gateways. ")
  ...
  public GETRefundPaymentTypeAutoUnapply softDescriptor(String softDescriptor) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply softDescriptorPhone(String softDescriptorPhone) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply status(StatusEnum status) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply submittedOn(OffsetDateTime submittedOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the refund was submitted, in `yyyy-mm-dd hh:mm:ss` format. ")
  ...
  public GETRefundPaymentTypeAutoUnapply success(Boolean success) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the refund. ")
  ...
  public GETRefundPaymentTypeAutoUnapply updatedById(String updatedById) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the the Zuora user who last updated the refund. ")
  ...
  public GETRefundPaymentTypeAutoUnapply updatedDate(OffsetDateTime updatedDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the refund was last updated, in `yyyy-mm-dd hh:mm:ss` format. For example, 2017-03-02 15:36:10. ")
  ...
  public GETRefundPaymentTypeAutoUnapply writeOffResults(GETRefundPaymentTypeAutoUnapplyAllOfWriteOffResults writeOffResults) {
    
    
    
    
    this.writeOffResults = writeOffResults;
    return this;
  }
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapplyAllOfWriteOffResults getWriteOffResults() {
    return writeOffResults;
  }


  public void setWriteOffResults(GETRefundPaymentTypeAutoUnapplyAllOfWriteOffResults writeOffResults) {
  ...
  public GETRefundPaymentTypeAutoUnapply integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Status of the refund's synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")
  ...
  public GETRefundPaymentTypeAutoUnapply originNS(String originNS) {
  ...
  **/
  ...
  public GETRefundPaymentTypeAutoUnapply syncDateNS(String syncDateNS) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date when the refund was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")
  ...
  public GETRefundPaymentTypeAutoUnapply synctoNetSuiteNS(String synctoNetSuiteNS) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies whether the refund should be synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")
   ...
   * @return the GETRefundPaymentTypeAutoUnapply instance itself
   */
  public GETRefundPaymentTypeAutoUnapply putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GETRefundPaymentTypeAutoUnapply geTRefundPaymentTypeAutoUnapply = (GETRefundPaymentTypeAutoUnapply) o;
    return Objects.equals(this.accountId, geTRefundPaymentTypeAutoUnapply.accountId) &&
        Objects.equals(this.amount, geTRefundPaymentTypeAutoUnapply.amount) &&
        Objects.equals(this.cancelledOn, geTRefundPaymentTypeAutoUnapply.cancelledOn) &&
        Objects.equals(this.comment, geTRefundPaymentTypeAutoUnapply.comment) &&
        Objects.equals(this.createdById, geTRefundPaymentTypeAutoUnapply.createdById) &&
        Objects.equals(this.createdDate, geTRefundPaymentTypeAutoUnapply.createdDate) &&
        Objects.equals(this.creditMemoId, geTRefundPaymentTypeAutoUnapply.creditMemoId) &&
        Objects.equals(this.financeInformation, geTRefundPaymentTypeAutoUnapply.financeInformation) &&
        Objects.equals(this.gatewayId, geTRefundPaymentTypeAutoUnapply.gatewayId) &&
        Objects.equals(this.gatewayReconciliationReason, geTRefundPaymentTypeAutoUnapply.gatewayReconciliationReason) &&
        Objects.equals(this.gatewayReconciliationStatus, geTRefundPaymentTypeAutoUnapply.gatewayReconciliationStatus) &&
        Objects.equals(this.gatewayResponse, geTRefundPaymentTypeAutoUnapply.gatewayResponse) &&
        Objects.equals(this.gatewayResponseCode, geTRefundPaymentTypeAutoUnapply.gatewayResponseCode) &&
        Objects.equals(this.gatewayState, geTRefundPaymentTypeAutoUnapply.gatewayState) &&
        Objects.equals(this.id, geTRefundPaymentTypeAutoUnapply.id) &&
        Objects.equals(this.markedForSubmissionOn, geTRefundPaymentTypeAutoUnapply.markedForSubmissionOn) &&
        Objects.equals(this.methodType, geTRefundPaymentTypeAutoUnapply.methodType) &&
        Objects.equals(this.number, geTRefundPaymentTypeAutoUnapply.number) &&
        Objects.equals(this.paymentGatewayNumber, geTRefundPaymentTypeAutoUnapply.paymentGatewayNumber) &&
        Objects.equals(this.paymentId, geTRefundPaymentTypeAutoUnapply.paymentId) &&
        Objects.equals(this.paymentMethodId, geTRefundPaymentTypeAutoUnapply.paymentMethodId) &&
        Objects.equals(this.paymentMethodSnapshotId, geTRefundPaymentTypeAutoUnapply.paymentMethodSnapshotId) &&
        Objects.equals(this.payoutId, geTRefundPaymentTypeAutoUnapply.payoutId) &&
        Objects.equals(this.reasonCode, geTRefundPaymentTypeAutoUnapply.reasonCode) &&
        Objects.equals(this.referenceId, geTRefundPaymentTypeAutoUnapply.referenceId) &&
        Objects.equals(this.refundDate, geTRefundPaymentTypeAutoUnapply.refundDate) &&
        Objects.equals(this.refundTransactionTime, geTRefundPaymentTypeAutoUnapply.refundTransactionTime) &&
        Objects.equals(this.secondRefundReferenceId, geTRefundPaymentTypeAutoUnapply.secondRefundReferenceId) &&
        Objects.equals(this.settledOn, geTRefundPaymentTypeAutoUnapply.settledOn) &&
        Objects.equals(this.softDescriptor, geTRefundPaymentTypeAutoUnapply.softDescriptor) &&
        Objects.equals(this.softDescriptorPhone, geTRefundPaymentTypeAutoUnapply.softDescriptorPhone) &&
        Objects.equals(this.status, geTRefundPaymentTypeAutoUnapply.status) &&
        Objects.equals(this.submittedOn, geTRefundPaymentTypeAutoUnapply.submittedOn) &&
        Objects.equals(this.success, geTRefundPaymentTypeAutoUnapply.success) &&
        Objects.equals(this.type, geTRefundPaymentTypeAutoUnapply.type) &&
        Objects.equals(this.updatedById, geTRefundPaymentTypeAutoUnapply.updatedById) &&
        Objects.equals(this.updatedDate, geTRefundPaymentTypeAutoUnapply.updatedDate) &&
        Objects.equals(this.writeOffResults, geTRefundPaymentTypeAutoUnapply.writeOffResults) &&
        Objects.equals(this.integrationIdNS, geTRefundPaymentTypeAutoUnapply.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, geTRefundPaymentTypeAutoUnapply.integrationStatusNS) &&
        Objects.equals(this.originNS, geTRefundPaymentTypeAutoUnapply.originNS) &&
        Objects.equals(this.syncDateNS, geTRefundPaymentTypeAutoUnapply.syncDateNS) &&
        Objects.equals(this.synctoNetSuiteNS, geTRefundPaymentTypeAutoUnapply.synctoNetSuiteNS)&&
        Objects.equals(this.additionalProperties, geTRefundPaymentTypeAutoUnapply.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, amount, cancelledOn, comment, createdById, createdDate, creditMemoId, financeInformation, gatewayId, gatewayReconciliationReason, gatewayReconciliationStatus, gatewayResponse, gatewayResponseCode, gatewayState, id, markedForSubmissionOn, methodType, number, paymentGatewayNumber, paymentId, paymentMethodId, paymentMethodSnapshotId, payoutId, reasonCode, referenceId, refundDate, refundTransactionTime, secondRefundReferenceId, settledOn, softDescriptor, softDescriptorPhone, status, submittedOn, success, type, updatedById, updatedDate, writeOffResults, integrationIdNS, integrationStatusNS, originNS, syncDateNS, synctoNetSuiteNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GETRefundPaymentTypeAutoUnapply {\n");
    ...
    sb.append("    writeOffResults: ").append(toIndentedString(writeOffResults)).append("\n");
  ...
  static {
    ...
    openapiFields.add("writeOffResults");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETRefundPaymentTypeAutoUnapply
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETRefundPaymentTypeAutoUnapply.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETRefundPaymentTypeAutoUnapply is not found in the empty JSON string", GETRefundPaymentTypeAutoUnapply.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("financeInformation") != null && !jsonObj.get("financeInformation").isJsonNull()) {
        GETRefundCreditMemoTypeAllOfFinanceInformation.validateJsonObject(jsonObj.getAsJsonObject("financeInformation"));
      }
      ...
      // validate the optional field `writeOffResults`
      if (jsonObj.get("writeOffResults") != null && !jsonObj.get("writeOffResults").isJsonNull()) {
        GETRefundPaymentTypeAutoUnapplyAllOfWriteOffResults.validateJsonObject(jsonObj.getAsJsonObject("writeOffResults"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETRefundPaymentTypeAutoUnapply.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETRefundPaymentTypeAutoUnapply' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETRefundPaymentTypeAutoUnapply> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETRefundPaymentTypeAutoUnapply.class));

       return (TypeAdapter<T>) new TypeAdapter<GETRefundPaymentTypeAutoUnapply>() {
           @Override
           public void write(JsonWriter out, GETRefundPaymentTypeAutoUnapply value) throws IOException {
           ...
           @Override
           public GETRefundPaymentTypeAutoUnapply read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETRefundPaymentTypeAutoUnapply instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETRefundPaymentTypeAutoUnapply given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETRefundPaymentTypeAutoUnapply
  * @throws IOException if the JSON string is invalid with respect to GETRefundPaymentTypeAutoUnapply
  */
  public static GETRefundPaymentTypeAutoUnapply fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETRefundPaymentTypeAutoUnapply.class);
  }

 /**
  * Convert an instance of GETRefundPaymentTypeAutoUnapply to an JSON string
  *
  * @return JSON string
  */
