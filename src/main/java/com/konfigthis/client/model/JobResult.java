...
import com.konfigthis.client.model.CommonResponseReasonsInner;
import com.konfigthis.client.model.JobResultAllOfOrderLineItems;
import com.konfigthis.client.model.JobResultAllOfRamps;
import com.konfigthis.client.model.JobResultAllOfSubscriptions;
...
/**
 * **Note:** The schema of the &#x60;result&#x60; nested field is the same as the response body schema of either the [\&quot;Create an order\&quot;](https://developer.zuora.com/api-references/api/operation/POST_Order) or the [\&quot;Preview an order\&quot;](https://developer.zuora.com/api-references/api/operation/POST_PreviewOrder) operation, depending on the purpose of the job.  The following schema for the nested &#x60;result&#x60; field is defined as the response body schema of \&quot;Create an order\&quot;. See [Preview an Order](https://developer.zuora.com/api-references/api/operation/POST_PreviewOrder) for the response body schema of \&quot;Preview an order\&quot;.  
 */
@ApiModel(description = "**Note:** The schema of the `result` nested field is the same as the response body schema of either the [\"Create an order\"](https://developer.zuora.com/api-references/api/operation/POST_Order) or the [\"Preview an order\"](https://developer.zuora.com/api-references/api/operation/POST_PreviewOrder) operation, depending on the purpose of the job.  The following schema for the nested `result` field is defined as the response body schema of \"Create an order\". See [Preview an Order](https://developer.zuora.com/api-references/api/operation/POST_PreviewOrder) for the response body schema of \"Preview an order\".  ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class JobResult {
  ...
  private List<CommonResponseReasonsInner> reasons = null;
  ...
  private List<String> invoiceId = null;
  ...
  private List<JobResultAllOfOrderLineItems> orderLineItems = null;
  ...
  private List<JobResultAllOfRamps> ramps = null;
 ...
 public enum StatusEnum {
  ...
  private List<JobResultAllOfSubscriptions> subscriptions = null;

  public JobResult() {
  }

  public JobResult processId(String processId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the process that handles the operation. ")
  ...
  public JobResult reasons(List<CommonResponseReasonsInner> reasons) {
  ...
  public JobResult addReasonsItem(CommonResponseReasonsInner reasonsItem) {
  ...
  **/
  ...
  public List<CommonResponseReasonsInner> getReasons() {
    return reasons;
  }


  public void setReasons(List<CommonResponseReasonsInner> reasons) {
  ...
  public JobResult requestId(UUID requestId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unique identifier of the request. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the call succeeded. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The account ID for the order. This field is returned only when the `returnIds` query parameter in the \"Create an order asynchronously\" operation is set to `true`.")
  ...
  public JobResult accountNumber(String accountNumber) {
  ...
  **/
  ...
  public JobResult creditMemoIds(List<String> creditMemoIds) {
  ...
  public JobResult addCreditMemoIdsItem(String creditMemoIdsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of the credit memo IDs that are generated in the \"Create an order asynchronously\" operation. This field is returned only when the `returnIds` query parameter in the \"Create an order asynchronously\" operation is set to `true`.")
  ...
  public JobResult creditMemoNumbers(List<String> creditMemoNumbers) {
  ...
  public JobResult addCreditMemoNumbersItem(String creditMemoNumbersItem) {
  ...
  **/
  ...
  public JobResult invoiceId(List<String> invoiceId) {
  ...
  public JobResult addInvoiceIdItem(String invoiceIdItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of the invoice IDs that are generated in the \"Create an order asynchronously\" operation. This field is returned only when the `returnIds` query parameter in the \"Create an order asynchronously\" operation is set to `true`.")
  ...
  public JobResult invoiceNumbers(List<String> invoiceNumbers) {
  ...
  public JobResult addInvoiceNumbersItem(String invoiceNumbersItem) {
  ...
  **/
  ...
  public JobResult orderId(String orderId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the order created. This field is returned only when the `returnIds` query parameter in the \"Create an order asynchronously\" operation is set to `true`.")
  ...
  public JobResult orderLineItems(List<JobResultAllOfOrderLineItems> orderLineItems) {
  ...
  public JobResult addOrderLineItemsItem(JobResultAllOfOrderLineItems orderLineItemsItem) {
  ...
  **/
  ...
  public List<JobResultAllOfOrderLineItems> getOrderLineItems() {
    return orderLineItems;
  }


  public void setOrderLineItems(List<JobResultAllOfOrderLineItems> orderLineItems) {
  ...
  public JobResult orderNumber(String orderNumber) {
  ...
  **/
  ...
  public JobResult paidAmount(String paidAmount) {
  ...
  **/
  ...
  public JobResult paymentId(String paymentId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the payment that is collected in the \"Create an order asynchronously\" operation. This field is returned only when the `returnIds` query parameter in the \"Create an order asynchronously\" operation is set to `true`.")
  ...
  public JobResult paymentNumber(String paymentNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The payment number that collected in this order request.")
  ...
  public JobResult ramps(List<JobResultAllOfRamps> ramps) {
  ...
  public JobResult addRampsItem(JobResultAllOfRamps rampsItem) {
    if (this.ramps == null) {
  ...
  **/
  ...
  public List<JobResultAllOfRamps> getRamps() {
    return ramps;
  }


  public void setRamps(List<JobResultAllOfRamps> ramps) {
  ...
  public JobResult status(StatusEnum status) {
  ...
  **/
  ...
  public JobResult subscriptionIds(List<String> subscriptionIds) {
  ...
  public JobResult addSubscriptionIdsItem(String subscriptionIdsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for the IDs of the subscriptions in the order. This field is returned only when the `returnIds` query parameter in the \"Create an order asynchronously\" operation is set to `true`.")
  ...
  public JobResult subscriptionNumbers(List<String> subscriptionNumbers) {
  ...
  public JobResult addSubscriptionNumbersItem(String subscriptionNumbersItem) {
  ...
  **/
  ...
  public JobResult subscriptions(List<JobResultAllOfSubscriptions> subscriptions) {
  ...
  public JobResult addSubscriptionsItem(JobResultAllOfSubscriptions subscriptionsItem) {
  ...
  **/
  ...
  public List<JobResultAllOfSubscriptions> getSubscriptions() {
    return subscriptions;
  }


  public void setSubscriptions(List<JobResultAllOfSubscriptions> subscriptions) {
   ...
   * @return the JobResult instance itself
   */
  public JobResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.processId, jobResult.processId) &&
        Objects.equals(this.reasons, jobResult.reasons) &&
        Objects.equals(this.requestId, jobResult.requestId) &&
        Objects.equals(this.success, jobResult.success) &&
        Objects.equals(this.accountId, jobResult.accountId) &&
        Objects.equals(this.accountNumber, jobResult.accountNumber) &&
        Objects.equals(this.creditMemoIds, jobResult.creditMemoIds) &&
        Objects.equals(this.creditMemoNumbers, jobResult.creditMemoNumbers) &&
        Objects.equals(this.invoiceId, jobResult.invoiceId) &&
        Objects.equals(this.invoiceNumbers, jobResult.invoiceNumbers) &&
        Objects.equals(this.orderId, jobResult.orderId) &&
        Objects.equals(this.orderLineItems, jobResult.orderLineItems) &&
        Objects.equals(this.orderNumber, jobResult.orderNumber) &&
        Objects.equals(this.paidAmount, jobResult.paidAmount) &&
        Objects.equals(this.paymentId, jobResult.paymentId) &&
        Objects.equals(this.paymentNumber, jobResult.paymentNumber) &&
        Objects.equals(this.ramps, jobResult.ramps) &&
        Objects.equals(this.status, jobResult.status) &&
        Objects.equals(this.subscriptionIds, jobResult.subscriptionIds) &&
        Objects.equals(this.subscriptionNumbers, jobResult.subscriptionNumbers) &&
        Objects.equals(this.subscriptions, jobResult.subscriptions)&&
        Objects.equals(this.additionalProperties, jobResult.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(processId, reasons, requestId, success, accountId, accountNumber, creditMemoIds, creditMemoNumbers, invoiceId, invoiceNumbers, orderId, orderLineItems, orderNumber, paidAmount, paymentId, paymentNumber, ramps, status, subscriptionIds, subscriptionNumbers, subscriptions, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("reasons") != null && !jsonObj.get("reasons").isJsonNull()) {
        ...
        if (jsonArrayreasons != null) {
          ...
          for (int i = 0; i < jsonArrayreasons.size(); i++) {
            CommonResponseReasonsInner.validateJsonObject(jsonArrayreasons.get(i).getAsJsonObject());
          };
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("invoiceId") != null && !jsonObj.get("invoiceId").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `invoiceId` to be an array in the JSON string but got `%s`", jsonObj.get("invoiceId").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("orderLineItems") != null && !jsonObj.get("orderLineItems").isJsonNull()) {
        ...
        if (jsonArrayorderLineItems != null) {
          ...
          for (int i = 0; i < jsonArrayorderLineItems.size(); i++) {
            JobResultAllOfOrderLineItems.validateJsonObject(jsonArrayorderLineItems.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("ramps") != null && !jsonObj.get("ramps").isJsonNull()) {
        ...
        if (jsonArrayramps != null) {
          ...
          for (int i = 0; i < jsonArrayramps.size(); i++) {
            JobResultAllOfRamps.validateJsonObject(jsonArrayramps.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("subscriptions") != null && !jsonObj.get("subscriptions").isJsonNull()) {
        ...
        if (jsonArraysubscriptions != null) {
          ...
          for (int i = 0; i < jsonArraysubscriptions.size(); i++) {
            JobResultAllOfSubscriptions.validateJsonObject(jsonArraysubscriptions.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JobResult>() {
           ...
           public JobResult read(JsonReader in) throws IOException {
             ...
             JobResult instance = thisAdapter.fromJsonTree(jsonObj);
