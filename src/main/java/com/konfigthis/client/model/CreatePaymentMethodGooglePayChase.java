...
public class CreatePaymentMethodGooglePayChase {
  /**
 ...
 public enum TypeEnum {
  ...
  public CreatePaymentMethodGooglePayChase() {
  }

  public CreatePaymentMethodGooglePayChase type(TypeEnum type) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayChase googlePaymentToken(String googlePaymentToken) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "This field is specific for setting up Google Pay on Chase gateway integrations to specify the stringified Google Pay token. For more information, see [Set up Google Pay on Chase](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Payment_Method_Types/Set_up_Google_Pay_on_Chase). ")
  ...
  public CreatePaymentMethodGooglePayChase accountKey(String accountKey) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayChase authGateway(String authGateway) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayChase currencyCode(String currencyCode) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayChase gatewayOptions(PaymentMethodCommonFieldsGatewayOptions gatewayOptions) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayChase ipAddress(String ipAddress) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayChase makeDefault(Boolean makeDefault) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayChase skipValidation(Boolean skipValidation) {
  ...
  **/
   ...
   * @return the CreatePaymentMethodGooglePayChase instance itself
   */
  public CreatePaymentMethodGooglePayChase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePaymentMethodGooglePayChase createPaymentMethodGooglePayChase = (CreatePaymentMethodGooglePayChase) o;
    return Objects.equals(this.type, createPaymentMethodGooglePayChase.type) &&
        Objects.equals(this.googlePaymentToken, createPaymentMethodGooglePayChase.googlePaymentToken) &&
        Objects.equals(this.accountKey, createPaymentMethodGooglePayChase.accountKey) &&
        Objects.equals(this.authGateway, createPaymentMethodGooglePayChase.authGateway) &&
        Objects.equals(this.currencyCode, createPaymentMethodGooglePayChase.currencyCode) &&
        Objects.equals(this.gatewayOptions, createPaymentMethodGooglePayChase.gatewayOptions) &&
        Objects.equals(this.ipAddress, createPaymentMethodGooglePayChase.ipAddress) &&
        Objects.equals(this.makeDefault, createPaymentMethodGooglePayChase.makeDefault) &&
        Objects.equals(this.skipValidation, createPaymentMethodGooglePayChase.skipValidation)&&
        Objects.equals(this.additionalProperties, createPaymentMethodGooglePayChase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, googlePaymentToken, accountKey, authGateway, currencyCode, gatewayOptions, ipAddress, makeDefault, skipValidation, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePaymentMethodGooglePayChase {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreatePaymentMethodGooglePayChase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreatePaymentMethodGooglePayChase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePaymentMethodGooglePayChase is not found in the empty JSON string", CreatePaymentMethodGooglePayChase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePaymentMethodGooglePayChase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePaymentMethodGooglePayChase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePaymentMethodGooglePayChase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePaymentMethodGooglePayChase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePaymentMethodGooglePayChase.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePaymentMethodGooglePayChase>() {
           @Override
           public void write(JsonWriter out, CreatePaymentMethodGooglePayChase value) throws IOException {
           ...
           @Override
           public CreatePaymentMethodGooglePayChase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreatePaymentMethodGooglePayChase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreatePaymentMethodGooglePayChase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreatePaymentMethodGooglePayChase
  * @throws IOException if the JSON string is invalid with respect to CreatePaymentMethodGooglePayChase
  */
  public static CreatePaymentMethodGooglePayChase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePaymentMethodGooglePayChase.class);
  }

 /**
  * Convert an instance of CreatePaymentMethodGooglePayChase to an JSON string
  *
  * @return JSON string
  */
