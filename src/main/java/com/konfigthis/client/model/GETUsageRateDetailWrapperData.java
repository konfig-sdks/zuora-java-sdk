 ...
 */
@ApiModel(description = "Contains usage rate details for the invoice item as specified in the request. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class GETUsageRateDetailWrapperData {
  ...
  public GETUsageRateDetailWrapperData() {
  }

  public GETUsageRateDetailWrapperData amountWithoutTax(Double amountWithoutTax) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The amount of the invoice item without tax. ")
  ...
  public GETUsageRateDetailWrapperData chargeNumber(String chargeNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique number of the product rate plan charge associated with the invoice item. ")
  ...
  public GETUsageRateDetailWrapperData invoiceId(String invoiceId) {
  ...
  **/
  ...
  public GETUsageRateDetailWrapperData invoiceItemId(String invoiceItemId) {
  ...
  **/
  ...
  public GETUsageRateDetailWrapperData invoiceNumber(String invoiceNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique number of the invoice. ")
  ...
  public GETUsageRateDetailWrapperData listPrice(String listPrice) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The list price of the product rate plan charge associated with the invoice item. For example, if the product rate plan charge uses the tiered charge model, its list price could be:   Tier / From / To / List Price / Price Format\\n1 / 0 / 9 / 0.00 / Per Unit\\n2 / 10 / 20 / 1.00 / Per Unit\\n3 / 21 / 30 / 2.00 / Flat Fee\\n4 / 31 /   / 3.00 / Per Unit\\n ")
  ...
  public GETUsageRateDetailWrapperData quantity(String quantity) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The quantity of the invoice item. ")
  ...
  public GETUsageRateDetailWrapperData rateDetail(String rateDetail) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The rate detail of the invoice item. It shows how the total amount is calculated. For example, if the product rate plan charge uses the tiered charge model, the rate detail for the associated invoice item could be:   Tier 1: 0-9, 9 Each(s) x $0.00/Each = $0.00\\nTier 2: 10-20, 11 Each(s) x $1.00/Each = $11.00\\nTier 3: 21-30, $2.00 Flat Fee\\nTier 4: >=31, 15 Each(s) x $3.00/Each = $45.00\\nTotal = $58.00.   The rate detail retrieved from this REST API operation is the same as the [Rate Detail presented on PDF invoices](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/IA_Invoices/Create_a_custom_invoice_template/DD_Display_Usage_Charge_Breakdown#How_UsageSummary.RateDetail_is_displayed_on_invoices).  ")
  ...
  public GETUsageRateDetailWrapperData servicePeriod(String servicePeriod) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The service period of the invoice item. ")
  ...
  public GETUsageRateDetailWrapperData uom(String uom) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unit of measurement of the invoice item. ")
   ...
   * @return the GETUsageRateDetailWrapperData instance itself
   */
  public GETUsageRateDetailWrapperData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GETUsageRateDetailWrapperData geTUsageRateDetailWrapperData = (GETUsageRateDetailWrapperData) o;
    return Objects.equals(this.amountWithoutTax, geTUsageRateDetailWrapperData.amountWithoutTax) &&
        Objects.equals(this.chargeNumber, geTUsageRateDetailWrapperData.chargeNumber) &&
        Objects.equals(this.invoiceId, geTUsageRateDetailWrapperData.invoiceId) &&
        Objects.equals(this.invoiceItemId, geTUsageRateDetailWrapperData.invoiceItemId) &&
        Objects.equals(this.invoiceNumber, geTUsageRateDetailWrapperData.invoiceNumber) &&
        Objects.equals(this.listPrice, geTUsageRateDetailWrapperData.listPrice) &&
        Objects.equals(this.quantity, geTUsageRateDetailWrapperData.quantity) &&
        Objects.equals(this.rateDetail, geTUsageRateDetailWrapperData.rateDetail) &&
        Objects.equals(this.servicePeriod, geTUsageRateDetailWrapperData.servicePeriod) &&
        Objects.equals(this.uom, geTUsageRateDetailWrapperData.uom)&&
        Objects.equals(this.additionalProperties, geTUsageRateDetailWrapperData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GETUsageRateDetailWrapperData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETUsageRateDetailWrapperData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETUsageRateDetailWrapperData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETUsageRateDetailWrapperData is not found in the empty JSON string", GETUsageRateDetailWrapperData.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETUsageRateDetailWrapperData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETUsageRateDetailWrapperData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETUsageRateDetailWrapperData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETUsageRateDetailWrapperData.class));

       return (TypeAdapter<T>) new TypeAdapter<GETUsageRateDetailWrapperData>() {
           @Override
           public void write(JsonWriter out, GETUsageRateDetailWrapperData value) throws IOException {
           ...
           @Override
           public GETUsageRateDetailWrapperData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETUsageRateDetailWrapperData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETUsageRateDetailWrapperData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETUsageRateDetailWrapperData
  * @throws IOException if the JSON string is invalid with respect to GETUsageRateDetailWrapperData
  */
  public static GETUsageRateDetailWrapperData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETUsageRateDetailWrapperData.class);
  }

 /**
  * Convert an instance of GETUsageRateDetailWrapperData to an JSON string
  *
  * @return JSON string
  */
