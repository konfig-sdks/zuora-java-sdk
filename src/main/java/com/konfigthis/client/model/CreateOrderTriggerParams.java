 ...
 */
@ApiModel(description = "Specifies when a charge becomes active. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CreateOrderTriggerParams {
   ...
   */
  @JsonAdapter(StartDatePolicyEnum.Adapter.class)
 public enum StartDatePolicyEnum {
    ...
    StartDatePolicyEnum(String value) {
      this.value = value;
    }
    ...
    public static StartDatePolicyEnum fromValue(String value) {
      for (StartDatePolicyEnum b : StartDatePolicyEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<StartDatePolicyEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final StartDatePolicyEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public StartDatePolicyEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return StartDatePolicyEnum.fromValue(value);
      }
    }
  }
  ...
  private StartDatePolicyEnum startDatePolicy;
   ...
   */
  @JsonAdapter(StartPeriodsTypeEnum.Adapter.class)
 public enum StartPeriodsTypeEnum {
    DAYS("Days"),
    ...
    StartPeriodsTypeEnum(String value) {
      this.value = value;
    }
    ...
    public static StartPeriodsTypeEnum fromValue(String value) {
      for (StartPeriodsTypeEnum b : StartPeriodsTypeEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<StartPeriodsTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final StartPeriodsTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public StartPeriodsTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return StartPeriodsTypeEnum.fromValue(value);
      }
    }
  }
  ...
  private StartPeriodsTypeEnum startPeriodsType;

  /**
   * Condition for the charge to become active.  If the value of this field is &#x60;SpecificDate&#x60;, use the &#x60;specificTriggerDate&#x60; field to specify the date when the charge becomes active. 
   */
 ...
 public enum TriggerEventEnum {
  ...
  public CreateOrderTriggerParams() {
  }

  public CreateOrderTriggerParams periodsAfterChargeStart(Integer periodsAfterChargeStart) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Duration of the discount charge in days, weeks, months, or years, depending on the value of the `startPeriodsType` field. Only applicable if the value of the `startDatePolicy` field is `FixedPeriodAfterApplyToChargeStartDate`.  **Note**: You must enable the [Enhanced Discounts](https://knowledgecenter.zuora.com/Zuora_Billing/Build_products_and_prices/Basic_concepts_and_terms/B_Charge_Models/D_Manage_Enhanced_Discount) feature to access this field. ")
  ...
  public CreateOrderTriggerParams specificTriggerDate(LocalDate specificTriggerDate) {
  ...
  **/
  ...
  public CreateOrderTriggerParams startDatePolicy(StartDatePolicyEnum startDatePolicy) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Start date policy of the discount charge to become active when the **Apply to billing period partially** checkbox is selected from the product catalog UI or the `applyToBillingPeriodPartially` field is set as true from the \"CRUD: Create a product rate plan charge\" operation.  - If the value of this field is `SpecificDate`, use the `specificTriggerDate` field to specify the date when the charge becomes active. - If the value of this field is `FixedPeriodAfterApplyToChargeStartDate`, the charge is active for a predefined duration based on the value of the `upToPeriodsType` and `upToPeriods` fields.  **Notes**:    - You must enable the [Enhanced Discounts](https://knowledgecenter.zuora.com/Zuora_Billing/Build_products_and_prices/Basic_concepts_and_terms/B_Charge_Models/D_Manage_Enhanced_Discount) feature to access this field.    - You can use either `triggerEvent` or `startDatePolicy` to define when a discount charge starts, but not both at the same time. ")

  public StartDatePolicyEnum getStartDatePolicy() {
    return startDatePolicy;
  }


  public void setStartDatePolicy(StartDatePolicyEnum startDatePolicy) {
  ...
  public CreateOrderTriggerParams startPeriodsType(StartPeriodsTypeEnum startPeriodsType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unit of time that the discount charge duration is measured in. Only applicable if the value of the `startDatePolicy` field is `FixedPeriodAfterApplyToChargeStartDate`.  **Note**: You must enable the [Enhanced Discounts](https://knowledgecenter.zuora.com/Zuora_Billing/Build_products_and_prices/Basic_concepts_and_terms/B_Charge_Models/D_Manage_Enhanced_Discount) feature to access this field. ")

  public StartPeriodsTypeEnum getStartPeriodsType() {
    return startPeriodsType;
  }


  public void setStartPeriodsType(StartPeriodsTypeEnum startPeriodsType) {
  ...
  public CreateOrderTriggerParams triggerEvent(TriggerEventEnum triggerEvent) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Condition for the charge to become active.  If the value of this field is `SpecificDate`, use the `specificTriggerDate` field to specify the date when the charge becomes active. ")
   ...
   * @return the CreateOrderTriggerParams instance itself
   */
  public CreateOrderTriggerParams putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateOrderTriggerParams createOrderTriggerParams = (CreateOrderTriggerParams) o;
    return Objects.equals(this.periodsAfterChargeStart, createOrderTriggerParams.periodsAfterChargeStart) &&
        Objects.equals(this.specificTriggerDate, createOrderTriggerParams.specificTriggerDate) &&
        Objects.equals(this.startDatePolicy, createOrderTriggerParams.startDatePolicy) &&
        Objects.equals(this.startPeriodsType, createOrderTriggerParams.startPeriodsType) &&
        Objects.equals(this.triggerEvent, createOrderTriggerParams.triggerEvent)&&
        Objects.equals(this.additionalProperties, createOrderTriggerParams.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(periodsAfterChargeStart, specificTriggerDate, startDatePolicy, startPeriodsType, triggerEvent, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateOrderTriggerParams {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateOrderTriggerParams
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateOrderTriggerParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOrderTriggerParams is not found in the empty JSON string", CreateOrderTriggerParams.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOrderTriggerParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOrderTriggerParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOrderTriggerParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOrderTriggerParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOrderTriggerParams>() {
           @Override
           public void write(JsonWriter out, CreateOrderTriggerParams value) throws IOException {
           ...
           @Override
           public CreateOrderTriggerParams read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateOrderTriggerParams instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateOrderTriggerParams given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateOrderTriggerParams
  * @throws IOException if the JSON string is invalid with respect to CreateOrderTriggerParams
  */
  public static CreateOrderTriggerParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOrderTriggerParams.class);
  }

 /**
  * Convert an instance of CreateOrderTriggerParams to an JSON string
  *
  * @return JSON string
  */
