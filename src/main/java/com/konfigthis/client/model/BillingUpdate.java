...
public class BillingUpdate {
 ...
 public enum BillingPeriodAlignmentEnum {
  ...
  public BillingUpdate billingPeriodAlignment(BillingPeriodAlignmentEnum billingPeriodAlignment) {
  ...
  **/
   ...
   * @return the BillingUpdate instance itself
   */
  public BillingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billingPeriodAlignment, billingUpdate.billingPeriodAlignment)&&
        Objects.equals(this.additionalProperties, billingUpdate.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BillingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BillingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BillingUpdate is not found in the empty JSON string", BillingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BillingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BillingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BillingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BillingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<BillingUpdate>() {
           @Override
           public void write(JsonWriter out, BillingUpdate value) throws IOException {
           ...
           @Override
           public BillingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BillingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BillingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BillingUpdate
  * @throws IOException if the JSON string is invalid with respect to BillingUpdate
  */
  public static BillingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BillingUpdate.class);
  }

 /**
  * Convert an instance of BillingUpdate to an JSON string
  *
  * @return JSON string
  */
