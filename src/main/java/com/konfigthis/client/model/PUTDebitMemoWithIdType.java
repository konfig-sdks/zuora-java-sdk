...
public class PUTDebitMemoWithIdType {
  ...
  private List<PUTDebitMemoItemType> items = null;
 ...
 public enum TransferredToAccountingEnum {
  ...
  public PUTDebitMemoWithIdType() {
  }

  public PUTDebitMemoWithIdType id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the debit memo. ")
  ...
  public PUTDebitMemoWithIdType autoPay(Boolean autoPay) {
  ...
  **/
  ...
  public PUTDebitMemoWithIdType comment(String comment) {
  ...
  **/
  ...
  public PUTDebitMemoWithIdType dueDate(LocalDate dueDate) {
  ...
  **/
  ...
  public PUTDebitMemoWithIdType effectiveDate(LocalDate effectiveDate) {
  ...
  **/
  ...
  public PUTDebitMemoWithIdType items(List<PUTDebitMemoItemType> items) {
  ...
  public PUTDebitMemoWithIdType addItemsItem(PUTDebitMemoItemType itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for debit memo items. ")

  public List<PUTDebitMemoItemType> getItems() {
    return items;
  }


  public void setItems(List<PUTDebitMemoItemType> items) {
  ...
  public PUTDebitMemoWithIdType reasonCode(String reasonCode) {
  ...
  **/
  ...
  public PUTDebitMemoWithIdType transferredToAccounting(TransferredToAccountingEnum transferredToAccounting) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the debit memo is transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite.  ")
  ...
  public PUTDebitMemoWithIdType integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public PUTDebitMemoWithIdType integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public PUTDebitMemoWithIdType syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the PUTDebitMemoWithIdType instance itself
   */
  public PUTDebitMemoWithIdType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PUTDebitMemoWithIdType puTDebitMemoWithIdType = (PUTDebitMemoWithIdType) o;
    return Objects.equals(this.id, puTDebitMemoWithIdType.id) &&
        Objects.equals(this.autoPay, puTDebitMemoWithIdType.autoPay) &&
        Objects.equals(this.comment, puTDebitMemoWithIdType.comment) &&
        Objects.equals(this.dueDate, puTDebitMemoWithIdType.dueDate) &&
        Objects.equals(this.effectiveDate, puTDebitMemoWithIdType.effectiveDate) &&
        Objects.equals(this.items, puTDebitMemoWithIdType.items) &&
        Objects.equals(this.reasonCode, puTDebitMemoWithIdType.reasonCode) &&
        Objects.equals(this.transferredToAccounting, puTDebitMemoWithIdType.transferredToAccounting) &&
        Objects.equals(this.integrationIdNS, puTDebitMemoWithIdType.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, puTDebitMemoWithIdType.integrationStatusNS) &&
        Objects.equals(this.syncDateNS, puTDebitMemoWithIdType.syncDateNS)&&
        Objects.equals(this.additionalProperties, puTDebitMemoWithIdType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, autoPay, comment, dueDate, effectiveDate, items, reasonCode, transferredToAccounting, integrationIdNS, integrationStatusNS, syncDateNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PUTDebitMemoWithIdType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTDebitMemoWithIdType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTDebitMemoWithIdType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTDebitMemoWithIdType is not found in the empty JSON string", PUTDebitMemoWithIdType.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            PUTDebitMemoItemType.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTDebitMemoWithIdType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTDebitMemoWithIdType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTDebitMemoWithIdType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTDebitMemoWithIdType.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTDebitMemoWithIdType>() {
           @Override
           public void write(JsonWriter out, PUTDebitMemoWithIdType value) throws IOException {
           ...
           @Override
           public PUTDebitMemoWithIdType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTDebitMemoWithIdType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTDebitMemoWithIdType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTDebitMemoWithIdType
  * @throws IOException if the JSON string is invalid with respect to PUTDebitMemoWithIdType
  */
  public static PUTDebitMemoWithIdType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTDebitMemoWithIdType.class);
  }

 /**
  * Convert an instance of PUTDebitMemoWithIdType to an JSON string
  *
  * @return JSON string
  */
