...
public class OrderActionRatePlanUsageTieredPricingUpdate {
  /**
 ...
 public enum PriceChangeOptionEnum {
  ...
  public OrderActionRatePlanUsageTieredPricingUpdate() {
  }

  public OrderActionRatePlanUsageTieredPricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public OrderActionRatePlanUsageTieredPricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public OrderActionRatePlanUsageTieredPricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanUsageTieredPricingUpdate tiers(List<OrderActionRatePlanChargeTier> tiers) {
  ...
  public OrderActionRatePlanUsageTieredPricingUpdate addTiersItem(OrderActionRatePlanChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the OrderActionRatePlanUsageTieredPricingUpdate instance itself
   */
  public OrderActionRatePlanUsageTieredPricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanUsageTieredPricingUpdate orderActionRatePlanUsageTieredPricingUpdate = (OrderActionRatePlanUsageTieredPricingUpdate) o;
    return Objects.equals(this.priceChangeOption, orderActionRatePlanUsageTieredPricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, orderActionRatePlanUsageTieredPricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.tiers, orderActionRatePlanUsageTieredPricingUpdate.tiers)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanUsageTieredPricingUpdate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderActionRatePlanUsageTieredPricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanUsageTieredPricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanUsageTieredPricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanUsageTieredPricingUpdate is not found in the empty JSON string", OrderActionRatePlanUsageTieredPricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanUsageTieredPricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanUsageTieredPricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanUsageTieredPricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanUsageTieredPricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanUsageTieredPricingUpdate>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanUsageTieredPricingUpdate value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanUsageTieredPricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanUsageTieredPricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanUsageTieredPricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanUsageTieredPricingUpdate
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanUsageTieredPricingUpdate
  */
  public static OrderActionRatePlanUsageTieredPricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanUsageTieredPricingUpdate.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanUsageTieredPricingUpdate to an JSON string
  *
  * @return JSON string
  */
