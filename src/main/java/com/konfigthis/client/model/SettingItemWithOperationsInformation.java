...
import com.konfigthis.client.model.SettingItemHttpOperation;
...
public class SettingItemWithOperationsInformation {
 ...
 public enum ContextEnum {
  ...
  private List<SettingItemHttpOperation> httpOperations = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "The description of the setting item as you see from Zuora UI.")
  ...
  public SettingItemWithOperationsInformation context(ContextEnum context) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The context where this setting item is effective.")
  ...
  public SettingItemWithOperationsInformation httpOperations(List<SettingItemHttpOperation> httpOperations) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of HTTP operation methods that are supported on this setting endpoint.")

  public List<SettingItemHttpOperation> getHttpOperations() {
    return httpOperations;
  }


  public void setHttpOperations(List<SettingItemHttpOperation> httpOperations) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique key to distinguish the setting item.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The path pattern of the setting endpoint, relative to `/settings`. For example, `/billing-rules`.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, settingItemWithOperationsInformation.description) &&
        Objects.equals(this.context, settingItemWithOperationsInformation.context) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, context, httpOperations, key, pathPattern, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SettingItemWithOperationsInformation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SettingItemWithOperationsInformation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("httpOperations") != null && !jsonObj.get("httpOperations").isJsonNull()) {
        ...
        if (jsonArrayhttpOperations != null) {
          ...
          for (int i = 0; i < jsonArrayhttpOperations.size(); i++) {
            SettingItemHttpOperation.validateJsonObject(jsonArrayhttpOperations.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<SettingItemWithOperationsInformation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SettingItemWithOperationsInformation.class));

       return (TypeAdapter<T>) new TypeAdapter<SettingItemWithOperationsInformation>() {
           @Override
