...
import com.konfigthis.client.model.CreditMemoItemFromWriteOffInvoiceAllOfFinanceInformation;
import com.konfigthis.client.model.CreditMemoTaxItemFromInvoiceTaxItemType;
...
public class CreditMemoItemFromInvoiceItemTypeAllOf {
  ...
  private CreditMemoItemFromWriteOffInvoiceAllOfFinanceInformation financeInformation;
  ...
  private List<CreditMemoTaxItemFromInvoiceTaxItemType> taxItems = null;
 ...
 public enum TaxModeEnum {
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf() {
  }

  public CreditMemoItemFromInvoiceItemTypeAllOf description(String description) {
  ...
  **/
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf amount(Double amount) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The amount of the credit memo item. ")
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf comment(String comment) {
  ...
  **/
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf financeInformation(CreditMemoItemFromWriteOffInvoiceAllOfFinanceInformation financeInformation) {
  ...
  **/
  ...
  public CreditMemoItemFromWriteOffInvoiceAllOfFinanceInformation getFinanceInformation() {
    return financeInformation;
  }


  public void setFinanceInformation(CreditMemoItemFromWriteOffInvoiceAllOfFinanceInformation financeInformation) {
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf invoiceItemId(String invoiceItemId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The ID of the invoice item. ")
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf quantity(Double quantity) {
  ...
  **/
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf serviceEndDate(LocalDate serviceEndDate) {
  ...
  **/
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf serviceStartDate(LocalDate serviceStartDate) {
  ...
  **/
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf skuName(String skuName) {
  ...
  **/
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf taxItems(List<CreditMemoTaxItemFromInvoiceTaxItemType> taxItems) {
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf addTaxItemsItem(CreditMemoTaxItemFromInvoiceTaxItemType taxItemsItem) {
  ...
  **/
  ...
  public List<CreditMemoTaxItemFromInvoiceTaxItemType> getTaxItems() {
    return taxItems;
  }


  public void setTaxItems(List<CreditMemoTaxItemFromInvoiceTaxItemType> taxItems) {
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf taxMode(TaxModeEnum taxMode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "TAXEXCLUSIVE", value = "The tax mode of the credit memo item, indicating whether the amount of the credit memo item includes tax. **Note**:    - Only includes the `taxMode` field if the credit memo needs to be processed with a different tax mode than what was processed during invoice generation or the product rate plan charge was defined with. Otherwise, do not specify a tax mode.   - You can set this field to `TaxInclusive` only if the `taxAutoCalculation` field is set to `true`.   - If you set `taxMode` to `TaxInclusive`, you cannot input tax amounts for credit memo items. The corresponding invoice item must use the same tax engine as the credit memo item to calculate tax amounts. ")
  ...
  public CreditMemoItemFromInvoiceItemTypeAllOf unitOfMeasure(String unitOfMeasure) {
  ...
  **/
   ...
   * @return the CreditMemoItemFromInvoiceItemTypeAllOf instance itself
   */
  public CreditMemoItemFromInvoiceItemTypeAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreditMemoItemFromInvoiceItemTypeAllOf creditMemoItemFromInvoiceItemTypeAllOf = (CreditMemoItemFromInvoiceItemTypeAllOf) o;
    return Objects.equals(this.description, creditMemoItemFromInvoiceItemTypeAllOf.description) &&
        Objects.equals(this.amount, creditMemoItemFromInvoiceItemTypeAllOf.amount) &&
        Objects.equals(this.comment, creditMemoItemFromInvoiceItemTypeAllOf.comment) &&
        Objects.equals(this.financeInformation, creditMemoItemFromInvoiceItemTypeAllOf.financeInformation) &&
        Objects.equals(this.invoiceItemId, creditMemoItemFromInvoiceItemTypeAllOf.invoiceItemId) &&
        Objects.equals(this.quantity, creditMemoItemFromInvoiceItemTypeAllOf.quantity) &&
        Objects.equals(this.serviceEndDate, creditMemoItemFromInvoiceItemTypeAllOf.serviceEndDate) &&
        Objects.equals(this.serviceStartDate, creditMemoItemFromInvoiceItemTypeAllOf.serviceStartDate) &&
        Objects.equals(this.skuName, creditMemoItemFromInvoiceItemTypeAllOf.skuName) &&
        Objects.equals(this.taxItems, creditMemoItemFromInvoiceItemTypeAllOf.taxItems) &&
        Objects.equals(this.taxMode, creditMemoItemFromInvoiceItemTypeAllOf.taxMode) &&
        Objects.equals(this.unitOfMeasure, creditMemoItemFromInvoiceItemTypeAllOf.unitOfMeasure)&&
        Objects.equals(this.additionalProperties, creditMemoItemFromInvoiceItemTypeAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreditMemoItemFromInvoiceItemTypeAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreditMemoItemFromInvoiceItemTypeAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreditMemoItemFromInvoiceItemTypeAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreditMemoItemFromInvoiceItemTypeAllOf is not found in the empty JSON string", CreditMemoItemFromInvoiceItemTypeAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreditMemoItemFromInvoiceItemTypeAllOf.openapiRequiredFields) {
      ...
      if (jsonObj.get("financeInformation") != null && !jsonObj.get("financeInformation").isJsonNull()) {
        CreditMemoItemFromWriteOffInvoiceAllOfFinanceInformation.validateJsonObject(jsonObj.getAsJsonObject("financeInformation"));
      }
      ...
      if (jsonObj.get("taxItems") != null && !jsonObj.get("taxItems").isJsonNull()) {
        ...
        if (jsonArraytaxItems != null) {
          ...
          for (int i = 0; i < jsonArraytaxItems.size(); i++) {
            CreditMemoTaxItemFromInvoiceTaxItemType.validateJsonObject(jsonArraytaxItems.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreditMemoItemFromInvoiceItemTypeAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreditMemoItemFromInvoiceItemTypeAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreditMemoItemFromInvoiceItemTypeAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreditMemoItemFromInvoiceItemTypeAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CreditMemoItemFromInvoiceItemTypeAllOf>() {
           @Override
           public void write(JsonWriter out, CreditMemoItemFromInvoiceItemTypeAllOf value) throws IOException {
           ...
           @Override
           public CreditMemoItemFromInvoiceItemTypeAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreditMemoItemFromInvoiceItemTypeAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreditMemoItemFromInvoiceItemTypeAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreditMemoItemFromInvoiceItemTypeAllOf
  * @throws IOException if the JSON string is invalid with respect to CreditMemoItemFromInvoiceItemTypeAllOf
  */
  public static CreditMemoItemFromInvoiceItemTypeAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreditMemoItemFromInvoiceItemTypeAllOf.class);
  }

 /**
  * Convert an instance of CreditMemoItemFromInvoiceItemTypeAllOf to an JSON string
  *
  * @return JSON string
  */
