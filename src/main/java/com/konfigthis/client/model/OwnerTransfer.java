 ...
 */
@ApiModel(description = "Information about an order action of type `OwnerTransfer`.  **Note:** The Owner Transfer feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/). ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OwnerTransfer {
  ...
  public OwnerTransfer billToContactId(String billToContactId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The contact id of the bill to contact that the subscription is being transferred to.  **Note**:    - If you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Bill_customers_at_subscription_level/Flexible_Billing_Attributes\" target=\"_blank\">Flexible Billing Attributes</a> feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.    - If you have the Flexible Billing Attributes feature enabled, and you do not specify this field in the request or you select **Default Contact from Account** for this field during subscription creation, the value of this field is automatically set to `null` in the response body. ")
  ...
  public OwnerTransfer clearingExistingBillToContact(Boolean clearingExistingBillToContact) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to clear the existing bill-to contact ID at the subscription level. This field is mutually exclusive with the `billToContactId` field.  **Note**: If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body. ")
  ...
  public OwnerTransfer clearingExistingInvoiceGroupNumber(Boolean clearingExistingInvoiceGroupNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to clear the existing invoice group number at the subscription level. This field is mutually exclusive with the `invoiceGroupNumber` field.  **Note**: If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body. ")
  ...
  public OwnerTransfer clearingExistingInvoiceTemplate(Boolean clearingExistingInvoiceTemplate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to clear the existing invoice template ID at the subscription level. This field is mutually exclusive with the `invoiceTemplateId` field.  **Note**: If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body. ")
  ...
  public OwnerTransfer clearingExistingPaymentTerm(Boolean clearingExistingPaymentTerm) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to clear the existing payment term at the subscription level. This field is mutually exclusive with the `paymentTerm` field.  **Note**: If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body. ")
  ...
  public OwnerTransfer clearingExistingSequenceSet(Boolean clearingExistingSequenceSet) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to clear the existing sequence set ID at the subscription level. This field is mutually exclusive with the `sequenceSetId` field.  **Note**: If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body. ")
  ...
  public OwnerTransfer clearingExistingSoldToContact(Boolean clearingExistingSoldToContact) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to clear the existing sold-to contact ID at the subscription level. This field is mutually exclusive with the `soldToContactId` field.  **Note**: If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body. ")
  ...
  public OwnerTransfer destinationAccountNumber(String destinationAccountNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The account number of the account that the subscription is being transferred to. ")
  ...
  public OwnerTransfer destinationInvoiceAccountNumber(String destinationInvoiceAccountNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The account number of the invoice owner account that the subscription is being transferred to. ")
  ...
  public OwnerTransfer invoiceGroupNumber(String invoiceGroupNumber) {
  ...
  **/
  ...
  public OwnerTransfer invoiceTemplateId(String invoiceTemplateId) {
  ...
  **/
  ...
  public OwnerTransfer paymentTerm(String paymentTerm) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the payment term associated with the account. For example, \"Net 30\". The payment term determines the due dates of invoices.  **Note**:    - If you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Bill_customers_at_subscription_level/Flexible_Billing_Attributes\" target=\"_blank\">Flexible Billing Attributes</a> feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.    - If you have the Flexible Billing Attributes feature enabled, and you do not specify this field in the request or you select **Default Term from Account** for this field during subscription creation, the value of this field is automatically set to `null` in the response body. ")
  ...
  public OwnerTransfer sequenceSetId(String sequenceSetId) {
  ...
  **/
  ...
  public OwnerTransfer soldToContactId(String soldToContactId) {
  ...
  **/
   ...
   * @return the OwnerTransfer instance itself
   */
  public OwnerTransfer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OwnerTransfer ownerTransfer = (OwnerTransfer) o;
    return Objects.equals(this.billToContactId, ownerTransfer.billToContactId) &&
        Objects.equals(this.clearingExistingBillToContact, ownerTransfer.clearingExistingBillToContact) &&
        Objects.equals(this.clearingExistingInvoiceGroupNumber, ownerTransfer.clearingExistingInvoiceGroupNumber) &&
        Objects.equals(this.clearingExistingInvoiceTemplate, ownerTransfer.clearingExistingInvoiceTemplate) &&
        Objects.equals(this.clearingExistingPaymentTerm, ownerTransfer.clearingExistingPaymentTerm) &&
        Objects.equals(this.clearingExistingSequenceSet, ownerTransfer.clearingExistingSequenceSet) &&
        Objects.equals(this.clearingExistingSoldToContact, ownerTransfer.clearingExistingSoldToContact) &&
        Objects.equals(this.destinationAccountNumber, ownerTransfer.destinationAccountNumber) &&
        Objects.equals(this.destinationInvoiceAccountNumber, ownerTransfer.destinationInvoiceAccountNumber) &&
        Objects.equals(this.invoiceGroupNumber, ownerTransfer.invoiceGroupNumber) &&
        Objects.equals(this.invoiceTemplateId, ownerTransfer.invoiceTemplateId) &&
        Objects.equals(this.paymentTerm, ownerTransfer.paymentTerm) &&
        Objects.equals(this.sequenceSetId, ownerTransfer.sequenceSetId) &&
        Objects.equals(this.soldToContactId, ownerTransfer.soldToContactId)&&
        Objects.equals(this.additionalProperties, ownerTransfer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OwnerTransfer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OwnerTransfer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OwnerTransfer is not found in the empty JSON string", OwnerTransfer.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OwnerTransfer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OwnerTransfer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OwnerTransfer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OwnerTransfer.class));

       return (TypeAdapter<T>) new TypeAdapter<OwnerTransfer>() {
           @Override
           public void write(JsonWriter out, OwnerTransfer value) throws IOException {
           ...
           @Override
           public OwnerTransfer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OwnerTransfer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OwnerTransfer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OwnerTransfer
  * @throws IOException if the JSON string is invalid with respect to OwnerTransfer
  */
  public static OwnerTransfer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OwnerTransfer.class);
  }

 /**
  * Convert an instance of OwnerTransfer to an JSON string
  *
  * @return JSON string
  */
