 ...
 */
@ApiModel(description = "Pricing information about a usage charge that uses the \"volume pricing\" charge model. In this charge model, the charge has a variable price per unit, depending on how many units are consumed. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UsageVolumePricingOverride {
 ...
 public enum RatingGroupEnum {
  ...
  public UsageVolumePricingOverride() {
  }

  public UsageVolumePricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public UsageVolumePricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public UsageVolumePricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public UsageVolumePricingOverride ratingGroup(RatingGroupEnum ratingGroup) {
  ...
  **/
  ...
  public UsageVolumePricingOverride tiers(List<ChargeTier> tiers) {
  ...
  public UsageVolumePricingOverride addTiersItem(ChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
  ...
  public UsageVolumePricingOverride uom(Double uom) {
  ...
  public UsageVolumePricingOverride uom(Integer uom) {
  ...
  **/
   ...
   * @return the UsageVolumePricingOverride instance itself
   */
  public UsageVolumePricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UsageVolumePricingOverride usageVolumePricingOverride = (UsageVolumePricingOverride) o;
    return Objects.equals(this.priceChangeOption, usageVolumePricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, usageVolumePricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.ratingGroup, usageVolumePricingOverride.ratingGroup) &&
        Objects.equals(this.tiers, usageVolumePricingOverride.tiers) &&
        Objects.equals(this.uom, usageVolumePricingOverride.uom)&&
        Objects.equals(this.additionalProperties, usageVolumePricingOverride.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, ratingGroup, tiers, uom, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UsageVolumePricingOverride {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsageVolumePricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsageVolumePricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsageVolumePricingOverride is not found in the empty JSON string", UsageVolumePricingOverride.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsageVolumePricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsageVolumePricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsageVolumePricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsageVolumePricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<UsageVolumePricingOverride>() {
           @Override
           public void write(JsonWriter out, UsageVolumePricingOverride value) throws IOException {
           ...
           @Override
           public UsageVolumePricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UsageVolumePricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UsageVolumePricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UsageVolumePricingOverride
  * @throws IOException if the JSON string is invalid with respect to UsageVolumePricingOverride
  */
  public static UsageVolumePricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsageVolumePricingOverride.class);
  }

 /**
  * Convert an instance of UsageVolumePricingOverride to an JSON string
  *
  * @return JSON string
  */
