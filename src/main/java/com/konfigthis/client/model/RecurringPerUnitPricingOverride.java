...
import com.konfigthis.client.model.PriceIntervalWithPrice;
 ...
 */
@ApiModel(description = "Pricing information about a recurring charge that uses the \"per unit\" charge model. In this charge model, the charge has a fixed price per unit purchased. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class RecurringPerUnitPricingOverride {
 ...
 public enum ListPriceBaseEnum {
  ...
  public static final String SERIALIZED_NAME_PRICE_INTERVALS = "priceIntervals";
  @SerializedName(SERIALIZED_NAME_PRICE_INTERVALS)
  private List<PriceIntervalWithPrice> priceIntervals = null;
  ...
  public RecurringPerUnitPricingOverride() {
  }

  public RecurringPerUnitPricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public RecurringPerUnitPricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public RecurringPerUnitPricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public RecurringPerUnitPricingOverride listPrice(Double listPrice) {
  ...
  public RecurringPerUnitPricingOverride listPrice(Integer listPrice) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Per-unit price of the charge in each recurring period. ")
  ...
  public RecurringPerUnitPricingOverride listPriceBase(ListPriceBaseEnum listPriceBase) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the duration of each recurring period. ")
  ...
  public RecurringPerUnitPricingOverride originalListPrice(Double originalListPrice) {
  ...
  public RecurringPerUnitPricingOverride originalListPrice(Integer originalListPrice) {
    
    
    
    
    this.originalListPrice = originalListPrice.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The original list price is the price of a product or service at which it is listed for sale by a manufacturer or retailer. ")
  ...
  public RecurringPerUnitPricingOverride priceIntervals(List<PriceIntervalWithPrice> priceIntervals) {
  ...
  public RecurringPerUnitPricingOverride addPriceIntervalsItem(PriceIntervalWithPrice priceIntervalsItem) {
    if (this.priceIntervals == null) {
      this.priceIntervals = new ArrayList<>();
    }
    this.priceIntervals.add(priceIntervalsItem);
    return this;
  }

   /**
   * List of interval pricing in the charge.  The &#x60;priceIntervals&#x60; field is not supported for a charge subscribed via a RatePlan, you can only override the &#x60;priceIntervals&#x60; field for a charge subscribed via an offer.   **Note**: You must enable the Offers feature to access this field. The Offers feature is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at &lt;a href&#x3D;\&quot;https://support.zuora.com/hc/en-us\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Zuora Global Support&lt;/a&gt;. 
   * @return priceIntervals
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of interval pricing in the charge.  The `priceIntervals` field is not supported for a charge subscribed via a RatePlan, you can only override the `priceIntervals` field for a charge subscribed via an offer.   **Note**: You must enable the Offers feature to access this field. The Offers feature is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at <a href=\"https://support.zuora.com/hc/en-us\" target=\"_blank\">Zuora Global Support</a>. ")

  public List<PriceIntervalWithPrice> getPriceIntervals() {
    return priceIntervals;
  }


  public void setPriceIntervals(List<PriceIntervalWithPrice> priceIntervals) {
  ...
  public RecurringPerUnitPricingOverride quantity(Double quantity) {
  ...
  public RecurringPerUnitPricingOverride quantity(Integer quantity) {
    if (quantity != null && quantity < 0) {
      throw new IllegalArgumentException("Invalid value for quantity. Must be greater than or equal to 0.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of units purchased. ")
  ...
  public RecurringPerUnitPricingOverride specificListPriceBase(Integer specificListPriceBase) {
  ...
  **/
  ...
  public RecurringPerUnitPricingOverride uom(Double uom) {
  ...
  public RecurringPerUnitPricingOverride uom(Integer uom) {
    
    
    
    
    this.uom = uom.doubleValue();
    return this;
  }

   /**
   * Unit of measure of the standalone charge.  **Note:** This field is available when the &lt;a href&#x3D;\&quot;https://knowledgecenter.zuora.com/Zuora_Billing/Manage_subscription_transactions/Orders/Standalone_Orders/AA_Overview_of_Standalone_Orders\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Standalone Orders&lt;/a&gt; feature is enabled. 
   * @return uom
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unit of measure of the standalone charge.  **Note:** This field is available when the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Manage_subscription_transactions/Orders/Standalone_Orders/AA_Overview_of_Standalone_Orders\" target=\"_blank\">Standalone Orders</a> feature is enabled. ")
   ...
   * @return the RecurringPerUnitPricingOverride instance itself
   */
  public RecurringPerUnitPricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecurringPerUnitPricingOverride recurringPerUnitPricingOverride = (RecurringPerUnitPricingOverride) o;
    return Objects.equals(this.priceChangeOption, recurringPerUnitPricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, recurringPerUnitPricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.listPrice, recurringPerUnitPricingOverride.listPrice) &&
        Objects.equals(this.listPriceBase, recurringPerUnitPricingOverride.listPriceBase) &&
        Objects.equals(this.originalListPrice, recurringPerUnitPricingOverride.originalListPrice) &&
        Objects.equals(this.priceIntervals, recurringPerUnitPricingOverride.priceIntervals) &&
        Objects.equals(this.quantity, recurringPerUnitPricingOverride.quantity) &&
        Objects.equals(this.specificListPriceBase, recurringPerUnitPricingOverride.specificListPriceBase) &&
        Objects.equals(this.uom, recurringPerUnitPricingOverride.uom)&&
        Objects.equals(this.additionalProperties, recurringPerUnitPricingOverride.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, listPrice, listPriceBase, originalListPrice, priceIntervals, quantity, specificListPriceBase, uom, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RecurringPerUnitPricingOverride {\n");
    ...
    sb.append("    priceIntervals: ").append(toIndentedString(priceIntervals)).append("\n");
  ...
  static {
    ...
    openapiFields.add("priceIntervals");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecurringPerUnitPricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecurringPerUnitPricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurringPerUnitPricingOverride is not found in the empty JSON string", RecurringPerUnitPricingOverride.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("priceIntervals") != null && !jsonObj.get("priceIntervals").isJsonNull()) {
        JsonArray jsonArraypriceIntervals = jsonObj.getAsJsonArray("priceIntervals");
        if (jsonArraypriceIntervals != null) {
          // ensure the json data is an array
          if (!jsonObj.get("priceIntervals").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `priceIntervals` to be an array in the JSON string but got `%s`", jsonObj.get("priceIntervals").toString()));
          }

          // validate the optional field `priceIntervals` (array)
          for (int i = 0; i < jsonArraypriceIntervals.size(); i++) {
            PriceIntervalWithPrice.validateJsonObject(jsonArraypriceIntervals.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurringPerUnitPricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurringPerUnitPricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurringPerUnitPricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurringPerUnitPricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurringPerUnitPricingOverride>() {
           @Override
           public void write(JsonWriter out, RecurringPerUnitPricingOverride value) throws IOException {
           ...
           @Override
           public RecurringPerUnitPricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecurringPerUnitPricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecurringPerUnitPricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecurringPerUnitPricingOverride
  * @throws IOException if the JSON string is invalid with respect to RecurringPerUnitPricingOverride
  */
  public static RecurringPerUnitPricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurringPerUnitPricingOverride.class);
  }

 /**
  * Convert an instance of RecurringPerUnitPricingOverride to an JSON string
  *
  * @return JSON string
  */
