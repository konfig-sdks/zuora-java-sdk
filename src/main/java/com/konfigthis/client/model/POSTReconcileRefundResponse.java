...
import com.konfigthis.client.model.POSTReconcileRefundResponseFinanceInformation;
...
public class POSTReconcileRefundResponse {
  ...
  private POSTReconcileRefundResponseFinanceInformation financeInformation;
 ...
 public enum TypeEnum {
  ...
  public POSTReconcileRefundResponse() {
  }

  public POSTReconcileRefundResponse accountId(String accountId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "4028905f5a87c0ff015a87d25ae90025", value = "The ID of the customer account that the refund is for. ")
  ...
  public POSTReconcileRefundResponse amount(Double amount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4", value = "The total amount of the refund. ")
  ...
  public POSTReconcileRefundResponse cancelledOn(OffsetDateTime cancelledOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the transaction was cancelled, in `yyyy-mm-dd hh:mm:ss` format. ")
  ...
  public POSTReconcileRefundResponse comment(String comment) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Create a refund for unapplied payment.", value = "Comments about the refund. ")
  ...
  public POSTReconcileRefundResponse createdById(String createdById) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "402881e522cf4f9b0122cf5d82860002", value = "The ID of the Zuora user who created the refund. ")
  ...
  public POSTReconcileRefundResponse createdDate(OffsetDateTime createdDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the refund is created, in `yyyy-mm-dd hh:mm:ss` format. ")
  ...
  public POSTReconcileRefundResponse creditMemoId(String creditMemoId) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse financeInformation(POSTReconcileRefundResponseFinanceInformation financeInformation) {
  ...
  **/
  ...
  public POSTReconcileRefundResponseFinanceInformation getFinanceInformation() {
    return financeInformation;
  }


  public void setFinanceInformation(POSTReconcileRefundResponseFinanceInformation financeInformation) {
  ...
  public POSTReconcileRefundResponse gatewayId(String gatewayId) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse gatewayReconciliationReason(String gatewayReconciliationReason) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "refund_paid", value = "The reason of gateway reconciliation. ")
  ...
  public POSTReconcileRefundResponse gatewayReconciliationStatus(String gatewayReconciliationStatus) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "paid", value = "The status of gateway reconciliation. ")
  ...
  public POSTReconcileRefundResponse gatewayResponse(String gatewayResponse) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse gatewayResponseCode(String gatewayResponseCode) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse gatewayState(GatewayStateEnum gatewayState) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SETTLED", value = "The status of the refund in the gateway; specifically used for reconciliation. ")
  ...
  public POSTReconcileRefundResponse id(String id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4028905f5a87c0ff015a889e590e00c9X", value = "The ID of the refund. ")
  ...
  public POSTReconcileRefundResponse markedForSubmissionOn(OffsetDateTime markedForSubmissionOn) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse methodType(MethodTypeEnum methodType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CREDITCARD", value = "How an external refund was issued to a customer.  ")
  ...
  public POSTReconcileRefundResponse number(String number) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "R-00000001", value = "The unique identification number of the refund. For example, R-00000001. ")
  ...
  public POSTReconcileRefundResponse organizationLabel(String organizationLabel) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse paymentId(String paymentId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4028905f5a87c0ff015a889ddfb800c0", value = "The ID of the payment that is refunded. ")
  ...
  public POSTReconcileRefundResponse paymentMethodId(String paymentMethodId) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse paymentMethodSnapshotId(String paymentMethodSnapshotId) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse payoutId(String payoutId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "PAYOUT123", value = "The payout ID of the refund from the gateway side. ")
  ...
  public POSTReconcileRefundResponse reasonCode(String reasonCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Standard Refund", value = "A code identifying the reason for the transaction.       ")
  ...
  public POSTReconcileRefundResponse referenceId(String referenceId) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse refundDate(LocalDate refundDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Sat Feb 29 16:00:00 PST 2020", value = "The date when the refund takes effect, in `yyyy-mm-dd` format. For example, 2020-03-01.        ")
  ...
  public POSTReconcileRefundResponse refundTransactionTime(OffsetDateTime refundTransactionTime) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse secondRefundReferenceId(String secondRefundReferenceId) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse settledOn(OffsetDateTime settledOn) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse softDescriptor(String softDescriptor) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse softDescriptorPhone(String softDescriptorPhone) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse status(String status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Processed", value = "The status of the refund. ")
  ...
  public POSTReconcileRefundResponse submittedOn(OffsetDateTime submittedOn) {
  ...
  **/
  ...
  public POSTReconcileRefundResponse success(Boolean success) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Indicates if the request is processed successfully. ")
  ...
  public POSTReconcileRefundResponse type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ELECTRONIC", value = "The type of the refund. ")
  ...
  public POSTReconcileRefundResponse updatedById(String updatedById) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "402881e522cf4f9b0122cf5d82860002", value = "The ID of the Zuora user who last updated the refund. ")
  ...
  public POSTReconcileRefundResponse updatedDate(OffsetDateTime updatedDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the refund was last updated, in `yyyy-mm-dd hh:mm:ss` format. ")
   ...
   * @return the POSTReconcileRefundResponse instance itself
   */
  public POSTReconcileRefundResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTReconcileRefundResponse poSTReconcileRefundResponse = (POSTReconcileRefundResponse) o;
    return Objects.equals(this.accountId, poSTReconcileRefundResponse.accountId) &&
        Objects.equals(this.amount, poSTReconcileRefundResponse.amount) &&
        Objects.equals(this.cancelledOn, poSTReconcileRefundResponse.cancelledOn) &&
        Objects.equals(this.comment, poSTReconcileRefundResponse.comment) &&
        Objects.equals(this.createdById, poSTReconcileRefundResponse.createdById) &&
        Objects.equals(this.createdDate, poSTReconcileRefundResponse.createdDate) &&
        Objects.equals(this.creditMemoId, poSTReconcileRefundResponse.creditMemoId) &&
        Objects.equals(this.financeInformation, poSTReconcileRefundResponse.financeInformation) &&
        Objects.equals(this.gatewayId, poSTReconcileRefundResponse.gatewayId) &&
        Objects.equals(this.gatewayReconciliationReason, poSTReconcileRefundResponse.gatewayReconciliationReason) &&
        Objects.equals(this.gatewayReconciliationStatus, poSTReconcileRefundResponse.gatewayReconciliationStatus) &&
        Objects.equals(this.gatewayResponse, poSTReconcileRefundResponse.gatewayResponse) &&
        Objects.equals(this.gatewayResponseCode, poSTReconcileRefundResponse.gatewayResponseCode) &&
        Objects.equals(this.gatewayState, poSTReconcileRefundResponse.gatewayState) &&
        Objects.equals(this.id, poSTReconcileRefundResponse.id) &&
        Objects.equals(this.markedForSubmissionOn, poSTReconcileRefundResponse.markedForSubmissionOn) &&
        Objects.equals(this.methodType, poSTReconcileRefundResponse.methodType) &&
        Objects.equals(this.number, poSTReconcileRefundResponse.number) &&
        Objects.equals(this.organizationLabel, poSTReconcileRefundResponse.organizationLabel) &&
        Objects.equals(this.paymentId, poSTReconcileRefundResponse.paymentId) &&
        Objects.equals(this.paymentMethodId, poSTReconcileRefundResponse.paymentMethodId) &&
        Objects.equals(this.paymentMethodSnapshotId, poSTReconcileRefundResponse.paymentMethodSnapshotId) &&
        Objects.equals(this.payoutId, poSTReconcileRefundResponse.payoutId) &&
        Objects.equals(this.reasonCode, poSTReconcileRefundResponse.reasonCode) &&
        Objects.equals(this.referenceId, poSTReconcileRefundResponse.referenceId) &&
        Objects.equals(this.refundDate, poSTReconcileRefundResponse.refundDate) &&
        Objects.equals(this.refundTransactionTime, poSTReconcileRefundResponse.refundTransactionTime) &&
        Objects.equals(this.secondRefundReferenceId, poSTReconcileRefundResponse.secondRefundReferenceId) &&
        Objects.equals(this.settledOn, poSTReconcileRefundResponse.settledOn) &&
        Objects.equals(this.softDescriptor, poSTReconcileRefundResponse.softDescriptor) &&
        Objects.equals(this.softDescriptorPhone, poSTReconcileRefundResponse.softDescriptorPhone) &&
        Objects.equals(this.status, poSTReconcileRefundResponse.status) &&
        Objects.equals(this.submittedOn, poSTReconcileRefundResponse.submittedOn) &&
        Objects.equals(this.success, poSTReconcileRefundResponse.success) &&
        Objects.equals(this.type, poSTReconcileRefundResponse.type) &&
        Objects.equals(this.updatedById, poSTReconcileRefundResponse.updatedById) &&
        Objects.equals(this.updatedDate, poSTReconcileRefundResponse.updatedDate)&&
        Objects.equals(this.additionalProperties, poSTReconcileRefundResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class POSTReconcileRefundResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTReconcileRefundResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTReconcileRefundResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTReconcileRefundResponse is not found in the empty JSON string", POSTReconcileRefundResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("financeInformation") != null && !jsonObj.get("financeInformation").isJsonNull()) {
        POSTReconcileRefundResponseFinanceInformation.validateJsonObject(jsonObj.getAsJsonObject("financeInformation"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTReconcileRefundResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTReconcileRefundResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTReconcileRefundResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTReconcileRefundResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTReconcileRefundResponse>() {
           @Override
           public void write(JsonWriter out, POSTReconcileRefundResponse value) throws IOException {
           ...
           @Override
           public POSTReconcileRefundResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTReconcileRefundResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTReconcileRefundResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTReconcileRefundResponse
  * @throws IOException if the JSON string is invalid with respect to POSTReconcileRefundResponse
  */
  public static POSTReconcileRefundResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTReconcileRefundResponse.class);
  }

 /**
  * Convert an instance of POSTReconcileRefundResponse to an JSON string
  *
  * @return JSON string
  */
