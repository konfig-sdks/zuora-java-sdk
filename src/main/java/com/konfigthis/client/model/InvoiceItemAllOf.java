...
import com.konfigthis.client.model.InvoiceItemAllOfTaxationItems;
...
public class InvoiceItemAllOf {
  ...
  private Double availableToCreditAmount;
 ...
 public enum SourceItemTypeEnum {
  ...
  private InvoiceItemAllOfTaxationItems taxationItems;
  ...
  public InvoiceItemAllOf() {
  }

  public InvoiceItemAllOf description(String description) {
  ...
  **/
  ...
  public InvoiceItemAllOf accountingCode(String accountingCode) {
  ...
  **/
  ...
  public InvoiceItemAllOf adjustmentLiabilityAccountingCode(String adjustmentLiabilityAccountingCode) {
  ...
  **/
  ...
  public InvoiceItemAllOf adjustmentRevenueAccountingCode(String adjustmentRevenueAccountingCode) {
  ...
  **/
  ...
  public InvoiceItemAllOf appliedToItemId(String appliedToItemId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique ID of the invoice item that the discount charge is applied to.")
  ...
  public InvoiceItemAllOf availableToCreditAmount(Double availableToCreditAmount) {
  ...
  public InvoiceItemAllOf availableToCreditAmount(Integer availableToCreditAmount) {
    
    
    
    
    this.availableToCreditAmount = availableToCreditAmount.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount of the invoice item that is available to credit.         ")

  public Double getAvailableToCreditAmount() {
    return availableToCreditAmount;
  }


  public void setAvailableToCreditAmount(Double availableToCreditAmount) {
  ...
  public InvoiceItemAllOf balance(BigDecimal balance) {
   ...
   /**
   * The balance of the invoice item.  **Note**: This field is only available if you have the Invoice Settlement feature enabled. 
   * @return balance
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The balance of the invoice item.  **Note**: This field is only available if you have the Invoice Settlement feature enabled. ")
  ...
  public InvoiceItemAllOf bookingReference(String bookingReference) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The booking reference of the invoice item. ")
  ...
  public InvoiceItemAllOf chargeAmount(BigDecimal chargeAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount of the charge.   This amount does not include taxes regardless if the charge's tax mode is inclusive or exclusive. ")
  ...
  public InvoiceItemAllOf chargeDate(OffsetDateTime chargeDate) {
  ...
  **/
  ...
  public InvoiceItemAllOf chargeDescription(String chargeDescription) {
  ...
  **/
  ...
  public InvoiceItemAllOf chargeId(String chargeId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique ID of the charge.")
  ...
  public InvoiceItemAllOf chargeName(String chargeName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the charge.")
  ...
  public InvoiceItemAllOf chargeType(ChargeTypeEnum chargeType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the charge.  ")
  ...
  public InvoiceItemAllOf contractAssetAccountingCode(String contractAssetAccountingCode) {
  ...
  **/
  ...
  public InvoiceItemAllOf contractLiabilityAccountingCode(String contractLiabilityAccountingCode) {
  ...
  **/
  ...
  public InvoiceItemAllOf contractRecognizedRevenueAccountingCode(String contractRecognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public InvoiceItemAllOf deferredRevenueAccountingCode(String deferredRevenueAccountingCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The deferred revenue accounting code associated with the invoice item.  **Note:** This field is only available if you have Zuora Finance enabled. ")
  ...
  public InvoiceItemAllOf excludeItemBillingFromRevenueAccounting(Boolean excludeItemBillingFromRevenueAccounting) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The flag to exclude the invoice item from revenue accounting.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.  ")
  ...
  public InvoiceItemAllOf fulfillmentId(String fulfillmentId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The reference ID of the fulfillment associated with the invoice item. ")
  ...
  public InvoiceItemAllOf id(String id) {
  ...
  **/
  ...
  public InvoiceItemAllOf invoiceScheduleId(String invoiceScheduleId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the invoice schedule item by which Invoice Schedule Item the invoice item is generated by when the Invoice Schedule Item is executed.  **Note**: This field is available only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Flexible_Billing/Billing_Schedule\" target=\"_blank\">Billing Schedule</a> feature enabled. ")
  ...
  public InvoiceItemAllOf invoiceScheduleItemId(String invoiceScheduleItemId) {
   ...
   /**
   * The ID of the invoice schedule item associated with the invoice item.  **Note**: This field is available only if you have the &lt;a href&#x3D;\&quot;https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Flexible_Billing/Billing_Schedule\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Billing Schedule&lt;/a&gt; feature enabled. 
   * @return invoiceScheduleItemId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the invoice schedule item associated with the invoice item.  **Note**: This field is available only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Flexible_Billing/Billing_Schedule\" target=\"_blank\">Billing Schedule</a> feature enabled. ")
  ...
  public InvoiceItemAllOf itemType(String itemType) {
  ...
  **/
  ...
  public InvoiceItemAllOf numberOfDeliveries(Double numberOfDeliveries) {
  ...
  public InvoiceItemAllOf numberOfDeliveries(Integer numberOfDeliveries) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of deliveries dedicated to the Delivery Pricing charges. **Note**: This field is available only if you have the Delivery Pricing feature enabled. ")
  ...
  public InvoiceItemAllOf orderLineItemId(String orderLineItemId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The reference ID of the oder line item associated with the invoice item. ")
  ...
  public InvoiceItemAllOf processingType(ProcessingTypeEnum processingType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The kind of the charge for the invoice item.  ")
  ...
  public InvoiceItemAllOf productName(String productName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the product associated with this item.")
  ...
  public InvoiceItemAllOf productRatePlanChargeId(String productRatePlanChargeId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the product rate plan charge that the invoice item is created from. ")
  ...
  public InvoiceItemAllOf purchaseOrderNumber(String purchaseOrderNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The purchase order number associated with the invoice item. ")
  ...
  public InvoiceItemAllOf quantity(BigDecimal quantity) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The quantity of this item, in the configured unit of measure for the charge.")
  ...
  public InvoiceItemAllOf recognizedRevenueAccountingCode(String recognizedRevenueAccountingCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The recognized revenue accounting code associated with the invoice item.  **Note:** This field is only available if you have Zuora Finance enabled. ")
  ...
  public InvoiceItemAllOf revRecCode(String revRecCode) {
  ...
  **/
  ...
  public InvoiceItemAllOf revRecTriggerCondition(RevRecTriggerConditionEnum revRecTriggerCondition) {
  ...
  **/
  ...
  public InvoiceItemAllOf revenueRecognitionRuleName(String revenueRecognitionRuleName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The tevenue recognition rule of the invoice item.  **Note:** This field is only available if you have Zuora Finance enabled. ")
  ...
  public InvoiceItemAllOf serviceEndDate(LocalDate serviceEndDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The end date of the service period for this item, i.e., the last day of the service period, as _yyyy-mm-dd_.")
  ...
  public InvoiceItemAllOf serviceStartDate(LocalDate serviceStartDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The start date of the service period for this item, as _yyyy-mm-dd_. For a one-time fee item, the date of the charge.")
  ...
  public InvoiceItemAllOf sku(String sku) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The SKU of the invoice item. ")
  ...
  public InvoiceItemAllOf soldToContactId(String soldToContactId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the sold-to contact associated with the invoice item.  **Note**: If you have the Flexible Billing Attributes feature disabled, the value of this field is `null`. ")
  ...
  public InvoiceItemAllOf soldToContactSnapshotId(String soldToContactSnapshotId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the sold-to contact snapshot associated with the invoice item.  **Note**: If you have the Flexible Billing Attributes feature disabled, the value of this field is `null`. ")
  ...
  public InvoiceItemAllOf sourceItemType(SourceItemTypeEnum sourceItemType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the source item. ")
  ...
  public InvoiceItemAllOf subscriptionId(String subscriptionId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the subscription for this item.")
  ...
  public InvoiceItemAllOf subscriptionName(String subscriptionName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the subscription for this item.")
  ...
  public InvoiceItemAllOf taxAmount(BigDecimal taxAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Tax applied to the charge.")
  ...
  public InvoiceItemAllOf taxCode(String taxCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The tax code of the invoice item. **Note** Only when taxation feature is enabled, this field can be presented. ")
  ...
  public InvoiceItemAllOf taxMode(String taxMode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The tax mode of the invoice item. **Note** Only when taxation feature is enabled, this field can be presented. ")
  ...
  public InvoiceItemAllOf taxationItems(InvoiceItemAllOfTaxationItems taxationItems) {
  ...
  **/
  ...
  public InvoiceItemAllOfTaxationItems getTaxationItems() {
    return taxationItems;
  }


  public void setTaxationItems(InvoiceItemAllOfTaxationItems taxationItems) {
  ...
  public InvoiceItemAllOf unbilledReceivablesAccountingCode(String unbilledReceivablesAccountingCode) {
  ...
  **/
  ...
  public InvoiceItemAllOf unitOfMeasure(String unitOfMeasure) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unit used to measure consumption.")
  ...
  public InvoiceItemAllOf unitPrice(Double unitPrice) {
  ...
  **/
   ...
   * @return the InvoiceItemAllOf instance itself
   */
  public InvoiceItemAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InvoiceItemAllOf invoiceItemAllOf = (InvoiceItemAllOf) o;
    return Objects.equals(this.description, invoiceItemAllOf.description) &&
        Objects.equals(this.accountingCode, invoiceItemAllOf.accountingCode) &&
        Objects.equals(this.adjustmentLiabilityAccountingCode, invoiceItemAllOf.adjustmentLiabilityAccountingCode) &&
        Objects.equals(this.adjustmentRevenueAccountingCode, invoiceItemAllOf.adjustmentRevenueAccountingCode) &&
        Objects.equals(this.appliedToItemId, invoiceItemAllOf.appliedToItemId) &&
        Objects.equals(this.availableToCreditAmount, invoiceItemAllOf.availableToCreditAmount) &&
        Objects.equals(this.balance, invoiceItemAllOf.balance) &&
        Objects.equals(this.bookingReference, invoiceItemAllOf.bookingReference) &&
        Objects.equals(this.chargeAmount, invoiceItemAllOf.chargeAmount) &&
        Objects.equals(this.chargeDate, invoiceItemAllOf.chargeDate) &&
        Objects.equals(this.chargeDescription, invoiceItemAllOf.chargeDescription) &&
        Objects.equals(this.chargeId, invoiceItemAllOf.chargeId) &&
        Objects.equals(this.chargeName, invoiceItemAllOf.chargeName) &&
        Objects.equals(this.chargeType, invoiceItemAllOf.chargeType) &&
        Objects.equals(this.contractAssetAccountingCode, invoiceItemAllOf.contractAssetAccountingCode) &&
        Objects.equals(this.contractLiabilityAccountingCode, invoiceItemAllOf.contractLiabilityAccountingCode) &&
        Objects.equals(this.contractRecognizedRevenueAccountingCode, invoiceItemAllOf.contractRecognizedRevenueAccountingCode) &&
        Objects.equals(this.deferredRevenueAccountingCode, invoiceItemAllOf.deferredRevenueAccountingCode) &&
        Objects.equals(this.excludeItemBillingFromRevenueAccounting, invoiceItemAllOf.excludeItemBillingFromRevenueAccounting) &&
        Objects.equals(this.fulfillmentId, invoiceItemAllOf.fulfillmentId) &&
        Objects.equals(this.id, invoiceItemAllOf.id) &&
        Objects.equals(this.invoiceScheduleId, invoiceItemAllOf.invoiceScheduleId) &&
        Objects.equals(this.invoiceScheduleItemId, invoiceItemAllOf.invoiceScheduleItemId) &&
        Objects.equals(this.itemType, invoiceItemAllOf.itemType) &&
        Objects.equals(this.numberOfDeliveries, invoiceItemAllOf.numberOfDeliveries) &&
        Objects.equals(this.orderLineItemId, invoiceItemAllOf.orderLineItemId) &&
        Objects.equals(this.processingType, invoiceItemAllOf.processingType) &&
        Objects.equals(this.productName, invoiceItemAllOf.productName) &&
        Objects.equals(this.productRatePlanChargeId, invoiceItemAllOf.productRatePlanChargeId) &&
        Objects.equals(this.purchaseOrderNumber, invoiceItemAllOf.purchaseOrderNumber) &&
        Objects.equals(this.quantity, invoiceItemAllOf.quantity) &&
        Objects.equals(this.recognizedRevenueAccountingCode, invoiceItemAllOf.recognizedRevenueAccountingCode) &&
        Objects.equals(this.revRecCode, invoiceItemAllOf.revRecCode) &&
        Objects.equals(this.revRecTriggerCondition, invoiceItemAllOf.revRecTriggerCondition) &&
        Objects.equals(this.revenueRecognitionRuleName, invoiceItemAllOf.revenueRecognitionRuleName) &&
        Objects.equals(this.serviceEndDate, invoiceItemAllOf.serviceEndDate) &&
        Objects.equals(this.serviceStartDate, invoiceItemAllOf.serviceStartDate) &&
        Objects.equals(this.sku, invoiceItemAllOf.sku) &&
        Objects.equals(this.soldToContactId, invoiceItemAllOf.soldToContactId) &&
        Objects.equals(this.soldToContactSnapshotId, invoiceItemAllOf.soldToContactSnapshotId) &&
        Objects.equals(this.sourceItemType, invoiceItemAllOf.sourceItemType) &&
        Objects.equals(this.subscriptionId, invoiceItemAllOf.subscriptionId) &&
        Objects.equals(this.subscriptionName, invoiceItemAllOf.subscriptionName) &&
        Objects.equals(this.taxAmount, invoiceItemAllOf.taxAmount) &&
        Objects.equals(this.taxCode, invoiceItemAllOf.taxCode) &&
        Objects.equals(this.taxMode, invoiceItemAllOf.taxMode) &&
        Objects.equals(this.taxationItems, invoiceItemAllOf.taxationItems) &&
        Objects.equals(this.unbilledReceivablesAccountingCode, invoiceItemAllOf.unbilledReceivablesAccountingCode) &&
        Objects.equals(this.unitOfMeasure, invoiceItemAllOf.unitOfMeasure) &&
        Objects.equals(this.unitPrice, invoiceItemAllOf.unitPrice)&&
        Objects.equals(this.additionalProperties, invoiceItemAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, accountingCode, adjustmentLiabilityAccountingCode, adjustmentRevenueAccountingCode, appliedToItemId, availableToCreditAmount, balance, bookingReference, chargeAmount, chargeDate, chargeDescription, chargeId, chargeName, chargeType, contractAssetAccountingCode, contractLiabilityAccountingCode, contractRecognizedRevenueAccountingCode, deferredRevenueAccountingCode, excludeItemBillingFromRevenueAccounting, fulfillmentId, id, invoiceScheduleId, invoiceScheduleItemId, itemType, numberOfDeliveries, orderLineItemId, processingType, productName, productRatePlanChargeId, purchaseOrderNumber, quantity, recognizedRevenueAccountingCode, revRecCode, revRecTriggerCondition, revenueRecognitionRuleName, serviceEndDate, serviceStartDate, sku, soldToContactId, soldToContactSnapshotId, sourceItemType, subscriptionId, subscriptionName, taxAmount, taxCode, taxMode, taxationItems, unbilledReceivablesAccountingCode, unitOfMeasure, unitPrice, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InvoiceItemAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceItemAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceItemAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceItemAllOf is not found in the empty JSON string", InvoiceItemAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("taxationItems") != null && !jsonObj.get("taxationItems").isJsonNull()) {
        InvoiceItemAllOfTaxationItems.validateJsonObject(jsonObj.getAsJsonObject("taxationItems"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceItemAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceItemAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceItemAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceItemAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceItemAllOf>() {
           @Override
           public void write(JsonWriter out, InvoiceItemAllOf value) throws IOException {
           ...
           @Override
           public InvoiceItemAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoiceItemAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoiceItemAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoiceItemAllOf
  * @throws IOException if the JSON string is invalid with respect to InvoiceItemAllOf
  */
  public static InvoiceItemAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceItemAllOf.class);
  }

 /**
  * Convert an instance of InvoiceItemAllOf to an JSON string
  *
  * @return JSON string
  */
