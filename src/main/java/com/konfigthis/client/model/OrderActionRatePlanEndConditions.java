...
public class OrderActionRatePlanEndConditions {
  /**
 ...
 public enum UpToPeriodsTypeEnum {
  ...
  public OrderActionRatePlanEndConditions() {
  }

  public OrderActionRatePlanEndConditions endDateCondition(EndDateConditionEnum endDateCondition) {
  ...
  **/
  ...
  public OrderActionRatePlanEndConditions specificEndDate(LocalDate specificEndDate) {
  ...
  **/
  ...
  public OrderActionRatePlanEndConditions upToPeriods(Integer upToPeriods) {
  ...
  **/
  ...
  public OrderActionRatePlanEndConditions upToPeriodsType(UpToPeriodsTypeEnum upToPeriodsType) {
  ...
  **/
   ...
   * @return the OrderActionRatePlanEndConditions instance itself
   */
  public OrderActionRatePlanEndConditions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanEndConditions orderActionRatePlanEndConditions = (OrderActionRatePlanEndConditions) o;
    return Objects.equals(this.endDateCondition, orderActionRatePlanEndConditions.endDateCondition) &&
        Objects.equals(this.specificEndDate, orderActionRatePlanEndConditions.specificEndDate) &&
        Objects.equals(this.upToPeriods, orderActionRatePlanEndConditions.upToPeriods) &&
        Objects.equals(this.upToPeriodsType, orderActionRatePlanEndConditions.upToPeriodsType)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanEndConditions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endDateCondition, specificEndDate, upToPeriods, upToPeriodsType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderActionRatePlanEndConditions {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanEndConditions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanEndConditions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanEndConditions is not found in the empty JSON string", OrderActionRatePlanEndConditions.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanEndConditions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanEndConditions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanEndConditions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanEndConditions.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanEndConditions>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanEndConditions value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanEndConditions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanEndConditions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanEndConditions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanEndConditions
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanEndConditions
  */
  public static OrderActionRatePlanEndConditions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanEndConditions.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanEndConditions to an JSON string
  *
  * @return JSON string
  */
