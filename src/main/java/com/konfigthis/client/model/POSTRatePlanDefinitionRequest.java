...
public class POSTRatePlanDefinitionRequest {
  ...
  public POSTRatePlanDefinitionRequest() {
  }

  public POSTRatePlanDefinitionRequest productRatePlanChargeId(String productRatePlanChargeId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2c9890e489f227bd0189f22f3482001f", value = "The unique ID of the product rate plan charge to be used in the product rate plan. ")
  ...
  public POSTRatePlanDefinitionRequest productRatePlanChargeNumber(String productRatePlanChargeNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "PRPC-00000001", value = "The unique number (natural key) of the product rate plan charge to be used in the product rate plan. ")
  ...
  public POSTRatePlanDefinitionRequest productRatePlanId(String productRatePlanId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2c9890678b1ca909018b1caea5c30000", value = "The unique ID of the product rate plan that uses this rate plan definition. ")
  ...
  public POSTRatePlanDefinitionRequest productRatePlanNumber(String productRatePlanNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "PRP-00000008", value = "The unique number (natural key) of the product rate plan that uses this rate plan definition. ")
   ...
   * @return the POSTRatePlanDefinitionRequest instance itself
   */
  public POSTRatePlanDefinitionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTRatePlanDefinitionRequest poSTRatePlanDefinitionRequest = (POSTRatePlanDefinitionRequest) o;
    return Objects.equals(this.productRatePlanChargeId, poSTRatePlanDefinitionRequest.productRatePlanChargeId) &&
        Objects.equals(this.productRatePlanChargeNumber, poSTRatePlanDefinitionRequest.productRatePlanChargeNumber) &&
        Objects.equals(this.productRatePlanId, poSTRatePlanDefinitionRequest.productRatePlanId) &&
        Objects.equals(this.productRatePlanNumber, poSTRatePlanDefinitionRequest.productRatePlanNumber)&&
        Objects.equals(this.additionalProperties, poSTRatePlanDefinitionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productRatePlanChargeId, productRatePlanChargeNumber, productRatePlanId, productRatePlanNumber, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class POSTRatePlanDefinitionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTRatePlanDefinitionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTRatePlanDefinitionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTRatePlanDefinitionRequest is not found in the empty JSON string", POSTRatePlanDefinitionRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTRatePlanDefinitionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTRatePlanDefinitionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTRatePlanDefinitionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTRatePlanDefinitionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTRatePlanDefinitionRequest>() {
           @Override
           public void write(JsonWriter out, POSTRatePlanDefinitionRequest value) throws IOException {
           ...
           @Override
           public POSTRatePlanDefinitionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTRatePlanDefinitionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTRatePlanDefinitionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTRatePlanDefinitionRequest
  * @throws IOException if the JSON string is invalid with respect to POSTRatePlanDefinitionRequest
  */
  public static POSTRatePlanDefinitionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTRatePlanDefinitionRequest.class);
  }

 /**
  * Convert an instance of POSTRatePlanDefinitionRequest to an JSON string
  *
  * @return JSON string
  */
