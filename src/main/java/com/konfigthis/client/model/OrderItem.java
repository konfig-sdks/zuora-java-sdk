 ...
 */
@ApiModel(description = "Represents an order item. An order item is a sales item within an order in the context of the recurring subscription business model. It can be a unit of products or a service, but defined by both quantity and term (the start and end dates).   For the one time and the recurring charge types, if an order action causes a quantity metric creation (when the delta quantity equals to or is greater than zero), an order item is created.  The following order actions will create an order item for the one time and recurring charges. The other order actions will refer to an existing order item. Also, the Owner Transfer order action always creates an order item whose quantity field is zero.    * Create Subscription   * Terms and Conditions - Extend Term   * Renewal   * Update Product - Increase Quantity   * Add product   * Owner Transfer  For the usage charge type, if the order action causes a usage increase, an order item is created, and the quantity field of the order item is always zero.  The following order actions will create an order item for for the usage charges.    * Create Subscription   * Terms and Conditions - Extend Term   * Renewal   * Add product   * Owner Transfer ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrderItem {
  ...
  public OrderItem endDate(LocalDate endDate) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The order item's effective end date, aligned with the end date of an increased quantity order metrics.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the order item.")
  ...
  public OrderItem orderActionId(String orderActionId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specify the order action that creates this order item.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The order item quantity. For the usage charge type, the value of this field is always zero. Also, the Owner Transfer order action always creates an order item whose Quantity field is zero.")
  ...
  public OrderItem scId(String scId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the charge segment that gets newly generated when the order item is created.")
  ...
  public OrderItem startDate(LocalDate startDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The order item's effective start date, aligned with the start date of an increased quantity order metrics.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endDate, orderItem.endDate) &&
        Objects.equals(this.id, orderItem.id) &&
        Objects.equals(this.orderActionId, orderItem.orderActionId) &&
        Objects.equals(this.quantity, orderItem.quantity) &&
        Objects.equals(this.scId, orderItem.scId) &&
        Objects.equals(this.startDate, orderItem.startDate)&&
        Objects.equals(this.additionalProperties, orderItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endDate, id, orderActionId, quantity, scId, startDate, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("scId") != null && !jsonObj.get("scId").isJsonNull()) && !jsonObj.get("scId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `scId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("scId").toString()));
      }
  }
