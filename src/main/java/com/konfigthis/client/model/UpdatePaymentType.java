...
public class UpdatePaymentType {
 ...
 public enum GatewayStateEnum {
  ...
  public UpdatePaymentType comment(String comment) {
  ...
  **/
  ...
  public UpdatePaymentType financeInformation(UpdatePaymentTypeAllOfFinanceInformation financeInformation) {
  ...
  **/
  ...
  public UpdatePaymentTypeAllOfFinanceInformation getFinanceInformation() {
    return financeInformation;
  }


  public void setFinanceInformation(UpdatePaymentTypeAllOfFinanceInformation financeInformation) {
  ...
  public UpdatePaymentType gatewayState(GatewayStateEnum gatewayState) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This field is mainly used for gateway reconciliation. See <a href=\"https://knowledgecenter.zuora.com/Zuora_Payments/Payment_Operations/DA_Electronic_Payment_Processing#Gateway_Reconciliation_Consideration\" target=\"_blank\">Electronic payment processing</a> for details.  You must have the **Edit Payment Gateway Status** <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/Tenant_Management/A_Administrator_Settings/User_Roles/e_Payments_Roles\" target=\"_blank\">user permission</a> to update this field. ")
  ...
  public UpdatePaymentType paymentScheduleKey(String paymentScheduleKey) {
  ...
  **/
  ...
  public UpdatePaymentType referenceId(String referenceId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The transaction ID returned by the payment gateway. Use this field to reconcile payments between your gateway and Zuora Payments.  You can only update the reference ID for external payments. ")
  ...
  public UpdatePaymentType integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public UpdatePaymentType integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public UpdatePaymentType originNS(String originNS) {
  ...
  **/
  ...
  public UpdatePaymentType syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public UpdatePaymentType transactionNS(String transactionNS) {
  ...
  **/
   ...
   * @return the UpdatePaymentType instance itself
   */
  public UpdatePaymentType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePaymentType updatePaymentType = (UpdatePaymentType) o;
    return Objects.equals(this.comment, updatePaymentType.comment) &&
        Objects.equals(this.financeInformation, updatePaymentType.financeInformation) &&
        Objects.equals(this.gatewayState, updatePaymentType.gatewayState) &&
        Objects.equals(this.paymentScheduleKey, updatePaymentType.paymentScheduleKey) &&
        Objects.equals(this.referenceId, updatePaymentType.referenceId) &&
        Objects.equals(this.integrationIdNS, updatePaymentType.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, updatePaymentType.integrationStatusNS) &&
        Objects.equals(this.originNS, updatePaymentType.originNS) &&
        Objects.equals(this.syncDateNS, updatePaymentType.syncDateNS) &&
        Objects.equals(this.transactionNS, updatePaymentType.transactionNS)&&
        Objects.equals(this.additionalProperties, updatePaymentType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, financeInformation, gatewayState, paymentScheduleKey, referenceId, integrationIdNS, integrationStatusNS, originNS, syncDateNS, transactionNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePaymentType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdatePaymentType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdatePaymentType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePaymentType is not found in the empty JSON string", UpdatePaymentType.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("financeInformation") != null && !jsonObj.get("financeInformation").isJsonNull()) {
        UpdatePaymentTypeAllOfFinanceInformation.validateJsonObject(jsonObj.getAsJsonObject("financeInformation"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePaymentType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePaymentType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePaymentType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePaymentType.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePaymentType>() {
           @Override
           public void write(JsonWriter out, UpdatePaymentType value) throws IOException {
           ...
           @Override
           public UpdatePaymentType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdatePaymentType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdatePaymentType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdatePaymentType
  * @throws IOException if the JSON string is invalid with respect to UpdatePaymentType
  */
  public static UpdatePaymentType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePaymentType.class);
  }

 /**
  * Convert an instance of UpdatePaymentType to an JSON string
  *
  * @return JSON string
  */
