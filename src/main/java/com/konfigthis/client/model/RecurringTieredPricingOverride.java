 ...
 */
@ApiModel(description = "Pricing information about a recurring charge that uses the \"tiered pricing\" charge model. In this charge model, the charge has cumulative pricing tiers that become effective as units are purchased. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class RecurringTieredPricingOverride {
 ...
 public enum ListPriceBaseEnum {
  ...
  public RecurringTieredPricingOverride() {
  }

  public RecurringTieredPricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public RecurringTieredPricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public RecurringTieredPricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public RecurringTieredPricingOverride listPriceBase(ListPriceBaseEnum listPriceBase) {
  ...
  **/
  ...
  public RecurringTieredPricingOverride priceIntervals(List<PriceIntervalWithTiers> priceIntervals) {
  ...
  public RecurringTieredPricingOverride addPriceIntervalsItem(PriceIntervalWithTiers priceIntervalsItem) {
  ...
  **/
  ...
  public RecurringTieredPricingOverride quantity(Double quantity) {
  ...
  public RecurringTieredPricingOverride quantity(Integer quantity) {
    if (quantity != null && quantity < 0) {
      throw new IllegalArgumentException("Invalid value for quantity. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public RecurringTieredPricingOverride specificListPriceBase(Integer specificListPriceBase) {
  ...
  **/
  ...
  public RecurringTieredPricingOverride tiers(List<ChargeTier> tiers) {
  ...
  public RecurringTieredPricingOverride addTiersItem(ChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the RecurringTieredPricingOverride instance itself
   */
  public RecurringTieredPricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecurringTieredPricingOverride recurringTieredPricingOverride = (RecurringTieredPricingOverride) o;
    return Objects.equals(this.priceChangeOption, recurringTieredPricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, recurringTieredPricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.listPriceBase, recurringTieredPricingOverride.listPriceBase) &&
        Objects.equals(this.priceIntervals, recurringTieredPricingOverride.priceIntervals) &&
        Objects.equals(this.quantity, recurringTieredPricingOverride.quantity) &&
        Objects.equals(this.specificListPriceBase, recurringTieredPricingOverride.specificListPriceBase) &&
        Objects.equals(this.tiers, recurringTieredPricingOverride.tiers)&&
        Objects.equals(this.additionalProperties, recurringTieredPricingOverride.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, listPriceBase, priceIntervals, quantity, specificListPriceBase, tiers, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RecurringTieredPricingOverride {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecurringTieredPricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecurringTieredPricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurringTieredPricingOverride is not found in the empty JSON string", RecurringTieredPricingOverride.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurringTieredPricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurringTieredPricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurringTieredPricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurringTieredPricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurringTieredPricingOverride>() {
           @Override
           public void write(JsonWriter out, RecurringTieredPricingOverride value) throws IOException {
           ...
           @Override
           public RecurringTieredPricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecurringTieredPricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecurringTieredPricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecurringTieredPricingOverride
  * @throws IOException if the JSON string is invalid with respect to RecurringTieredPricingOverride
  */
  public static RecurringTieredPricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurringTieredPricingOverride.class);
  }

 /**
  * Convert an instance of RecurringTieredPricingOverride to an JSON string
  *
  * @return JSON string
  */
