...
import com.konfigthis.client.model.GetWorkflowResponseTasks;
...
public class GetWorkflowResponse {
  ...
  **/
  ...
  @ApiModelProperty(value = "The overall CPU time for the execution of the workflow. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the execution of the workflow completes, in the `YYYY-MM-DD HH:MM:SS` format. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Messages from tasks.   **Note:** This field is only returned in Production. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique run number of the workflow. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the workflow setup. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The execution time of the workflow including the waiting time, in seconds. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the workflow:   - Queued: The workflow is in queue for being processed.   - Processing: The workflow is in process.   - Stopping: The workflow is being stopped through Zuora UI.   - Stopped: The workflow is stopped through Zuora UI.   - Finished: The workflow is finished. When a workflow is finished, it might have tasks pending for retry or delay. Pending tasks do not block the onfinish branch of the workflow, but they block the oncomplete branch of the iterate.  ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the current workflow. Possible values:   - `Workflow::Setup`: The workflow is a setup and is used for creating workflow instances.   - `Workflow::Instance`: The workflow is an execution that has data. ")
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetWorkflowResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetWorkflowResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("tasks") != null && !jsonObj.get("tasks").isJsonNull()) {
        GetWorkflowResponseTasks.validateJsonObject(jsonObj.getAsJsonObject("tasks"));
      }
