...
import com.konfigthis.client.model.CustomObjectDefinitionUpdateActionResponseRelationship;
...
public class CustomObjectDefinitionUpdateActionResponse {
  ...
  private CustomObjectDefinitionUpdateActionResponseRelationship relationship;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "default", value = "The namespace of the custom object definition to be updated")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "address", value = "The API name of the custom object definition to be updated")
  ...
  public CustomObjectDefinitionUpdateActionResponse relationship(CustomObjectDefinitionUpdateActionResponseRelationship relationship) {
  ...
  **/
  ...
  public CustomObjectDefinitionUpdateActionResponseRelationship getRelationship() {
    return relationship;
  }


  public void setRelationship(CustomObjectDefinitionUpdateActionResponseRelationship relationship) {
  ...
  public CustomObjectDefinitionUpdateActionResponse type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ADDFIELD", value = "The type of the updating action on a custom object definition")
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomObjectDefinitionUpdateActionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomObjectDefinitionUpdateActionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("relationship") != null && !jsonObj.get("relationship").isJsonNull()) {
        CustomObjectDefinitionUpdateActionResponseRelationship.validateJsonObject(jsonObj.getAsJsonObject("relationship"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CustomObjectDefinitionUpdateActionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomObjectDefinitionUpdateActionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomObjectDefinitionUpdateActionResponse>() {
           @Override
