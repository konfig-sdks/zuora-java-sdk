...
import com.konfigthis.client.model.CustomObjectAllFieldsDefinition;
import com.konfigthis.client.model.CustomObjectDefinitionSchemaRelationshipsInner;
 ...
 */
@ApiModel(description = "The schema of the custom object definition")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CustomObjectDefinitionSchema {
  ...
  private List<CustomObjectDefinitionSchemaRelationshipsInner> relationships = null;
 ...
 public enum TypeEnum {
  ...
  public CustomObjectDefinitionSchema auditable(List<String> auditable) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The set of fields which Audit Trail tracks and records changes of.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether to audit the creation of custom object records of this custom object definition.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether to audit the deletion of custom object records of this custom object definition.")
  ...
  public CustomObjectDefinitionSchema filterable(List<String> filterable) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Personal Profile", value = "A label for the custom object")
  ...
  **/
  ...
  public CustomObjectDefinitionSchema relationships(List<CustomObjectDefinitionSchemaRelationshipsInner> relationships) {
  ...
  public CustomObjectDefinitionSchema addRelationshipsItem(CustomObjectDefinitionSchemaRelationshipsInner relationshipsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of relationships with Zuora objects or other custom objects")

  public List<CustomObjectDefinitionSchemaRelationshipsInner> getRelationships() {
    return relationships;
  }


  public void setRelationships(List<CustomObjectDefinitionSchemaRelationshipsInner> relationships) {
  ...
  public CustomObjectDefinitionSchema required(List<String> required) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The required fields of the custom object definition. You can change required fields to optional. However, you can only change optional fields to required on the custom objects with no records.")
  ...
  public CustomObjectDefinitionSchema type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "OBJECT", value = "The custom object definition type. Can only be `object` currently.")
  ...
  public CustomObjectDefinitionSchema unique(List<String> unique) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The fields with unique constraints.")
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomObjectDefinitionSchema
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomObjectDefinitionSchema.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        CustomObjectAllFieldsDefinition.validateJsonObject(jsonObj.getAsJsonObject("properties"));
      }
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        ...
        if (jsonArrayrelationships != null) {
          ...
          for (int i = 0; i < jsonArrayrelationships.size(); i++) {
            CustomObjectDefinitionSchemaRelationshipsInner.validateJsonObject(jsonArrayrelationships.get(i).getAsJsonObject());
          };
        }
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CustomObjectDefinitionSchema> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomObjectDefinitionSchema.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomObjectDefinitionSchema>() {
           @Override
