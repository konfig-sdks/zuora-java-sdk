...
public class EventType {
  ...
  **/
  ...
  @ApiModelProperty(example = "An invoice is posted with amount over 1000", value = "The description of the event type.")
  ...
  **/
  ...
  @ApiModelProperty(example = "Large Invoice Posted", required = true, value = "The display name for the event type.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "LargeInvoicePosted", required = true, value = "The name of the event. Should be unique, contain no space, and be in the pattern: ^[A-Za-z]{1,}[\\\\w\\\\-]*$")
   ...
   * @return the EventType instance itself
   */
  public EventType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, eventType.description) &&
        ...
        Objects.equals(this.additionalProperties, eventType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, displayName, name, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EventType>() {
           ...
           public EventType read(JsonReader in) throws IOException {
             ...
             EventType instance = thisAdapter.fromJsonTree(jsonObj);
