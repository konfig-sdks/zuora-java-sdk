...
public class PostRefundwithAutoUnapplyType {
  ...
  private List<PaymentDebitMemoApplicationApplyRequestType> debitMemos = null;
  ...
  private List<PaymentInvoiceApplicationApplyRequestType> invoices = null;
 ...
 public enum TypeEnum {
   ...
   */
  @JsonAdapter(RefundTransactionTypeEnum.Adapter.class)
 public enum RefundTransactionTypeEnum {
    ...
    RefundTransactionTypeEnum(String value) {
      this.value = value;
    }
    ...
    public static RefundTransactionTypeEnum fromValue(String value) {
      for (RefundTransactionTypeEnum b : RefundTransactionTypeEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<RefundTransactionTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RefundTransactionTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RefundTransactionTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return RefundTransactionTypeEnum.fromValue(value);
      }
    }
  }
  ...
  private RefundTransactionTypeEnum refundTransactionType;
  ...
  public static final String SERIALIZED_NAME_WRITE_OFF_OPTIONS = "writeOffOptions";
  @SerializedName(SERIALIZED_NAME_WRITE_OFF_OPTIONS)
  ...
  public PostRefundwithAutoUnapplyType() {
  }

  public PostRefundwithAutoUnapplyType comment(String comment) {
  ...
  **/
  ...
  public PostRefundwithAutoUnapplyType debitMemos(List<PaymentDebitMemoApplicationApplyRequestType> debitMemos) {
  ...
  public PostRefundwithAutoUnapplyType addDebitMemosItem(PaymentDebitMemoApplicationApplyRequestType debitMemosItem) {
  ...
  **/
  ...
  public List<PaymentDebitMemoApplicationApplyRequestType> getDebitMemos() {
    return debitMemos;
  }


  public void setDebitMemos(List<PaymentDebitMemoApplicationApplyRequestType> debitMemos) {
  ...
  public PostRefundwithAutoUnapplyType financeInformation(PostRefundTypeAllOfFinanceInformation financeInformation) {
  ...
  **/
  ...
  public PostRefundTypeAllOfFinanceInformation getFinanceInformation() {
    return financeInformation;
  }


  public void setFinanceInformation(PostRefundTypeAllOfFinanceInformation financeInformation) {
  ...
  public PostRefundwithAutoUnapplyType gatewayOptions(PostRefundTypeAllOfGatewayOptions gatewayOptions) {
  ...
  **/
  ...
  public PostRefundTypeAllOfGatewayOptions getGatewayOptions() {
    return gatewayOptions;
  }


  public void setGatewayOptions(PostRefundTypeAllOfGatewayOptions gatewayOptions) {
  ...
  public PostRefundwithAutoUnapplyType invoices(List<PaymentInvoiceApplicationApplyRequestType> invoices) {
  ...
  public PostRefundwithAutoUnapplyType addInvoicesItem(PaymentInvoiceApplicationApplyRequestType invoicesItem) {
  ...
  **/
  ...
  public List<PaymentInvoiceApplicationApplyRequestType> getInvoices() {
    return invoices;
  }


  public void setInvoices(List<PaymentInvoiceApplicationApplyRequestType> invoices) {
  ...
  public PostRefundwithAutoUnapplyType methodType(MethodTypeEnum methodType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "How an external refund was issued to a customer. This field is required for an external refund and must be left empty for an electronic refund. You can issue an external refund on an electronic payment. ")
  ...
  public PostRefundwithAutoUnapplyType reasonCode(String reasonCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A code identifying the reason for the transaction. The value must be an existing reason code or empty. If you do not specify a value, Zuora uses the default reason code. ")
  ...
  public PostRefundwithAutoUnapplyType referenceId(String referenceId) {
  ...
  **/
  ...
  public PostRefundwithAutoUnapplyType refundDate(LocalDate refundDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the refund takes effect, in `yyyy-mm-dd` format. The date of the refund cannot be before the payment date. Specify this field only for external refunds. Zuora automatically generates this field for electronic refunds. ")
  ...
  public PostRefundwithAutoUnapplyType secondRefundReferenceId(String secondRefundReferenceId) {
    
    
    if (secondRefundReferenceId != null && secondRefundReferenceId.length() < 0) {
      throw new IllegalArgumentException("Invalid value for secondRefundReferenceId. Length must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public PostRefundwithAutoUnapplyType softDescriptor(String softDescriptor) {
  ...
  **/
  ...
  public PostRefundwithAutoUnapplyType softDescriptorPhone(String softDescriptorPhone) {
  ...
  **/
  ...
  public PostRefundwithAutoUnapplyType totalAmount(Double totalAmount) {
  ...
  **/
  ...
  public PostRefundwithAutoUnapplyType type(TypeEnum type) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The type of the refund. ")
  ...
  public PostRefundwithAutoUnapplyType refundTransactionType(RefundTransactionTypeEnum refundTransactionType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The transaction type of the refund. ")

  public RefundTransactionTypeEnum getRefundTransactionType() {
    return refundTransactionType;
  }


  public void setRefundTransactionType(RefundTransactionTypeEnum refundTransactionType) {
  ...
  public PostRefundwithAutoUnapplyType writeOff(Boolean writeOff) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Indicates whether to write off a document. ")
  ...
  public PostRefundwithAutoUnapplyType writeOffOptions(PostRefundwithAutoUnapplyTypeAllOfWriteOffOptions writeOffOptions) {
   ...
   /**
   * Get writeOffOptions
   * @return writeOffOptions
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public PostRefundwithAutoUnapplyTypeAllOfWriteOffOptions getWriteOffOptions() {
    return writeOffOptions;
  }


  public void setWriteOffOptions(PostRefundwithAutoUnapplyTypeAllOfWriteOffOptions writeOffOptions) {
  ...
  public PostRefundwithAutoUnapplyType integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public PostRefundwithAutoUnapplyType integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public PostRefundwithAutoUnapplyType originNS(String originNS) {
  ...
  **/
  ...
  public PostRefundwithAutoUnapplyType syncDateNS(String syncDateNS) {
  ...
  **/
  ...
  public PostRefundwithAutoUnapplyType synctoNetSuiteNS(String synctoNetSuiteNS) {
  ...
  **/
   ...
   * @return the PostRefundwithAutoUnapplyType instance itself
   */
  public PostRefundwithAutoUnapplyType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PostRefundwithAutoUnapplyType postRefundwithAutoUnapplyType = (PostRefundwithAutoUnapplyType) o;
    return Objects.equals(this.comment, postRefundwithAutoUnapplyType.comment) &&
        Objects.equals(this.debitMemos, postRefundwithAutoUnapplyType.debitMemos) &&
        Objects.equals(this.financeInformation, postRefundwithAutoUnapplyType.financeInformation) &&
        Objects.equals(this.gatewayOptions, postRefundwithAutoUnapplyType.gatewayOptions) &&
        Objects.equals(this.invoices, postRefundwithAutoUnapplyType.invoices) &&
        Objects.equals(this.methodType, postRefundwithAutoUnapplyType.methodType) &&
        Objects.equals(this.reasonCode, postRefundwithAutoUnapplyType.reasonCode) &&
        Objects.equals(this.referenceId, postRefundwithAutoUnapplyType.referenceId) &&
        Objects.equals(this.refundDate, postRefundwithAutoUnapplyType.refundDate) &&
        Objects.equals(this.secondRefundReferenceId, postRefundwithAutoUnapplyType.secondRefundReferenceId) &&
        Objects.equals(this.softDescriptor, postRefundwithAutoUnapplyType.softDescriptor) &&
        Objects.equals(this.softDescriptorPhone, postRefundwithAutoUnapplyType.softDescriptorPhone) &&
        Objects.equals(this.totalAmount, postRefundwithAutoUnapplyType.totalAmount) &&
        Objects.equals(this.type, postRefundwithAutoUnapplyType.type) &&
        Objects.equals(this.refundTransactionType, postRefundwithAutoUnapplyType.refundTransactionType) &&
        Objects.equals(this.writeOff, postRefundwithAutoUnapplyType.writeOff) &&
        Objects.equals(this.writeOffOptions, postRefundwithAutoUnapplyType.writeOffOptions) &&
        Objects.equals(this.integrationIdNS, postRefundwithAutoUnapplyType.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, postRefundwithAutoUnapplyType.integrationStatusNS) &&
        Objects.equals(this.originNS, postRefundwithAutoUnapplyType.originNS) &&
        Objects.equals(this.syncDateNS, postRefundwithAutoUnapplyType.syncDateNS) &&
        Objects.equals(this.synctoNetSuiteNS, postRefundwithAutoUnapplyType.synctoNetSuiteNS)&&
        Objects.equals(this.additionalProperties, postRefundwithAutoUnapplyType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, debitMemos, financeInformation, gatewayOptions, invoices, methodType, reasonCode, referenceId, refundDate, secondRefundReferenceId, softDescriptor, softDescriptorPhone, totalAmount, type, refundTransactionType, writeOff, writeOffOptions, integrationIdNS, integrationStatusNS, originNS, syncDateNS, synctoNetSuiteNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostRefundwithAutoUnapplyType {\n");
    ...
    sb.append("    writeOffOptions: ").append(toIndentedString(writeOffOptions)).append("\n");
  ...
  static {
    ...
    openapiFields.add("writeOffOptions");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PostRefundwithAutoUnapplyType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PostRefundwithAutoUnapplyType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostRefundwithAutoUnapplyType is not found in the empty JSON string", PostRefundwithAutoUnapplyType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostRefundwithAutoUnapplyType.openapiRequiredFields) {
      ...
      if (jsonObj.get("debitMemos") != null && !jsonObj.get("debitMemos").isJsonNull()) {
        ...
        if (jsonArraydebitMemos != null) {
          ...
          for (int i = 0; i < jsonArraydebitMemos.size(); i++) {
            PaymentDebitMemoApplicationApplyRequestType.validateJsonObject(jsonArraydebitMemos.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("financeInformation") != null && !jsonObj.get("financeInformation").isJsonNull()) {
        PostRefundTypeAllOfFinanceInformation.validateJsonObject(jsonObj.getAsJsonObject("financeInformation"));
      }
      // validate the optional field `gatewayOptions`
      if (jsonObj.get("gatewayOptions") != null && !jsonObj.get("gatewayOptions").isJsonNull()) {
        PostRefundTypeAllOfGatewayOptions.validateJsonObject(jsonObj.getAsJsonObject("gatewayOptions"));
      }
      if (jsonObj.get("invoices") != null && !jsonObj.get("invoices").isJsonNull()) {
        ...
        if (jsonArrayinvoices != null) {
          ...
          for (int i = 0; i < jsonArrayinvoices.size(); i++) {
            PaymentInvoiceApplicationApplyRequestType.validateJsonObject(jsonArrayinvoices.get(i).getAsJsonObject());
          };
        }
      }
      ...
      // validate the optional field `writeOffOptions`
      if (jsonObj.get("writeOffOptions") != null && !jsonObj.get("writeOffOptions").isJsonNull()) {
        PostRefundwithAutoUnapplyTypeAllOfWriteOffOptions.validateJsonObject(jsonObj.getAsJsonObject("writeOffOptions"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostRefundwithAutoUnapplyType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostRefundwithAutoUnapplyType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostRefundwithAutoUnapplyType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostRefundwithAutoUnapplyType.class));

       return (TypeAdapter<T>) new TypeAdapter<PostRefundwithAutoUnapplyType>() {
           @Override
           public void write(JsonWriter out, PostRefundwithAutoUnapplyType value) throws IOException {
           ...
           @Override
           public PostRefundwithAutoUnapplyType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PostRefundwithAutoUnapplyType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PostRefundwithAutoUnapplyType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PostRefundwithAutoUnapplyType
  * @throws IOException if the JSON string is invalid with respect to PostRefundwithAutoUnapplyType
  */
  public static PostRefundwithAutoUnapplyType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostRefundwithAutoUnapplyType.class);
  }

 /**
  * Convert an instance of PostRefundwithAutoUnapplyType to an JSON string
  *
  * @return JSON string
  */
