...
import com.konfigthis.client.model.DiscountApplyDetail;
 ...
 */
@ApiModel(description = "Pricing information about a discount charge. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DiscountPricingOverride {
 ...
 public enum ApplyDiscountToEnum {
  ...
  private List<DiscountApplyDetail> discountApplyDetails = null;
 ...
 public enum DiscountLevelEnum {
  ...
  public static final String SERIALIZED_NAME_ORIGINAL_DISCOUNT_AMOUNT = "originalDiscountAmount";
  @SerializedName(SERIALIZED_NAME_ORIGINAL_DISCOUNT_AMOUNT)
  private Double originalDiscountAmount;

  public static final String SERIALIZED_NAME_ORIGINAL_DISCOUNT_PERCENTAGE = "originalDiscountPercentage";
  @SerializedName(SERIALIZED_NAME_ORIGINAL_DISCOUNT_PERCENTAGE)
 ...
 public enum PriceChangeOptionEnum {
  ...
  public DiscountPricingOverride() {
  }

  public DiscountPricingOverride applyDiscountTo(ApplyDiscountToEnum applyDiscountTo) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Specifies which type of charge the discount charge applies to. ")
  ...
  public DiscountPricingOverride applyToBillingPeriodPartially(Boolean applyToBillingPeriodPartially) {
   ...
   /**
   * Allow the discount duration to be aligned with the billing period partially.  **Note**: You must enable the [Enhanced Discounts](https://knowledgecenter.zuora.com/Zuora_Billing/Build_products_and_prices/Basic_concepts_and_terms/B_Charge_Models/D_Manage_Enhanced_Discount) feature to access this field. 
   * @return applyToBillingPeriodPartially
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Allow the discount duration to be aligned with the billing period partially.  **Note**: You must enable the [Enhanced Discounts](https://knowledgecenter.zuora.com/Zuora_Billing/Build_products_and_prices/Basic_concepts_and_terms/B_Charge_Models/D_Manage_Enhanced_Discount) feature to access this field. ")
  ...
  public DiscountPricingOverride discountAmount(Double discountAmount) {
  ...
  public DiscountPricingOverride discountAmount(Integer discountAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Only applicable if the discount charge is a fixed-amount discount. ")
  ...
  public DiscountPricingOverride discountApplyDetails(List<DiscountApplyDetail> discountApplyDetails) {
  ...
  public DiscountPricingOverride addDiscountApplyDetailsItem(DiscountApplyDetail discountApplyDetailsItem) {
   ...
   /**
   * Charge list of discount be applied to.  **Note**: You must enable the [Enhanced Discounts](https://knowledgecenter.zuora.com/Zuora_Billing/Build_products_and_prices/Basic_concepts_and_terms/B_Charge_Models/D_Manage_Enhanced_Discount) feature to access this field. 
   * @return discountApplyDetails
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Charge list of discount be applied to.  **Note**: You must enable the [Enhanced Discounts](https://knowledgecenter.zuora.com/Zuora_Billing/Build_products_and_prices/Basic_concepts_and_terms/B_Charge_Models/D_Manage_Enhanced_Discount) feature to access this field. ")
  ...
  public void setDiscountApplyDetails(List<DiscountApplyDetail> discountApplyDetails) {
  ...
  public DiscountPricingOverride discountClass(String discountClass) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The discount class defines the sequence in which discount product rate plan charges are applied.  **Note**: You must enable the [Enhanced Discounts](https://knowledgecenter.zuora.com/Zuora_Billing/Build_products_and_prices/Basic_concepts_and_terms/B_Charge_Models/D_Manage_Enhanced_Discount) feature to access this field. ")
  ...
  public DiscountPricingOverride discountLevel(DiscountLevelEnum discountLevel) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Application scope of the discount charge. For example, if the value of this field is `subscription` and the value of the `applyDiscountTo` field is `RECURRING`, the discount charge applies to all recurring charges in the same subscription as the discount charge. ")
  ...
  public DiscountPricingOverride discountPercentage(Double discountPercentage) {
  ...
  public DiscountPricingOverride discountPercentage(Integer discountPercentage) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Only applicable if the discount charge is a percentage discount. ")
  ...
  public DiscountPricingOverride originalDiscountAmount(Double originalDiscountAmount) {
  ...
  public DiscountPricingOverride originalDiscountAmount(Integer originalDiscountAmount) {
    
    
    
    
    this.originalDiscountAmount = originalDiscountAmount.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The manufacturer's suggested retail discount price for standalone charge.  Only applicable if the standalone discount charge is a fixed-amount discount.  **Note:** This field is available when the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Manage_subscription_transactions/Orders/Standalone_Orders/AA_Overview_of_Standalone_Orders\" target=\"_blank\">Standalone Orders</a> feature is enabled. ")

  public Double getOriginalDiscountAmount() {
    return originalDiscountAmount;
  }


  public void setOriginalDiscountAmount(Double originalDiscountAmount) {
  ...
  public DiscountPricingOverride originalDiscountPercentage(Double originalDiscountPercentage) {
    
    
    
    
    this.originalDiscountPercentage = originalDiscountPercentage;
    return this;
  }

  public DiscountPricingOverride originalDiscountPercentage(Integer originalDiscountPercentage) {
    
    
    
    
    this.originalDiscountPercentage = originalDiscountPercentage.doubleValue();
    return this;
  }
   ...
   * @return originalDiscountPercentage
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The manufacturer's suggested retail discount percentage for standalone charge.  Only applicable if the standalone discount charge is a percentage discount.  **Note:** This field is available when the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Manage_subscription_transactions/Orders/Standalone_Orders/AA_Overview_of_Standalone_Orders\" target=\"_blank\">Standalone Orders</a> feature is enabled. ")
  ...
  public void setOriginalDiscountPercentage(Double originalDiscountPercentage) {
  ...
  public DiscountPricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies how Zuora changes the price of the charge each time the subscription renews. ")
   ...
   * @return the DiscountPricingOverride instance itself
   */
  public DiscountPricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DiscountPricingOverride discountPricingOverride = (DiscountPricingOverride) o;
    return Objects.equals(this.applyDiscountTo, discountPricingOverride.applyDiscountTo) &&
        Objects.equals(this.applyToBillingPeriodPartially, discountPricingOverride.applyToBillingPeriodPartially) &&
        Objects.equals(this.discountAmount, discountPricingOverride.discountAmount) &&
        Objects.equals(this.discountApplyDetails, discountPricingOverride.discountApplyDetails) &&
        Objects.equals(this.discountClass, discountPricingOverride.discountClass) &&
        Objects.equals(this.discountLevel, discountPricingOverride.discountLevel) &&
        Objects.equals(this.discountPercentage, discountPricingOverride.discountPercentage) &&
        Objects.equals(this.originalDiscountAmount, discountPricingOverride.originalDiscountAmount) &&
        Objects.equals(this.originalDiscountPercentage, discountPricingOverride.originalDiscountPercentage) &&
        Objects.equals(this.priceChangeOption, discountPricingOverride.priceChangeOption)&&
        Objects.equals(this.additionalProperties, discountPricingOverride.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applyDiscountTo, applyToBillingPeriodPartially, discountAmount, discountApplyDetails, discountClass, discountLevel, discountPercentage, originalDiscountAmount, originalDiscountPercentage, priceChangeOption, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DiscountPricingOverride {\n");
    ...
    sb.append("    originalDiscountPercentage: ").append(toIndentedString(originalDiscountPercentage)).append("\n");
  ...
  static {
    ...
    openapiFields.add("originalDiscountAmount");
    openapiFields.add("originalDiscountPercentage");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DiscountPricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DiscountPricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DiscountPricingOverride is not found in the empty JSON string", DiscountPricingOverride.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("discountApplyDetails") != null && !jsonObj.get("discountApplyDetails").isJsonNull()) {
        ...
        if (jsonArraydiscountApplyDetails != null) {
          ...
          for (int i = 0; i < jsonArraydiscountApplyDetails.size(); i++) {
            DiscountApplyDetail.validateJsonObject(jsonArraydiscountApplyDetails.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiscountPricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiscountPricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiscountPricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiscountPricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<DiscountPricingOverride>() {
           @Override
           public void write(JsonWriter out, DiscountPricingOverride value) throws IOException {
           ...
           @Override
           public DiscountPricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DiscountPricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DiscountPricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DiscountPricingOverride
  * @throws IOException if the JSON string is invalid with respect to DiscountPricingOverride
  */
  public static DiscountPricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiscountPricingOverride.class);
  }

 /**
  * Convert an instance of DiscountPricingOverride to an JSON string
  *
  * @return JSON string
  */
