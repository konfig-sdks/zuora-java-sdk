...
import com.konfigthis.client.model.CreateOrderChangePlanRatePlanOverride;
...
public class CreateChangePlan {
 ...
 public enum SubTypeEnum {
  ...
  public CreateChangePlan effectivePolicy(EffectivePolicyEnum effectivePolicy) {
  ...
  **/
  ...
  public CreateChangePlan externalCatalogPlanId(String externalCatalogPlanId) {
  ...
  **/
  ...
  public CreateChangePlan newProductRatePlan(CreateOrderChangePlanRatePlanOverride newProductRatePlan) {
  ...
  **/
  ...
  public CreateChangePlan productRatePlanId(String productRatePlanId) {
  ...
  **/
  ...
  public CreateChangePlan productRatePlanNumber(String productRatePlanNumber) {
  ...
  **/
  ...
  public CreateChangePlan ratePlanId(String ratePlanId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of the rate plan to remove. This can be the latest version or any history version of ID. Note that the removal of a rate plan through the Change Plan order action supports the function of <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Subscriptions/Orders/Order_actions_tutorials/E2_Remove_rate_plan_on_subscription_before_future-dated_removals\" target=\"_blank\">removal before future-dated removals</a>, as in a Remove Product order action. ")
  ...
  public CreateChangePlan resetBcd(Boolean resetBcd) {
  ...
  **/
  ...
  public CreateChangePlan subType(SubTypeEnum subType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Use this field to choose the sub type for your change plan order action.  However, if you do not set this field, the field will be automatically generated by the system according to the following rules:  When the old and new rate plans are within the same Grading catalog group: * If the grade of new plan is greater than that of the old plan, this is an \"Upgrade\". * If the grade of new plan is less than that of the old plan, this is a \"Downgrade\". * If the grade of new plan equals that of the old plan, this is a \"Crossgrade\".  When the old and new rate plans are not in the same Grading catalog group, or either has no group, this is \"PlanChanged\". ")
  ...
  public CreateChangePlan subscriptionRatePlanNumber(String subscriptionRatePlanNumber) {
  ...
  **/
   ...
   * @return the CreateChangePlan instance itself
   */
  public CreateChangePlan putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateChangePlan createChangePlan = (CreateChangePlan) o;
    return Objects.equals(this.effectivePolicy, createChangePlan.effectivePolicy) &&
        Objects.equals(this.externalCatalogPlanId, createChangePlan.externalCatalogPlanId) &&
        Objects.equals(this.newProductRatePlan, createChangePlan.newProductRatePlan) &&
        Objects.equals(this.productRatePlanId, createChangePlan.productRatePlanId) &&
        Objects.equals(this.productRatePlanNumber, createChangePlan.productRatePlanNumber) &&
        Objects.equals(this.ratePlanId, createChangePlan.ratePlanId) &&
        Objects.equals(this.resetBcd, createChangePlan.resetBcd) &&
        Objects.equals(this.subType, createChangePlan.subType) &&
        Objects.equals(this.subscriptionRatePlanNumber, createChangePlan.subscriptionRatePlanNumber)&&
        Objects.equals(this.additionalProperties, createChangePlan.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateChangePlan {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateChangePlan
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateChangePlan.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateChangePlan is not found in the empty JSON string", CreateChangePlan.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateChangePlan.openapiRequiredFields) {
      ...
      CreateOrderChangePlanRatePlanOverride.validateJsonObject(jsonObj.getAsJsonObject("newProductRatePlan"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateChangePlan.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateChangePlan' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateChangePlan> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateChangePlan.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateChangePlan>() {
           @Override
           public void write(JsonWriter out, CreateChangePlan value) throws IOException {
           ...
           @Override
           public CreateChangePlan read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateChangePlan instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateChangePlan given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateChangePlan
  * @throws IOException if the JSON string is invalid with respect to CreateChangePlan
  */
  public static CreateChangePlan fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateChangePlan.class);
  }

 /**
  * Convert an instance of CreateChangePlan to an JSON string
  *
  * @return JSON string
  */
