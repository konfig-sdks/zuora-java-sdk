 ...
 */
@ApiModel(description = "The credit memo apply information. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Transactions {
   ...
   */
  @JsonAdapter(CreditMemoStatusEnum.Adapter.class)
 public enum CreditMemoStatusEnum {
    ...
    CreditMemoStatusEnum(String value) {
      this.value = value;
    }
    ...
    public static CreditMemoStatusEnum fromValue(String value) {
      for (CreditMemoStatusEnum b : CreditMemoStatusEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<CreditMemoStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final CreditMemoStatusEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public CreditMemoStatusEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return CreditMemoStatusEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_CREDIT_MEMO_STATUS = "creditMemoStatus";
  @SerializedName(SERIALIZED_NAME_CREDIT_MEMO_STATUS)
  private CreditMemoStatusEnum creditMemoStatus;
  ...
  public Transactions appliedAmount(Double appliedAmount) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The credit memo applied amopunt. ")
  ...
  public Transactions creditMemoAmount(String creditMemoAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The credit memo amount. ")
  ...
  public Transactions creditMemoNumber(String creditMemoNumber) {
  ...
  **/
  ...
  public Transactions creditMemoStatus(CreditMemoStatusEnum creditMemoStatus) {
  ...
  **/
  ...
  public CreditMemoStatusEnum getCreditMemoStatus() {
    return creditMemoStatus;
  }


  public void setCreditMemoStatus(CreditMemoStatusEnum creditMemoStatus) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appliedAmount, transactions.appliedAmount) &&
        Objects.equals(this.creditMemoAmount, transactions.creditMemoAmount) &&
        Objects.equals(this.creditMemoNumber, transactions.creditMemoNumber) &&
        Objects.equals(this.creditMemoStatus, transactions.creditMemoStatus) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appliedAmount, creditMemoAmount, creditMemoNumber, creditMemoStatus, invoiceNumber, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("creditMemoStatus");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("creditMemoAmount") != null && !jsonObj.get("creditMemoAmount").isJsonNull()) && !jsonObj.get("creditMemoAmount").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `creditMemoAmount` to be a primitive type in the JSON string but got `%s`", jsonObj.get("creditMemoAmount").toString()));
      }
      ...
      if ((jsonObj.get("creditMemoStatus") != null && !jsonObj.get("creditMemoStatus").isJsonNull()) && !jsonObj.get("creditMemoStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `creditMemoStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("creditMemoStatus").toString()));
      }
