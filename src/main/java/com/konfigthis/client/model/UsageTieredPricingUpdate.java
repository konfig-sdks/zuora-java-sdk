...
public class UsageTieredPricingUpdate {
 ...
 public enum PriceChangeOptionEnum {
  ...
  public UsageTieredPricingUpdate() {
  }

  public UsageTieredPricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public UsageTieredPricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public UsageTieredPricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public UsageTieredPricingUpdate tiers(List<ChargeTier> tiers) {
  ...
  public UsageTieredPricingUpdate addTiersItem(ChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the UsageTieredPricingUpdate instance itself
   */
  public UsageTieredPricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UsageTieredPricingUpdate usageTieredPricingUpdate = (UsageTieredPricingUpdate) o;
    return Objects.equals(this.priceChangeOption, usageTieredPricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, usageTieredPricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.tiers, usageTieredPricingUpdate.tiers)&&
        Objects.equals(this.additionalProperties, usageTieredPricingUpdate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UsageTieredPricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsageTieredPricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsageTieredPricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsageTieredPricingUpdate is not found in the empty JSON string", UsageTieredPricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsageTieredPricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsageTieredPricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsageTieredPricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsageTieredPricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<UsageTieredPricingUpdate>() {
           @Override
           public void write(JsonWriter out, UsageTieredPricingUpdate value) throws IOException {
           ...
           @Override
           public UsageTieredPricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UsageTieredPricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UsageTieredPricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UsageTieredPricingUpdate
  * @throws IOException if the JSON string is invalid with respect to UsageTieredPricingUpdate
  */
  public static UsageTieredPricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsageTieredPricingUpdate.class);
  }

 /**
  * Convert an instance of UsageTieredPricingUpdate to an JSON string
  *
  * @return JSON string
  */
