...
public class ProxyCreateTaxationItem {
  ...
  public ProxyCreateTaxationItem() {
  }
  ...
  **/
   ...
   * @return the ProxyCreateTaxationItem instance itself
   */
  public ProxyCreateTaxationItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountingCode, proxyCreateTaxationItem.accountingCode) &&
        ...
        Objects.equals(this.additionalProperties, proxyCreateTaxationItem.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProxyCreateTaxationItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProxyCreateTaxationItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProxyCreateTaxationItem is not found in the empty JSON string", ProxyCreateTaxationItem.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProxyCreateTaxationItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProxyCreateTaxationItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProxyCreateTaxationItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProxyCreateTaxationItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProxyCreateTaxationItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ProxyCreateTaxationItem>() {
           @Override
           public void write(JsonWriter out, ProxyCreateTaxationItem value) throws IOException {
           ...
           @Override
           public ProxyCreateTaxationItem read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProxyCreateTaxationItem instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProxyCreateTaxationItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProxyCreateTaxationItem
  * @throws IOException if the JSON string is invalid with respect to ProxyCreateTaxationItem
  */
  public static ProxyCreateTaxationItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProxyCreateTaxationItem.class);
  }

 /**
  * Convert an instance of ProxyCreateTaxationItem to an JSON string
  *
  * @return JSON string
  */
