...
import com.konfigthis.client.model.AccountCreditCardHolder;
 ...
 */
@ApiModel(description = "Default payment method associated with an account. Only credit card payment methods are supported. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CreditCard {
  ...
  private AccountCreditCardHolder cardHolderInfo;
 ...
 public enum CardTypeEnum {
  ...
  public CreditCard cardHolderInfo(AccountCreditCardHolder cardHolderInfo) {
  ...
  **/
  ...
  public AccountCreditCardHolder getCardHolderInfo() {
    return cardHolderInfo;
  }


  public void setCardHolderInfo(AccountCreditCardHolder cardHolderInfo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Card number. Once set, you cannot update or query the value of this field. The value of this field is only available in masked format. For example, XXXX-XXXX-XXXX-1234 (hyphens must not be used when you set the credit card number). ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Expiration date of the card. ")
  ...
  public CreditCard expirationYear(Integer expirationYear) {
    if (expirationYear != null && expirationYear < 1980) {
      throw new IllegalArgumentException("Invalid value for expirationYear. Must be greater than or equal to 1980.");
    }
    if (expirationYear != null && expirationYear > 2500) {
      throw new IllegalArgumentException("Invalid value for expirationYear. Must be less than or equal to 2500.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "CVV or CVV2 security code of the card. To ensure PCI compliance, Zuora does not store the value of this field. ")
   ...
   * @return the CreditCard instance itself
   */
  public CreditCard putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cardHolderInfo, creditCard.cardHolderInfo) &&
        ...
        Objects.equals(this.additionalProperties, creditCard.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreditCard.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("cardHolderInfo") != null && !jsonObj.get("cardHolderInfo").isJsonNull()) {
        AccountCreditCardHolder.validateJsonObject(jsonObj.getAsJsonObject("cardHolderInfo"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreditCard>() {
           ...
           public CreditCard read(JsonReader in) throws IOException {
             ...
             CreditCard instance = thisAdapter.fromJsonTree(jsonObj);
