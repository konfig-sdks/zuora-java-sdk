 ...
 * Invoice or Payment.
 */
@ApiModel(description = "Invoice or Payment.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Options {
  ...
  private Double maxSubscriptionsPerAccount;
  ...
  **/
  ...
  @ApiModelProperty(example = "Wed Jun 30 17:00:00 PDT 2021", value = "Date through which to calculate charges if an invoice is generated. See [What is a Target Date?](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/J_Billing_Operations/G_Bill_Runs/Creating_Bill_Runs#What_is_a_Target_Date.3F).")
  ...
  **/
  ...
  public Options maxSubscriptionsPerAccount(Double maxSubscriptionsPerAccount) {
  ...
  public Options maxSubscriptionsPerAccount(Integer maxSubscriptionsPerAccount) {
    
    
    
    
    this.maxSubscriptionsPerAccount = maxSubscriptionsPerAccount.doubleValue();
    return this;
  }
  ...
  **/
  ...
  public Double getMaxSubscriptionsPerAccount() {
    return maxSubscriptionsPerAccount;
  }


  public void setMaxSubscriptionsPerAccount(Double maxSubscriptionsPerAccount) {
