...
public class SignUpCreatePaymentMethodCommon {
  ...
  public SignUpCreatePaymentMethodCommon() {
  }

  public SignUpCreatePaymentMethodCommon accountKey(String accountKey) {
  ...
  **/
  ...
  public SignUpCreatePaymentMethodCommon authGateway(String authGateway) {
  ...
  **/
  ...
  public SignUpCreatePaymentMethodCommon ipAddress(String ipAddress) {
  ...
  **/
  ...
  public SignUpCreatePaymentMethodCommon makeDefault(Boolean makeDefault) {
  ...
  **/
   ...
   * @return the SignUpCreatePaymentMethodCommon instance itself
   */
  public SignUpCreatePaymentMethodCommon putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SignUpCreatePaymentMethodCommon signUpCreatePaymentMethodCommon = (SignUpCreatePaymentMethodCommon) o;
    return Objects.equals(this.accountKey, signUpCreatePaymentMethodCommon.accountKey) &&
        Objects.equals(this.authGateway, signUpCreatePaymentMethodCommon.authGateway) &&
        Objects.equals(this.ipAddress, signUpCreatePaymentMethodCommon.ipAddress) &&
        Objects.equals(this.makeDefault, signUpCreatePaymentMethodCommon.makeDefault)&&
        Objects.equals(this.additionalProperties, signUpCreatePaymentMethodCommon.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountKey, authGateway, ipAddress, makeDefault, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SignUpCreatePaymentMethodCommon {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SignUpCreatePaymentMethodCommon
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SignUpCreatePaymentMethodCommon.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SignUpCreatePaymentMethodCommon is not found in the empty JSON string", SignUpCreatePaymentMethodCommon.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SignUpCreatePaymentMethodCommon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SignUpCreatePaymentMethodCommon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SignUpCreatePaymentMethodCommon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SignUpCreatePaymentMethodCommon.class));

       return (TypeAdapter<T>) new TypeAdapter<SignUpCreatePaymentMethodCommon>() {
           @Override
           public void write(JsonWriter out, SignUpCreatePaymentMethodCommon value) throws IOException {
           ...
           @Override
           public SignUpCreatePaymentMethodCommon read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SignUpCreatePaymentMethodCommon instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SignUpCreatePaymentMethodCommon given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SignUpCreatePaymentMethodCommon
  * @throws IOException if the JSON string is invalid with respect to SignUpCreatePaymentMethodCommon
  */
  public static SignUpCreatePaymentMethodCommon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SignUpCreatePaymentMethodCommon.class);
  }

 /**
  * Convert an instance of SignUpCreatePaymentMethodCommon to an JSON string
  *
  * @return JSON string
  */
