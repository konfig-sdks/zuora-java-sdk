...
import com.konfigthis.client.model.ChargeTier;
import com.konfigthis.client.model.PriceIntervalWithTiers;
 ...
 */
@ApiModel(description = "Pricing information about a recurring charge that uses the \"volume pricing\" charge model. In this charge model, the charge has a variable price per unit, depending on how many units are purchased. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class RecurringVolumePricingOverride {
 ...
 public enum ListPriceBaseEnum {
  ...
  private List<PriceIntervalWithTiers> priceIntervals = null;
  ...
  private List<ChargeTier> tiers = null;

  public static final String SERIALIZED_NAME_UOM = "uom";
  @SerializedName(SERIALIZED_NAME_UOM)
  private Double uom;

  public RecurringVolumePricingOverride() {
  }

  public RecurringVolumePricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public RecurringVolumePricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public RecurringVolumePricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public RecurringVolumePricingOverride listPriceBase(ListPriceBaseEnum listPriceBase) {
  ...
  **/
  ...
  public RecurringVolumePricingOverride priceIntervals(List<PriceIntervalWithTiers> priceIntervals) {
  ...
  public RecurringVolumePricingOverride addPriceIntervalsItem(PriceIntervalWithTiers priceIntervalsItem) {
  ...
  **/
  ...
  public RecurringVolumePricingOverride quantity(Double quantity) {
  ...
  public RecurringVolumePricingOverride quantity(Integer quantity) {
    if (quantity != null && quantity < 0) {
      throw new IllegalArgumentException("Invalid value for quantity. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public RecurringVolumePricingOverride specificListPriceBase(Integer specificListPriceBase) {
  ...
  **/
  ...
  public RecurringVolumePricingOverride tiers(List<ChargeTier> tiers) {
  ...
  public RecurringVolumePricingOverride addTiersItem(ChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of variable pricing tiers in the charge. ")
  ...
  public RecurringVolumePricingOverride uom(Double uom) {
  ...
  public RecurringVolumePricingOverride uom(Integer uom) {
  ...
  **/
   ...
   * @return the RecurringVolumePricingOverride instance itself
   */
  public RecurringVolumePricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecurringVolumePricingOverride recurringVolumePricingOverride = (RecurringVolumePricingOverride) o;
    return Objects.equals(this.priceChangeOption, recurringVolumePricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, recurringVolumePricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.listPriceBase, recurringVolumePricingOverride.listPriceBase) &&
        Objects.equals(this.priceIntervals, recurringVolumePricingOverride.priceIntervals) &&
        Objects.equals(this.quantity, recurringVolumePricingOverride.quantity) &&
        Objects.equals(this.specificListPriceBase, recurringVolumePricingOverride.specificListPriceBase) &&
        Objects.equals(this.tiers, recurringVolumePricingOverride.tiers) &&
        Objects.equals(this.uom, recurringVolumePricingOverride.uom)&&
        Objects.equals(this.additionalProperties, recurringVolumePricingOverride.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, listPriceBase, priceIntervals, quantity, specificListPriceBase, tiers, uom, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RecurringVolumePricingOverride {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecurringVolumePricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecurringVolumePricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurringVolumePricingOverride is not found in the empty JSON string", RecurringVolumePricingOverride.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("priceIntervals") != null && !jsonObj.get("priceIntervals").isJsonNull()) {
        ...
        if (jsonArraypriceIntervals != null) {
          ...
          for (int i = 0; i < jsonArraypriceIntervals.size(); i++) {
            PriceIntervalWithTiers.validateJsonObject(jsonArraypriceIntervals.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("tiers") != null && !jsonObj.get("tiers").isJsonNull()) {
        ...
        if (jsonArraytiers != null) {
          ...
          for (int i = 0; i < jsonArraytiers.size(); i++) {
            ChargeTier.validateJsonObject(jsonArraytiers.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurringVolumePricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurringVolumePricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurringVolumePricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurringVolumePricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurringVolumePricingOverride>() {
           @Override
           public void write(JsonWriter out, RecurringVolumePricingOverride value) throws IOException {
           ...
           @Override
           public RecurringVolumePricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecurringVolumePricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecurringVolumePricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecurringVolumePricingOverride
  * @throws IOException if the JSON string is invalid with respect to RecurringVolumePricingOverride
  */
  public static RecurringVolumePricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurringVolumePricingOverride.class);
  }

 /**
  * Convert an instance of RecurringVolumePricingOverride to an JSON string
  *
  * @return JSON string
  */
