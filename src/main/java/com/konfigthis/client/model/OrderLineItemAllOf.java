...
public class OrderLineItemAllOf {
  ...
  public OrderLineItemAllOf() {
  }

  public OrderLineItemAllOf amount(Double amount) {
  ...
  public OrderLineItemAllOf amount(Integer amount) {
  ...
  **/
  ...
  public OrderLineItemAllOf amountWithoutTax(Double amountWithoutTax) {
  ...
  public OrderLineItemAllOf amountWithoutTax(Integer amountWithoutTax) {
  ...
  **/
  ...
  public OrderLineItemAllOf id(UUID id) {
  ...
  **/
  ...
  public OrderLineItemAllOf invoiceGroupNumber(String invoiceGroupNumber) {
  ...
  **/
  ...
  public OrderLineItemAllOf quantityFulfilled(Double quantityFulfilled) {
  ...
  public OrderLineItemAllOf quantityFulfilled(Integer quantityFulfilled) {
  ...
  **/
  ...
  public OrderLineItemAllOf quantityPendingFulfillment(Double quantityPendingFulfillment) {
  ...
  public OrderLineItemAllOf quantityPendingFulfillment(Integer quantityPendingFulfillment) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The quantity that needs to be fulfilled by fulfillments for the order line item. This field will be updated automatically when related fulfillments become 'SentToBilling' or 'Complete' state. ")
   ...
   * @return the OrderLineItemAllOf instance itself
   */
  public OrderLineItemAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, orderLineItemAllOf.amount) &&
        Objects.equals(this.amountWithoutTax, orderLineItemAllOf.amountWithoutTax) &&
        Objects.equals(this.id, orderLineItemAllOf.id) &&
        Objects.equals(this.invoiceGroupNumber, orderLineItemAllOf.invoiceGroupNumber) &&
        Objects.equals(this.quantityFulfilled, orderLineItemAllOf.quantityFulfilled) &&
        Objects.equals(this.quantityPendingFulfillment, orderLineItemAllOf.quantityPendingFulfillment)&&
        Objects.equals(this.additionalProperties, orderLineItemAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, amountWithoutTax, id, invoiceGroupNumber, quantityFulfilled, quantityPendingFulfillment, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderLineItemAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderLineItemAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderLineItemAllOf is not found in the empty JSON string", OrderLineItemAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderLineItemAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderLineItemAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderLineItemAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderLineItemAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderLineItemAllOf>() {
           @Override
           public void write(JsonWriter out, OrderLineItemAllOf value) throws IOException {
           ...
           @Override
           public OrderLineItemAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderLineItemAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderLineItemAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderLineItemAllOf
  * @throws IOException if the JSON string is invalid with respect to OrderLineItemAllOf
  */
  public static OrderLineItemAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderLineItemAllOf.class);
  }

 /**
  * Convert an instance of OrderLineItemAllOf to an JSON string
  *
  * @return JSON string
  */
