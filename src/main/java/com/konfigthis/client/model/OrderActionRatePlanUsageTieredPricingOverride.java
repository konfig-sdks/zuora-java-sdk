...
public class OrderActionRatePlanUsageTieredPricingOverride {
  /**
 ...
 public enum RatingGroupEnum {
  ...
  public OrderActionRatePlanUsageTieredPricingOverride() {
  }

  public OrderActionRatePlanUsageTieredPricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public OrderActionRatePlanUsageTieredPricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public OrderActionRatePlanUsageTieredPricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanUsageTieredPricingOverride ratingGroup(RatingGroupEnum ratingGroup) {
  ...
  **/
  ...
  public OrderActionRatePlanUsageTieredPricingOverride tiers(List<OrderActionRatePlanChargeTier> tiers) {
  ...
  public OrderActionRatePlanUsageTieredPricingOverride addTiersItem(OrderActionRatePlanChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the OrderActionRatePlanUsageTieredPricingOverride instance itself
   */
  public OrderActionRatePlanUsageTieredPricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanUsageTieredPricingOverride orderActionRatePlanUsageTieredPricingOverride = (OrderActionRatePlanUsageTieredPricingOverride) o;
    return Objects.equals(this.priceChangeOption, orderActionRatePlanUsageTieredPricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, orderActionRatePlanUsageTieredPricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.ratingGroup, orderActionRatePlanUsageTieredPricingOverride.ratingGroup) &&
        Objects.equals(this.tiers, orderActionRatePlanUsageTieredPricingOverride.tiers)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanUsageTieredPricingOverride.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, ratingGroup, tiers, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderActionRatePlanUsageTieredPricingOverride {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanUsageTieredPricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanUsageTieredPricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanUsageTieredPricingOverride is not found in the empty JSON string", OrderActionRatePlanUsageTieredPricingOverride.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanUsageTieredPricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanUsageTieredPricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanUsageTieredPricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanUsageTieredPricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanUsageTieredPricingOverride>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanUsageTieredPricingOverride value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanUsageTieredPricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanUsageTieredPricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanUsageTieredPricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanUsageTieredPricingOverride
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanUsageTieredPricingOverride
  */
  public static OrderActionRatePlanUsageTieredPricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanUsageTieredPricingOverride.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanUsageTieredPricingOverride to an JSON string
  *
  * @return JSON string
  */
