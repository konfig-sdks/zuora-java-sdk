...
public class PriceChangeParams {
  /**
 ...
 public enum PriceChangeOptionEnum {
  ...
  public PriceChangeParams priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public PriceChangeParams priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public PriceChangeParams priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
   ...
   * @return the PriceChangeParams instance itself
   */
  public PriceChangeParams putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PriceChangeParams priceChangeParams = (PriceChangeParams) o;
    return Objects.equals(this.priceChangeOption, priceChangeParams.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, priceChangeParams.priceIncreasePercentage)&&
        Objects.equals(this.additionalProperties, priceChangeParams.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PriceChangeParams {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PriceChangeParams
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PriceChangeParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PriceChangeParams is not found in the empty JSON string", PriceChangeParams.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PriceChangeParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PriceChangeParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PriceChangeParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PriceChangeParams.class));

       return (TypeAdapter<T>) new TypeAdapter<PriceChangeParams>() {
           @Override
           public void write(JsonWriter out, PriceChangeParams value) throws IOException {
           ...
           @Override
           public PriceChangeParams read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PriceChangeParams instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PriceChangeParams given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PriceChangeParams
  * @throws IOException if the JSON string is invalid with respect to PriceChangeParams
  */
  public static PriceChangeParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PriceChangeParams.class);
  }

 /**
  * Convert an instance of PriceChangeParams to an JSON string
  *
  * @return JSON string
  */
