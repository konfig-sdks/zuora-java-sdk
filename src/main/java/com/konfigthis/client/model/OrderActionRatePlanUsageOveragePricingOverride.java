 ...
 */
@ApiModel(description = "Pricing information about a usage charge that uses the \"overage\" charge model. In this charge model, the charge has an allowance of free units and a fixed price per additional unit consumed. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrderActionRatePlanUsageOveragePricingOverride {
  /**
 ...
 public enum OverageUnusedUnitsCreditOptionEnum {
  ...
  public OrderActionRatePlanUsageOveragePricingOverride() {
  }

  public OrderActionRatePlanUsageOveragePricingOverride priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public OrderActionRatePlanUsageOveragePricingOverride priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public OrderActionRatePlanUsageOveragePricingOverride priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanUsageOveragePricingOverride includedUnits(Double includedUnits) {
    if (includedUnits != null && includedUnits < 0) {
      throw new IllegalArgumentException("Invalid value for includedUnits. Must be greater than or equal to 0.");
    }
  ...
  public OrderActionRatePlanUsageOveragePricingOverride includedUnits(Integer includedUnits) {
    if (includedUnits != null && includedUnits < 0) {
      throw new IllegalArgumentException("Invalid value for includedUnits. Must be greater than or equal to 0.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of free units that may be consumed. ")
  ...
  public OrderActionRatePlanUsageOveragePricingOverride numberOfPeriods(Integer numberOfPeriods) {
  ...
  **/
  ...
  public OrderActionRatePlanUsageOveragePricingOverride overagePrice(Double overagePrice) {
  ...
  public OrderActionRatePlanUsageOveragePricingOverride overagePrice(Integer overagePrice) {
  ...
  **/
  ...
  public OrderActionRatePlanUsageOveragePricingOverride overageUnusedUnitsCreditOption(OverageUnusedUnitsCreditOptionEnum overageUnusedUnitsCreditOption) {
  ...
  **/
  ...
  public OrderActionRatePlanUsageOveragePricingOverride unusedUnitsCreditRates(Double unusedUnitsCreditRates) {
  ...
  public OrderActionRatePlanUsageOveragePricingOverride unusedUnitsCreditRates(Integer unusedUnitsCreditRates) {
  ...
  **/
   ...
   * @return the OrderActionRatePlanUsageOveragePricingOverride instance itself
   */
  public OrderActionRatePlanUsageOveragePricingOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanUsageOveragePricingOverride orderActionRatePlanUsageOveragePricingOverride = (OrderActionRatePlanUsageOveragePricingOverride) o;
    return Objects.equals(this.priceChangeOption, orderActionRatePlanUsageOveragePricingOverride.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, orderActionRatePlanUsageOveragePricingOverride.priceIncreasePercentage) &&
        Objects.equals(this.includedUnits, orderActionRatePlanUsageOveragePricingOverride.includedUnits) &&
        Objects.equals(this.numberOfPeriods, orderActionRatePlanUsageOveragePricingOverride.numberOfPeriods) &&
        Objects.equals(this.overagePrice, orderActionRatePlanUsageOveragePricingOverride.overagePrice) &&
        Objects.equals(this.overageUnusedUnitsCreditOption, orderActionRatePlanUsageOveragePricingOverride.overageUnusedUnitsCreditOption) &&
        Objects.equals(this.unusedUnitsCreditRates, orderActionRatePlanUsageOveragePricingOverride.unusedUnitsCreditRates)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanUsageOveragePricingOverride.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, includedUnits, numberOfPeriods, overagePrice, overageUnusedUnitsCreditOption, unusedUnitsCreditRates, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderActionRatePlanUsageOveragePricingOverride {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanUsageOveragePricingOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanUsageOveragePricingOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanUsageOveragePricingOverride is not found in the empty JSON string", OrderActionRatePlanUsageOveragePricingOverride.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanUsageOveragePricingOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanUsageOveragePricingOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanUsageOveragePricingOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanUsageOveragePricingOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanUsageOveragePricingOverride>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanUsageOveragePricingOverride value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanUsageOveragePricingOverride read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanUsageOveragePricingOverride instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanUsageOveragePricingOverride given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanUsageOveragePricingOverride
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanUsageOveragePricingOverride
  */
  public static OrderActionRatePlanUsageOveragePricingOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanUsageOveragePricingOverride.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanUsageOveragePricingOverride to an JSON string
  *
  * @return JSON string
  */
