...
import com.konfigthis.client.model.BillRunFilters;
...
public class ExecuteInvoiceScheduleBillRunResponseAllOf {
  ...
  private List<BillRunFilters> billRunFilters = null;
 ...
 public enum StatusEnum {
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf() {
  }

  public ExecuteInvoiceScheduleBillRunResponseAllOf autoEmail(Boolean autoEmail) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Whether to automatically send an email after Auto-Post is complete. ")
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf autoPost(Boolean autoPost) {
  ...
  **/
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf autoRenewal(Boolean autoRenewal) {
  ...
  **/
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf batches(List<String> batches) {
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf addBatchesItem(String batchesItem) {
   ...
   /**
   * A list of the batches of accounts for this bill run.   This field cannot exist with the &#x60;billRunFilters&#x60; field.  **Values:** &#x60;AllBatches&#x60; or Batch*n* where *n* is a number between 1 and 50, for example, &#x60;Batch7&#x60;. 
   * @return batches
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of the batches of accounts for this bill run.   This field cannot exist with the `billRunFilters` field.  **Values:** `AllBatches` or Batch*n* where *n* is a number between 1 and 50, for example, `Batch7`. ")
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf billCycleDay(String billCycleDay) {
   ...
   /**
   * The day of the bill cycle, this field is only valid when &#x60;batches&#x60; is specified.  **Values:**  - &#x60;AllBillCycleDays&#x60; or 1 - 31 for an ad-hoc bill run  - &#x60;AllBillCycleDays&#x60; or 1 - 31 or &#x60;AsRunDay&#x60; for a scheduled bill run 
   * @return billCycleDay
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The day of the bill cycle, this field is only valid when `batches` is specified.  **Values:**  - `AllBillCycleDays` or 1 - 31 for an ad-hoc bill run  - `AllBillCycleDays` or 1 - 31 or `AsRunDay` for a scheduled bill run ")
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf billRunFilters(List<BillRunFilters> billRunFilters) {
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf addBillRunFiltersItem(BillRunFilters billRunFiltersItem) {
   ...
   /**
   * A list of the target account or subscriptions for this bill run.  This field cannot exist with the &#x60;batches&#x60; field. 
   * @return billRunFilters
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of the target account or subscriptions for this bill run.  This field cannot exist with the `batches` field. ")

  public List<BillRunFilters> getBillRunFilters() {
    return billRunFilters;
  }


  public void setBillRunFilters(List<BillRunFilters> billRunFilters) {
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf billRunNumber(String billRunNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of bill run. ")
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf chargeTypeToExclude(List<ChargeTypeToExcludeEnum> chargeTypeToExclude) {
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf addChargeTypeToExcludeItem(ChargeTypeToExcludeEnum chargeTypeToExcludeItem) {
  ...
  **/
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf createdById(String createdById) {
  ...
  **/
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf createdDate(OffsetDateTime createdDate) {
  ...
  **/
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf id(String id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique ID of the bill run. ")
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf invoiceDate(LocalDate invoiceDate) {
  ...
  **/
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf invoiceDateOffset(Integer invoiceDateOffset) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The offset compared to bill run execution date, only valid for scheduled bill runs. ")
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf noEmailForZeroAmountInvoice(Boolean noEmailForZeroAmountInvoice) {
   ...
   /**
   * Whether to suppress emails for invoices with the total amount of zero or not for this bill run after the bill run is complete.   **Note**: Do not email invoices with the total amount of zero. 
   * @return noEmailForZeroAmountInvoice
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether to suppress emails for invoices with the total amount of zero or not for this bill run after the bill run is complete.   **Note**: Do not email invoices with the total amount of zero. ")
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf organizationLabels(List<GETProductTypeAllOfOrganizationLabels> organizationLabels) {
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf addOrganizationLabelsItem(GETProductTypeAllOfOrganizationLabels organizationLabelsItem) {
  ...
  **/
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf scheduledExecutionTime(OffsetDateTime scheduledExecutionTime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The scheduled execution time for a bill run. ")
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf status(StatusEnum status) {
  ...
  **/
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf targetDate(LocalDate targetDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The target date for this bill run, only valid for ad-hoc bill run. ")
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf targetDateOffset(Integer targetDateOffset) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The offset compared to bill run execution date, only valid for scheduled bill run. ")
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf updatedById(String updatedById) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the user who updated the bill run. ")
  ...
  public ExecuteInvoiceScheduleBillRunResponseAllOf updatedDate(OffsetDateTime updatedDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time when the bill run was updated. ")
   ...
   * @return the ExecuteInvoiceScheduleBillRunResponseAllOf instance itself
   */
  public ExecuteInvoiceScheduleBillRunResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExecuteInvoiceScheduleBillRunResponseAllOf executeInvoiceScheduleBillRunResponseAllOf = (ExecuteInvoiceScheduleBillRunResponseAllOf) o;
    return Objects.equals(this.autoEmail, executeInvoiceScheduleBillRunResponseAllOf.autoEmail) &&
        Objects.equals(this.autoPost, executeInvoiceScheduleBillRunResponseAllOf.autoPost) &&
        Objects.equals(this.autoRenewal, executeInvoiceScheduleBillRunResponseAllOf.autoRenewal) &&
        Objects.equals(this.batches, executeInvoiceScheduleBillRunResponseAllOf.batches) &&
        Objects.equals(this.billCycleDay, executeInvoiceScheduleBillRunResponseAllOf.billCycleDay) &&
        Objects.equals(this.billRunFilters, executeInvoiceScheduleBillRunResponseAllOf.billRunFilters) &&
        Objects.equals(this.billRunNumber, executeInvoiceScheduleBillRunResponseAllOf.billRunNumber) &&
        Objects.equals(this.chargeTypeToExclude, executeInvoiceScheduleBillRunResponseAllOf.chargeTypeToExclude) &&
        Objects.equals(this.createdById, executeInvoiceScheduleBillRunResponseAllOf.createdById) &&
        Objects.equals(this.createdDate, executeInvoiceScheduleBillRunResponseAllOf.createdDate) &&
        Objects.equals(this.id, executeInvoiceScheduleBillRunResponseAllOf.id) &&
        Objects.equals(this.invoiceDate, executeInvoiceScheduleBillRunResponseAllOf.invoiceDate) &&
        Objects.equals(this.invoiceDateOffset, executeInvoiceScheduleBillRunResponseAllOf.invoiceDateOffset) &&
        Objects.equals(this.noEmailForZeroAmountInvoice, executeInvoiceScheduleBillRunResponseAllOf.noEmailForZeroAmountInvoice) &&
        Objects.equals(this.organizationLabels, executeInvoiceScheduleBillRunResponseAllOf.organizationLabels) &&
        Objects.equals(this.scheduledExecutionTime, executeInvoiceScheduleBillRunResponseAllOf.scheduledExecutionTime) &&
        Objects.equals(this.status, executeInvoiceScheduleBillRunResponseAllOf.status) &&
        Objects.equals(this.targetDate, executeInvoiceScheduleBillRunResponseAllOf.targetDate) &&
        Objects.equals(this.targetDateOffset, executeInvoiceScheduleBillRunResponseAllOf.targetDateOffset) &&
        Objects.equals(this.updatedById, executeInvoiceScheduleBillRunResponseAllOf.updatedById) &&
        Objects.equals(this.updatedDate, executeInvoiceScheduleBillRunResponseAllOf.updatedDate)&&
        Objects.equals(this.additionalProperties, executeInvoiceScheduleBillRunResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoEmail, autoPost, autoRenewal, batches, billCycleDay, billRunFilters, billRunNumber, chargeTypeToExclude, createdById, createdDate, id, invoiceDate, invoiceDateOffset, noEmailForZeroAmountInvoice, organizationLabels, scheduledExecutionTime, status, targetDate, targetDateOffset, updatedById, updatedDate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExecuteInvoiceScheduleBillRunResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExecuteInvoiceScheduleBillRunResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExecuteInvoiceScheduleBillRunResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExecuteInvoiceScheduleBillRunResponseAllOf is not found in the empty JSON string", ExecuteInvoiceScheduleBillRunResponseAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("billRunFilters") != null && !jsonObj.get("billRunFilters").isJsonNull()) {
        ...
        if (jsonArraybillRunFilters != null) {
          ...
          for (int i = 0; i < jsonArraybillRunFilters.size(); i++) {
            BillRunFilters.validateJsonObject(jsonArraybillRunFilters.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExecuteInvoiceScheduleBillRunResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExecuteInvoiceScheduleBillRunResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExecuteInvoiceScheduleBillRunResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExecuteInvoiceScheduleBillRunResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ExecuteInvoiceScheduleBillRunResponseAllOf>() {
           @Override
           public void write(JsonWriter out, ExecuteInvoiceScheduleBillRunResponseAllOf value) throws IOException {
           ...
           @Override
           public ExecuteInvoiceScheduleBillRunResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ExecuteInvoiceScheduleBillRunResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ExecuteInvoiceScheduleBillRunResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExecuteInvoiceScheduleBillRunResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to ExecuteInvoiceScheduleBillRunResponseAllOf
  */
  public static ExecuteInvoiceScheduleBillRunResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExecuteInvoiceScheduleBillRunResponseAllOf.class);
  }

 /**
  * Convert an instance of ExecuteInvoiceScheduleBillRunResponseAllOf to an JSON string
  *
  * @return JSON string
  */
