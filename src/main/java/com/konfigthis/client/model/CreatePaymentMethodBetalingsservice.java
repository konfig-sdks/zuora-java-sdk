...
public class CreatePaymentMethodBetalingsservice {
  /**
 ...
 public enum TypeEnum {
  ...
  public CreatePaymentMethodBetalingsservice() {
  }

  public CreatePaymentMethodBetalingsservice type(TypeEnum type) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice accountHolderInfo(CreatePaymentMethodBetalingsserviceAllOfAccountHolderInfo accountHolderInfo) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice accountNumber(String accountNumber) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice accountMaskNumber(String accountMaskNumber) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The masked account number such as ****1234. ")
  ...
  public CreatePaymentMethodBetalingsservice bankCode(String bankCode) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice identityNumber(String identityNumber) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The identity number used for Bank Transfer. ")
  ...
  public CreatePaymentMethodBetalingsservice mandateInfo(CreatePaymentMethodCreditCardAllOfMandateInfo mandateInfo) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice processingOptions(CreatePaymentMethodCreditCardAllOfProcessingOptions processingOptions) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice accountKey(String accountKey) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice authGateway(String authGateway) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice currencyCode(String currencyCode) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice gatewayOptions(PaymentMethodCommonFieldsGatewayOptions gatewayOptions) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice ipAddress(String ipAddress) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice makeDefault(Boolean makeDefault) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsservice skipValidation(Boolean skipValidation) {
  ...
  **/
   ...
   * @return the CreatePaymentMethodBetalingsservice instance itself
   */
  public CreatePaymentMethodBetalingsservice putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePaymentMethodBetalingsservice createPaymentMethodBetalingsservice = (CreatePaymentMethodBetalingsservice) o;
    return Objects.equals(this.type, createPaymentMethodBetalingsservice.type) &&
        Objects.equals(this.accountHolderInfo, createPaymentMethodBetalingsservice.accountHolderInfo) &&
        Objects.equals(this.accountNumber, createPaymentMethodBetalingsservice.accountNumber) &&
        Objects.equals(this.accountMaskNumber, createPaymentMethodBetalingsservice.accountMaskNumber) &&
        Objects.equals(this.bankCode, createPaymentMethodBetalingsservice.bankCode) &&
        Objects.equals(this.identityNumber, createPaymentMethodBetalingsservice.identityNumber) &&
        Objects.equals(this.mandateInfo, createPaymentMethodBetalingsservice.mandateInfo) &&
        Objects.equals(this.processingOptions, createPaymentMethodBetalingsservice.processingOptions) &&
        Objects.equals(this.accountKey, createPaymentMethodBetalingsservice.accountKey) &&
        Objects.equals(this.authGateway, createPaymentMethodBetalingsservice.authGateway) &&
        Objects.equals(this.currencyCode, createPaymentMethodBetalingsservice.currencyCode) &&
        Objects.equals(this.gatewayOptions, createPaymentMethodBetalingsservice.gatewayOptions) &&
        Objects.equals(this.ipAddress, createPaymentMethodBetalingsservice.ipAddress) &&
        Objects.equals(this.makeDefault, createPaymentMethodBetalingsservice.makeDefault) &&
        Objects.equals(this.skipValidation, createPaymentMethodBetalingsservice.skipValidation)&&
        Objects.equals(this.additionalProperties, createPaymentMethodBetalingsservice.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, accountHolderInfo, accountNumber, accountMaskNumber, bankCode, identityNumber, mandateInfo, processingOptions, accountKey, authGateway, currencyCode, gatewayOptions, ipAddress, makeDefault, skipValidation, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePaymentMethodBetalingsservice {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("identityNumber");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreatePaymentMethodBetalingsservice
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreatePaymentMethodBetalingsservice.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePaymentMethodBetalingsservice is not found in the empty JSON string", CreatePaymentMethodBetalingsservice.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePaymentMethodBetalingsservice.openapiRequiredFields) {
      ...
      if (!jsonObj.get("identityNumber").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePaymentMethodBetalingsservice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePaymentMethodBetalingsservice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePaymentMethodBetalingsservice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePaymentMethodBetalingsservice.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePaymentMethodBetalingsservice>() {
           @Override
           public void write(JsonWriter out, CreatePaymentMethodBetalingsservice value) throws IOException {
           ...
           @Override
           public CreatePaymentMethodBetalingsservice read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreatePaymentMethodBetalingsservice instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreatePaymentMethodBetalingsservice given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreatePaymentMethodBetalingsservice
  * @throws IOException if the JSON string is invalid with respect to CreatePaymentMethodBetalingsservice
  */
  public static CreatePaymentMethodBetalingsservice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePaymentMethodBetalingsservice.class);
  }

 /**
  * Convert an instance of CreatePaymentMethodBetalingsservice to an JSON string
  *
  * @return JSON string
  */
