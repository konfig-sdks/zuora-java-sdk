...
public class ProxyCreateTaxationItemAllOf {
  ...
  public ProxyCreateTaxationItemAllOf() {
  }

  public ProxyCreateTaxationItemAllOf accountingCode(String accountingCode) {
  ...
  **/
  ...
  @ApiModelProperty(value = " The Chart of Accounts ")
  ...
  public ProxyCreateTaxationItemAllOf exemptAmount(Double exemptAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The calculated tax amount excluded due to the exemption. **Character limit**: 16 **Values**: a decimal value ")
  ...
  public ProxyCreateTaxationItemAllOf invoiceItemId(String invoiceItemId) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = " The ID of the specific invoice item that the taxation information applies to. **Character limit**: 32 **Values**: a valid invoice item ID ")
  ...
  public ProxyCreateTaxationItemAllOf jurisdiction(String jurisdiction) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = " The jurisdiction that applies the tax or VAT. This value is typically a state, province, county, or city. **Character limit**: 32 **Values**: a string of 32 characterrs or fewer ")
  ...
  public ProxyCreateTaxationItemAllOf locationCode(String locationCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The identifier for the location based on the value of the `TaxCode` field. **Character limit**: 32 **Values**: automatically generated ")
  ...
  public ProxyCreateTaxationItemAllOf name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = " The name of the tax rate, such as sales tax or GST. This name is displayed on invoices. **Character limit**: 128 **Values**: a string of 128 characters or fewer ")
  ...
  public ProxyCreateTaxationItemAllOf taxAmount(Double taxAmount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = " The amount of the tax applied to the charge. **Character limit**: 16 **Values**: a decimal value ")
  ...
  public ProxyCreateTaxationItemAllOf taxCode(String taxCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The tax code identifies which tax rules and tax rates to apply to a specific charge. **Character limit**: 32 **Values**: a string of 32 characters or fewer ")
  ...
  public ProxyCreateTaxationItemAllOf taxCodeDescription(String taxCodeDescription) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The description for the tax code. **Character limit**: 255 **Values**: a string of 255 characters or fewer ")
  ...
  public ProxyCreateTaxationItemAllOf taxDate(LocalDate taxDate) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = " The date that the tax is applied to the charge, in `yyyy-mm-dd` format. **Character limit**: 29 ")
  ...
  public ProxyCreateTaxationItemAllOf taxRate(Double taxRate) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = " The tax rate applied to the charge. **Character limit**: 16 **Values**: a valid decimal value ")
  ...
  public ProxyCreateTaxationItemAllOf taxRateDescription(String taxRateDescription) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " The description of the tax rate. **Character limit**: 255 **Values**: a string of 255 characters or fewer ")
  ...
  public ProxyCreateTaxationItemAllOf taxRateType(String taxRateType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = " The type of the tax rate applied to the charge. **Character limit**: 10 **Values**: `Percentage`, `FlatFee` ")
   ...
   * @return the ProxyCreateTaxationItemAllOf instance itself
   */
  public ProxyCreateTaxationItemAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProxyCreateTaxationItemAllOf proxyCreateTaxationItemAllOf = (ProxyCreateTaxationItemAllOf) o;
    return Objects.equals(this.accountingCode, proxyCreateTaxationItemAllOf.accountingCode) &&
        Objects.equals(this.exemptAmount, proxyCreateTaxationItemAllOf.exemptAmount) &&
        Objects.equals(this.invoiceItemId, proxyCreateTaxationItemAllOf.invoiceItemId) &&
        Objects.equals(this.jurisdiction, proxyCreateTaxationItemAllOf.jurisdiction) &&
        Objects.equals(this.locationCode, proxyCreateTaxationItemAllOf.locationCode) &&
        Objects.equals(this.name, proxyCreateTaxationItemAllOf.name) &&
        Objects.equals(this.taxAmount, proxyCreateTaxationItemAllOf.taxAmount) &&
        Objects.equals(this.taxCode, proxyCreateTaxationItemAllOf.taxCode) &&
        Objects.equals(this.taxCodeDescription, proxyCreateTaxationItemAllOf.taxCodeDescription) &&
        Objects.equals(this.taxDate, proxyCreateTaxationItemAllOf.taxDate) &&
        Objects.equals(this.taxRate, proxyCreateTaxationItemAllOf.taxRate) &&
        Objects.equals(this.taxRateDescription, proxyCreateTaxationItemAllOf.taxRateDescription) &&
        Objects.equals(this.taxRateType, proxyCreateTaxationItemAllOf.taxRateType)&&
        Objects.equals(this.additionalProperties, proxyCreateTaxationItemAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProxyCreateTaxationItemAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProxyCreateTaxationItemAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProxyCreateTaxationItemAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProxyCreateTaxationItemAllOf is not found in the empty JSON string", ProxyCreateTaxationItemAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProxyCreateTaxationItemAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProxyCreateTaxationItemAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProxyCreateTaxationItemAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProxyCreateTaxationItemAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProxyCreateTaxationItemAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ProxyCreateTaxationItemAllOf>() {
           @Override
           public void write(JsonWriter out, ProxyCreateTaxationItemAllOf value) throws IOException {
           ...
           @Override
           public ProxyCreateTaxationItemAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProxyCreateTaxationItemAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProxyCreateTaxationItemAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProxyCreateTaxationItemAllOf
  * @throws IOException if the JSON string is invalid with respect to ProxyCreateTaxationItemAllOf
  */
  public static ProxyCreateTaxationItemAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProxyCreateTaxationItemAllOf.class);
  }

 /**
  * Convert an instance of ProxyCreateTaxationItemAllOf to an JSON string
  *
  * @return JSON string
  */
