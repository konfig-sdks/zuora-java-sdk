 ...
 */
@ApiModel(description = "Container for tax exempt information, used to establish the tax exempt status of a customer account. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class POSTAccountTypeAllOfTaxInfo {
  ...
  public POSTAccountTypeAllOfTaxInfo() {
  }

  public POSTAccountTypeAllOfTaxInfo vaTId(String vaTId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "EU Value Added Tax ID.   **Note:** This feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](https://support.zuora.com). ")
  ...
  public POSTAccountTypeAllOfTaxInfo companyCode(String companyCode) {
  ...
  **/
  ...
  public POSTAccountTypeAllOfTaxInfo exemptCertificateId(String exemptCertificateId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of the customer tax exemption certificate. Requires Zuora Tax. ")
  ...
  public POSTAccountTypeAllOfTaxInfo exemptCertificateType(String exemptCertificateType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Type of tax exemption certificate that the customer holds. Requires Zuora Tax. ")
  ...
  public POSTAccountTypeAllOfTaxInfo exemptDescription(String exemptDescription) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Description of the tax exemption certificate that the customer holds. Requires Zuora Tax. ")
  ...
  public POSTAccountTypeAllOfTaxInfo exemptEffectiveDate(LocalDate exemptEffectiveDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date when the customer tax exemption starts. Requires Zuora Tax.  Format: `yyyy-mm-dd`. Defaults to the current date. ")
  ...
  public POSTAccountTypeAllOfTaxInfo exemptEntityUseCode(String exemptEntityUseCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A unique entity use code to apply exemptions in Avalara AvaTax.  This account-level field is required only when you choose Avalara as your tax engine. See [Exempt Transactions](https://developer.avalara.com/avatax/handling-tax-exempt-customers/)for more details. ")
  ...
  public POSTAccountTypeAllOfTaxInfo exemptExpirationDate(LocalDate exemptExpirationDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date when the customer tax exemption expires. Requires Zuora Tax.  Format: `yyyy-mm-dd`. Defaults to the current date. ")
  ...
  public POSTAccountTypeAllOfTaxInfo exemptIssuingJurisdiction(String exemptIssuingJurisdiction) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Jurisdiction in which the customer tax exemption certificate was issued. ")
  ...
  public POSTAccountTypeAllOfTaxInfo exemptStatus(String exemptStatus) {
   ...
   /**
   * Status of the account tax exemption. Requires Zuora Tax.  Required if you use Zuora Tax. This field is unavailable if Zuora Tax is not used.  Values: &#x60;Yes&#x60;, &#x60;No&#x60;(default), &#x60;pendingVerification&#x60;. Note that the value will be set to &#x60;No&#x60; if no input. 
   * @return exemptStatus
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Status of the account tax exemption. Requires Zuora Tax.  Required if you use Zuora Tax. This field is unavailable if Zuora Tax is not used.  Values: `Yes`, `No`(default), `pendingVerification`. Note that the value will be set to `No` if no input. ")
   ...
   * @return the POSTAccountTypeAllOfTaxInfo instance itself
   */
  public POSTAccountTypeAllOfTaxInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    POSTAccountTypeAllOfTaxInfo poSTAccountTypeAllOfTaxInfo = (POSTAccountTypeAllOfTaxInfo) o;
    return Objects.equals(this.vaTId, poSTAccountTypeAllOfTaxInfo.vaTId) &&
        Objects.equals(this.companyCode, poSTAccountTypeAllOfTaxInfo.companyCode) &&
        Objects.equals(this.exemptCertificateId, poSTAccountTypeAllOfTaxInfo.exemptCertificateId) &&
        Objects.equals(this.exemptCertificateType, poSTAccountTypeAllOfTaxInfo.exemptCertificateType) &&
        Objects.equals(this.exemptDescription, poSTAccountTypeAllOfTaxInfo.exemptDescription) &&
        Objects.equals(this.exemptEffectiveDate, poSTAccountTypeAllOfTaxInfo.exemptEffectiveDate) &&
        Objects.equals(this.exemptEntityUseCode, poSTAccountTypeAllOfTaxInfo.exemptEntityUseCode) &&
        Objects.equals(this.exemptExpirationDate, poSTAccountTypeAllOfTaxInfo.exemptExpirationDate) &&
        Objects.equals(this.exemptIssuingJurisdiction, poSTAccountTypeAllOfTaxInfo.exemptIssuingJurisdiction) &&
        Objects.equals(this.exemptStatus, poSTAccountTypeAllOfTaxInfo.exemptStatus)&&
        Objects.equals(this.additionalProperties, poSTAccountTypeAllOfTaxInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vaTId, companyCode, exemptCertificateId, exemptCertificateType, exemptDescription, exemptEffectiveDate, exemptEntityUseCode, exemptExpirationDate, exemptIssuingJurisdiction, exemptStatus, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class POSTAccountTypeAllOfTaxInfo {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTAccountTypeAllOfTaxInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTAccountTypeAllOfTaxInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTAccountTypeAllOfTaxInfo is not found in the empty JSON string", POSTAccountTypeAllOfTaxInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("exemptStatus") != null && !jsonObj.get("exemptStatus").isJsonNull()) && !jsonObj.get("exemptStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `exemptStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("exemptStatus").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTAccountTypeAllOfTaxInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTAccountTypeAllOfTaxInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTAccountTypeAllOfTaxInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTAccountTypeAllOfTaxInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTAccountTypeAllOfTaxInfo>() {
           @Override
           public void write(JsonWriter out, POSTAccountTypeAllOfTaxInfo value) throws IOException {
           ...
           @Override
           public POSTAccountTypeAllOfTaxInfo read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTAccountTypeAllOfTaxInfo instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTAccountTypeAllOfTaxInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTAccountTypeAllOfTaxInfo
  * @throws IOException if the JSON string is invalid with respect to POSTAccountTypeAllOfTaxInfo
  */
  public static POSTAccountTypeAllOfTaxInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTAccountTypeAllOfTaxInfo.class);
  }

 /**
  * Convert an instance of POSTAccountTypeAllOfTaxInfo to an JSON string
  *
  * @return JSON string
  */
