...
import com.konfigthis.client.model.GETProductRatePlanChargeType;
...
public class GETProductRatePlanType {
  ...
  public static final String SERIALIZED_NAME_PRODUCT_RATE_PLAN_CHARGES = "productRatePlanCharges";
  @SerializedName(SERIALIZED_NAME_PRODUCT_RATE_PLAN_CHARGES)
  private List<GETProductRatePlanChargeType> productRatePlanCharges = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "Rate plan description. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Final date the rate plan is active, as `yyyy-mm-dd`. After this date, the rate plan status is `Expired`. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "First date the rate plan is active (i.e., available to be subscribed to), as `yyyy-mm-dd`.  Before this date, the status is `NotStarted`. ")
  ...
  public GETProductRatePlanType grade(Double grade) {
  ...
  public GETProductRatePlanType grade(Integer grade) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The grade of the product rate plan.  **Note**: This field is in the **Early Adopter** phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/). ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unique product rate-plan ID. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Field attributes describing the product rate plan charges: ")
  ...
  public GETProductRatePlanType productRatePlanNumber(String productRatePlanNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The natural key of the product rate plan.   ")
  ...
  public GETProductRatePlanType status(StatusEnum status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the product rate plan. ")
  ...
  public GETProductRatePlanType billingPeriodNS(BillingPeriodNSEnum billingPeriodNS) {
  ...
  **/
  ...
  public GETProductRatePlanType classNS(String classNS) {
  ...
  **/
  ...
  public GETProductRatePlanType departmentNS(String departmentNS) {
  ...
  **/
  ...
  public GETProductRatePlanType includeChildrenNS(IncludeChildrenNSEnum includeChildrenNS) {
  ...
  **/
  ...
  public GETProductRatePlanType integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public GETProductRatePlanType integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public GETProductRatePlanType itemTypeNS(ItemTypeNSEnum itemTypeNS) {
  ...
  **/
  ...
  public GETProductRatePlanType locationNS(String locationNS) {
  ...
  **/
  ...
  public GETProductRatePlanType multiCurrencyPriceNS(String multiCurrencyPriceNS) {
  ...
  **/
  ...
  public GETProductRatePlanType priceNS(String priceNS) {
  ...
  **/
  ...
  public GETProductRatePlanType subsidiaryNS(String subsidiaryNS) {
  ...
  **/
  ...
  public GETProductRatePlanType syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the GETProductRatePlanType instance itself
   */
  public GETProductRatePlanType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, geTProductRatePlanType.description) &&
        ...
        Objects.equals(this.grade, geTProductRatePlanType.grade) &&
        ...
        Objects.equals(this.productRatePlanNumber, geTProductRatePlanType.productRatePlanNumber) &&
        Objects.equals(this.status, geTProductRatePlanType.status) &&
        Objects.equals(this.billingPeriodNS, geTProductRatePlanType.billingPeriodNS) &&
        Objects.equals(this.classNS, geTProductRatePlanType.classNS) &&
        Objects.equals(this.departmentNS, geTProductRatePlanType.departmentNS) &&
        Objects.equals(this.includeChildrenNS, geTProductRatePlanType.includeChildrenNS) &&
        Objects.equals(this.integrationIdNS, geTProductRatePlanType.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, geTProductRatePlanType.integrationStatusNS) &&
        Objects.equals(this.itemTypeNS, geTProductRatePlanType.itemTypeNS) &&
        Objects.equals(this.locationNS, geTProductRatePlanType.locationNS) &&
        Objects.equals(this.multiCurrencyPriceNS, geTProductRatePlanType.multiCurrencyPriceNS) &&
        Objects.equals(this.priceNS, geTProductRatePlanType.priceNS) &&
        Objects.equals(this.subsidiaryNS, geTProductRatePlanType.subsidiaryNS) &&
        Objects.equals(this.syncDateNS, geTProductRatePlanType.syncDateNS)&&
        Objects.equals(this.additionalProperties, geTProductRatePlanType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, effectiveEndDate, effectiveStartDate, grade, id, name, productRatePlanCharges, productRatePlanNumber, status, billingPeriodNS, classNS, departmentNS, includeChildrenNS, integrationIdNS, integrationStatusNS, itemTypeNS, locationNS, multiCurrencyPriceNS, priceNS, subsidiaryNS, syncDateNS, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("productRatePlanCharges");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GETProductRatePlanType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GETProductRatePlanType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETProductRatePlanType is not found in the empty JSON string", GETProductRatePlanType.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("productRatePlanCharges") != null && !jsonObj.get("productRatePlanCharges").isJsonNull()) {
        JsonArray jsonArrayproductRatePlanCharges = jsonObj.getAsJsonArray("productRatePlanCharges");
        if (jsonArrayproductRatePlanCharges != null) {
          // ensure the json data is an array
          if (!jsonObj.get("productRatePlanCharges").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `productRatePlanCharges` to be an array in the JSON string but got `%s`", jsonObj.get("productRatePlanCharges").toString()));
          }

          // validate the optional field `productRatePlanCharges` (array)
          for (int i = 0; i < jsonArrayproductRatePlanCharges.size(); i++) {
            GETProductRatePlanChargeType.validateJsonObject(jsonArrayproductRatePlanCharges.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETProductRatePlanType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETProductRatePlanType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETProductRatePlanType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETProductRatePlanType.class));

       return (TypeAdapter<T>) new TypeAdapter<GETProductRatePlanType>() {
           @Override
           public void write(JsonWriter out, GETProductRatePlanType value) throws IOException {
           ...
           @Override
           public GETProductRatePlanType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GETProductRatePlanType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GETProductRatePlanType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GETProductRatePlanType
  * @throws IOException if the JSON string is invalid with respect to GETProductRatePlanType
  */
  public static GETProductRatePlanType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETProductRatePlanType.class);
  }

 /**
  * Convert an instance of GETProductRatePlanType to an JSON string
  *
  * @return JSON string
  */
