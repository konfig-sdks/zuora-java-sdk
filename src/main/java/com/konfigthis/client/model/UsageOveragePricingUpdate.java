...
public class UsageOveragePricingUpdate {
 ...
 public enum PriceChangeOptionEnum {
  ...
  public UsageOveragePricingUpdate() {
  }

  public UsageOveragePricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public UsageOveragePricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public UsageOveragePricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public UsageOveragePricingUpdate includedUnits(Double includedUnits) {
  ...
  public UsageOveragePricingUpdate includedUnits(Integer includedUnits) {
  ...
  **/
  ...
  public UsageOveragePricingUpdate overagePrice(Double overagePrice) {
  ...
  public UsageOveragePricingUpdate overagePrice(Integer overagePrice) {
  ...
  **/
   ...
   * @return the UsageOveragePricingUpdate instance itself
   */
  public UsageOveragePricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UsageOveragePricingUpdate usageOveragePricingUpdate = (UsageOveragePricingUpdate) o;
    return Objects.equals(this.priceChangeOption, usageOveragePricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, usageOveragePricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.includedUnits, usageOveragePricingUpdate.includedUnits) &&
        Objects.equals(this.overagePrice, usageOveragePricingUpdate.overagePrice)&&
        Objects.equals(this.additionalProperties, usageOveragePricingUpdate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UsageOveragePricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsageOveragePricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsageOveragePricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsageOveragePricingUpdate is not found in the empty JSON string", UsageOveragePricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsageOveragePricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsageOveragePricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsageOveragePricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsageOveragePricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<UsageOveragePricingUpdate>() {
           @Override
           public void write(JsonWriter out, UsageOveragePricingUpdate value) throws IOException {
           ...
           @Override
           public UsageOveragePricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UsageOveragePricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UsageOveragePricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UsageOveragePricingUpdate
  * @throws IOException if the JSON string is invalid with respect to UsageOveragePricingUpdate
  */
  public static UsageOveragePricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsageOveragePricingUpdate.class);
  }

 /**
  * Convert an instance of UsageOveragePricingUpdate to an JSON string
  *
  * @return JSON string
  */
