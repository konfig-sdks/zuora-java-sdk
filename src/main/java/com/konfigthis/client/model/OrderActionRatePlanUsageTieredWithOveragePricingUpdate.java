...
public class OrderActionRatePlanUsageTieredWithOveragePricingUpdate {
  /**
 ...
 public enum PriceChangeOptionEnum {
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingUpdate() {
  }

  public OrderActionRatePlanUsageTieredWithOveragePricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingUpdate overagePrice(Double overagePrice) {
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingUpdate overagePrice(Integer overagePrice) {
  ...
  **/
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingUpdate tiers(List<OrderActionRatePlanChargeTier> tiers) {
  ...
  public OrderActionRatePlanUsageTieredWithOveragePricingUpdate addTiersItem(OrderActionRatePlanChargeTier tiersItem) {
    if (this.tiers == null) {
  ...
  **/
   ...
   * @return the OrderActionRatePlanUsageTieredWithOveragePricingUpdate instance itself
   */
  public OrderActionRatePlanUsageTieredWithOveragePricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderActionRatePlanUsageTieredWithOveragePricingUpdate orderActionRatePlanUsageTieredWithOveragePricingUpdate = (OrderActionRatePlanUsageTieredWithOveragePricingUpdate) o;
    return Objects.equals(this.priceChangeOption, orderActionRatePlanUsageTieredWithOveragePricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, orderActionRatePlanUsageTieredWithOveragePricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.overagePrice, orderActionRatePlanUsageTieredWithOveragePricingUpdate.overagePrice) &&
        Objects.equals(this.tiers, orderActionRatePlanUsageTieredWithOveragePricingUpdate.tiers)&&
        Objects.equals(this.additionalProperties, orderActionRatePlanUsageTieredWithOveragePricingUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(priceChangeOption, priceIncreasePercentage, overagePrice, tiers, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderActionRatePlanUsageTieredWithOveragePricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderActionRatePlanUsageTieredWithOveragePricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderActionRatePlanUsageTieredWithOveragePricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderActionRatePlanUsageTieredWithOveragePricingUpdate is not found in the empty JSON string", OrderActionRatePlanUsageTieredWithOveragePricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderActionRatePlanUsageTieredWithOveragePricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderActionRatePlanUsageTieredWithOveragePricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderActionRatePlanUsageTieredWithOveragePricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderActionRatePlanUsageTieredWithOveragePricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderActionRatePlanUsageTieredWithOveragePricingUpdate>() {
           @Override
           public void write(JsonWriter out, OrderActionRatePlanUsageTieredWithOveragePricingUpdate value) throws IOException {
           ...
           @Override
           public OrderActionRatePlanUsageTieredWithOveragePricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderActionRatePlanUsageTieredWithOveragePricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderActionRatePlanUsageTieredWithOveragePricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderActionRatePlanUsageTieredWithOveragePricingUpdate
  * @throws IOException if the JSON string is invalid with respect to OrderActionRatePlanUsageTieredWithOveragePricingUpdate
  */
  public static OrderActionRatePlanUsageTieredWithOveragePricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderActionRatePlanUsageTieredWithOveragePricingUpdate.class);
  }

 /**
  * Convert an instance of OrderActionRatePlanUsageTieredWithOveragePricingUpdate to an JSON string
  *
  * @return JSON string
  */
