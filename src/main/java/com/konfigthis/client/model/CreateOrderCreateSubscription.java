...
import com.konfigthis.client.model.CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount;
...
public class CreateOrderCreateSubscription {
  ...
  private CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount newSubscriptionOwnerAccount;
  ...
  private List<CreateOrderRatePlanOverride> subscribeToRatePlans = null;
  ...
  **/
  ...
  public CreateOrderCreateSubscription newSubscriptionOwnerAccount(CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount newSubscriptionOwnerAccount) {
  ...
  **/
  ...
  public CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount getNewSubscriptionOwnerAccount() {
    return newSubscriptionOwnerAccount;
  }


  public void setNewSubscriptionOwnerAccount(CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount newSubscriptionOwnerAccount) {
  ...
  **/
  ...
  public CreateOrderCreateSubscription subscribeToRatePlans(List<CreateOrderRatePlanOverride> subscribeToRatePlans) {
  ...
  **/
  ...
  public void setSubscribeToRatePlans(List<CreateOrderRatePlanOverride> subscribeToRatePlans) {
  ...
  **/
  ...
  public CreateOrderCreateSubscription terms(PreviewOrderCreateSubscriptionTerms terms) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateOrderCreateSubscription
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateOrderCreateSubscription.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("newSubscriptionOwnerAccount") != null && !jsonObj.get("newSubscriptionOwnerAccount").isJsonNull()) {
        CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount.validateJsonObject(jsonObj.getAsJsonObject("newSubscriptionOwnerAccount"));
      }
      ...
      if (jsonObj.get("subscribeToRatePlans") != null && !jsonObj.get("subscribeToRatePlans").isJsonNull()) {
        ...
        if (jsonArraysubscribeToRatePlans != null) {
          ...
          for (int i = 0; i < jsonArraysubscribeToRatePlans.size(); i++) {
            CreateOrderRatePlanOverride.validateJsonObject(jsonArraysubscribeToRatePlans.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CreateOrderCreateSubscription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOrderCreateSubscription.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOrderCreateSubscription>() {
           @Override
