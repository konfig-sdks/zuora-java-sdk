...
public class CreatePaymentMethodCCReferenceTransactionAllOf {
  ...
  public CreatePaymentMethodCCReferenceTransactionAllOf() {
  }

  public CreatePaymentMethodCCReferenceTransactionAllOf type(String type) {
  ...
  **/
  ...
  public CreatePaymentMethodCCReferenceTransactionAllOf creditCardMaskNumber(String creditCardMaskNumber) {
  ...
  **/
  ...
  public CreatePaymentMethodCCReferenceTransactionAllOf secondTokenId(String secondTokenId) {
  ...
  **/
  ...
  public CreatePaymentMethodCCReferenceTransactionAllOf tokenId(String tokenId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A gateway unique identifier that replaces sensitive payment method data or represents a gateway's unique customer profile.  When `tokenId` is used to represent a customer profile, `secondTokenId` is conditionally required for representing the underlying tokenized payment method.  The values for the `tokenId` and `secondTokenId` fields differ for gateways. For more information, see the Knowledge Center article specific to each gateway that supports the CC Reference Transaction payment method. ")
  ...
  public CreatePaymentMethodCCReferenceTransactionAllOf mandateInfo(Object mandateInfo) {
  ...
  **/
   ...
   * @return the CreatePaymentMethodCCReferenceTransactionAllOf instance itself
   */
  public CreatePaymentMethodCCReferenceTransactionAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePaymentMethodCCReferenceTransactionAllOf createPaymentMethodCCReferenceTransactionAllOf = (CreatePaymentMethodCCReferenceTransactionAllOf) o;
    return Objects.equals(this.type, createPaymentMethodCCReferenceTransactionAllOf.type) &&
        Objects.equals(this.creditCardMaskNumber, createPaymentMethodCCReferenceTransactionAllOf.creditCardMaskNumber) &&
        Objects.equals(this.secondTokenId, createPaymentMethodCCReferenceTransactionAllOf.secondTokenId) &&
        Objects.equals(this.tokenId, createPaymentMethodCCReferenceTransactionAllOf.tokenId) &&
        Objects.equals(this.mandateInfo, createPaymentMethodCCReferenceTransactionAllOf.mandateInfo)&&
        Objects.equals(this.additionalProperties, createPaymentMethodCCReferenceTransactionAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, creditCardMaskNumber, secondTokenId, tokenId, mandateInfo, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePaymentMethodCCReferenceTransactionAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreatePaymentMethodCCReferenceTransactionAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreatePaymentMethodCCReferenceTransactionAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePaymentMethodCCReferenceTransactionAllOf is not found in the empty JSON string", CreatePaymentMethodCCReferenceTransactionAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePaymentMethodCCReferenceTransactionAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePaymentMethodCCReferenceTransactionAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePaymentMethodCCReferenceTransactionAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePaymentMethodCCReferenceTransactionAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePaymentMethodCCReferenceTransactionAllOf>() {
           @Override
           public void write(JsonWriter out, CreatePaymentMethodCCReferenceTransactionAllOf value) throws IOException {
           ...
           @Override
           public CreatePaymentMethodCCReferenceTransactionAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreatePaymentMethodCCReferenceTransactionAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreatePaymentMethodCCReferenceTransactionAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreatePaymentMethodCCReferenceTransactionAllOf
  * @throws IOException if the JSON string is invalid with respect to CreatePaymentMethodCCReferenceTransactionAllOf
  */
  public static CreatePaymentMethodCCReferenceTransactionAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePaymentMethodCCReferenceTransactionAllOf.class);
  }

 /**
  * Convert an instance of CreatePaymentMethodCCReferenceTransactionAllOf to an JSON string
  *
  * @return JSON string
  */
