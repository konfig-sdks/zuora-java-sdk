...
public class GetOrderResponse {
  ...
  public GetOrderResponse processId(String processId) {
  ...
  **/
  ...
  public GetOrderResponse reasons(List<CommonResponseReasonsInner> reasons) {
  ...
  public GetOrderResponse addReasonsItem(CommonResponseReasonsInner reasonsItem) {
  ...
  **/
  ...
  public GetOrderResponse requestId(UUID requestId) {
  ...
  **/
  ...
  public GetOrderResponse success(Boolean success) {
  ...
  **/
   ...
   * @return the GetOrderResponse instance itself
   */
  public GetOrderResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.processId, getOrderResponse.processId) &&
        Objects.equals(this.reasons, getOrderResponse.reasons) &&
        Objects.equals(this.requestId, getOrderResponse.requestId) &&
        Objects.equals(this.success, getOrderResponse.success) &&
        Objects.equals(this.order, getOrderResponse.order)&&
        Objects.equals(this.additionalProperties, getOrderResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(processId, reasons, requestId, success, order, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetOrderResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetOrderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetOrderResponse>() {
           ...
           public GetOrderResponse read(JsonReader in) throws IOException {
             ...
             GetOrderResponse instance = thisAdapter.fromJsonTree(jsonObj);
