...
import com.konfigthis.client.model.OrderLineItemRetrieveOrder;
import com.konfigthis.client.model.OrderSchedulingOptions;
import com.konfigthis.client.model.OrderSubscriptionsInner;
 ...
 */
@ApiModel(description = "Represents the order information that will be returned in the GET call.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Order {
 ...
 public enum CategoryEnum {
  ...
  private List<OrderLineItemRetrieveOrder> orderLineItems = null;
 ...
 public enum StatusEnum {
  ...
  private List<OrderSubscriptionsInner> subscriptions = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "A description of the order.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the user who created this order.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The time that the order gets created in the system, in the `YYYY-MM-DD HH:MM:SS` format.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The account number that this order has been created under. This is also the invoice owner of the subscriptions included in this order.")
  ...
  public Order invoiceScheduleId(Integer invoiceScheduleId) {
   ...
   /**
   * The ID of the invoice schedule associated with the order.  **Note**: This field is available only if you have the &lt;a href&#x3D;\&quot;https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Schedule\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Billing Schedule&lt;/a&gt; feature enabled. 
   * @return invoiceScheduleId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the invoice schedule associated with the order.  **Note**: This field is available only if you have the <a href=\"https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Schedule\" target=\"_blank\">Billing Schedule</a> feature enabled. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the order is signed. All the order actions under this order will use this order date as the contract effective date if no additinal contractEffectiveDate is provided.")
  ...
  public Order orderLineItems(List<OrderLineItemRetrieveOrder> orderLineItems) {
  ...
  public Order addOrderLineItemsItem(OrderLineItemRetrieveOrder orderLineItemsItem) {
  ...
  **/
  ...
  public List<OrderLineItemRetrieveOrder> getOrderLineItems() {
    return orderLineItems;
  }


  public void setOrderLineItems(List<OrderLineItemRetrieveOrder> orderLineItems) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The order number of the order.")
  ...
  public Order organizationLabel(String organizationLabel) {
  ...
  **/
  ...
  public Order scheduledOrderActivationResponse(PostOrderResponseType scheduledOrderActivationResponse) {
  ...
  **/
  ...
  public PostOrderResponseType getScheduledOrderActivationResponse() {
    return scheduledOrderActivationResponse;
  }


  public void setScheduledOrderActivationResponse(PostOrderResponseType scheduledOrderActivationResponse) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the order. If the order contains any `Pending Activation` or `Pending Acceptance` subscription, the order status will be `Pending`; If the order is in draft status, the order status will be `Draft`; otherwise the order status is `Completed`.  The available order statuses are as follow: - `Draft`: The order is in draft status. - `Pending`: The order is in pending status. - `Completed`: The order is in completed status. - `Cancelled`: The draft or scheduled order is cancelled. - `Scheduled`: The order is in scheduled status and it is only valid if the Scheduled Orders feature is enabled. - `Executing`: The scheduled order is executed by a scheduler and it is only valid if the Scheduled Orders feature is enabled. - `Failed`: The scheduled order has failed.  **Note**: To manage and access the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Manage_subscription_transactions/Orders/AA_Overview_of_Orders/P_Scheduled_Orders\" target=\"_blank\">Scheduled Orders</a> feature from the self-service interface, see <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Configure_billing_settings/System_settings/Enable_billing_features_by_yourself\" target=\"_blank\">Enable billing features by yourself</a>. ")
  ...
  public Order subscriptions(List<OrderSubscriptionsInner> subscriptions) {
  ...
  public Order addSubscriptionsItem(OrderSubscriptionsInner subscriptionsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Represents a processed subscription, including the origin request (order actions) that create this version of subscription and the processing result (order metrics). The reference part in the request will be overridden with the info in the new subscription version.")

  public List<OrderSubscriptionsInner> getSubscriptions() {
    return subscriptions;
  }


  public void setSubscriptions(List<OrderSubscriptionsInner> subscriptions) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the user who updated this order.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The time that the order gets updated in the system(for example, an order description update), in the `YYYY-MM-DD HH:MM:SS` format.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, order.description) &&
        ...
        Objects.equals(this.organizationLabel, order.organizationLabel) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, category, createdBy, createdDate, currency, customFields, existingAccountNumber, invoiceScheduleId, orderDate, orderLineItems, orderNumber, organizationLabel, reasonCode, schedulingOptions, scheduledOrderActivationResponse, status, subscriptions, updatedBy, updatedDate, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("orderLineItems") != null && !jsonObj.get("orderLineItems").isJsonNull()) {
        ...
        if (jsonArrayorderLineItems != null) {
          ...
          for (int i = 0; i < jsonArrayorderLineItems.size(); i++) {
            OrderLineItemRetrieveOrder.validateJsonObject(jsonArrayorderLineItems.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("schedulingOptions") != null && !jsonObj.get("schedulingOptions").isJsonNull()) {
        OrderSchedulingOptions.validateJsonObject(jsonObj.getAsJsonObject("schedulingOptions"));
      }
      ...
      if (jsonObj.get("scheduledOrderActivationResponse") != null && !jsonObj.get("scheduledOrderActivationResponse").isJsonNull()) {
        PostOrderResponseType.validateJsonObject(jsonObj.getAsJsonObject("scheduledOrderActivationResponse"));
      }
      ...
      if (jsonObj.get("subscriptions") != null && !jsonObj.get("subscriptions").isJsonNull()) {
        ...
        if (jsonArraysubscriptions != null) {
          ...
          for (int i = 0; i < jsonArraysubscriptions.size(); i++) {
            OrderSubscriptionsInner.validateJsonObject(jsonArraysubscriptions.get(i).getAsJsonObject());
          };
        }
      }
