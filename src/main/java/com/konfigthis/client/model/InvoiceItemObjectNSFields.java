 ...
 */
@ApiModel(description = "Container for Invoice Item fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class InvoiceItemObjectNSFields {
  ...
  public InvoiceItemObjectNSFields() {
  }

  public InvoiceItemObjectNSFields integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public InvoiceItemObjectNSFields integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public InvoiceItemObjectNSFields syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the InvoiceItemObjectNSFields instance itself
   */
  public InvoiceItemObjectNSFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InvoiceItemObjectNSFields invoiceItemObjectNSFields = (InvoiceItemObjectNSFields) o;
    return Objects.equals(this.integrationIdNS, invoiceItemObjectNSFields.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, invoiceItemObjectNSFields.integrationStatusNS) &&
        Objects.equals(this.syncDateNS, invoiceItemObjectNSFields.syncDateNS)&&
        Objects.equals(this.additionalProperties, invoiceItemObjectNSFields.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvoiceItemObjectNSFields {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceItemObjectNSFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceItemObjectNSFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceItemObjectNSFields is not found in the empty JSON string", InvoiceItemObjectNSFields.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceItemObjectNSFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceItemObjectNSFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceItemObjectNSFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceItemObjectNSFields.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceItemObjectNSFields>() {
           @Override
           public void write(JsonWriter out, InvoiceItemObjectNSFields value) throws IOException {
           ...
           @Override
           public InvoiceItemObjectNSFields read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoiceItemObjectNSFields instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoiceItemObjectNSFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoiceItemObjectNSFields
  * @throws IOException if the JSON string is invalid with respect to InvoiceItemObjectNSFields
  */
  public static InvoiceItemObjectNSFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceItemObjectNSFields.class);
  }

 /**
  * Convert an instance of InvoiceItemObjectNSFields to an JSON string
  *
  * @return JSON string
  */
