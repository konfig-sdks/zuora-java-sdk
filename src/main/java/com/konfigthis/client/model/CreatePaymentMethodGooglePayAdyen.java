...
public class CreatePaymentMethodGooglePayAdyen {
  /**
 ...
 public enum TypeEnum {
  ...
  public CreatePaymentMethodGooglePayAdyen() {
  }

  public CreatePaymentMethodGooglePayAdyen type(TypeEnum type) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayAdyen googlePaymentToken(String googlePaymentToken) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayAdyen email(String email) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Email address associated with the payment method. This field is specific for setting up Google Pay on Adyen v2.0. This field will be passed to Adyen as `shopperEmail`. ")
  ...
  public CreatePaymentMethodGooglePayAdyen accountKey(String accountKey) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayAdyen authGateway(String authGateway) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayAdyen currencyCode(String currencyCode) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayAdyen gatewayOptions(PaymentMethodCommonFieldsGatewayOptions gatewayOptions) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayAdyen ipAddress(String ipAddress) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayAdyen makeDefault(Boolean makeDefault) {
  ...
  **/
  ...
  public CreatePaymentMethodGooglePayAdyen skipValidation(Boolean skipValidation) {
  ...
  **/
   ...
   * @return the CreatePaymentMethodGooglePayAdyen instance itself
   */
  public CreatePaymentMethodGooglePayAdyen putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePaymentMethodGooglePayAdyen createPaymentMethodGooglePayAdyen = (CreatePaymentMethodGooglePayAdyen) o;
    return Objects.equals(this.type, createPaymentMethodGooglePayAdyen.type) &&
        Objects.equals(this.googlePaymentToken, createPaymentMethodGooglePayAdyen.googlePaymentToken) &&
        Objects.equals(this.email, createPaymentMethodGooglePayAdyen.email) &&
        Objects.equals(this.accountKey, createPaymentMethodGooglePayAdyen.accountKey) &&
        Objects.equals(this.authGateway, createPaymentMethodGooglePayAdyen.authGateway) &&
        Objects.equals(this.currencyCode, createPaymentMethodGooglePayAdyen.currencyCode) &&
        Objects.equals(this.gatewayOptions, createPaymentMethodGooglePayAdyen.gatewayOptions) &&
        Objects.equals(this.ipAddress, createPaymentMethodGooglePayAdyen.ipAddress) &&
        Objects.equals(this.makeDefault, createPaymentMethodGooglePayAdyen.makeDefault) &&
        Objects.equals(this.skipValidation, createPaymentMethodGooglePayAdyen.skipValidation)&&
        Objects.equals(this.additionalProperties, createPaymentMethodGooglePayAdyen.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, googlePaymentToken, email, accountKey, authGateway, currencyCode, gatewayOptions, ipAddress, makeDefault, skipValidation, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePaymentMethodGooglePayAdyen {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("googlePaymentToken");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreatePaymentMethodGooglePayAdyen
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreatePaymentMethodGooglePayAdyen.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePaymentMethodGooglePayAdyen is not found in the empty JSON string", CreatePaymentMethodGooglePayAdyen.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePaymentMethodGooglePayAdyen.openapiRequiredFields) {
      ...
      if (!jsonObj.get("googlePaymentToken").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePaymentMethodGooglePayAdyen.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePaymentMethodGooglePayAdyen' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePaymentMethodGooglePayAdyen> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePaymentMethodGooglePayAdyen.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePaymentMethodGooglePayAdyen>() {
           @Override
           public void write(JsonWriter out, CreatePaymentMethodGooglePayAdyen value) throws IOException {
           ...
           @Override
           public CreatePaymentMethodGooglePayAdyen read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreatePaymentMethodGooglePayAdyen instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreatePaymentMethodGooglePayAdyen given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreatePaymentMethodGooglePayAdyen
  * @throws IOException if the JSON string is invalid with respect to CreatePaymentMethodGooglePayAdyen
  */
  public static CreatePaymentMethodGooglePayAdyen fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePaymentMethodGooglePayAdyen.class);
  }

 /**
  * Convert an instance of CreatePaymentMethodGooglePayAdyen to an JSON string
  *
  * @return JSON string
  */
