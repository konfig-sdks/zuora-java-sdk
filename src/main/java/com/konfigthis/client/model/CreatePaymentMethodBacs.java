...
import com.konfigthis.client.model.BacsPaymentMethodTokens;
import com.konfigthis.client.model.CreatePaymentMethodBetalingsserviceAllOfAccountHolderInfo;
...
public class CreatePaymentMethodBacs {
  /**
 ...
 public enum TypeEnum {
  ...
  private CreatePaymentMethodBetalingsserviceAllOfAccountHolderInfo accountHolderInfo;
  ...
  private BacsPaymentMethodTokens tokens;
  ...
  public CreatePaymentMethodBacs() {
  }

  public CreatePaymentMethodBacs type(TypeEnum type) {
  ...
  **/
  ...
  public CreatePaymentMethodBacs accountHolderInfo(CreatePaymentMethodBetalingsserviceAllOfAccountHolderInfo accountHolderInfo) {
  ...
  **/
  ...
  public CreatePaymentMethodBetalingsserviceAllOfAccountHolderInfo getAccountHolderInfo() {
    return accountHolderInfo;
  }


  public void setAccountHolderInfo(CreatePaymentMethodBetalingsserviceAllOfAccountHolderInfo accountHolderInfo) {
  ...
  public CreatePaymentMethodBacs accountNumber(String accountNumber) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The number of the customer's bank account. ")
  ...
  public CreatePaymentMethodBacs accountMaskNumber(String accountMaskNumber) {
   ...
   /**
   * The masked account number such as ****1234. When creating BACS payment methods on Stripe, if the &#x60;tokens&#x60; field is provided, this &#x60;accountMaskNumber&#x60; field is required. For more information, see  &lt;a href&#x3D;\&quot;https://knowledgecenter.zuora.com/Zuora_Payments/Payment_gateway_integrations/Supported_payment_gateways/Stripe_Payment_Gateway/A_Overview_of_Stripe_payment_gateway_integration\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Overview of Stripe payment gateway integration&lt;/a&gt;. 
   * @return accountMaskNumber
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The masked account number such as ****1234. When creating BACS payment methods on Stripe, if the `tokens` field is provided, this `accountMaskNumber` field is required. For more information, see  <a href=\"https://knowledgecenter.zuora.com/Zuora_Payments/Payment_gateway_integrations/Supported_payment_gateways/Stripe_Payment_Gateway/A_Overview_of_Stripe_payment_gateway_integration\" target=\"_blank\">Overview of Stripe payment gateway integration</a>. ")
  ...
  public CreatePaymentMethodBacs bankCode(String bankCode) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The sort code or number that identifies the bank. This is also known as the sort code. ")
  ...
  public CreatePaymentMethodBacs mandateInfo(CreatePaymentMethodCreditCardAllOfMandateInfo mandateInfo) {
  ...
  **/
  ...
  public CreatePaymentMethodBacs tokenize(Boolean tokenize) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "When creating a BACS payment method on Adyen v2.0, set this field to `true` to support processing BACS recurring payments. For more information about other requirements for processing BACS recurring payments, see <a href=\"https://knowledgecenter.zuora.com/Zuora_Payments/Payment_gateway_integrations/Supported_payment_gateways/Adyen_Integration_v2.0/A_Overview_of_Adyen_Integration_v2.0#Direct_Debit_UK_(BACS)\" target=\"_blank\">Overview of Adyen Integration v2.0</a>. ")
  ...
  public CreatePaymentMethodBacs tokens(BacsPaymentMethodTokens tokens) {
  ...
  **/
  ...
  public BacsPaymentMethodTokens getTokens() {
    return tokens;
  }


  public void setTokens(BacsPaymentMethodTokens tokens) {
  ...
  public CreatePaymentMethodBacs processingOptions(CreatePaymentMethodCreditCardAllOfProcessingOptions processingOptions) {
  ...
  **/
  ...
  public CreatePaymentMethodBacs accountKey(String accountKey) {
  ...
  **/
  ...
  public CreatePaymentMethodBacs authGateway(String authGateway) {
  ...
  **/
  ...
  public CreatePaymentMethodBacs currencyCode(String currencyCode) {
  ...
  **/
  ...
  public CreatePaymentMethodBacs gatewayOptions(PaymentMethodCommonFieldsGatewayOptions gatewayOptions) {
  ...
  **/
  ...
  public CreatePaymentMethodBacs ipAddress(String ipAddress) {
  ...
  **/
  ...
  public CreatePaymentMethodBacs makeDefault(Boolean makeDefault) {
  ...
  **/
  ...
  public CreatePaymentMethodBacs skipValidation(Boolean skipValidation) {
  ...
  **/
   ...
   * @return the CreatePaymentMethodBacs instance itself
   */
  public CreatePaymentMethodBacs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePaymentMethodBacs createPaymentMethodBacs = (CreatePaymentMethodBacs) o;
    return Objects.equals(this.type, createPaymentMethodBacs.type) &&
        Objects.equals(this.accountHolderInfo, createPaymentMethodBacs.accountHolderInfo) &&
        Objects.equals(this.accountNumber, createPaymentMethodBacs.accountNumber) &&
        Objects.equals(this.accountMaskNumber, createPaymentMethodBacs.accountMaskNumber) &&
        Objects.equals(this.bankCode, createPaymentMethodBacs.bankCode) &&
        Objects.equals(this.mandateInfo, createPaymentMethodBacs.mandateInfo) &&
        Objects.equals(this.tokenize, createPaymentMethodBacs.tokenize) &&
        Objects.equals(this.tokens, createPaymentMethodBacs.tokens) &&
        Objects.equals(this.processingOptions, createPaymentMethodBacs.processingOptions) &&
        Objects.equals(this.accountKey, createPaymentMethodBacs.accountKey) &&
        Objects.equals(this.authGateway, createPaymentMethodBacs.authGateway) &&
        Objects.equals(this.currencyCode, createPaymentMethodBacs.currencyCode) &&
        Objects.equals(this.gatewayOptions, createPaymentMethodBacs.gatewayOptions) &&
        Objects.equals(this.ipAddress, createPaymentMethodBacs.ipAddress) &&
        Objects.equals(this.makeDefault, createPaymentMethodBacs.makeDefault) &&
        Objects.equals(this.skipValidation, createPaymentMethodBacs.skipValidation)&&
        Objects.equals(this.additionalProperties, createPaymentMethodBacs.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, accountHolderInfo, accountNumber, accountMaskNumber, bankCode, mandateInfo, tokenize, tokens, processingOptions, accountKey, authGateway, currencyCode, gatewayOptions, ipAddress, makeDefault, skipValidation, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePaymentMethodBacs {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreatePaymentMethodBacs
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreatePaymentMethodBacs.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePaymentMethodBacs is not found in the empty JSON string", CreatePaymentMethodBacs.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePaymentMethodBacs.openapiRequiredFields) {
      ...
      CreatePaymentMethodBetalingsserviceAllOfAccountHolderInfo.validateJsonObject(jsonObj.getAsJsonObject("accountHolderInfo"));
      ...
      if (jsonObj.get("tokens") != null && !jsonObj.get("tokens").isJsonNull()) {
        BacsPaymentMethodTokens.validateJsonObject(jsonObj.getAsJsonObject("tokens"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePaymentMethodBacs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePaymentMethodBacs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePaymentMethodBacs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePaymentMethodBacs.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePaymentMethodBacs>() {
           @Override
           public void write(JsonWriter out, CreatePaymentMethodBacs value) throws IOException {
           ...
           @Override
           public CreatePaymentMethodBacs read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreatePaymentMethodBacs instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreatePaymentMethodBacs given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreatePaymentMethodBacs
  * @throws IOException if the JSON string is invalid with respect to CreatePaymentMethodBacs
  */
  public static CreatePaymentMethodBacs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePaymentMethodBacs.class);
  }

 /**
  * Convert an instance of CreatePaymentMethodBacs to an JSON string
  *
  * @return JSON string
  */
