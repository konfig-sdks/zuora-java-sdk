 ...
 */
@ApiModel(description = "Container for bill-to contact information for this account. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PUTAccountTypeBillToContact {
  ...
  public PUTAccountTypeBillToContact() {
  }
  ...
  **/
   ...
   * @return the PUTAccountTypeBillToContact instance itself
   */
  public PUTAccountTypeBillToContact putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address1, puTAccountTypeBillToContact.address1) &&
        ...
        Objects.equals(this.additionalProperties, puTAccountTypeBillToContact.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTAccountTypeBillToContact
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTAccountTypeBillToContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTAccountTypeBillToContact is not found in the empty JSON string", PUTAccountTypeBillToContact.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PUTAccountTypeBillToContact.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTAccountTypeBillToContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTAccountTypeBillToContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTAccountTypeBillToContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTAccountTypeBillToContact.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTAccountTypeBillToContact>() {
           @Override
           public void write(JsonWriter out, PUTAccountTypeBillToContact value) throws IOException {
           ...
           @Override
           public PUTAccountTypeBillToContact read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTAccountTypeBillToContact instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTAccountTypeBillToContact given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTAccountTypeBillToContact
  * @throws IOException if the JSON string is invalid with respect to PUTAccountTypeBillToContact
  */
  public static PUTAccountTypeBillToContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTAccountTypeBillToContact.class);
  }

 /**
  * Convert an instance of PUTAccountTypeBillToContact to an JSON string
  *
  * @return JSON string
  */
