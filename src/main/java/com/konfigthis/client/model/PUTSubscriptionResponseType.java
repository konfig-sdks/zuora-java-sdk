...
import com.konfigthis.client.model.PUTSubscriptionPreviewInvoiceItemsType;
import com.konfigthis.client.model.PUTSubscriptionResponseTypeChargeMetrics;
import com.konfigthis.client.model.PUTSubscriptionResponseTypeCreditMemo;
import com.konfigthis.client.model.PUTSubscriptionResponseTypeInvoice;
...
public class PUTSubscriptionResponseType {
  ...
  private PUTSubscriptionResponseTypeChargeMetrics chargeMetrics;

  public static final String SERIALIZED_NAME_CREDIT_MEMO = "creditMemo";
  @SerializedName(SERIALIZED_NAME_CREDIT_MEMO)
  private PUTSubscriptionResponseTypeCreditMemo creditMemo;
  ...
  private PUTSubscriptionResponseTypeInvoice invoice;
  ...
  private List<PUTSubscriptionPreviewInvoiceItemsType> invoiceItems = null;
  ...
  private Double totalDeltaMrr;

  public static final String SERIALIZED_NAME_TOTAL_DELTA_TCV = "totalDeltaTcv";
  @SerializedName(SERIALIZED_NAME_TOTAL_DELTA_TCV)
  private Double totalDeltaTcv;

  public PUTSubscriptionResponseType() {
  }

  public PUTSubscriptionResponseType amount(Double amount) {
  ...
  public PUTSubscriptionResponseType amount(Integer amount) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Invoice amount. Preview mode only. ")
  ...
  public PUTSubscriptionResponseType amountWithoutTax(Double amountWithoutTax) {
  ...
  public PUTSubscriptionResponseType amountWithoutTax(Integer amountWithoutTax) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Invoice amount minus tax. Preview mode only. ")
  ...
  **/
  ...
  public PUTSubscriptionResponseType creditMemo(PUTSubscriptionResponseTypeCreditMemo creditMemo) {
  ...
  **/
  ...
  public PUTSubscriptionResponseTypeCreditMemo getCreditMemo() {
    return creditMemo;
  }


  public void setCreditMemo(PUTSubscriptionResponseTypeCreditMemo creditMemo) {
  ...
  public PUTSubscriptionResponseType creditMemoId(String creditMemoId) {
  ...
  **/
  ...
  public PUTSubscriptionResponseType invoice(PUTSubscriptionResponseTypeInvoice invoice) {
  ...
  **/
  ...
  public PUTSubscriptionResponseTypeInvoice getInvoice() {
    return invoice;
  }


  public void setInvoice(PUTSubscriptionResponseTypeInvoice invoice) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Invoice ID, if an invoice is generated during the update. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for invoice items. ")
  ...
  public PUTSubscriptionResponseType invoiceTargetDate(LocalDate invoiceTargetDate) {
   ...
   /**
   * Date through which charges are calculated on the invoice, as yyyy-mm-dd. Preview mode only.  **Note:** This field is only available if you do not specify the Zuora REST API minor version or specify the minor version to 186.0, 187.0, 188.0, 189.0, and 196.0. . 
   * @return invoiceTargetDate
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date through which charges are calculated on the invoice, as yyyy-mm-dd. Preview mode only.  **Note:** This field is only available if you do not specify the Zuora REST API minor version or specify the minor version to 186.0, 187.0, 188.0, 189.0, and 196.0. . ")
  ...
  public PUTSubscriptionResponseType paidAmount(Double paidAmount) {
  ...
  public PUTSubscriptionResponseType paidAmount(Integer paidAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Payment amount, if a payment is collected ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Payment ID, if a payment is collected. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the resulting new subscription. ")
  ...
  **/
  ...
  public PUTSubscriptionResponseType targetDate(LocalDate targetDate) {
  ...
  **/
  ...
  public PUTSubscriptionResponseType taxAmount(Double taxAmount) {
  ...
  public PUTSubscriptionResponseType taxAmount(Integer taxAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Tax amount on the invoice. ")
  ...
  public PUTSubscriptionResponseType totalDeltaMrr(Double totalDeltaMrr) {
  ...
  public PUTSubscriptionResponseType totalDeltaMrr(Integer totalDeltaMrr) {
    
    
    
    
    this.totalDeltaMrr = totalDeltaMrr.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Change in the subscription monthly recurring revenue as a result of the update. ")
  ...
  public PUTSubscriptionResponseType totalDeltaTcv(Double totalDeltaTcv) {
  ...
  public PUTSubscriptionResponseType totalDeltaTcv(Integer totalDeltaTcv) {
    
    
    
    
    this.totalDeltaTcv = totalDeltaTcv.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Change in the total contracted value of the subscription as a result of the update. ")
   ...
   * @return the PUTSubscriptionResponseType instance itself
   */
  public PUTSubscriptionResponseType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, puTSubscriptionResponseType.amount) &&
        ...
        Objects.equals(this.creditMemo, puTSubscriptionResponseType.creditMemo) &&
        Objects.equals(this.creditMemoId, puTSubscriptionResponseType.creditMemoId) &&
        Objects.equals(this.invoice, puTSubscriptionResponseType.invoice) &&
        ...
        Objects.equals(this.targetDate, puTSubscriptionResponseType.targetDate) &&
        ...
        Objects.equals(this.additionalProperties, puTSubscriptionResponseType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, amountWithoutTax, chargeMetrics, creditMemo, creditMemoId, invoice, invoiceId, invoiceItems, invoiceTargetDate, paidAmount, paymentId, subscriptionId, success, targetDate, taxAmount, totalDeltaMrr, totalDeltaTcv, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTSubscriptionResponseType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTSubscriptionResponseType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTSubscriptionResponseType is not found in the empty JSON string", PUTSubscriptionResponseType.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `chargeMetrics`
      if (jsonObj.get("chargeMetrics") != null && !jsonObj.get("chargeMetrics").isJsonNull()) {
        PUTSubscriptionResponseTypeChargeMetrics.validateJsonObject(jsonObj.getAsJsonObject("chargeMetrics"));
      }
      // validate the optional field `creditMemo`
      if (jsonObj.get("creditMemo") != null && !jsonObj.get("creditMemo").isJsonNull()) {
        PUTSubscriptionResponseTypeCreditMemo.validateJsonObject(jsonObj.getAsJsonObject("creditMemo"));
      }
      ...
      if (jsonObj.get("invoice") != null && !jsonObj.get("invoice").isJsonNull()) {
        PUTSubscriptionResponseTypeInvoice.validateJsonObject(jsonObj.getAsJsonObject("invoice"));
      }
      ...
      if (jsonObj.get("invoiceItems") != null && !jsonObj.get("invoiceItems").isJsonNull()) {
        ...
        if (jsonArrayinvoiceItems != null) {
          ...
          for (int i = 0; i < jsonArrayinvoiceItems.size(); i++) {
            PUTSubscriptionPreviewInvoiceItemsType.validateJsonObject(jsonArrayinvoiceItems.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTSubscriptionResponseType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTSubscriptionResponseType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTSubscriptionResponseType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTSubscriptionResponseType.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTSubscriptionResponseType>() {
           @Override
           public void write(JsonWriter out, PUTSubscriptionResponseType value) throws IOException {
           ...
           @Override
           public PUTSubscriptionResponseType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTSubscriptionResponseType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTSubscriptionResponseType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTSubscriptionResponseType
  * @throws IOException if the JSON string is invalid with respect to PUTSubscriptionResponseType
  */
  public static PUTSubscriptionResponseType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTSubscriptionResponseType.class);
  }

 /**
  * Convert an instance of PUTSubscriptionResponseType to an JSON string
  *
  * @return JSON string
  */
