...
public class ProxyCreateProductRatePlan {
   ...
   */
  @JsonAdapter(BillingPeriodNSEnum.Adapter.class)
 public enum BillingPeriodNSEnum {
    MONTHLY("Monthly"),
    ...
    BillingPeriodNSEnum(String value) {
      this.value = value;
    }
    ...
    public static BillingPeriodNSEnum fromValue(String value) {
      for (BillingPeriodNSEnum b : BillingPeriodNSEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<BillingPeriodNSEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final BillingPeriodNSEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public BillingPeriodNSEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return BillingPeriodNSEnum.fromValue(value);
      }
    }
  }
  ...
  private BillingPeriodNSEnum billingPeriodNS;
 ...
 public enum ItemTypeNSEnum {
  ...
  public ProxyCreateProductRatePlan() {
  }

  public ProxyCreateProductRatePlan activeCurrencies(List<String> activeCurrencies) {
  ...
  public ProxyCreateProductRatePlan addActiveCurrenciesItem(String activeCurrenciesItem) {
   ...
   /**
   * A list of 3-letter currency codes representing active currencies for the product rate plan. Use a comma to separate each currency code.  When creating a product rate plan, you can use this field to specify default currency and at most four other active currencies. 
   * @return activeCurrencies
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of 3-letter currency codes representing active currencies for the product rate plan. Use a comma to separate each currency code.  When creating a product rate plan, you can use this field to specify default currency and at most four other active currencies. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A description of the product rate plan. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the product rate plan expires and can't be subscribed to, in `yyyy-mm-dd` format. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the product rate plan becomes available and can be subscribed to, in `yyyy-mm-dd` format. ")
  ...
  public ProxyCreateProductRatePlan grade(Double grade) {
  ...
  public ProxyCreateProductRatePlan grade(Integer grade) {
    
    
    
    
    this.grade = grade.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The grade that is assigned for the product rate plan. The value of this field must be a positive integer. The greater the value, the higher the grade.  A product rate plan to be added to a Grading catalog group must have one grade. You can specify a grade for a product rate plan in this request or update the product rate plan individually.  **Notes**:    - To use this field, you must set the `X-Zuora-WSDL-Version` request header to `116` or later. Otherwise, an error occurs.   - This field is in the **Early Adopter** phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/). ")
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The name of the product rate plan. The name doesn't have to be unique in a Product Catalog, but the name has to be unique within a product. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The ID of the product that contains the product rate plan. ")
  ...
  public ProxyCreateProductRatePlan productRatePlanNumber(String productRatePlanNumber) {
   ...
   /**
   * The natural key of the product rate plan.  **Possible values**:    - leave null for automatically generated string   - an alphanumeric string of 100 characters or fewer  **Note**: This field is only available if you set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;133&#x60; or later. 
   * @return productRatePlanNumber
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The natural key of the product rate plan.  **Possible values**:    - leave null for automatically generated string   - an alphanumeric string of 100 characters or fewer  **Note**: This field is only available if you set the `X-Zuora-WSDL-Version` request header to `133` or later. ")
  ...
  public ProxyCreateProductRatePlan billingPeriodNS(BillingPeriodNSEnum billingPeriodNS) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Billing period associated with the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")

  public BillingPeriodNSEnum getBillingPeriodNS() {
    return billingPeriodNS;
  }


  public void setBillingPeriodNS(BillingPeriodNSEnum billingPeriodNS) {
  ...
  public ProxyCreateProductRatePlan classNS(String classNS) {
  ...
  **/
  ...
  public ProxyCreateProductRatePlan departmentNS(String departmentNS) {
  ...
  **/
  ...
  public ProxyCreateProductRatePlan includeChildrenNS(IncludeChildrenNSEnum includeChildrenNS) {
  ...
  **/
  ...
  public ProxyCreateProductRatePlan integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public ProxyCreateProductRatePlan integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Status of the product rate plan's synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")
  ...
  public ProxyCreateProductRatePlan itemTypeNS(ItemTypeNSEnum itemTypeNS) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Type of item that is created in NetSuite for the product rate plan. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")
  ...
  public ProxyCreateProductRatePlan locationNS(String locationNS) {
  ...
  **/
  ...
  public ProxyCreateProductRatePlan multiCurrencyPriceNS(String multiCurrencyPriceNS) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Multi-currency price associated with the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")
  ...
  public ProxyCreateProductRatePlan priceNS(String priceNS) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Price associated with the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")
  ...
  public ProxyCreateProductRatePlan subsidiaryNS(String subsidiaryNS) {
  ...
  **/
  ...
  public ProxyCreateProductRatePlan syncDateNS(String syncDateNS) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date when the product rate plan was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265). ")
   ...
   * @return the ProxyCreateProductRatePlan instance itself
   */
  public ProxyCreateProductRatePlan putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activeCurrencies, proxyCreateProductRatePlan.activeCurrencies) &&
        Objects.equals(this.description, proxyCreateProductRatePlan.description) &&
        ...
        Objects.equals(this.grade, proxyCreateProductRatePlan.grade) &&
        ...
        Objects.equals(this.productRatePlanNumber, proxyCreateProductRatePlan.productRatePlanNumber) &&
        Objects.equals(this.billingPeriodNS, proxyCreateProductRatePlan.billingPeriodNS) &&
        Objects.equals(this.classNS, proxyCreateProductRatePlan.classNS) &&
        Objects.equals(this.departmentNS, proxyCreateProductRatePlan.departmentNS) &&
        Objects.equals(this.includeChildrenNS, proxyCreateProductRatePlan.includeChildrenNS) &&
        Objects.equals(this.integrationIdNS, proxyCreateProductRatePlan.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, proxyCreateProductRatePlan.integrationStatusNS) &&
        Objects.equals(this.itemTypeNS, proxyCreateProductRatePlan.itemTypeNS) &&
        Objects.equals(this.locationNS, proxyCreateProductRatePlan.locationNS) &&
        Objects.equals(this.multiCurrencyPriceNS, proxyCreateProductRatePlan.multiCurrencyPriceNS) &&
        Objects.equals(this.priceNS, proxyCreateProductRatePlan.priceNS) &&
        Objects.equals(this.subsidiaryNS, proxyCreateProductRatePlan.subsidiaryNS) &&
        Objects.equals(this.syncDateNS, proxyCreateProductRatePlan.syncDateNS)&&
        Objects.equals(this.additionalProperties, proxyCreateProductRatePlan.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(activeCurrencies, description, effectiveEndDate, effectiveStartDate, grade, name, productId, productRatePlanNumber, billingPeriodNS, classNS, departmentNS, includeChildrenNS, integrationIdNS, integrationStatusNS, itemTypeNS, locationNS, multiCurrencyPriceNS, priceNS, subsidiaryNS, syncDateNS, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProxyCreateProductRatePlan
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProxyCreateProductRatePlan.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProxyCreateProductRatePlan is not found in the empty JSON string", ProxyCreateProductRatePlan.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProxyCreateProductRatePlan.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("ActiveCurrencies") != null && !jsonObj.get("ActiveCurrencies").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProxyCreateProductRatePlan.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProxyCreateProductRatePlan' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProxyCreateProductRatePlan> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProxyCreateProductRatePlan.class));

       return (TypeAdapter<T>) new TypeAdapter<ProxyCreateProductRatePlan>() {
           @Override
           public void write(JsonWriter out, ProxyCreateProductRatePlan value) throws IOException {
           ...
           @Override
           public ProxyCreateProductRatePlan read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProxyCreateProductRatePlan instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProxyCreateProductRatePlan given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProxyCreateProductRatePlan
  * @throws IOException if the JSON string is invalid with respect to ProxyCreateProductRatePlan
  */
  public static ProxyCreateProductRatePlan fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProxyCreateProductRatePlan.class);
  }

 /**
  * Convert an instance of ProxyCreateProductRatePlan to an JSON string
  *
  * @return JSON string
  */
