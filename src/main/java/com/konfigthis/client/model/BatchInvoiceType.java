...
public class BatchInvoiceType {
  ...
  private List<PutInvoiceItemType> invoiceItems = null;
 ...
 public enum TransferredToAccountingEnum {
  ...
  public BatchInvoiceType() {
  }

  public BatchInvoiceType autoPay(Boolean autoPay) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Whether invoices are automatically picked up for processing in the corresponding payment run.  By default, invoices are automatically picked up for processing in the corresponding payment run. ")
  ...
  public BatchInvoiceType comments(String comments) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Additional information related to the invoice that a Zuora user added to the invoice. ")
  ...
  public BatchInvoiceType dueDate(LocalDate dueDate) {
  ...
  **/
  ...
  public BatchInvoiceType id(String id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the invoice to be updated. ")
  ...
  public BatchInvoiceType invoiceDate(LocalDate invoiceDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The new invoice date of the invoice. The new invoice date cannot fall in a closed accounting period.  You can only specify `invoiceDate` or `dueDate` in one request. Otherwise, an error occurs. ")
  ...
  public BatchInvoiceType invoiceItems(List<PutInvoiceItemType> invoiceItems) {
  ...
  public BatchInvoiceType addInvoiceItemsItem(PutInvoiceItemType invoiceItemsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for invoice items. The maximum number of items is 1,000. ")

  public List<PutInvoiceItemType> getInvoiceItems() {
    return invoiceItems;
  }


  public void setInvoiceItems(List<PutInvoiceItemType> invoiceItems) {
  ...
  public BatchInvoiceType transferredToAccounting(TransferredToAccountingEnum transferredToAccounting) {
  ...
  **/
  ...
  public BatchInvoiceType integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public BatchInvoiceType integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public BatchInvoiceType syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the BatchInvoiceType instance itself
   */
  public BatchInvoiceType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BatchInvoiceType batchInvoiceType = (BatchInvoiceType) o;
    return Objects.equals(this.autoPay, batchInvoiceType.autoPay) &&
        Objects.equals(this.comments, batchInvoiceType.comments) &&
        Objects.equals(this.dueDate, batchInvoiceType.dueDate) &&
        Objects.equals(this.id, batchInvoiceType.id) &&
        Objects.equals(this.invoiceDate, batchInvoiceType.invoiceDate) &&
        Objects.equals(this.invoiceItems, batchInvoiceType.invoiceItems) &&
        Objects.equals(this.transferredToAccounting, batchInvoiceType.transferredToAccounting) &&
        Objects.equals(this.integrationIdNS, batchInvoiceType.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, batchInvoiceType.integrationStatusNS) &&
        Objects.equals(this.syncDateNS, batchInvoiceType.syncDateNS)&&
        Objects.equals(this.additionalProperties, batchInvoiceType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoPay, comments, dueDate, id, invoiceDate, invoiceItems, transferredToAccounting, integrationIdNS, integrationStatusNS, syncDateNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchInvoiceType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BatchInvoiceType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BatchInvoiceType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchInvoiceType is not found in the empty JSON string", BatchInvoiceType.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("invoiceItems") != null && !jsonObj.get("invoiceItems").isJsonNull()) {
        ...
        if (jsonArrayinvoiceItems != null) {
          ...
          for (int i = 0; i < jsonArrayinvoiceItems.size(); i++) {
            PutInvoiceItemType.validateJsonObject(jsonArrayinvoiceItems.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchInvoiceType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchInvoiceType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchInvoiceType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchInvoiceType.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchInvoiceType>() {
           @Override
           public void write(JsonWriter out, BatchInvoiceType value) throws IOException {
           ...
           @Override
           public BatchInvoiceType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BatchInvoiceType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BatchInvoiceType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BatchInvoiceType
  * @throws IOException if the JSON string is invalid with respect to BatchInvoiceType
  */
  public static BatchInvoiceType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchInvoiceType.class);
  }

 /**
  * Convert an instance of BatchInvoiceType to an JSON string
  *
  * @return JSON string
  */
