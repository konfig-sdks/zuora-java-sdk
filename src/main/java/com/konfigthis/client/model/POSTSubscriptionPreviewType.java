...
public class POSTSubscriptionPreviewType {
  ...
  public POSTSubscriptionPreviewType() {
  }
  ...
  **/
  ...
  public POSTSubscriptionPreviewType documentDate(LocalDate documentDate) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewType includeExistingDraftDocItems(Boolean includeExistingDraftDocItems) {
  ...
  **/
  ...
  public POSTSubscriptionPreviewType targetDate(LocalDate targetDate) {
  ...
  **/
   ...
   * @return the POSTSubscriptionPreviewType instance itself
   */
  public POSTSubscriptionPreviewType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountKey, poSTSubscriptionPreviewType.accountKey) &&
        ...
        Objects.equals(this.documentDate, poSTSubscriptionPreviewType.documentDate) &&
        Objects.equals(this.includeExistingDraftDocItems, poSTSubscriptionPreviewType.includeExistingDraftDocItems) &&
        ...
        Objects.equals(this.targetDate, poSTSubscriptionPreviewType.targetDate) &&
        ...
        Objects.equals(this.additionalProperties, poSTSubscriptionPreviewType.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to POSTSubscriptionPreviewType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!POSTSubscriptionPreviewType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in POSTSubscriptionPreviewType is not found in the empty JSON string", POSTSubscriptionPreviewType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : POSTSubscriptionPreviewType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!POSTSubscriptionPreviewType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'POSTSubscriptionPreviewType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<POSTSubscriptionPreviewType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(POSTSubscriptionPreviewType.class));

       return (TypeAdapter<T>) new TypeAdapter<POSTSubscriptionPreviewType>() {
           @Override
           public void write(JsonWriter out, POSTSubscriptionPreviewType value) throws IOException {
           ...
           @Override
           public POSTSubscriptionPreviewType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             POSTSubscriptionPreviewType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of POSTSubscriptionPreviewType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of POSTSubscriptionPreviewType
  * @throws IOException if the JSON string is invalid with respect to POSTSubscriptionPreviewType
  */
  public static POSTSubscriptionPreviewType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, POSTSubscriptionPreviewType.class);
  }

 /**
  * Convert an instance of POSTSubscriptionPreviewType to an JSON string
  *
  * @return JSON string
  */
