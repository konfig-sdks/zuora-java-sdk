...
public class CreateOrderResume {
  ...
  **/
  ...
  @ApiModelProperty(value = "Specifies whether to extend the subscription term by the length of time the suspension is in effect. ")
  ...
  **/
  ...
  public CreateOrderResume resumePeriodsType(ResumePeriodsTypeEnum resumePeriodsType) {
  ...
  **/
  ...
  public CreateOrderResume resumePolicy(ResumePolicyEnum resumePolicy) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Resume methods. Specify a way to resume a subscription. See [Resume Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Resume_a_Subscription#Resume_Date) for more information.  If `SuspendDate` is specfied, the resumption will take place on the same day as the suspension.  ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This field is applicable only when the `resumePolicy` field is set to `SpecificDate`.  A specific date when the subscription resumption takes effect, in YYYY-MM-DD format. The value should not be earlier than the subscription suspension date. ")
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateOrderResume
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateOrderResume.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CreateOrderResume> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOrderResume.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOrderResume>() {
           @Override
