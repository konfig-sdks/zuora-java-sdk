...
public class RecurringDeliveryPricingUpdate {
  /**
 ...
 public enum PriceChangeOptionEnum {
  ...
  public RecurringDeliveryPricingUpdate() {
  }

  public RecurringDeliveryPricingUpdate priceChangeOption(PriceChangeOptionEnum priceChangeOption) {
  ...
  **/
  ...
  public RecurringDeliveryPricingUpdate priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  public RecurringDeliveryPricingUpdate priceIncreasePercentage(Integer priceIncreasePercentage) {
    if (priceIncreasePercentage != null && priceIncreasePercentage < -100) {
      throw new IllegalArgumentException("Invalid value for priceIncreasePercentage. Must be greater than or equal to -100.");
    }
  ...
  **/
  ...
  public RecurringDeliveryPricingUpdate deliverySchedule(DeliveryScheduleParams deliverySchedule) {
  ...
  **/
  ...
  public RecurringDeliveryPricingUpdate listPrice(Double listPrice) {
  ...
  public RecurringDeliveryPricingUpdate listPrice(Integer listPrice) {
  ...
  **/
   ...
   * @return the RecurringDeliveryPricingUpdate instance itself
   */
  public RecurringDeliveryPricingUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecurringDeliveryPricingUpdate recurringDeliveryPricingUpdate = (RecurringDeliveryPricingUpdate) o;
    return Objects.equals(this.priceChangeOption, recurringDeliveryPricingUpdate.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, recurringDeliveryPricingUpdate.priceIncreasePercentage) &&
        Objects.equals(this.deliverySchedule, recurringDeliveryPricingUpdate.deliverySchedule) &&
        Objects.equals(this.listPrice, recurringDeliveryPricingUpdate.listPrice)&&
        Objects.equals(this.additionalProperties, recurringDeliveryPricingUpdate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecurringDeliveryPricingUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecurringDeliveryPricingUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecurringDeliveryPricingUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurringDeliveryPricingUpdate is not found in the empty JSON string", RecurringDeliveryPricingUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurringDeliveryPricingUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurringDeliveryPricingUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurringDeliveryPricingUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurringDeliveryPricingUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurringDeliveryPricingUpdate>() {
           @Override
           public void write(JsonWriter out, RecurringDeliveryPricingUpdate value) throws IOException {
           ...
           @Override
           public RecurringDeliveryPricingUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecurringDeliveryPricingUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecurringDeliveryPricingUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecurringDeliveryPricingUpdate
  * @throws IOException if the JSON string is invalid with respect to RecurringDeliveryPricingUpdate
  */
  public static RecurringDeliveryPricingUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurringDeliveryPricingUpdate.class);
  }

 /**
  * Convert an instance of RecurringDeliveryPricingUpdate to an JSON string
  *
  * @return JSON string
  */
