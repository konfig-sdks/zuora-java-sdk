...
import com.konfigthis.client.model.PostDiscountItemType;
import com.konfigthis.client.model.PostTaxationItemType;
...
public class PostInvoiceItemType {
  ...
  private List<PostDiscountItemType> discountItems = null;
 ...
 public enum RevRecTriggerConditionEnum {
  ...
  private List<PostTaxationItemType> taxItems = null;

  /**
   * The tax mode of the invoice item, indicating whether the amount of the invoice item includes tax.  **Note**: This field is only available only if you have Taxation enabled. 
   */
 ...
 public enum TaxModeEnum {
  ...
  public PostInvoiceItemType() {
  }

  public PostInvoiceItemType description(String description) {
  ...
  **/
  ...
  public PostInvoiceItemType accountingCode(String accountingCode) {
  ...
  **/
  ...
  public PostInvoiceItemType adjustmentLiabilityAccountingCode(String adjustmentLiabilityAccountingCode) {
  ...
  **/
  ...
  public PostInvoiceItemType adjustmentRevenueAccountingCode(String adjustmentRevenueAccountingCode) {
  ...
  **/
  ...
  public PostInvoiceItemType amount(BigDecimal amount) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The amount of the invoice item.   - For tax-inclusive invoice items, the amount indicates the invoice item amount including tax.  - For tax-exclusive invoice items, the amount indicates the invoice item amount excluding tax. ")
  ...
  public PostInvoiceItemType bookingReference(String bookingReference) {
  ...
  **/
  ...
  public PostInvoiceItemType chargeDate(OffsetDateTime chargeDate) {
  ...
  **/
  ...
  public PostInvoiceItemType chargeName(String chargeName) {
  ...
  **/
  ...
  public PostInvoiceItemType contractAssetAccountingCode(String contractAssetAccountingCode) {
  ...
  **/
  ...
  public PostInvoiceItemType contractLiabilityAccountingCode(String contractLiabilityAccountingCode) {
  ...
  **/
  ...
  public PostInvoiceItemType contractRecognizedRevenueAccountingCode(String contractRecognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public PostInvoiceItemType deferredRevenueAccountingCode(String deferredRevenueAccountingCode) {
  ...
  **/
  ...
  public PostInvoiceItemType discountItems(List<PostDiscountItemType> discountItems) {
  ...
  public PostInvoiceItemType addDiscountItemsItem(PostDiscountItemType discountItemsItem) {
  ...
  **/
  ...
  public List<PostDiscountItemType> getDiscountItems() {
    return discountItems;
  }


  public void setDiscountItems(List<PostDiscountItemType> discountItems) {
  ...
  public PostInvoiceItemType excludeItemBillingFromRevenueAccounting(Boolean excludeItemBillingFromRevenueAccounting) {
  ...
  **/
  ...
  public PostInvoiceItemType itemType(String itemType) {
  ...
  **/
  ...
  public PostInvoiceItemType productRatePlanChargeId(String productRatePlanChargeId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the product rate plan charge that the invoice item is created from.  If you specify a value for the `productRatePlanChargeId` field in the request, Zuora directly copies the values of the following fields from the corresponding product rate plan charge, regardless of the values specified in the request body: - `chargeName` - `sku` - `uom` - `taxCode` - `taxMode` - `accountingCode` - `deferredRevenueAccountingCode`  - `recognizedRevenueAccountingCode` ")
  ...
  public PostInvoiceItemType purchaseOrderNumber(String purchaseOrderNumber) {
  ...
  **/
  ...
  public PostInvoiceItemType quantity(BigDecimal quantity) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The number of units for the invoice item. ")
  ...
  public PostInvoiceItemType recognizedRevenueAccountingCode(String recognizedRevenueAccountingCode) {
  ...
  **/
  ...
  public PostInvoiceItemType revRecCode(String revRecCode) {
  ...
  **/
  ...
  public PostInvoiceItemType revRecTriggerCondition(RevRecTriggerConditionEnum revRecTriggerCondition) {
  ...
  **/
  ...
  public PostInvoiceItemType revenueRecognitionRuleName(String revenueRecognitionRuleName) {
  ...
  **/
  ...
  public PostInvoiceItemType serviceEndDate(LocalDate serviceEndDate) {
  ...
  **/
  ...
  public PostInvoiceItemType serviceStartDate(LocalDate serviceStartDate) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The service start date of the invoice item. ")
  ...
  public PostInvoiceItemType sku(String sku) {
  ...
  **/
  ...
  public PostInvoiceItemType taxCode(String taxCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The tax code identifies which tax rules and tax rates to apply to the invoice item.  **Note**: This field is only available only if you have Taxation enabled. ")
  ...
  public PostInvoiceItemType taxItems(List<PostTaxationItemType> taxItems) {
  ...
  public PostInvoiceItemType addTaxItemsItem(PostTaxationItemType taxItemsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Container for taxation items. The maximum number of taxation items is 5.  **Note**: This field is only available only if you have Taxation enabled. ")

  public List<PostTaxationItemType> getTaxItems() {
    return taxItems;
  }


  public void setTaxItems(List<PostTaxationItemType> taxItems) {
  ...
  public PostInvoiceItemType taxMode(TaxModeEnum taxMode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The tax mode of the invoice item, indicating whether the amount of the invoice item includes tax.  **Note**: This field is only available only if you have Taxation enabled. ")
  ...
  public PostInvoiceItemType unbilledReceivablesAccountingCode(String unbilledReceivablesAccountingCode) {
  ...
  **/
  ...
  public PostInvoiceItemType unitPrice(BigDecimal unitPrice) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The per-unit price of the invoice item. To pass Level 3 data to the gateway, this field is required and must be greater than zero. ")
  ...
  public PostInvoiceItemType uom(String uom) {
  ...
  **/
  ...
  public PostInvoiceItemType integrationIdNS(String integrationIdNS) {
  ...
  **/
  ...
  public PostInvoiceItemType integrationStatusNS(String integrationStatusNS) {
  ...
  **/
  ...
  public PostInvoiceItemType syncDateNS(String syncDateNS) {
  ...
  **/
   ...
   * @return the PostInvoiceItemType instance itself
   */
  public PostInvoiceItemType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PostInvoiceItemType postInvoiceItemType = (PostInvoiceItemType) o;
    return Objects.equals(this.description, postInvoiceItemType.description) &&
        Objects.equals(this.accountingCode, postInvoiceItemType.accountingCode) &&
        Objects.equals(this.adjustmentLiabilityAccountingCode, postInvoiceItemType.adjustmentLiabilityAccountingCode) &&
        Objects.equals(this.adjustmentRevenueAccountingCode, postInvoiceItemType.adjustmentRevenueAccountingCode) &&
        Objects.equals(this.amount, postInvoiceItemType.amount) &&
        Objects.equals(this.bookingReference, postInvoiceItemType.bookingReference) &&
        Objects.equals(this.chargeDate, postInvoiceItemType.chargeDate) &&
        Objects.equals(this.chargeName, postInvoiceItemType.chargeName) &&
        Objects.equals(this.contractAssetAccountingCode, postInvoiceItemType.contractAssetAccountingCode) &&
        Objects.equals(this.contractLiabilityAccountingCode, postInvoiceItemType.contractLiabilityAccountingCode) &&
        Objects.equals(this.contractRecognizedRevenueAccountingCode, postInvoiceItemType.contractRecognizedRevenueAccountingCode) &&
        Objects.equals(this.deferredRevenueAccountingCode, postInvoiceItemType.deferredRevenueAccountingCode) &&
        Objects.equals(this.discountItems, postInvoiceItemType.discountItems) &&
        Objects.equals(this.excludeItemBillingFromRevenueAccounting, postInvoiceItemType.excludeItemBillingFromRevenueAccounting) &&
        Objects.equals(this.itemType, postInvoiceItemType.itemType) &&
        Objects.equals(this.productRatePlanChargeId, postInvoiceItemType.productRatePlanChargeId) &&
        Objects.equals(this.purchaseOrderNumber, postInvoiceItemType.purchaseOrderNumber) &&
        Objects.equals(this.quantity, postInvoiceItemType.quantity) &&
        Objects.equals(this.recognizedRevenueAccountingCode, postInvoiceItemType.recognizedRevenueAccountingCode) &&
        Objects.equals(this.revRecCode, postInvoiceItemType.revRecCode) &&
        Objects.equals(this.revRecTriggerCondition, postInvoiceItemType.revRecTriggerCondition) &&
        Objects.equals(this.revenueRecognitionRuleName, postInvoiceItemType.revenueRecognitionRuleName) &&
        Objects.equals(this.serviceEndDate, postInvoiceItemType.serviceEndDate) &&
        Objects.equals(this.serviceStartDate, postInvoiceItemType.serviceStartDate) &&
        Objects.equals(this.sku, postInvoiceItemType.sku) &&
        Objects.equals(this.taxCode, postInvoiceItemType.taxCode) &&
        Objects.equals(this.taxItems, postInvoiceItemType.taxItems) &&
        Objects.equals(this.taxMode, postInvoiceItemType.taxMode) &&
        Objects.equals(this.unbilledReceivablesAccountingCode, postInvoiceItemType.unbilledReceivablesAccountingCode) &&
        Objects.equals(this.unitPrice, postInvoiceItemType.unitPrice) &&
        Objects.equals(this.uom, postInvoiceItemType.uom) &&
        Objects.equals(this.integrationIdNS, postInvoiceItemType.integrationIdNS) &&
        Objects.equals(this.integrationStatusNS, postInvoiceItemType.integrationStatusNS) &&
        Objects.equals(this.syncDateNS, postInvoiceItemType.syncDateNS)&&
        Objects.equals(this.additionalProperties, postInvoiceItemType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, accountingCode, adjustmentLiabilityAccountingCode, adjustmentRevenueAccountingCode, amount, bookingReference, chargeDate, chargeName, contractAssetAccountingCode, contractLiabilityAccountingCode, contractRecognizedRevenueAccountingCode, deferredRevenueAccountingCode, discountItems, excludeItemBillingFromRevenueAccounting, itemType, productRatePlanChargeId, purchaseOrderNumber, quantity, recognizedRevenueAccountingCode, revRecCode, revRecTriggerCondition, revenueRecognitionRuleName, serviceEndDate, serviceStartDate, sku, taxCode, taxItems, taxMode, unbilledReceivablesAccountingCode, unitPrice, uom, integrationIdNS, integrationStatusNS, syncDateNS, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostInvoiceItemType {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("serviceStartDate");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PostInvoiceItemType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PostInvoiceItemType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostInvoiceItemType is not found in the empty JSON string", PostInvoiceItemType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostInvoiceItemType.openapiRequiredFields) {
      ...
      if (jsonObj.get("discountItems") != null && !jsonObj.get("discountItems").isJsonNull()) {
        ...
        if (jsonArraydiscountItems != null) {
          ...
          for (int i = 0; i < jsonArraydiscountItems.size(); i++) {
            PostDiscountItemType.validateJsonObject(jsonArraydiscountItems.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("taxItems") != null && !jsonObj.get("taxItems").isJsonNull()) {
        ...
        if (jsonArraytaxItems != null) {
          ...
          for (int i = 0; i < jsonArraytaxItems.size(); i++) {
            PostTaxationItemType.validateJsonObject(jsonArraytaxItems.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostInvoiceItemType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostInvoiceItemType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostInvoiceItemType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostInvoiceItemType.class));

       return (TypeAdapter<T>) new TypeAdapter<PostInvoiceItemType>() {
           @Override
           public void write(JsonWriter out, PostInvoiceItemType value) throws IOException {
           ...
           @Override
           public PostInvoiceItemType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PostInvoiceItemType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PostInvoiceItemType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PostInvoiceItemType
  * @throws IOException if the JSON string is invalid with respect to PostInvoiceItemType
  */
  public static PostInvoiceItemType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostInvoiceItemType.class);
  }

 /**
  * Convert an instance of PostInvoiceItemType to an JSON string
  *
  * @return JSON string
  */
