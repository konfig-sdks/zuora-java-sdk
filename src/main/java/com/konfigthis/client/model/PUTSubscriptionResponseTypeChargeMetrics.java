...
public class PUTSubscriptionResponseTypeChargeMetrics {
  ...
  public PUTSubscriptionResponseTypeChargeMetrics() {
  }
  ...
  **/
   ...
   * @return the PUTSubscriptionResponseTypeChargeMetrics instance itself
   */
  public PUTSubscriptionResponseTypeChargeMetrics putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dmrr, puTSubscriptionResponseTypeChargeMetrics.dmrr) &&
        ...
        Objects.equals(this.additionalProperties, puTSubscriptionResponseTypeChargeMetrics.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PUTSubscriptionResponseTypeChargeMetrics
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PUTSubscriptionResponseTypeChargeMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PUTSubscriptionResponseTypeChargeMetrics is not found in the empty JSON string", PUTSubscriptionResponseTypeChargeMetrics.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PUTSubscriptionResponseTypeChargeMetrics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PUTSubscriptionResponseTypeChargeMetrics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PUTSubscriptionResponseTypeChargeMetrics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PUTSubscriptionResponseTypeChargeMetrics.class));

       return (TypeAdapter<T>) new TypeAdapter<PUTSubscriptionResponseTypeChargeMetrics>() {
           @Override
           public void write(JsonWriter out, PUTSubscriptionResponseTypeChargeMetrics value) throws IOException {
           ...
           @Override
           public PUTSubscriptionResponseTypeChargeMetrics read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PUTSubscriptionResponseTypeChargeMetrics instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PUTSubscriptionResponseTypeChargeMetrics given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PUTSubscriptionResponseTypeChargeMetrics
  * @throws IOException if the JSON string is invalid with respect to PUTSubscriptionResponseTypeChargeMetrics
  */
  public static PUTSubscriptionResponseTypeChargeMetrics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PUTSubscriptionResponseTypeChargeMetrics.class);
  }

 /**
  * Convert an instance of PUTSubscriptionResponseTypeChargeMetrics to an JSON string
  *
  * @return JSON string
  */
