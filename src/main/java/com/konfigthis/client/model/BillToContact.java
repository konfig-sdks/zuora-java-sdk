...
public class BillToContact {
  ...
  **/
  ...
  public BillToContact otherPhoneType(OtherPhoneTypeEnum otherPhoneType) {
  ...
  **/
   ...
   * @return the BillToContact instance itself
   */
  public BillToContact putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address1, billToContact.address1) &&
        ...
        Objects.equals(this.additionalProperties, billToContact.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BillToContact
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BillToContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BillToContact is not found in the empty JSON string", BillToContact.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BillToContact.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BillToContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BillToContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BillToContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BillToContact.class));

       return (TypeAdapter<T>) new TypeAdapter<BillToContact>() {
           @Override
           public void write(JsonWriter out, BillToContact value) throws IOException {
           ...
           @Override
           public BillToContact read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BillToContact instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BillToContact given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BillToContact
  * @throws IOException if the JSON string is invalid with respect to BillToContact
  */
  public static BillToContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BillToContact.class);
  }

 /**
  * Convert an instance of BillToContact to an JSON string
  *
  * @return JSON string
  */
