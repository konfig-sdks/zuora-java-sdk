...
/**
 * API tests for PaymentRunsApi
 */
@Disabled
public class PaymentRunsApiTest {

    private static PaymentRunsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PaymentRunsApi(apiClient);
    }
     ...
     */
    @Test
    public void paymentRunTest() throws ApiException {
        UUID accountId = null;
        Boolean applyCreditBalance = null;
        Boolean autoApplyCreditMemo = null;
        Boolean autoApplyUnappliedPayment = null;
        String batch = null;
        String billCycleDay = null;
        UUID billingRunId = null;
        Boolean collectPayment = null;
        Boolean consolidatedPayment = null;
        String currency = null;
        List<POSTPaymentRunDataElementRequest> data = null;
        List<GETCatalogGroupProductRatePlanResponseOrganizationLabelsInner> organizationLabels = null;
        UUID paymentGatewayId = null;
        Boolean processPaymentWithClosedPM = null;
        OffsetDateTime runDate = null;
        ...
        GETPaymentRunType response = api.paymentRun()
                .accountId(accountId)
     ...
     */
    @Test
    public void paymentRunDataTest() throws ApiException {
        String paymentRunKey = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        String zuoraTrackId = null;
        GETPaymentRunDataArrayResponse response = api.paymentRunData(paymentRunKey)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void paymentRunSummaryTest() throws ApiException {
        String paymentRunKey = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        String zuoraTrackId = null;
        GETPaymentRunSummaryResponse response = api.paymentRunSummary(paymentRunKey)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void paymentRun_0Test() throws ApiException {
        String paymentRunKey = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        ...
        String zuoraEntityIds = null;
        String zuoraOrgIds = null;
        GETPaymentRunType response = api.paymentRun_0(paymentRunKey)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void paymentRun_1Test() throws ApiException {
        String paymentRunKey = null;
        UUID accountId = null;
        Boolean applyCreditBalance = null;
        Boolean autoApplyCreditMemo = null;
        ...
        String zuoraEntityIds = null;
        String zuoraOrgIds = null;
        GETPaymentRunType response = api.paymentRun_1(paymentRunKey)
                .accountId(accountId)
                .applyCreditBalance(applyCreditBalance)
                .autoApplyCreditMemo(autoApplyCreditMemo)
                .autoApplyUnappliedPayment(autoApplyUnappliedPayment)
     ...
     */
    @Test
    public void paymentRun_2Test() throws ApiException {
        String paymentRunKey = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        String zuoraTrackId = null;
        CommonResponse response = api.paymentRun_2(paymentRunKey)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void paymentRunsTest() throws ApiException {
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        String zuoraTrackId = null;
        ...
        String sort = null;
        GETPaymentRunCollectionType response = api.paymentRuns()
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
