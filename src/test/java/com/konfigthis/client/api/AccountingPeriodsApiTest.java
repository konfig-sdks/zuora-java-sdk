...
import com.konfigthis.client.model.GETAccountingPeriodType;
import com.konfigthis.client.model.GETAccountingPeriodsType;
import com.konfigthis.client.model.GETProductTypeAllOfOrganizationLabels;
import java.time.LocalDate;
import com.konfigthis.client.model.POSTAccountingPeriodResponseType;
import com.konfigthis.client.model.POSTAccountingPeriodType;
import com.konfigthis.client.model.PUTAccountingPeriodType;
...
public class AccountingPeriodsApiTest {
    ...
    private static AccountingPeriodsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new AccountingPeriodsApi(apiClient);
    }
     ...
     */
    @Test
    public void accountingPeriodTest() throws ApiException {
        LocalDate endDate = null;
        String fiscalYear = null;
        Long fiscalQuarter = null;
        String name = null;
        String notes = null;
        List<GETProductTypeAllOfOrganizationLabels> organizationLabels = null;
        ...
        POSTAccountingPeriodResponseType response = api.accountingPeriod()
                .endDate(endDate)
     ...
     */
    @Test
    public void accountingPeriod_0Test() throws ApiException {
        String apId = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        ...
        String zuoraEntityIds = null;
        String zuoraOrgIds = null;
        GETAccountingPeriodType response = api.accountingPeriod_0(apId)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void accountingPeriod_1Test() throws ApiException {
        String apId = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        ...
        String zuoraEntityIds = null;
        String zuoraOrgIds = null;
        CommonResponse response = api.accountingPeriod_1(apId)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void allAccountingPeriodsTest() throws ApiException {
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        String zuoraTrackId = null;
        ...
        GETAccountingPeriodsType response = api.allAccountingPeriods()
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void closeAccountingPeriodTest() throws ApiException {
        String apId = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        ...
        String zuoraEntityIds = null;
        String zuoraOrgIds = null;
        CommonResponse response = api.closeAccountingPeriod(apId)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void pendingCloseAccountingPeriodTest() throws ApiException {
        String apId = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        ...
        String zuoraEntityIds = null;
        String zuoraOrgIds = null;
        CommonResponse response = api.pendingCloseAccountingPeriod(apId)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void reopenAccountingPeriodTest() throws ApiException {
        String apId = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        ...
        String zuoraEntityIds = null;
        String zuoraOrgIds = null;
        CommonResponse response = api.reopenAccountingPeriod(apId)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void runTrialBalanceTest() throws ApiException {
        String apId = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        ...
        String zuoraEntityIds = null;
        String zuoraOrgIds = null;
        CommonResponse response = api.runTrialBalance(apId)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
    ...
    public void updateAccountingPeriodTest() throws ApiException {
        ...
        String zuoraEntityIds = null;
        String zuoraOrgIds = null;
        CommonResponse response = api.updateAccountingPeriod(apId)
                .endDate(endDate)
                .fiscalYear(fiscalYear)
                .fiscalQuarter(fiscalQuarter)
                .name(name)
