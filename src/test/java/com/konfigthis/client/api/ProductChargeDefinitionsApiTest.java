...
/**
 * API tests for ProductChargeDefinitionsApi
 */
@Disabled
public class ProductChargeDefinitionsApiTest {

    private static ProductChargeDefinitionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ProductChargeDefinitionsApi(apiClient);
    }
     ...
     */
    @Test
    public void createProductChargeDefinitionTest() throws ApiException {
        ...
        POSTChargeDefinitionResponse response = api.createProductChargeDefinition()
     ...
     */
    @Test
    public void createProductChargeDefinitionBulkTest() throws ApiException {
        List<POSTChargeDefinitionRequest> productChargeDefinitions = null;
        String idempotencyKey = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        String zuoraTrackId = null;
        String zuoraEntityIds = null;
        POSTChargeDefinitionBulkResponse response = api.createProductChargeDefinitionBulk()
     ...
     */
    @Test
    public void productChargeDefnitionTest() throws ApiException {
        String productChargeDefinitionKey = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        String zuoraTrackId = null;
        String zuoraEntityIds = null;
        CommonResponse response = api.productChargeDefnition(productChargeDefinitionKey)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void retrieveProductChargeDefinitionTest() throws ApiException {
        String productChargeDefinitionKey = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        String zuoraTrackId = null;
        String zuoraEntityIds = null;
        Boolean hideInheritedValues = null;
        GETProductChargeDefinitionResponse response = api.retrieveProductChargeDefinition(productChargeDefinitionKey)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void retrieveProductChargeDefinitionsTest() throws ApiException {
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        String zuoraTrackId = null;
        ...
        Boolean hideInheritedValues = null;
        GETProductChargeDefinitionsResponse response = api.retrieveProductChargeDefinitions()
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
     ...
     */
    @Test
    public void updateProductChargeDefinitionTest() throws ApiException {
        String productChargeDefinitionKey = null;
        String billingPeriod = null;
        String billingTiming = null;
        String chargeModel = null;
        ...
        String zuoraTrackId = null;
        String zuoraEntityIds = null;
        GETProductChargeDefinitionResponse response = api.updateProductChargeDefinition(productChargeDefinitionKey)
                .billingPeriod(billingPeriod)
                .billingTiming(billingTiming)
                .chargeModel(chargeModel)
                .defaultQuantity(defaultQuantity)
     ...
     */
    @Test
    public void updateProductChargeDefinitionBulkTest() throws ApiException {
        List<PUTBulkProductChargeDefinitionRequest> productChargeDefinitions = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        String zuoraTrackId = null;
        String zuoraEntityIds = null;
        GETProductChargeDefinitionsResponse response = api.updateProductChargeDefinitionBulk()
                .productChargeDefinitions(productChargeDefinitions)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
