...
public class ProductRatePlanChargesApiTest {
    ...
    private static ProductRatePlanChargesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ProductRatePlanChargesApi(apiClient);
    }
     ...
     */
    @Test
    public void dELETEProductRatePlanChargeTest() throws ApiException {
        String id = null;
        ...
        ProxyDeleteResponse response = api.dELETEProductRatePlanCharge(id)
     ...
     */
    @Test
    public void gETProductRatePlanChargeTest() throws ApiException {
        String id = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        ...
        String zuoraOrgIds = null;
        String zuoraTrackId = null;
        String xZuoraWSDLVersion = null;
        String fields = null;
        ProxyGetProductRatePlanCharge response = api.gETProductRatePlanCharge(id)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraEntityIds(zuoraEntityIds)
     ...
     */
    @Test
    public void pOSTProductRatePlanChargeTest() throws ApiException {
        String accountingCode = null;
        String applyDiscountTo = null;
        Integer billCycleDay = null;
        String billCycleType = null;
        String billingPeriod = null;
        String billingPeriodAlignment = null;
        String billingTiming = null;
        String chargeFunction = null;
        String commitmentType = null;
        String chargeModel = null;
        ProxyCreateOrModifyProductRatePlanChargeChargeModelConfiguration chargeModelConfiguration = null;
        String chargeType = null;
        String creditOption = null;
        Double defaultQuantity = null;
        String deferredRevenueAccount = null;
        ProxyCreateOrModifyDeliverySchedule deliverySchedule = null;
        String description = null;
        String discountLevel = null;
        Double drawdownRate = null;
        String drawdownUom = null;
        String endDateCondition = null;
        Boolean excludeItemBillingFromRevenueAccounting = null;
        Boolean excludeItemBookingFromRevenueAccounting = null;
        Double includedUnits = null;
        Boolean isAllocationEligible = null;
        Boolean isPrepaid = null;
        Boolean isRollover = null;
        Boolean isStackedDiscount = null;
        Boolean isUnbilled = null;
        Boolean legacyRevenueReporting = null;
        String listPriceBase = null;
        Double maxQuantity = null;
        Double minQuantity = null;
        String name = null;
        Long numberOfPeriod = null;
        String overageCalculationOption = null;
        String overageUnusedUnitsCreditOption = null;
        String prepaidOperationType = null;
        Double prepaidQuantity = null;
        Double prepaidTotalQuantity = null;
        String prepaidUom = null;
        String priceChangeOption = null;
        String priceIncreaseOption = null;
        Double priceIncreasePercentage = null;
        String productCategory = null;
        String productClass = null;
        String productFamily = null;
        String productLine = null;
        String revenueRecognitionTiming = null;
        String revenueAmortizationMethod = null;
        String productRatePlanChargeNumber = null;
        ProxyCreateOrModifyProductRatePlanChargeTierData productRatePlanChargeTierData = null;
        String productRatePlanId = null;
        String ratingGroup = null;
        String recognizedRevenueAccount = null;
        String revRecCode = null;
        String revRecTriggerCondition = null;
        String revenueRecognitionRuleName = null;
        String rolloverApply = null;
        Double rolloverPeriods = null;
        String smoothingModel = null;
        Long specificBillingPeriod = null;
        Integer specificListPriceBase = null;
        String taxCode = null;
        String taxMode = null;
        Boolean taxable = null;
        String triggerEvent = null;
        String UOM = null;
        Long upToPeriods = null;
        String upToPeriodsType = null;
        String usageRecordRatingOption = null;
        Boolean useDiscountSpecificAccountingCode = null;
        Boolean useTenantDefaultForPriceChange = null;
        String validityPeriodType = null;
        String weeklyBillCycleDay = null;
        Boolean applyToBillingPeriodPartially = null;
        Integer rolloverPeriodLength = null;
        String formula = null;
        String classNS = null;
        String deferredRevAccountNS = null;
        String departmentNS = null;
        String includeChildrenNS = null;
        String integrationIdNS = null;
        String integrationStatusNS = null;
        String itemTypeNS = null;
        String locationNS = null;
        String recognizedRevAccountNS = null;
        String revRecEndNS = null;
        String revRecStartNS = null;
        String revRecTemplateTypeNS = null;
        ...
        String contentEncoding = null;
        String authorization = null;
        Boolean rejectUnknownFields = null;
        String zuoraEntityIds = null;
        String zuoraOrgIds = null;
        String zuoraTrackId = null;
        String xZuoraWSDLVersion = null;
        ProxyCreateOrModifyResponse response = api.pOSTProductRatePlanCharge()
     ...
     */
    @Test
    public void pUTProductRatePlanChargeTest() throws ApiException {
        String id = null;
        String accountingCode = null;
        String applyDiscountTo = null;
        Integer billCycleDay = null;
        ...
        String zuoraTrackId = null;
        String xZuoraWSDLVersion = null;
        ProxyCreateOrModifyResponse response = api.pUTProductRatePlanCharge(id)
                .accountingCode(accountingCode)
                .applyDiscountTo(applyDiscountTo)
                .billCycleDay(billCycleDay)
                .billCycleType(billCycleType)
     ...
     */
    @Test
    public void retrieveProductRatePlanChargeTest() throws ApiException {
        String productRatePlanChargeKey = null;
        String acceptEncoding = null;
        String contentEncoding = null;
        String authorization = null;
        String zuoraTrackId = null;
        String zuoraEntityIds = null;
        Boolean showChargeDefinitions = null;
        GETProductRatePlanChargeResponse response = api.retrieveProductRatePlanCharge(productRatePlanChargeKey)
                .acceptEncoding(acceptEncoding)
                .contentEncoding(contentEncoding)
                .authorization(authorization)
                .zuoraTrackId(zuoraTrackId)
