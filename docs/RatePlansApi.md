...
|------------- | ------------- | -------------|
| [**ratePlan**](RatePlansApi.md#ratePlan) | **GET** /v1/rateplans/{ratePlanId} | Retrieve a rate plan |


<a name="ratePlan"></a>
# **ratePlan**
> GetOrderActionRatePlanResponse ratePlan(ratePlanId).acceptEncoding(acceptEncoding).contentEncoding(contentEncoding).authorization(authorization).zuoraTrackId(zuoraTrackId).zuoraEntityIds(zuoraEntityIds).zuoraOrgIds(zuoraOrgIds).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String ratePlanId = "ratePlanId_example"; // The ID of the subscription rate plan to be retrieved.
    ...
    try {
      GetOrderActionRatePlanResponse result = client
              .ratePlans
              .ratePlan(ratePlanId)
      ...
      System.out.println(result.getAmendment());
      System.out.println(result.getExternallyManagedPlanId());
      System.out.println(result.getId());
      System.out.println(result.getLastChangeType());
      ...
      System.out.println(result.getProductSku());
      System.out.println(result.getRatePlanName());
      System.out.println(result.getSubscriptionId());
      System.out.println(result.getSubscriptionVersion());
    } catch (ApiException e) {
      System.err.println("Exception when calling RatePlansApi#ratePlan");
    ...
    try {
      ApiResponse<GetOrderActionRatePlanResponse> response = client
              .ratePlans
              .ratePlan(ratePlanId)
              .acceptEncoding(acceptEncoding)
              .contentEncoding(contentEncoding)
