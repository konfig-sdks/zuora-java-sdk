...
|------------- | ------------- | -------------|
| [**paymentgateways**](PaymentGatewaysApi.md#paymentgateways) | **GET** /v1/paymentgateways | List all payment gateways |


<a name="paymentgateways"></a>
# **paymentgateways**
> GETPaymentGatwaysResponse paymentgateways().acceptEncoding(acceptEncoding).contentEncoding(contentEncoding).authorization(authorization).zuoraTrackId(zuoraTrackId).zuoraEntityIds(zuoraEntityIds).zuoraOrgIds(zuoraOrgIds).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GETPaymentGatwaysResponse result = client
              .paymentGateways
              .paymentgateways()
      ...
      System.out.println(result.getPaymentgateways());
      System.out.println(result.getSuccess());
    } catch (ApiException e) {
      System.err.println("Exception when calling PaymentGatewaysApi#paymentgateways");
    ...
    try {
      ApiResponse<GETPaymentGatwaysResponse> response = client
              .paymentGateways
              .paymentgateways()
              .acceptEncoding(acceptEncoding)
              .contentEncoding(contentEncoding)
