...
|------------- | ------------- | -------------|
| [**systemHealthPaymentVolumeSummary**](ElectronicPaymentsHealthApi.md#systemHealthPaymentVolumeSummary) | **GET** /system-health/payments/volume-summary | List payment volume summary records |


<a name="systemHealthPaymentVolumeSummary"></a>
# **systemHealthPaymentVolumeSummary**
> GetPaymentVolumeSummaryResponse systemHealthPaymentVolumeSummary(authorization, startTime, endTime).acceptEncoding(acceptEncoding).contentEncoding(contentEncoding).zuoraEntityIds(zuoraEntityIds).zuoraOrgIds(zuoraOrgIds).zuoraTrackId(zuoraTrackId).paymentGatewayType(paymentGatewayType).paymentMethodType(paymentMethodType).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    OffsetDateTime endTime = OffsetDateTime.now(); // End time of the volume summary.  Format: `yyyy-MM-dd'T'HH:mmZ` Example: `2022-09-22T09:07+0800`. 
    ...
    String paymentGatewayType = "paymentGatewayType_example"; // Filters the volume summary by payment gateway type. Example: `Adyen`. 
    String paymentMethodType = "paymentMethodType_example"; // Filters the volume summary by payment method type. Example: `CreditCard`. 
    try {
      GetPaymentVolumeSummaryResponse result = client
              .electronicPaymentsHealth
              .systemHealthPaymentVolumeSummary(authorization, startTime, endTime)
      ...
      System.err.println("Exception when calling ElectronicPaymentsHealthApi#systemHealthPaymentVolumeSummary");
    ...
    try {
      ApiResponse<GetPaymentVolumeSummaryResponse> response = client
              .electronicPaymentsHealth
              .systemHealthPaymentVolumeSummary(authorization, startTime, endTime)
              .acceptEncoding(acceptEncoding)
              .contentEncoding(contentEncoding)
...
| **endTime** | **OffsetDateTime**| End time of the volume summary.  Format: &#x60;yyyy-MM-dd&#39;T&#39;HH:mmZ&#x60; Example: &#x60;2022-09-22T09:07+0800&#x60;.  | |
...
| **paymentGatewayType** | **String**| Filters the volume summary by payment gateway type. Example: &#x60;Adyen&#x60;.  | [optional] |
| **paymentMethodType** | **String**| Filters the volume summary by payment method type. Example: &#x60;CreditCard&#x60;.  | [optional] |
