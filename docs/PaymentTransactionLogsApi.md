...
|------------- | ------------- | -------------|
| [**gETPaymentTransactionLog**](PaymentTransactionLogsApi.md#gETPaymentTransactionLog) | **GET** /v1/object/payment-transaction-log/{id} | CRUD: Retrieve a payment transaction log |


<a name="gETPaymentTransactionLog"></a>
# **gETPaymentTransactionLog**
> ProxyGetPaymentTransactionLog gETPaymentTransactionLog(id).acceptEncoding(acceptEncoding).contentEncoding(contentEncoding).authorization(authorization).zuoraEntityIds(zuoraEntityIds).zuoraOrgIds(zuoraOrgIds).zuoraTrackId(zuoraTrackId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // The ID of a payment transaction log. 
    ...
    try {
      ProxyGetPaymentTransactionLog result = client
              .paymentTransactionLogs
              .gETPaymentTransactionLog(id)
      ...
      System.out.println(result.getAvSResponseCode());
      System.out.println(result.getBatchId());
      System.out.println(result.getCvVResponseCode());
      ...
      System.err.println("Exception when calling PaymentTransactionLogsApi#gETPaymentTransactionLog");
    ...
    try {
      ApiResponse<ProxyGetPaymentTransactionLog> response = client
              .paymentTransactionLogs
              .gETPaymentTransactionLog(id)
              .acceptEncoding(acceptEncoding)
              .contentEncoding(contentEncoding)
