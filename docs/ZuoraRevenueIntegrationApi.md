# ZuoraRevenueIntegrationApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|------------- | ------------- | -------------|
| [**revProAccountingCodes**](ZuoraRevenueIntegrationApi.md#revProAccountingCodes) | **PUT** /v1/revpro-accounting-codes | Update a Zuora Revenue accounting code |


<a name="revProAccountingCodes"></a>
# **revProAccountingCodes**
> PUTRevproAccCodeResponse revProAccountingCodes(authorization, revproAccountingCodes).acceptEncoding(acceptEncoding).contentEncoding(contentEncoding).zuoraEntityIds(zuoraEntityIds).zuoraOrgIds(zuoraOrgIds).zuoraTrackId(zuoraTrackId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String adjustmentLiabilityAccount = "adjustmentLiabilityAccount_example"; // The name of the account where the Account Type is \\\"Adjustment Liability\\\".
    String adjustmentRevenueAccount = "adjustmentRevenueAccount_example"; // The name of the account where the Account Type is \\\"Adjustment Revenue\\\".
    String contractAssetAccount = "contractAssetAccount_example"; // The name of the account where the Account Type is \\\"Contract Asset\\\".
    String contractLiabilityAccount = "contractLiabilityAccount_example"; // The name of the account where the Account Type is \\\"Contract Liability\\\".
    String productRatePlanChargeId = "productRatePlanChargeId_example"; // The ID of your product rate plan charge.
    String recognizedRevenueAccount = "recognizedRevenueAccount_example"; // The name of the account where the Account Type is \\\"Recognized Revenue\\\".
    String unbilledReceivablesAccount = "unbilledReceivablesAccount_example"; // The name of the account where the Account Type is \\\"Unbilled Receivables\\\".
    ...
    try {
      PUTRevproAccCodeResponse result = client
              .zuoraRevenueIntegration
              .revProAccountingCodes(adjustmentLiabilityAccount, adjustmentRevenueAccount, contractAssetAccount, contractLiabilityAccount, productRatePlanChargeId, recognizedRevenueAccount, unbilledReceivablesAccount, authorization)
      ...
      System.err.println("Exception when calling ZuoraRevenueIntegrationApi#revProAccountingCodes");
    ...
    try {
      ApiResponse<PUTRevproAccCodeResponse> response = client
              .zuoraRevenueIntegration
              .revProAccountingCodes(adjustmentLiabilityAccount, adjustmentRevenueAccount, contractAssetAccount, contractLiabilityAccount, productRatePlanChargeId, recognizedRevenueAccount, unbilledReceivablesAccount, authorization)
              .acceptEncoding(acceptEncoding)
              .contentEncoding(contentEncoding)
...
| **revproAccountingCodes** | [**RevproAccountingCodes**](RevproAccountingCodes.md)|  | |
